...
{ 
  ...
  private void chkKeyPressed(KeyEvent e)
  {
    if (e.getKeyCode() == KeyEvent.VK_F11)
    {
      ...
      VariablesRecepCiega.vOrden = FarmaLoadCVL.getCVLCode(ConstantsRecepCiega.NOM_HASTABLE_CMBORDEN,cmbOrden.getSelectedIndex());
        System.out.println("VariablesRecepCiega.vColumna "+VariablesRecepCiega.vColumna);
        System.out.println("VariablesRecepCiega.vOrden "+VariablesRecepCiega.vOrden);
      cerrarVentana(true);
    }
  ...
  /* ************************************************************************ */
   private void cargaCombos(){
     ...
     System.out.println("CARGA COMBOS");
