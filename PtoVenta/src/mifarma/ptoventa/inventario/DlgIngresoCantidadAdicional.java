 ...
 * Nombre de la Aplicación : DlgIngresoCantidadAdicional.java<br>
 * <br>
 * Histórico de Creación/Modificación<br>
 * LREQUE      20.04.2007   Creación<br>
 * <br>
...
public class DlgIngresoCantidadAdicional extends JDialog {
    /* ********************************************************************** */
    /*                        DECLARACION PROPIEDADES                         */
    /* ********************************************************************** */
    private static final Logger log = LoggerFactory.getLogger(DlgIngresoCantidadAdicional.class);
    ...
    public DlgIngresoCantidadAdicional(Frame parent, String title, boolean modal) {
    ...
    private void jbInit() throws Exception {
        ...
        this.setTitle("Ingreso Cantidad Adicional");
        ...
        lblCodProd_t.setText("Código");
        lblCodProd_t.setBounds(new Rectangle(15, 10, 60, 20));
        lblDescProd_t.setText("Descripción");
        ...
        lblValFrac_t.setText("Valor Fracción");
    ...
    private void funcion_f11() {
        ...
        if (!FarmaUtility.isInteger(vCantidad))
        ...
        else if (FarmaUtility.getDecimalNumber(vCantidad) <=
                 FarmaUtility.getDecimalNumber(VariablesInventario.vCantMax_PedRep) &&
                 !vCantidad.equalsIgnoreCase("0")) {
            FarmaUtility.showMessage(this, "La cantidad ingresada tiene que ser entera", txtCantAdic);
        } else {
            if (com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,
                ...
                try {
                    UtilityInventario.guardarCantidadAdicional();
    ...
    private void mostrarDatos() {
        ...
        lblDescProd.setText(VariablesInventario.vNomProd_PedRep);
        lblLab.setText(VariablesInventario.vNomLab_PedRep);
        lblFecha.setText(VariablesInventario.vFechaHora_PedRep);
        lblStock.setText(VariablesInventario.vStkFisico_PedRep);
        lblUnid.setText(VariablesInventario.vUnidMed_PedRep);
