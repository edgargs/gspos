  ...
  extends JDialog
{
  ...
  private void agregarProducto()
  {
    ...
    System.out.println("VariablesProducto.vArrayProductosEspeciales "+VariablesProducto.vArrayListaProdsEsp);
  ...
  private void modificarCantidad()
  {
      ...
      System.out.println("cantidad modificada del producto "+array);
      System.out.println("VariablesProducto.vArrayProductosEspeciales "+VariablesProducto.vArrayProductosEspeciales);
  }
  ...
  private boolean validaCantidadIngreso()
  {
    ...
    try{
        ...
        valor = false;
        System.out.println("valor incorrecto:"+cantIngreso+" ERROR: "+e);        
    }
    return valor;
  }
