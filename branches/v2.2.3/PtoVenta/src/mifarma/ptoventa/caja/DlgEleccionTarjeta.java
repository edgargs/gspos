...
public class DlgEleccionTarjeta extends JDialog
{
    ...
    private void jbInit() throws Exception {
        ...
        lblDatoNumTarjeta.setText("jLabel1");
    ...
    public void setValores(String numTarjeta)
    ...
    {   //se cargan las marcas de tarjeta a procesar
        formasPago.put("VISA PINPAD","00083");
        formasPago.put("MASTERCARD PINPAD","00084");
        //formasPago.put("Recaudación CMR","00086");
        formasPago.put("DINERS PINPAD","00087");
        formasPago.put("AMEX PINPAD","00088");
