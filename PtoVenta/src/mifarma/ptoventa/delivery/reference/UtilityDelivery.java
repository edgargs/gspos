...
public class UtilityDelivery {
    ...
    public static String resumenPedidoVentas(Frame myParentFrame,
                                        String pCorrelativo, String pCliente, String pRuc, String pFecha, String pHora, String pUsuario, String pEstado,
                                       ArrayList<ArrayList<String>> formasPagoDelivery,
                                             String pComprobante,
                                             String pMotorizado,
                                             boolean verDelivery,
