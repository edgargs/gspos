		...
		SELECT K.COD_PROD ,
		 ...
		 WHERE I.COD_GRUPO_CIA = PTOVENTA_RECEP_CIEGA_JCG.get_g_cCodGrupoCia
		   ...
		   AND I.COD_PROD NOT IN
			   (SELECT K.COD_PROD
				  FROM PTOVENTA.LGT_PROD_CONTEO K
				 WHERE K.COD_GRUPO_CIA = PTOVENTA_RECEP_CIEGA_JCG.get_g_cCodGrupoCia
				   AND K.COD_LOCAL     = PTOVENTA_RECEP_CIEGA_JCG.get_g_cCodLocal
				   AND K.NRO_RECEP     = PTOVENTA_RECEP_CIEGA_JCG.get_g_cNroRecep
