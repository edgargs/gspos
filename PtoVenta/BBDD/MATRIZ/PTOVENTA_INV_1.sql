...
--------------------------------------------------------
  ...
  BEGIN
  	...
  	ELSIF cTipOrigen_in = g_cTipoOrigenProveedor THEN --PROVEEDOR
        ...
        --JQUISPE 13.08.2010 CAMBIO COD GRUPO CIA
  ...
  FUNCTION INV_GET_MOTIVO_NOTA_E(cCodMotivo_in IN CHAR,cCodGrupoCia_in IN CHAR default '001')
  RETURN VARCHAR2
  IS
  	v_vDes VARCHAR2(30);
  BEGIN
  ...
  BEGIN
  	...
  	WHERE P.COD_GRUPO_CIA = cGrupoCia_in
          --13.08.2010 JQUISPE CAMBIO COD GRUPO CIA
  ...
  FUNCTION INV_GET_TIPO_ORIGEN_GUIA_E(cCodGrupoCia_in IN CHAR default '001')
  RETURN FarmaCursor
  IS
  ...
  FUNCTION INV_GET_TIPO_DOCUMENTO(cGrupoCia_in IN CHAR)
  RETURN FarmaCursor
  IS
  	curDocs FarmaCursor;
  BEGIN
  ...
  BEGIN
	  ...
	  INSERT INTO LGT_NOTA_ES_CAB(COD_GRUPO_CIA,COD_LOCAL,NUM_NOTA_ES, FEC_NOTA_ES_CAB,TIP_DOC,NUM_DOC,TIP_ORIGEN_NOTA_ES,COD_ORIGEN_NOTA_ES,CANT_ITEMS,VAL_TOTAL_NOTA_ES_CAB, TIP_NOTA_ES,USU_CREA_NOTA_ES_CAB,COD_DESTINO_NOTA_ES,
                                        ...
                                        RUC_EMPRESA,
                                        DIR_EMPRESA)
	  VALUES(cCodGrupoCia_in,cCodLocal_in,v_nNumNota, TO_DATE(vFechaGuia_in,'dd/MM/yyyy'),cTipDoc_in,cNumDoc_in,cTipOrigen_in,vCodOrigen_in,nCantItems_in,nValTotal_in, g_cTipoNotaEntrada,vUsu_in,cCodLocal_in,
                  vNombreTienda_in,
                  vRucTienda_in,
                  vCiudadTienda_in);
          ...
          --AGREGA GUIA
            INSERT INTO LGT_GUIA_REM(COD_GRUPO_CIA,
                                     ...
                                     USU_CREA_GUIA_REM,
                                     FEC_CREA_GUIA_REM)
            VALUES (cCodGrupoCia_in,cCodLocal_in,v_nNumNota,1,cNumDoc_in,vUsu_in,SYSDATE);
          END IF;
  ...
  BEGIN
    ...
    END IF;
  	...
  	VALUES(cCodGrupoCia_in,cCodLocal_in,cNumNota_in,nSec, cCodProd_in,nValPrecUnit_in,nValPrecTotal_in,nCantMov_in,TO_DATE(vFecNota_in,'dd/MM/yyyy'),TO_DATE(vFecVecProd_in,'dd/MM/yyyy'),vNumLote_in, vUsu_in, v_nValFrac,v_vDescUnidVta);
 ...
 FUNCTION GET_DESC_ORIGEN(cCodGrupoCia IN CHAR, cTipoMaestro_in IN CHAR,cCodBusqueda_in IN CHAR,cNumNotaEs_in IN CHAR DEFAULT NULL)
  ...
  BEGIN
       OPEN curGuias FOR
            SELECT NC.NUM_NOTA_ES || 'Ã' ||
                   NVL(INV_GET_DESTINO_TRANSFERENCIA(TIP_ORIGEN_NOTA_ES,COD_DESTINO_NOTA_ES,cGrupoCia_in,cCia_in),
                   ' ') || 'Ã' ||
  ...
  BEGIN
    ...
    ELSIF cTipOrigen_in = g_cTipoOrigenMatriz THEN --MATRIZ
      ...
      WHERE COD_GRUPO_CIA = cGrupoCia_in
            ...
            AND TIP_LOCAL = g_cTipoLocalMatriz;
    ELSIF cTipOrigen_in = g_cTipoOrigenProveedor THEN --PROVEEDOR
      SELECT NVL(DESC_CORTA,' ') INTO v_vDes
      FROM  PBL_TAB_GRAL
	    WHERE COD_APL = g_vCodPtoVenta2
  		  AND COD_TAB_GRAL = g_vGralProveedor
  		  AND LLAVE_TAB_GRAL = cCodOrigen_in
  ...
  BEGIN
    ...
    SELECT P.COD_PROD || 'Ã' ||
          ...
          DECODE(P.IND_PROD_FRACCIONABLE,'S',L.UNID_VTA,P.DESC_UNID_PRESENT) || 'Ã' ||
          B.NOM_LAB || 'Ã' ||
          TO_CHAR(L.STK_FISICO - L.STK_COMPROMETIDO,'999,990.00') || 'Ã' ||
          L.VAL_FRAC_LOCAL || 'Ã' ||
  ...
  FUNCTION INV_GET_TIPO_TRANSFERENCIA(cCodGrupoCia_in IN CHAR default '001')
  RETURN FarmaCursor
  IS
  	curDest FarmaCursor;
  BEGIN
  ...
  FUNCTION INV_GET_MOTIVO_TRANSFERENCIA(cCodGrupoCia_in IN CHAR default '001')
  RETURN FarmaCursor
  IS
...
/****************************************************************************************************/
  ...
  /*PROCEDURE INV_AGREGA_DET_TRANSFERENCIA(cCodGrupoCia_in IN CHAR,cCodLocal_in IN CHAR,cNumNota_in IN CHAR,
                                        cCodProd_in IN CHAR, nValPrecUnit_in IN NUMBER, nValPrecTotal_in IN NUMBER, nCantMov_in IN NUMBER, vFecVecProd_in IN VARCHAR2, vNumLote_in IN VARCHAR2,
                                        cCodMotKardex_in IN CHAR,cTipDocKardex_in IN CHAR,
                                        vValFrac_in IN NUMBER,vUsu_in IN VARCHAR2,
                                        vTipDestino_in IN CHAR,cCodDestino_in IN CHAR)
  AS
    v_dFechaNota DATE;
    nSec LGT_NOTA_ES_DET.SEC_DET_NOTA_ES%TYPE;
  	v_nValFrac LGT_NOTA_ES_DET.VAL_FRAC%TYPE;
  ...
  BEGIN
    ...
    SELECT VAL_FRAC_LOCAL,NVL(TRIM(UNID_VTA),(SELECT DESC_UNID_PRESENT
                                              FROM LGT_PROD
                                              WHERE COD_GRUPO_CIA = cCodGrupoCia_in
                                              AND COD_PROD = cCodProd_in )),STK_FISICO INTO v_nValFrac,v_vDescUnidVta,v_nStkFisico
  	FROM LGT_PROD_LOCAL
  	WHERE COD_GRUPO_CIA = cCodGrupoCia_in
  	      AND COD_LOCAL = cCodLocal_in
  	      AND COD_PROD = cCodProd_in;
    ...
    IF vTipDestino_in = g_cTipoOrigenLocal THEN
      ...
      IF v_cInd != 'V' THEN
        RAISE_APPLICATION_ERROR(-20081,'ALGUNOS PRODUCTOS NO PUEDEN SER TRANSFERIDOS, DEBIDO A LA FRACCION ACTUAL DEL LOCAL DESTINO.');
      END IF;
    END IF;

  	INSERT INTO LGT_NOTA_ES_DET(COD_GRUPO_CIA,COD_LOCAl,NUM_NOTA_ES,SEC_DET_NOTA_ES, COD_PROD,VAL_PREC_UNIT,VAL_PREC_TOTAL,CANT_MOV,FEC_NOTA_ES_DET,FEC_VCTO_PROD,NUM_LOTE_PROD, USU_CREA_NOTA_ES_DET, VAL_FRAC,DESC_UNID_VTA)
  	VALUES(cCodGrupoCia_in,cCodLocal_in,cNumNota_in,nSec, cCodProd_in,nValPrecUnit_in,nValPrecTotal_in,nCantMov_in,v_dFechaNota,TO_DATE(vFecVecProd_in,'dd/MM/yyyy'),vNumLote_in, vUsu_in, v_nValFrac,v_vDescUnidVta);
...
WHERE
    ...
    --13.08.2010 JQUISPE CAMBIO COD GRUPO CIA
    LAB.COD_GRUPO_CIA=DET.COD_GRUPO_CIA    AND
...
/*ORDER BY NVL(TO_CHAR(NUM_PAG_RECEP),' '),
  ...
  BEGIN
  	...
  	WHERE C.COD_GRUPO_CIA = cCodGrupoCia_in
  	      ...
  	      AND O.LLAVE_TAB_GRAL = C.TIP_ORIGEN_NOTA_ES
          --JQUISPE 13.08.2010 CAMBIO COD GRUPO CIA
          AND O.COD_GRUPO_CIA = C.COD_GRUPO_CIA;
   	RETURN curCab;
  END;
...
--
  ...
  BEGIN
    ...
    FOR det IN curDet
    LOOP
      SELECT STK_FISICO,STK_FISICO-STK_COMPROMETIDO,VAL_FRAC_LOCAL,UNID_VTA,L.IND_PROD_CONG
  ...
  BEGIN
    OPEN curVta FOR
		SELECT (PROD_LOCAL.STK_FISICO - PROD_LOCAL.STK_COMPROMETIDO)
  ...
  BEGIN
    OPEN curProd FOR
		SELECT (STK_FISICO - STK_COMPROMETIDO)  || 'Ã' ||
			   IND_PROD_CONG  || 'Ã' ||
  ...
  cRucTransportista_in IN CHAR)
  RETURN FarmaCursor
  IS
    curTransp FarmaCursor;
  BEGIN
    OPEN curTransp FOR
    SELECT NVL(L.DIREC_TRANSPORTISTA,' ') || 'Ã' || NVL(L.NUM_PLACA,' ')
    FROM LGT_TRANSPORTISTA L
    WHERE L.RUC_TRANSPORTISTA = cRucTransportista_in
    --13.08.2010 JQUISPE CAMBIO COD GRUPO CIA
  ...
  BEGIN
    ...
    IF v_cCodTransp IS NULL THEN
      ...
      FROM DUAL;
    ELSE
      SELECT NVL(L.NOM_TRANSPORTISTA,' ')  || 'Ã' || NVL(L.RUC_TRANSPORTISTA,' ')  || 'Ã' || NVL(L.DIREC_TRANSPORTISTA,' ') || 'Ã' || NVL(L.NUM_PLACA,' ')
      INTO v_vTransp
      FROM LGT_TRANSPORTISTA L
      WHERE L.COD_TRANSPORTISTA = v_cCodTransp
          --13.08.2010 JQUISPE CAMBIO COD GRUPO CIA
       AND   L.COD_GRUPO_CIA= cCodGrupoCia_in;
    END IF;
  ...
  FUNCTION INV_LISTA_PROD_REPOSICION(cCodGrupoCia_in IN CHAR,cCodLocal_in IN CHAR)
    ...
    BEGIN
     ...
     /* OPEN curProd FOR
      ...
      --30/03/2007 ERIOS Se modifico la consulta.
      OPEN curProd FOR
      SELECT P.COD_PROD || 'Ã' ||
             P.DESC_PROD || 'Ã' ||
             P.DESC_UNID_PRESENT || 'Ã' ||
      ...
      WHERE L.COD_GRUPO_CIA = cCodGrupoCia_in
            --13.08.2010 JQUISPE CAMBIO COD GRUPO CIA
            AND B.COD_GRUPO_CIA=L.COD_GRUPO_CIA
            AND L.COD_LOCAL = cCodLocal_in
            AND P.EST_PROD = 'A'
            AND L.COD_GRUPO_CIA = P.COD_GRUPO_CIA
            AND L.COD_PROD = P.COD_PROD
  ...
  BEGIN
    ...
    WHERE O.COD_GRUPO_CIA = cCodGrupoCia_in
          --13.08.2010 JQUISPE CAMBIO COD GRUPO CIA
          AND L.COD_GRUPO_CIA=O.COD_GRUPO_CIA
 ...
 BEGIN
   ...
   --13.08.2010 JQUISPE CAMBIO COD GRUPO CIA
   AND    PL.COD_GRUPO_CIA=L.COD_GRUPO_CIA
...
*/
			 ...
			 WHERE  PROD_LOCAL.COD_GRUPO_CIA     = cCodGrupoCia_in
       --13.08.2010 JQUISPE CAMBIO COD GRUPO CIA
       AND    LAB.COD_GRUPO_CIA      =   PROD_LOCAL.COD_GRUPO_CIA
       and    IGV.Cod_Grupo_Cia      =    LAB.COD_GRUPO_CIA
			 AND	  PROD_LOCAL.COD_LOCAL 		 = cCodLocal_in
...
*/
       ...
       --13.08.2010 JQUISPE CAMBIO COD GRUPO CIA
       AND    LAB.COD_GRUPO_CIA            = PROD_LOCAL.COD_GRUPO_CIA
       AND    ACC_TER.COD_GRUPO_CIA        = PROD_LOCAL.COD_GRUPO_CIA
       AND    IGV.COD_GRUPO_CIA            =  ACC_TER.COD_GRUPO_CIA
			 AND	  PROD_LOCAL.COD_LOCAL         = cCodLocal_in
...
*/
       ...
       --13.08.2010 JQUISPE CAMBIO COD GRUPO CIA
       AND    LAB.COD_GRUPO_CIA          = PROD_LOCAL.COD_GRUPO_CIA
       AND    PROD_LOCAL.COD_GRUPO_CIA   =IGV.COD_GRUPO_CIA
			 AND	  PROD_LOCAL.COD_LOCAL     = cCodLocal_in
  ...
  BEGIN
    ...
    IF v_cTipNotaEs=g_cTipoNotaSalida AND v_cTipOrigen=g_cTipoOrigenMatriz THEN --MATRIZ
      ...
      SELECT D.COD_PROD || 'Ã' ||
              ...
              -- 2010-02-17 JOLIVA: Se agrega la politica de canje en el nombre del laboratorio
--              B.NOM_LAB       || 'Ã' ||
...
PROCEDURE INV_RECONFIG_IMPRESORA(cCodGrupoCia_in   IN CHAR,
  ...
  BEGIN
/*    SELECT DISTINCT COUNT(D.NUM_LOTE_PROD || 'Ã' || D.FEC_VCTO_PROD)
    INTO cant
    FROM LGT_NOTA_ES_CAB C, LGT_NOTA_ES_DET D
    WHERE C.COD_GRUPO_CIA = cCodGrupoCia_in
          AND C.COD_LOCAL = cCodLocal_in
...
PROCEDURE INV_ACT_KARDEX_GUIA_REC(cGrupoCia_in   IN CHAR,
	...
	OPEN curLabs FOR
	 SELECT lp.cod_prod || 'Ã' ||
	  ...
	  WHERE K.COD_GRUPO_CIA  = cCodGrupoCia_in
               --13.08.2010 JQUISPE CAMBIO COD GRUPO CIA
                AND    LB.COD_GRUPO_CIA            = K.COD_GRUPO_CIA AND
                K.COD_LOCAL      = cCodLocal_in		  AND
 ...
 END;
  ...
  AS
    ...
    ReceiverAddress VARCHAR2(30) := FARMA_EMAIL.GET_RECEIVER_ADDRESS_AJUSTES(cCodGrupoCia_in);
  ...
  BEGIN
    ...
    FARMA_EMAIL.envia_correo(v_vDescLocal||FARMA_EMAIL.GET_SENDDOR_ADDRESS(cCodGrupoCia_in),
                          ReceiverAddress,
                          vAsunto_in||v_vDescLocal,--'VIAJERO EXITOSO: '||v_vDescLocal,
                          vTitulo_in,--'EXITO',
                          mesg_body,
                          CCReceiverAddress,
                          FARMA_EMAIL.GET_EMAIL_SERVER(cCodGrupoCia_in),
                          true);
  ...
  BEGIN
        --JQUISPE 13.08.2010 CAMBIO COD GRUPO CIA
        DELETE FROM VTA_STK_LOCALES V WHERE V.COD_GRUPO_CIA=cCodGrupoCia_in;
        --JQUISPE 13.08.2010 CAMBIO COD GRUPO CIA
        EXECUTE IMMEDIATE
...
--        EXECUTE IMMEDIATE 'ALTER SESSION CLOSE DATABASE LINK XE_DEL_999';
    ...
    OPEN curInv FOR
        ...
        ---JQUISPE 13.08.2010 CAMBIOS COD GRUPO CIA
        WHERE  SL.COD_GRUPO_CIA=cCodGrupoCia_in;
  ...
  BEGIN
    OPEN curInv FOR
        ...
        FROM   LGT_PROD_LOCAL@xe_del_999 PROD_LOCAL,
               PBL_LOCAL LOCAL
        WHERE  PROD_LOCAL.COD_GRUPO_CIA = CCODGRUPOCIA_IN
        AND    PROD_LOCAL.COD_LOCAL  NOT IN (SELECT COD_LOCAL_PREFERIDO
                                             FROM PBL_LOCAL_PREFERIDO
                                             WHERE COD_LOCAL = ccodlocal_in)
        AND    LOCAL.Tip_Local = g_cTipoLocalVenta
        AND    PROD_LOCAL.cod_prod = ccodprod_in
  ...
  BEGIN
   EXECUTE IMMEDIATE ' SELECT PTOVENTA_INV.INV_OBTIENE_STOCK_EN_LINEA@XE_000(:1,:2,:3) FROM DUAL '
                     INTO RETORNO USING cCodGrupoCia_in,CCODLOCAL_IN,CCODPROD_IN;--JSANTIVANEZ 02.09.2010
--  PTOVENTA_INV.INV_OBTIENE_STOCK_EN_LINEA@XE_000(CCODGRUPOCIA_IN,CCODLOCAL_IN,CCODPROD_IN,STOCK,UNIDAD_VENTA  );
  ...
  FUNCTION INV_OBTIENE_IND_STOCK(cCodProd_in IN CHAR,cCodGrupoCia_in IN CHAR default '001')
  RETURN VARCHAR2
  IS
   v_vSentencia VARCHAR2(32767);
  BEGIN
 ...
 /******************************************************************************/
  ...
  END;
  /*****************************************************************************/
  FUNCTION INV_GET_MOTIVO_TRANS_INTERNO(cCodGrupoCia_in IN CHAR default '001')
  RETURN FARMACURSOR
  ...
  BEGIN
       OPEN curMot FOR
            ...
            ---jquispe 13.08.2010 cambio cod grupo cia
            AND    PTG.COD_GRUPO_CIA = cCodGrupoCia_in;
  RETURN CURMOT ;
...
/* ********************************************************************** */
  FUNCTION TRANSF_F_DESC_LARGA_TRANS(cLlaveTabGral_in IN CHAR,
                                     ...
                                     cCodGrupoCia_in IN CHAR default '001'  )
  RETURN VARCHAR2
  IS
...
RETURN vRecep;
 EXCEPTION
  WHEN OTHERS THEN
   RAISE_APPLICATION_ERROR(-20020,'!Error al grabar Cabecera Recepcion!');
...
IS
 ...
 SELECT substr(sys_context('USERENV','IP_ADDRESS'),1,50) INTO v_ip
  ...
  EXCEPTION
  WHEN NO_DATA_FOUND THEN
    RAISE_APPLICATION_ERROR(-20021,'Error No existe la recepcion.');
  WHEN OTHERS THEN
...
/*********************************************************************************************/
 ...
 FUNCTION INV_GET_IND_NUEVA_TRANSF(cCodGrupoCia_in IN CHAR default '001')
 RETURN CHAR
 IS
  vRpta CHAR(1) := 'N';
 BEGIN
