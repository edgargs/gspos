...
public class DBCaja
{
  ...
  public static void getListaPedidosPendientes(FarmaTableModel pTableModel)throws SQLException {
    ...
    parametros.add(FarmaVariables.vCodLocal);
    parametros.add(FarmaVariables.vNuSecUsu);
    System.out.println("Lista Ped Pendientes " + parametros);
  ...
  public static void anularPedidoPendiente(String pNumPed) throws SQLException
  {
    ...
    parametros.add(FarmaVariables.vIdUsu);
    System.out.println("Anula Pedido Pendiente:"+parametros);
  ...
  public static void anularPedidoPendienteSinRespaldo(String pNumPed) throws SQLException
  {
    ...
    parametros.add(pNumPed.trim());
    parametros.add(FarmaVariables.vIdUsu);
    System.out.println("Anula Pedido Pendiente sin Respaldo:"+parametros);
 ...
 public static void cambiarEstadoPed(String pNumPed ,String pEst) throws SQLException{
    ...
    public static void getListaPedidosComp(FarmaTableModel pTableModel) throws SQLException {
        System.out.println("Entra en DBCaja.getListaPedidosComp=");
		pTableModel.clearTable();
		parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
 ...
 /*
  public static void obtieneFormasPago(FarmaTableModel pTableModel,
    ...
    //System.out.println("VariablesVentas.vEsPedidoConvenio >>" + VariablesVentas.vEsPedidoConvenio);
    ...
    System.out.println("Parameter for listado Formas de Pago " + parametros);
 ...
 */
  ...
  public static void grabaFormaPagoPedido(String pCodFormaPago,
    ...
    parametros.add(FarmaVariables.vIdUsu);
    System.out.println("CAJ_GRABAR_FORMA_PAGO_PEDIDO: "+parametros);
  ...
  public static String agregarCabeceraNotaCredito(String numPedVta,String tipCambio,String motivoAnulacion) throws SQLException
  {
    ...
    parametros.add(new Integer(VariablesCaja.vNumCaja.trim()));
    parametros.add(motivoAnulacion);
    System.out.println("agregarCabeceraNotaCredito MotivoAnulacion :" + parametros);
  ...
  public static void cobraNotaCredito(String pTipComp) throws SQLException{
	    ...
	    parametros.add(FarmaVariables.vCodGrupoCia);
	    parametros.add(FarmaVariables.vCodLocal);
	    parametros.add(VariablesCaja.vNumPedVta);System.out.println("Numero Ped Vta: "+VariablesCaja.vNumPedVta);
	    parametros.add(VariablesCaja.vNumPedVta_Anul);System.out.println("Numero Ped Vta Anul: "+VariablesCaja.vNumPedVta_Anul);
	    parametros.add(VariablesCaja.vSecMovCaja);System.out.println("Secuencial Mov Caja: "+VariablesCaja.vSecMovCaja);
	    parametros.add(FarmaConstants.COD_NUMERA_SEC_COMP_PAGO);
	    parametros.add(pTipComp);
	    ...
	    parametros.add(FarmaVariables.vIdUsu);
	    parametros.add(new Integer(VariablesCaja.vNumCaja.trim()));
      parametros.add(VariablesCaja.vTipComp);System.out.println("vTipComp: "+VariablesCaja.vTipComp);
      parametros.add(VariablesCaja.vNumComp_Anul);System.out.println("vNumComp_Anul: "+VariablesCaja.vNumComp_Anul);
  ...
  public static void anulaPedidosPendientesMasivo() throws SQLException
  {
    ...
    parametros.add(FarmaVariables.vMinutosPedidosPendientes);
    parametros.add(FarmaVariables.vIdUsu);
    System.out.println("parametros anulaPedidosPendientesMasivo: "+parametros);
  ...
  public static void intercambiarComprobante(String numDocA,String monDocA,String numDocB,String monDocB,String tipComp) throws SQLException
  {
    ...
    System.out.println("Para cambio : " + parametros);
  ...
  public static String verifica_Credito_Convenio(String cod_Convenio) throws SQLException {
    ...
    System.out.println(cod_Convenio);
  ...
  */
  ...
  public static String getNumeroRecarga(String pNumPed) throws SQLException
  {
    ...
    System.out.println("Param. Numeros recarga  :"+ parametros);
  ...
  public static String getNumeroPedido(String pnumeroComp) throws SQLException
  {
    ...
    System.out.println("Param.ver el numero de Pedido :"+ parametros);
  ...
  public static String obtieneTipoPedido() throws SQLException{
    ...
    parametros.add(FarmaVariables.vCodLocal);
    parametros.add(VariablesCaja.vNumPedVta);
    System.out.println("Param.ver el tipo pedido :"+ parametros);
    //FarmaDBUtility.executeSQLStoredProcedureArrayList(pArrayList,"PTOVENTA_CAJ.CAJ_OBTIENE_INFO_PEDIDO(?,?,?,?)",parametros);
  ...
  public static String obtieneFormaPagoPedido() throws SQLException{
    ...
    parametros.add(FarmaVariables.vCodLocal);
    parametros.add(VariablesCaja.vNumPedVta);
    System.out.println("Param.ver Formas Pago pedido :"+ parametros);
    //FarmaDBUtility.executeSQLStoredProcedureArrayList(pArrayList,"PTOVENTA_CAJ.CAJ_OBTIENE_INFO_PEDIDO(?,?,?,?)",parametros);
  ...
  */
  public static void getcuponesPedido(String pNumPedVta,
    ...
    public static String pruebaImpresoraTermica(String pCodCupon) throws SQLException {
      ...
      return FarmaDBUtility.executeSQLStoredProcedureStr(
                 "Farma_Gral.F_PRUEBA_IMPR_TERMICA(?,?,?,?)",parametros);
    }
...
public static String obtCodigoRptaProdVirtual() throws SQLException{
  ...
  public static void analizaCanjeMatriz(
      ...
      parametros = new ArrayList();        
      System.out.println("15/07/09 Analiza Cupon");
      parametros.add(FarmaVariables.vCodGrupoCia);
      parametros.add(FarmaVariables.vCodLocal);
      parametros.add(pNumPed.trim());
  ...
  public static String getExistRegaloCampanaAcumulada(
    ...
    public static String getCabHtmlCampAcumXCliente(String pDni) throws SQLException{
        ...
        parametros.add(FarmaVariables.vIPBD);
        parametros.add(pDni);
        log.debug("invocando a PTOVENTA_CA_CLIENTE.CA_F_VAR_IMP_CAB_HTML(?,?):"+parametros);
     ...
     * */
     ...
     public static void getSobresFec(FarmaTableModel pTableModel,String vFechaVta) throws SQLException
     {
       ...
       System.err.println("PTOVENTA_CE_SEGURIDAD.SEG_F_CUR_SOBRE_FECHA_DET");
    ...
    public static void getSobresFecNuevoRemito(FarmaTableModel pTableModel,String vFechaVta) throws SQLException
    {
      ...
      parametros.add(FarmaVariables.vCodLocal);
      parametros.add(vFechaVta.trim());
      System.err.println("PTOVENTA_CE_SEGURIDAD.SEG_F_CUR_SOBRE_FECHA");
      System.err.println("parametros:"+parametros);
      ...
      throws SQLException
    {
      for (int i = 0; i < arrayLocales.size(); i++)
      {
        ...
        System.out.println("INGRESANDO.."+parametros);
    ...
    /**
       ...
       public static ArrayList ObtieneValorComprobantes() throws SQLException {
         ArrayList pOutParams = new ArrayList();
             ...
             parametros.add(FarmaVariables.vCodGrupoCia);
             parametros.add(FarmaVariables.vCodLocal);
             System.err.println("ObtieneValorComprobantes: " + parametros);
    ...
    /**
       ...
       public static ArrayList ObtieneRespuestaAnulacion(int codigo) throws SQLException {
         ArrayList pOutParams = new ArrayList();
             ...
             System.err.println("ObtieneRespuestaAnulacion: " + parametros);
    ...
    /**
       ...
       public static ArrayList ObtieneValorComprobanteBoleta() throws SQLException {
         ArrayList pOutParams = new ArrayList();
             ...
             System.err.println("ObtieneValorComprobanteBoleta: " + parametros);
  ...
  public static String obtieneDatosTicket(String pNumPedVta,int pMonto) throws SQLException{
    ...
    */
    ...
    public static String ObtieneDirectorio() throws SQLException
    {
      parametros = new ArrayList();
      log.debug("invocando a Farma_Gral.F_OBT_RUTA_DIRECTORIO():"+parametros);
      return FarmaDBUtility.executeSQLStoredProcedureStr("Farma_Gral.F_OBT_RUTA_DIRECTORIO()",parametros);
    }
...
/**@author jmiranda 
    ...
    public static void grabaInicioFinProcesoCobroPedido( String pCorrelativo,String pTipoTmp) throws SQLException
    {
      ...
      System.out.println("Parametros para grabar Tiempos INI-FIN :" + parametros);
    ...
    public static String obtieneMensajeTicket() throws SQLException {
          ...
          return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_VTA.VTA_F_GET_MENS_TICKET(?,?)",vParameters);
    }
                                             ...
                                             String Sec)throws SQLException
    {
      ...
      parametros.add(FarmaVariables.vIdUsu.trim());
      System.out.println("Elimina Sobre:" + parametros);
    ...
    parametros.add(FarmaVariables.vIdUsu);
    System.out.println("Agrega Forma Pago:"+parametros);
   ...
   public static void enviaCorreoSobre(String codSobre)throws SQLException
   {
     ...
     System.out.println("envia correo sobre creado:" + parametros);
     ...
     * @throws SQLException
     */
    public static boolean elegirVentanaCobro()throws SQLException{
        boolean flag=false;
        parametros =new ArrayList();
        String ind=FarmaDBUtility.executeSQLStoredProcedureStr("PTOVTA_GEN_COBRO_PED.PVTA_F_ELEGIR_VENT_COBRO()",parametros);
        if(ind.equalsIgnoreCase(FarmaConstants.INDICADOR_S)) flag=true;
        return flag;
    }
     ...
     * @throws SQLException
     */
    public static boolean llamarNewVentanaCobro(String numPed)throws SQLException{
        boolean flag=true;
        parametros=new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(numPed.trim());
        String ind=FarmaDBUtility.executeSQLStoredProcedureStr("PTOVTA_GEN_COBRO_PED.PVTA_F_NEW_VENT_COBRO(?,?,?)",parametros);
        if(ind.equalsIgnoreCase(FarmaConstants.INDICADOR_N)) flag=false;
        return flag;
    }
    ...
    public static void obtenerInfoTarjeta(ArrayList pArrayList, String nrotarj)throws SQLException{
        ...
        System.out.println("parametros obtenerInfoTarjeta: "+parametros);
        FarmaDBUtility.executeSQLStoredProcedureArrayList(pArrayList,"PTOVTA_GEN_COBRO_PED.PVTA_F_OBTENER_TARJETA(?,?)",parametros);
    }
     ...
     * @throws SQLException
     */
    public static void grabaFormaPagoPedidoNew(String pCodFormaPago,
                                            String pImPago,
                                            String pTipMoneda,
                                            String pTipoCambio,
                                            String pVuelto,
        ...
        parametros.add(FarmaVariables.vIdUsu);
        parametros.add(dni);
        parametros.add(codvou);
        parametros.add(lote);
        FarmaDBUtility.executeSQLStoredProcedure(null,"PTOVTA_GEN_COBRO_PED.PVTA_P_INS_FORM_PAGO_PED(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",parametros,false);
    }
     ...
     * @throws SQLException
     */
    public static String determinarRecVirConvCred(String numPed)throws SQLException{
        parametros=new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(numPed.trim());
        System.out.println("parametros determinarRecVirConvCred: "+parametros);
        String fpago=FarmaDBUtility.executeSQLStoredProcedureStr("PTOVTA_GEN_COBRO_PED.PVTA_F_RECVIR_CONVCRED(?,?,?)",parametros);        
        return fpago;
    }
     ...
     * @throws SQLException
     */
    public static String obtenerFPagoConvenio(String codconv)throws SQLException{
        parametros=new ArrayList();
        parametros.add(FarmaVariables.vCodCia);
        parametros.add(codconv.trim());
        System.out.println("ERROR en obtenerFPagoConvenio : "+parametros);
        String fpago=FarmaDBUtility.executeSQLStoredProcedureStr("PTOVTA_GEN_COBRO_PED.PVTA_F_OBTENER_FPAGO(?,?)",parametros);
        return fpago;
    }
     ...
     * @throws SQLException
     */
    public static void listaNewDetaPedido(FarmaTableModel pTableModel, String numped) throws SQLException
    {
      parametros = new ArrayList();
      parametros.add(FarmaVariables.vCodGrupoCia);
      parametros.add(FarmaVariables.vCodLocal);
      parametros.add(numped);
      FarmaDBUtility.executeSQLStoredProcedure(pTableModel,"PTOVTA_GEN_COBRO_PED.PVTA_LISTA_DETA_PED(?,?,?)", parametros, false);
    }
    ...
    public static String obtieneDatosConvenio(String pNumPedVta,
      ...
      System.out.println("invocando a PTOVENTA_CONV.IMP_DATOS_CONVENIO(?,?,?,?,?,?):"+parametros);
    ...
    public static void validaEstadosobre( String FecVta,
     ...
     System.out.println("VALIDA ESTADO DEL SOBRE");
      ...
      throws SQLException
    {
     ...
     parametros.add(FarmaVariables.vNuSecUsu);
     System.out.println("APROBAR SOBRE........."+parametros);
     ...
     * @throws SQLException
     */
    public static String getPVTA_F_GET_TOLERA_DOLARES() throws SQLException{
      parametros = new ArrayList();
      parametros.add(FarmaVariables.vCodGrupoCia);
      return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVTA_GEN_COBRO_PED.PVTA_F_GET_TOLERA_DOLARES(?)",parametros);
    }
     ...
     * @throws SQLException
     */
    public static void enviarEmailDiferXRedondeo(String numped,
                                                 String soles,
                                                 String dolares,
                                                 String monto,
                                                 String monto2,
                                                 String diferencia)throws SQLException{
        parametros=new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);        
        parametros.add(numped.trim());
        parametros.add(soles.trim());
        parametros.add(dolares.trim());
        parametros.add(monto.trim());
        parametros.add(monto2.trim());
        parametros.add(diferencia.trim());
        FarmaDBUtility.executeSQLStoredProcedure(null,"PTOVTA_GEN_COBRO_PED.PVTA_P_ENVIAR_MAIL_DIFERENCIA(?,?,?,?,?,?,?,?)",parametros, false);
    }
    ...
    System.out.println("PTOVENTA_CE_SEGURIDAD.SEG_F_ACCION_SOBRE_TMP(?,?,?,?,?,?,?,?,?,?,?):"+parametros);
    ...
    parametros.add(pCodigoSobre);
    parametros.add(pTipoAccion);
    System.out.println("PTOVENTA_CE_SEGURIDAD.SEG_F_BLOQUEO_ESTADO(?,?,?,?,?,?):"+parametros);
    ...
    parametros.add(FarmaVariables.vCodLocal);
    parametros.add(FarmaVariables.vNuSecUsu);
    System.out.println("PTOVENTA_CE_SEGURIDAD.CAJ_F_OBTIENE_SEC_MOV_CAJA(?,?,?):"+parametros);
    ...
    public static double getTipoCambioDU() throws SQLException {
        ...
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(FarmaVariables.vNuSecUsu);
        System.out.println("PTOVENTA_CE_SEGURIDAD.SEG_F_GET_TIPO_CAMBIO(?,?,?):"+parametros);
    ...
    public static void anulaPedidosPendientesMasivo_02() throws SQLException
    {
      ...
      parametros.add(FarmaVariables.vMinutosPedidosPendientes);
      parametros.add(FarmaVariables.vIdUsu);
      System.out.println("parametros anulaPedidosPendientesMasivo_02 PTOVTA_RESPALDO_STK.CAJ_ANULA_PED_PEND_MASIVO(?,?,?,?): "+parametros);
...
/**
    ...
    System.out.println("PTOVENTA_CE_SOBRES.SEG_F_ACCION_SOBRE_TMP(?,?,?,?,?,?,?,?,?,?,?,?):"+parametros);
    ...
    public static void anularPedidoPendiente_02(String pNumPed) throws SQLException
    {
      ...
      parametros.add(pNumPed.trim());
      parametros.add(FarmaVariables.vIdUsu);
      System.out.println("invocando PTOVTA_RESPALDO_STK.CAJ_ANULAR_PEDIDO_PENDIENTE(?,?,?,?):"+parametros);
      FarmaDBUtility.executeSQLStoredProcedure(null,"PTOVTA_RESPALDO_STK.CAJ_ANULAR_PEDIDO_PENDIENTE(?,?,?,?)",parametros,false);
    }
    ...
    public static void anularPedidoPendienteSinRespaldo_02(String pNumPed) throws SQLException
    {
      ...
      parametros.add(pNumPed.trim());
      parametros.add(FarmaVariables.vIdUsu);
      System.out.println("invocando a PTOVTA_RESPALDO_STK.CAJ_P_ANULA_PED_SIN_RESPALDO(?,?,?,?): "+parametros);
    ...
    public static String pruebaImpresoraTermStick(String pCodCupon,int r_inicio,int r_fin) throws SQLException {
      ...
      return FarmaDBUtility.executeSQLStoredProcedureStr(
                 "Farma_Gral.F_IMPR_TERMICA_STICK(?,?,?,?,?,?)",parametros);
    }
