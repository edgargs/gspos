...
/**
     ...
     * @throws SQLException
     */
    public static String ingresaDatosTrans_02(String pCantGuias,
                                              String codTransp, 
                                              String nroHojaRes, //ASOSA - 24/07/2014
      ...
      throws SQLException
    {
        ...
        parametros.add(nroHojaRes); //ASOSA - 24/07/2014
     ...
     * @throws SQLException
     */
    public static void obtenerDocTransporte(FarmaTableModel pTableModel, 
                                            String pHojaResumen) throws SQLException {
        parametros = new ArrayList();
        parametros.add(pHojaResumen);
        log.debug("PTOVENTA_RECEP_CIEGA_AS.RECEP_F_GET_DOC_TRANSPORTE"+parametros);
        FarmaDBUtility.executeSQLStoredProcedure(pTableModel,"PTOVENTA_RECEP_CIEGA_AS.RECEP_F_GET_DOC_TRANSPORTE(?)",parametros,false);      
    }
     ...
     * @throws SQLException
     */
    public static String buscarBandejaHojaResumen(String pHojaResumen,
                                                  String pNroBandeja) throws SQLException{
        parametros = new ArrayList();
        parametros.add(pHojaResumen);
     ...
     * @throws SQLException
     */
    public static String buscarHojaResumenGrabada(String pHojaResumen) throws SQLException{
        parametros = new ArrayList();
        parametros.add(pHojaResumen);        
     ...
     * @throws SQLException
     */
    public static void getListActaRecepcionMercaderia(FarmaTableModel pTableModel, 
                                                      String pNumeroRecepcion,
      ...
      FarmaDBUtility.executeSQLStoredProcedure(pTableModel,"PTOVENTA_RECEP_CIEGA_JC.RECEP_F_DATOS_ACTA(?,?,?,?)",parametros,false);
    }   
