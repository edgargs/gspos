  ...
  private void chkKeyPressed(KeyEvent e)
  {
    ...
    if(e.getKeyCode() == KeyEvent.VK_F1 &&
        ...
        if( ! VariablesOtros.vFlagDialogAbierto){
            ...
            System.out.println("ya se encuentra abierto el dialogo de ingreso de nuevo registro de medida de presion");
        }           
  ...
  private boolean validarFechas(){
	...
	private void eliminarMedidaPresion() {	  
	  ...
	  if( row > -1 ){
		  ...
		  if(FarmaUtility.rptaConfirmDialog(this, "Esta seguro que desea eliminar ?"+
