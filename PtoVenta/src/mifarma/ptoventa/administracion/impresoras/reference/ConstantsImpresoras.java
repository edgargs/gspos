...
public class ConstantsImpresoras {
    ...
    public static final FarmaColumnData[] columnsListaImpresorasTermicasDespacho = { 
        new FarmaColumnData("Sec. Imp.", 70, JLabel.CENTER), 
        new FarmaColumnData("Desc. Imp", 140, JLabel.LEFT),
        new FarmaColumnData("Marca", 90, JLabel.LEFT), 
        new FarmaColumnData("Estado", 90, JLabel.LEFT),
        new FarmaColumnData("", 0, JLabel.LEFT),
        new FarmaColumnData("Piso", 50, JLabel.CENTER) 
    };

    public static final Object[] defaultValuesListaImpresorasTermicasDespacho = { " ", " ", " ", " ", " ", " ", " ", " " };
}
