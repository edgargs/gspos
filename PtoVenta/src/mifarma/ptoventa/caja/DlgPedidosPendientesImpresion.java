            ...
            try {
                ...
                if ("S".equalsIgnoreCase(DBCaja.getIndPedConvenio(VariablesCaja.vNumPedVta))) {
                    ...
                    VariablesConvenioBTLMF.vDatosConvenio =
                            UtilityConvenioBTLMF.listaDatosConvenio(VariablesConvenioBTLMF.vCodConvenio, this, null);
                    ...
                    if (VariablesVentas.vTip_Comp_Ped.equalsIgnoreCase(ConstantesDocElectronico.TIPNOTACREDITO)) {
                        if (indicElectronico.equalsIgnoreCase(ConstantesDocElectronico.INDELECTRONICO)) {
                            ...
                            flag =
electronico.printDocumento(VariablesCaja.vNumPedVta, VariablesCaja.vSecComprobante, false, false);
                            if (flag) {
...
electronico.printDocumento(VariablesCaja.vNumPedVta, VariablesCaja.vSecComprobante, false, false);
                        ...
                        UtilityCaja.procesoImpresionComprobante(this, tblListaPendientes, true);
                    }
                }
                cargaListaPendientes();
