...
public class DlgIngresoProdTransferencia extends JDialog  {
            ...
            if (datosValidados()) {
                if (VariablesRecepCiega.vIndModificarIngresoCantProdTranf) {
                    ...
                    if (!existeStockDisponible(VariablesRecepCiega.vCodProd, 
                        ...
                        System.out.println("VariablesRecepCiega.vCantIngreso: " + VariablesRecepCiega.vCantIngreso);
                        System.out.println("VariablesRecepCiega.vValFrac: " + VariablesRecepCiega.vValFrac);
                        System.out.println("VariablesRecepCiega.vCantProdTransferir: " + VariablesRecepCiega.vCantProdTransferir);
                        cerrarVentana(true);
                    }


                } else {
                    System.out.println("Ingreso cantidad valida: " + txtCantidad.getText().toString());
                    ...
                    if (!existeProductoEnLista()) {
                        if (!existeStockDisponible(VariablesRecepCiega.vCodProd, 
                            ...
                            System.err.println("cant_total_trans:"+cant_total_trans);
                            if (cant_total_trans==0)     {
                                ...
                                VariablesRecepCiega.vCantIngreso =   Integer.parseInt(cantidad);
                                System.out.println("INGRESA OTRO LOTE VariablesRecepCiega.vCantIngreso: " +  VariablesRecepCiega.vCantIngreso);
                                System.out.println("INGRESA OTRO LOTEVariablesRecepCiega.vValFrac: " + VariablesRecepCiega.vValFrac);
                                System.out.println("INGRESA OTRO LOTEVariablesRecepCiega.vCantProdTransferir: " +  VariablesRecepCiega.vCantProdTransferir);
    ...
    private boolean existeProductoEnLista(){
        ...
        if (VariablesRecepCiega.vTableModelProdTranf != null){
            while (!encontrado && i<VariablesRecepCiega.vTableModelProdTranf.getRowCount()){
                ...
                System.out.println("codLote-->"+codLote);
            }
    ...
    private boolean existeStockDisponible(String codProd, int cantidad, String lote){
        ...
        if (VariablesRecepCiega.vTableModelProdTranf != null){
            while (i<VariablesRecepCiega.vTableModelProdTranf.getRowCount()){
                ...
                {                    
                    System.out.println("codProd -- cant_prod-->"+codProd + "  " + FarmaUtility.getValueFieldArrayList(VariablesRecepCiega.vTableModelProdTranf.data,i,2) );                    
            ...
            System.out.println("cant_prod total existeStockDisponible:"+ cant_prod);
        }
    ...
    private int obtieneCantidadTotalTrans(){
        ...
        if (VariablesRecepCiega.vTableModelProdTranf != null){
            System.err.println("VariablesRecepCiega.vTableModelProdTranf: "+ VariablesRecepCiega.vTableModelProdTranf.data);
            while (i<VariablesRecepCiega.vTableModelProdTranf.getRowCount()){
                codProd = (String)VariablesRecepCiega.vTableModelProdTranf.getValueAt(i,5);               
                if (codProd.equalsIgnoreCase(VariablesRecepCiega.vCodProd) )
                {                    
                    System.err.println("codProd -- cant_prod-->"+codProd + "  " + FarmaUtility.getValueFieldArrayList(VariablesRecepCiega.vTableModelProdTranf.data,i,2) );                    
                    cant_prod= cant_prod + Integer.parseInt(FarmaUtility.getValueFieldArrayList(VariablesRecepCiega.vTableModelProdTranf.data,i,2));  
                }                    
                i++;
            }
            System.err.println("cant_prod total "+ cant_prod);
        }
        return cant_prod ;
    }
