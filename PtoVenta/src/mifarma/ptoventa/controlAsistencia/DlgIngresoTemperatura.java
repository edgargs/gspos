...
public class DlgIngresoTemperatura extends JDialog {
        ...
        if (mifarma.ptoventa.reference.UtilityPtoVenta.verificaVK_F11(e)) {
            if (datosValidados()) {
                if (com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,
                    ...
                    try {
                        if (VariablesControlAsistencia.vTipoAccionTemp == FarmaConstants.ACCION_INSERT)
                            insertarTemp();
    ...
    private void insertarTemp() throws SQLException {
        DBControlAsistencia.ingresaTemperatura(txtVTa.getText().trim(), txtAlmc.getText().trim(),
