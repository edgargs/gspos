...
public class SolicitudCia extends Thread{
    ...
    public SolicitudCia(String pCodCia,Properties farmadaemon,BeanConexion matriz) throws Exception {
        ...
        //ERIOS 17.11.2014 Obtiene el tiempo de espera
        this.tiempoEspera = Integer.parseInt(farmadaemon.getProperty("TiempoEspera"));
        ...
        try {
            while (!isInterrupted()) {
                ...
                try {
                    ...
                    sleep(tiempoEspera*1000L); //30 segundos
                }
