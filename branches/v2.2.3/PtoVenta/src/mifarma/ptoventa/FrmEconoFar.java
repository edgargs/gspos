...
public class FrmEconoFar extends JFrame  {
    ...
    private void jbInit() throws Exception {
        ...
        mnuVentas_Digemid.setText("7. Lista Precios Consumidor");
        mnuVentas_Digemid.setFont(new Font("SansSerif", 0, 11));
        mnuVentas_Digemid.setMnemonic('7');
        ...
        statusBar.setText("Copyright (c) 2005 - 2013");
    ...
    dlgLogin.setVisible(true);
      if (!FarmaVariables.vAceptar) {
        ...
        salirSistema();
          ...
          log.info( "Iniciando subprocesos" );
  ...
  private void verificaRolUsuario_sinAdmin() {
    ...
    private boolean readFileFarmaVentaProperties() {
        ...
        try {
            ...
            tituloBaseFrame = "FarmaVenta "+prop.getProperty("version")+" - "+prop.getProperty("compilacion");
            log.debug("Version: "+tituloBaseFrame);           
        } catch (IOException e) {
            log.error("",e);
            return false;
        }        
 ...
 private void mnuCE_ReciboSencillo_actionPerformed(ActionEvent e) {
    ...
    private void bloquearOpcionesPorCompania(){
          log.info("[INICIO] - bloquearOpcionesPorCompania");    
          try{
          ...
          log.info("[FIN] - bloquearOpcionesPorCompania");    
      }
