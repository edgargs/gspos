...
public class ConstantsInventario {
    ...
    { new FarmaColumnData("Sel", 30, JLabel.LEFT), new FarmaColumnData("Codigo", 50, JLabel.LEFT),
      new FarmaColumnData("Descripcion", 250, JLabel.LEFT), new FarmaColumnData("Unidad", 120, JLabel.LEFT),
      new FarmaColumnData("Laboratorio", 210, JLabel.LEFT), new FarmaColumnData("Stock", 0, JLabel.LEFT),
      new FarmaColumnData("Precio", 0, JLabel.RIGHT), new FarmaColumnData("Zan", 0, JLabel.RIGHT),
    ...
    { new FarmaColumnData("Codigo", 50, JLabel.LEFT), new FarmaColumnData("Descripcion", 200, JLabel.LEFT),
      ...
      new FarmaColumnData("Cantidad", 60, JLabel.RIGHT), new FarmaColumnData("Pre. U.", 50, JLabel.RIGHT),
      new FarmaColumnData("Total", 50, JLabel.RIGHT), new FarmaColumnData("Lote", 0, JLabel.RIGHT),
      new FarmaColumnData("Fec Vec", 0, JLabel.RIGHT), new FarmaColumnData("Val Frac", 0, JLabel.RIGHT) };
    ...
    { new FarmaColumnData("No. Nota", 80, JLabel.CENTER), new FarmaColumnData("Tipo", 70, JLabel.LEFT),
      new FarmaColumnData("Numero Doc.", 90, JLabel.LEFT), new FarmaColumnData("Origen", 100, JLabel.LEFT),
      new FarmaColumnData("Fec. Doc.", 70, JLabel.CENTER), new FarmaColumnData("F. Cierre", 70, JLabel.CENTER),
      new FarmaColumnData("Items", 40, JLabel.RIGHT), new FarmaColumnData("Estado", 70, JLabel.CENTER),
      new FarmaColumnData("Num. Entrega", 90, JLabel.LEFT), new FarmaColumnData("Tip.Nota", 0, JLabel.CENTER),
    ...
    { new FarmaColumnData("Codigo", 50, JLabel.LEFT), new FarmaColumnData("Descripcion", 200, JLabel.LEFT),
      new FarmaColumnData("Unidad", 80, JLabel.LEFT), new FarmaColumnData("Stock", 60, JLabel.RIGHT),
    ...
    { new FarmaColumnData("Codigo", 50, JLabel.LEFT), new FarmaColumnData("Descripcion", 300, JLabel.LEFT) };
    ...
    { new FarmaColumnData("Fecha", 120, JLabel.LEFT), new FarmaColumnData("Descripcion", 200, JLabel.LEFT),
      new FarmaColumnData("Motivo.", 80, JLabel.LEFT), new FarmaColumnData("N. Documento", 100, JLabel.LEFT),
      new FarmaColumnData("Stock Ant.", 75, JLabel.RIGHT), new FarmaColumnData("Movimiento", 75, JLabel.RIGHT),
      new FarmaColumnData("Stock Act.", 75, JLabel.RIGHT), new FarmaColumnData("Fraccion Mov.", 90, JLabel.LEFT),
    ...
    { new FarmaColumnData("Codigo", 50, JLabel.LEFT), new FarmaColumnData("Tipo", 60, JLabel.LEFT),
      new FarmaColumnData("Descripcion", 200, JLabel.LEFT), new FarmaColumnData("Doc. 1", 40, JLabel.LEFT),
      new FarmaColumnData("No. Doc.", 80, JLabel.LEFT), new FarmaColumnData("Doc. 2", 40, JLabel.LEFT),
    ...
    { new FarmaColumnData("Sel", 30, JLabel.LEFT), new FarmaColumnData("Codigo", 50, JLabel.LEFT),
      new FarmaColumnData("Descripcion", 200, JLabel.LEFT), new FarmaColumnData("Unidad", 80, JLabel.LEFT),
      new FarmaColumnData("Laboratorio", 150, JLabel.LEFT), new FarmaColumnData("Stock", 50, JLabel.RIGHT),
    ...
    { new FarmaColumnData("Codigo", 50, JLabel.LEFT), new FarmaColumnData("Descripcion", 200, JLabel.LEFT),
      new FarmaColumnData("Unidad", 80, JLabel.LEFT), new FarmaColumnData("Laboratorio", 150, JLabel.LEFT),
      new FarmaColumnData("Cantidad", 60, JLabel.RIGHT), new FarmaColumnData("Stock", 50, JLabel.RIGHT) };
    ...
    { new FarmaColumnData("No Pedido", 60, JLabel.LEFT), new FarmaColumnData("Fecha", 70, JLabel.LEFT),
      new FarmaColumnData("Motivo", 200, JLabel.LEFT), new FarmaColumnData("Items", 40, JLabel.LEFT),
 ...
 public static final Object[] defaultValuesListaProductosPedidoReposicionDetalle =
    ...
    { new FarmaColumnData("Codigo", 50, JLabel.LEFT), //0
        ...
        new FarmaColumnData("Laboratorio", 0, JLabel.RIGHT), //7
    ...
    { new FarmaColumnData("Codigo", 50, JLabel.LEFT), //0
       ...
       */
        ...
        FarmaColumnData("Adicional", 0, JLabel.RIGHT), //8
        //
        new FarmaColumnData("Laboratorio", 0, JLabel.RIGHT), //9
    ...
    { new FarmaColumnData("No Pedido", 120, JLabel.LEFT), new FarmaColumnData("Fecha", 150, JLabel.LEFT),
    ...
    { new FarmaColumnData("Codigo", 50, JLabel.LEFT), //0
        ...
        //
        new FarmaColumnData("Laboratorio", 0, JLabel.RIGHT), //10
    ...
    { new FarmaColumnData("Codigo", 50, JLabel.LEFT), new FarmaColumnData("Descripcion", 240, JLabel.LEFT),
      ...
      new FarmaColumnData("Cant.", 40, JLabel.RIGHT), new FarmaColumnData("OK", 40, JLabel.RIGHT),
      new FarmaColumnData("Difer.", 40, JLabel.RIGHT), new FarmaColumnData("Afect.", 40, JLabel.CENTER),
      new FarmaColumnData("Guia", 0, JLabel.CENTER), new FarmaColumnData("Val Frac.", 0, JLabel.CENTER),
      new FarmaColumnData("stk fis", 0, JLabel.CENTER), new FarmaColumnData("sec det", 0, JLabel.CENTER),
      new FarmaColumnData("", 0, JLabel.LEFT), new FarmaColumnData("Pag.", 0, JLabel.CENTER) };
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Guia", 80, JLabel.CENTER),
      new FarmaColumnData("Pag.", 30, JLabel.CENTER), new FarmaColumnData("Items", 40, JLabel.CENTER),
      new FarmaColumnData("Prods", 40, JLabel.CENTER), new FarmaColumnData("Num. Entrega", 80, JLabel.CENTER),
      new FarmaColumnData("Fecha", 120, JLabel.CENTER), new FarmaColumnData("Tipo Ped. Rep.", 60, JLabel.CENTER),
    ...
    { new FarmaColumnData("Num. Nota", 80, JLabel.CENTER), new FarmaColumnData("Fecha", 140, JLabel.CENTER),
      new FarmaColumnData("Estado", 50, JLabel.CENTER), new FarmaColumnData("Items", 60, JLabel.RIGHT),
      new FarmaColumnData("Tipo Origen", 90, JLabel.RIGHT), new FarmaColumnData("Est. Recepcion", 90, JLabel.CENTER),
    ...
    { new FarmaColumnData("Sel", 30, JLabel.LEFT), new FarmaColumnData("Codigo", 50, JLabel.LEFT),
      new FarmaColumnData("Descripcion", 250, JLabel.LEFT), new FarmaColumnData("Unidad", 120, JLabel.LEFT),
      new FarmaColumnData("Laboratorio", 210, JLabel.LEFT), new FarmaColumnData("Stock", 60, JLabel.RIGHT),
      new FarmaColumnData("Precio", 0, JLabel.RIGHT), new FarmaColumnData("Zan.", 0, JLabel.RIGHT),
      new FarmaColumnData("Ind Cong", 0, JLabel.RIGHT), new FarmaColumnData("", 0, JLabel.RIGHT),
      //valor de fraccion de local
    ...
    { new FarmaColumnData("Codigo", 50, JLabel.LEFT), new FarmaColumnData("Descripcion", 200, JLabel.LEFT),
      ...
      new FarmaColumnData("Fec. Vto.", 70, JLabel.RIGHT), new FarmaColumnData("Lote", 70, JLabel.RIGHT),
      new FarmaColumnData("Stock", 0, JLabel.RIGHT), new FarmaColumnData("Valor Frac.", 0, JLabel.RIGHT),
      new FarmaColumnData("Total", 0, JLabel.RIGHT), new FarmaColumnData("Sysdate", 0, JLabel.RIGHT) };
    ...
    { new FarmaColumnData("No. Transf.", 80, JLabel.LEFT), new FarmaColumnData("Local Dest.", 100, JLabel.LEFT),
      new FarmaColumnData("Fecha", 120, JLabel.LEFT), new FarmaColumnData("Items", 40, JLabel.RIGHT),
      new FarmaColumnData("Estado", 110, JLabel.LEFT), new FarmaColumnData("No. Guia", 80, JLabel.LEFT),
      new FarmaColumnData("Imp.", 30, JLabel.CENTER), new FarmaColumnData("Motivo", 160, JLabel.LEFT),
      new FarmaColumnData("Proc.", 30, JLabel.CENTER), new FarmaColumnData("", 0, JLabel.LEFT), //tipo nota
    ...
    { new FarmaColumnData("No. Devoluc.", 75, JLabel.LEFT), new FarmaColumnData("Proveedor.", 180, JLabel.LEFT),
      new FarmaColumnData("Fecha Envio", 120, JLabel.LEFT), new FarmaColumnData("Items", 35, JLabel.RIGHT),
      new FarmaColumnData("Estado", 110, JLabel.LEFT), new FarmaColumnData("No. Guia", 80, JLabel.LEFT),
      new FarmaColumnData("Imp.", 30, JLabel.CENTER), new FarmaColumnData("Motivo", 135, JLabel.LEFT),
    ...
    { new FarmaColumnData("Codigo.", 100, JLabel.LEFT), new FarmaColumnData("Proveedor", 260, JLabel.LEFT),
      new FarmaColumnData("Fec. Venci.", 100, JLabel.RIGHT), new FarmaColumnData("Cant. Dias", 70, JLabel.LEFT),
    ...
    { new FarmaColumnData("Codigo.", 120, JLabel.LEFT), new FarmaColumnData("Producto", 280, JLabel.LEFT),
      new FarmaColumnData("Cant. Unid.", 100, JLabel.LEFT), new FarmaColumnData("Stock", 100, JLabel.LEFT), };
    ...
    { new FarmaColumnData("Codigo", 50, JLabel.LEFT), new FarmaColumnData("Descripcion", 200, JLabel.LEFT),
      new FarmaColumnData("Unidad", 80, JLabel.LEFT), new FarmaColumnData("Laboratorio", 200, JLabel.LEFT),
      new FarmaColumnData("Cantidad", 60, JLabel.RIGHT), new FarmaColumnData("Precio", 60, JLabel.RIGHT),
      new FarmaColumnData("Fec. Vto.", 85, JLabel.RIGHT), new FarmaColumnData("Lote", 0, JLabel.RIGHT),
      new FarmaColumnData("Stock", 0, JLabel.RIGHT), new FarmaColumnData("Valor Frac.", 0, JLabel.RIGHT),
      new FarmaColumnData("Total", 0, JLabel.RIGHT), new FarmaColumnData("Sysdate", 0, JLabel.RIGHT),
    ...
    { new FarmaColumnData("Codigo", 55, JLabel.CENTER), new FarmaColumnData("Descripcion", 230, JLabel.LEFT),
      new FarmaColumnData("Unidad", 110, JLabel.LEFT), new FarmaColumnData("Laboratorio", 170, JLabel.LEFT),
      new FarmaColumnData("Unidad Frac", 100, JLabel.LEFT), new FarmaColumnData("C. Ent", 45, JLabel.RIGHT),
      new FarmaColumnData("C. Frac", 45, JLabel.RIGHT), new FarmaColumnData("Frac", 0, JLabel.RIGHT),
    ...
    public static final FarmaColumnData columnsListaProductosInsmo[] =
    { new FarmaColumnData("Codigo", 55, JLabel.CENTER), new FarmaColumnData("Descripcion", 230, JLabel.LEFT),
      new FarmaColumnData("Unidad", 110, JLabel.LEFT), new FarmaColumnData("Laboratorio", 170, JLabel.LEFT),
      new FarmaColumnData("Unidad Frac", 100, JLabel.LEFT), new FarmaColumnData("C. Ent", 45, JLabel.RIGHT),
      new FarmaColumnData("C. Frac", 45, JLabel.RIGHT), new FarmaColumnData("Frac", 0, JLabel.RIGHT),
      new FarmaColumnData("", 0, JLabel.RIGHT), // TIPO PROD VIRTUAL
        new FarmaColumnData("", 0, JLabel.RIGHT), //estado
        new FarmaColumnData("Ult.Fec.Manual", 80, JLabel.LEFT) //ultima fecha manual
        } ;

    public static final Object[] defaultValuesListaProductosInsu =
    { " ", " ", " ", " ", " ", " ", " ", " ", " ", " " };
    ...
    { new FarmaColumnData("Fecha", 120, JLabel.CENTER), new FarmaColumnData("Descripcion", 180, JLabel.LEFT),
      new FarmaColumnData("Tip. Doc", 60, JLabel.LEFT), new FarmaColumnData("Num. Doc.", 100, JLabel.CENTER),
      new FarmaColumnData("Stk.Ant", 40, JLabel.RIGHT), new FarmaColumnData("Mov", 40, JLabel.RIGHT),
      new FarmaColumnData("Stk.Act", 40, JLabel.RIGHT), new FarmaColumnData("Frac.", 40, JLabel.RIGHT),
      new FarmaColumnData("Usuario", 90, JLabel.LEFT), new FarmaColumnData("Glosa", 100, JLabel.LEFT),
      new FarmaColumnData("ord", 0, JLabel.CENTER), new FarmaColumnData("suma", 0, JLabel.CENTER),
      ...
      new FarmaColumnData("Fec. Lote", 100, JLabel.LEFT)
        } ;
    ...
    { new FarmaColumnData("Lote", 160, JLabel.RIGHT),
      new FarmaColumnData("Fecha Lote Venc.", 120, JLabel.CENTER),
      new FarmaColumnData("Stock", 80, JLabel.RIGHT)
    } ;

    public static final Object[] defaultListaLoteProd =
    { " ", " ", " " };
///////////////////////////////////////////////////

    public static final FarmaColumnData[] columnsListaAjustesporFecha =
    { new FarmaColumnData("Codigo", 60, JLabel.LEFT), new FarmaColumnData("Descripcion", 200, JLabel.LEFT),
      new FarmaColumnData("Fecha", 120, JLabel.CENTER), new FarmaColumnData("Motivo", 182, JLabel.LEFT),
      new FarmaColumnData("Stk.Ant", 40, JLabel.RIGHT), new FarmaColumnData("Mov", 40, JLabel.RIGHT),
      new FarmaColumnData("Stk.Act", 40, JLabel.RIGHT), new FarmaColumnData("Val. Fracc.", 60, JLabel.RIGHT),
      new FarmaColumnData("ord", 0, JLabel.CENTER), new FarmaColumnData("Laboratorio", 0, JLabel.LEFT),
      new FarmaColumnData("Usuario", 0, JLabel.LEFT), new FarmaColumnData("Glosa", 0, JLabel.LEFT), };
    ...
    { new FarmaColumnData("Sec.", 60, JLabel.LEFT), new FarmaColumnData("Descripcion", 200, JLabel.LEFT),
      new FarmaColumnData("Num. Comp.", 100, JLabel.LEFT), };

    public static final Object[] defaultValuesListaImpresoras = { " ", " ", " " };

    //DlgExcesoListado
    public static final FarmaColumnData columnsListaExcesos[] =
    { new FarmaColumnData("Sec", 80, JLabel.LEFT), new FarmaColumnData("Cod", 60, JLabel.LEFT),
      new FarmaColumnData("Descripcion", 200, JLabel.LEFT), new FarmaColumnData("Unidad", 150, JLabel.LEFT),
      new FarmaColumnData("Cant", 50, JLabel.RIGHT), new FarmaColumnData("Fecha", 120, JLabel.LEFT),
      new FarmaColumnData("Num. Entrega", 80, JLabel.LEFT), new FarmaColumnData("Numero Lote", 0, JLabel.LEFT),
      new FarmaColumnData("Fecha Venc.", 0, JLabel.LEFT), new FarmaColumnData("Laboratorio", 0, JLabel.LEFT) };
    ...
    { new FarmaColumnData("Correlativo", 90, JLabel.CENTER), new FarmaColumnData("Sec.", 30, JLabel.RIGHT),
      new FarmaColumnData("Tipo Nota", 120, JLabel.CENTER), new FarmaColumnData("No. Guía", 90, JLabel.CENTER),
      new FarmaColumnData("Fecha", 120, JLabel.CENTER), new FarmaColumnData("Estado", 80, JLabel.CENTER),
      new FarmaColumnData("Ord. Guia", 0, JLabel.CENTER), new FarmaColumnData("Tipo Nota", 0, JLabel.CENTER) };
    ...
    { new FarmaColumnData("No. Transf.", 80, JLabel.LEFT), new FarmaColumnData("Local Dest.", 100, JLabel.LEFT),
      new FarmaColumnData("No. Guia.", 80, JLabel.LEFT), new FarmaColumnData("Fecha", 120, JLabel.LEFT),
      new FarmaColumnData("Items", 40, JLabel.RIGHT), new FarmaColumnData("Estado", 60, JLabel.LEFT) };
    ...
    /* public static final String[] vDescCampoPedRep = {"Codigo", "Descripcion","Unidad","Solicitud",
                                                   ...
                                                   "Rotacion","Max Dia"};*/
    public static final String[] vDescCampoPedRep = { "Codigo", "Descripcion", "Unidad", "Solicitud", "Stock", "PVM" };
    ...
    public static String[] COD_TIPO_GUIA = { "01", "04", "02" };
    public static String[] DESC_TIPO_GUIA = { "Local", "Competencia", "Matriz" };

    //Histórico de Creación/Modificación
    //ERIOS      25.07.2006   Creación
    //DlgTransferenciasLocal
    public static final FarmaColumnData columnsListaTransfLocal[] =
    { new FarmaColumnData("No. Transf.", 80, JLabel.LEFT), new FarmaColumnData("Local Origen.", 100, JLabel.LEFT),
      new FarmaColumnData("No. Guia.", 80, JLabel.LEFT), new FarmaColumnData("Fecha", 120, JLabel.LEFT),
      new FarmaColumnData("Items", 40, JLabel.RIGHT), new FarmaColumnData("CodLocal", 0, JLabel.RIGHT) };
    ...
    { new FarmaColumnData("Codigo", 50, JLabel.LEFT), new FarmaColumnData("Descripcion", 150, JLabel.LEFT),
    ...
    { new FarmaColumnData("RUC", 100, JLabel.LEFT), new FarmaColumnData("Descripcion", 220, JLabel.LEFT) };
    ...
    { new FarmaColumnData("Unid.Autorizada", 0, JLabel.RIGHT), new FarmaColumnData("Codigo", 50, JLabel.LEFT),
      new FarmaColumnData("Descripcion", 250, JLabel.LEFT),
      new FarmaColumnData("Unidad Presentacion", 120, JLabel.LEFT),
      new FarmaColumnData("Laboratorio", 210, JLabel.LEFT), new FarmaColumnData("Unid.Solicitada", 100, JLabel.LEFT),
    ...
    /* public static final String[] vDescCampoPedRep = {"Codigo", "Descripcion","Unidad","Solicitud",
                                                    "Sugerido","Stock","Vendidos","Minimo","Maximo",
                                                    "Rotacion","Max Dia"};*/
    public static final String[] vDescCampoPedPVM =
    { "Codigo", "Estado", "Descripcion", "Unidad", "Stk.Linea", "PVM", "Solic", "Autoriz" };
    ...
    { new FarmaColumnData("No Pedido", 90, JLabel.LEFT), new FarmaColumnData("Fecha", 130, JLabel.LEFT),
      new FarmaColumnData("Items", 50, JLabel.RIGHT), new FarmaColumnData("Estado", 90, JLabel.RIGHT),
      new FarmaColumnData("Usuario", 90, JLabel.RIGHT), new FarmaColumnData("Fecha Envio", 130, JLabel.LEFT),
      new FarmaColumnData("", 0, JLabel.RIGHT) };
    ...
    { new FarmaColumnData("Sel.", 30, JLabel.LEFT), new FarmaColumnData("Codigo", 50, JLabel.LEFT),
      new FarmaColumnData("Descripcion", 230, JLabel.LEFT), new FarmaColumnData("Unidad", 110, JLabel.LEFT),
      new FarmaColumnData("Laboratorio", 180, JLabel.LEFT), new FarmaColumnData("Stock", 70, JLabel.RIGHT),
      new FarmaColumnData("Cant.Sol.", 60, JLabel.RIGHT), new FarmaColumnData("", 0, JLabel.RIGHT),
      new FarmaColumnData("", 0, JLabel.RIGHT) };
    ...
    { new FarmaColumnData("Codigo", 50, JLabel.LEFT), new FarmaColumnData("Descripcion", 210, JLabel.LEFT),
      new FarmaColumnData("Unidad", 100, JLabel.LEFT), new FarmaColumnData("Laboratorio", 150, JLabel.LEFT),
      new FarmaColumnData("Cantidad", 60, JLabel.RIGHT), new FarmaColumnData("Estado", 0, JLabel.RIGHT),
      new FarmaColumnData("", 0, JLabel.RIGHT) };
    ...
    { new FarmaColumnData("Codigo", 50, JLabel.LEFT), new FarmaColumnData("Descripcion", 230, JLabel.LEFT),
      new FarmaColumnData("Unidad", 110, JLabel.LEFT), new FarmaColumnData("Laboratorio", 180, JLabel.LEFT),
      new FarmaColumnData("Stock", 70, JLabel.RIGHT), new FarmaColumnData("Cant.Sol.", 60, JLabel.RIGHT),
      new FarmaColumnData("", 0, JLabel.RIGHT), new FarmaColumnData("", 0, JLabel.RIGHT) };
    ...
    { new FarmaColumnData("Nº O/C", 100, JLabel.CENTER), new FarmaColumnData("Local", 35, JLabel.RIGHT),
      new FarmaColumnData("RUC", 85, JLabel.RIGHT), new FarmaColumnData("Proveedor", 150, JLabel.LEFT),
      new FarmaColumnData("Nº Items", 60, JLabel.RIGHT), new FarmaColumnData("Importe Total", 90, JLabel.RIGHT),
      new FarmaColumnData("Fec. Emisión.", 85, JLabel.CENTER), new FarmaColumnData("Fec. Entrega.", 85, JLabel.CENTER),
    ...
    //INI ASOSA - 26/08/2014
    public static final FarmaColumnData[] columnsListaOrdenPendRegul =
    { new FarmaColumnData("Nº O/C", 100, JLabel.CENTER), new FarmaColumnData("Local", 35, JLabel.RIGHT),
      new FarmaColumnData("RUC", 85, JLabel.RIGHT), new FarmaColumnData("Proveedor", 200, JLabel.LEFT),
      new FarmaColumnData("Nº Items", 60, JLabel.RIGHT), new FarmaColumnData("Importe Total", 90, JLabel.RIGHT),
      new FarmaColumnData("Fec. Emisión.", 85, JLabel.CENTER),
      new FarmaColumnData("Fec. Entrega.", 85, JLabel.CENTER) };
    public static final Object[] defaultListaOrdenPendRegul = { " ", " ", " ", " ", " ", " ", " ", " " };
    //FIN ASOSA - 26/08/2014

    public static final FarmaColumnData[] columnsListaItemOrden =
    { new FarmaColumnData("Sel", 35, JLabel.LEFT), new FarmaColumnData("Cod. Prod.", 70, JLabel.RIGHT),
      new FarmaColumnData("Descripción", 385, JLabel.LEFT), new FarmaColumnData("Cant. Ped.", 70, JLabel.RIGHT),
      new FarmaColumnData("Cant. Rec.", 70, JLabel.RIGHT), new FarmaColumnData("Precio", 0, JLabel.RIGHT),
      //No se desea mostrar el precio
        new FarmaColumnData("IGV", 0, JLabel.RIGHT), //No se desea mostrar el igv
        new FarmaColumnData("CANT_PRESENT", 0, JLabel.RIGHT), new FarmaColumnData("VAL_FRAC_LOCAL", 0, JLabel.RIGHT) };
    public static final Object[] defaultListaItemOrden =
    { " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " " }; //ASOSA - 30/09/2014

    //INI ASOSA - 19/08/2014
    public static final FarmaColumnData[] columnsListaItemOrdenSobr =
    { new FarmaColumnData("Sel", 35, JLabel.LEFT), new FarmaColumnData("Cod. Prod.", 70, JLabel.RIGHT),
      new FarmaColumnData("Descripción", 385, JLabel.LEFT), new FarmaColumnData("Cant. Exceso", 80, JLabel.RIGHT),
      new FarmaColumnData("Cant. Devol.", 70, JLabel.RIGHT), new FarmaColumnData("Precio", 0, JLabel.RIGHT),
      //No se desea mostrar el precio
        new FarmaColumnData("IGV", 0, JLabel.RIGHT), //No se desea mostrar el igv
        new FarmaColumnData("CANT_PRESENT", 0, JLabel.RIGHT), new FarmaColumnData("VAL_FRAC_LOCAL", 0, JLabel.RIGHT),
        //8
        new FarmaColumnData("Laboratorio", 0, JLabel.RIGHT), new FarmaColumnData("StockDisponible", 0, JLabel.RIGHT),
        new FarmaColumnData("FechaVencimiento", 0, JLabel.RIGHT), new FarmaColumnData("NumeroLote", 0, JLabel.RIGHT),
        //12
        new FarmaColumnData("cantidad adicional", 0, JLabel.RIGHT), new FarmaColumnData("innerPack", 0, JLabel.RIGHT),
        new FarmaColumnData("estado", 0, JLabel.RIGHT), new FarmaColumnData("subtotal", 0, JLabel.RIGHT), //16
        new FarmaColumnData("codOrdenCompra", 0, JLabel.RIGHT),
        new FarmaColumnData("secuencialDetalle", 0, JLabel.RIGHT) };
    public static final Object[] defaultListaItemOrdenSobr =
    { " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " " };
    //FIN ASOSA - 19/08/2014


    public static final FarmaColumnData[] columnsListaProductoOrden =
    { new FarmaColumnData("Cod. Producto", 97, JLabel.RIGHT), new FarmaColumnData("Descripción", 195, JLabel.LEFT),
      new FarmaColumnData("Cant. Pedida", 85, JLabel.RIGHT), new FarmaColumnData("Cant. Recibida", 85, JLabel.RIGHT),
      new FarmaColumnData("Precio", 95, JLabel.RIGHT), new FarmaColumnData("IGV", 33, JLabel.RIGHT) };
    public static final Object[] defaultListaProductoOrden = { " ", " ", " ", " ", " ", " ", " ", " ", " ", " " };

    public static final FarmaColumnData[] columnsListaDocumentos =
    { new FarmaColumnData("Ord. Compra", 85, JLabel.RIGHT), new FarmaColumnData("Num. Guia", 80, JLabel.RIGHT),
      new FarmaColumnData("Tipo.", 70, JLabel.LEFT), new FarmaColumnData("Serie", 50, JLabel.RIGHT),
      new FarmaColumnData("Num. Docum.", 100, JLabel.RIGHT), new FarmaColumnData("Proveedor", 150, JLabel.LEFT),
      new FarmaColumnData("Fec. Ingreso", 75, JLabel.RIGHT), new FarmaColumnData("Redondeo", 67, JLabel.RIGHT),
      new FarmaColumnData("Importe Docum.", 90, JLabel.RIGHT), new FarmaColumnData("Estado", 0, JLabel.RIGHT),
      new FarmaColumnData("TipComp", 0, JLabel.RIGHT), new FarmaColumnData("CodProv", 0, JLabel.RIGHT),
    ...
    { new FarmaColumnData("N° Nota", 100, JLabel.RIGHT), new FarmaColumnData("Num. Guia Rem", 100, JLabel.RIGHT),
      new FarmaColumnData("Fecha Crea. Guia.", 120, JLabel.LEFT),
      new FarmaColumnData("Usu. Crea. Guia", 100, JLabel.LEFT), new FarmaColumnData("Estado", 120, JLabel.LEFT),
    ...
    public static final FarmaColumnData[] columnsListaMaestroProductos = {
        ...
        new FarmaColumnData("Codigo.", 120, JLabel.LEFT), new FarmaColumnData("Producto", 280, JLabel.LEFT),
        new FarmaColumnData("Cant. Unid.", 100, JLabel.LEFT), new FarmaColumnData("Stock", 100, JLabel.LEFT),
        new FarmaColumnData("Uni.Venta", 0, JLabel.LEFT), new FarmaColumnData(" ", 0, JLabel.LEFT),
        //Ind prod Fraccionable
    ...
    public static final String COD_MOT_KDX_SOBRANTE = "112"; //ASOSA - 18/08/2014

    public static final int COD_IND_ING_MANUAL = 522; //ASOSA - 26/08/2014
    public static final int COD_NUM_CANT_MULT = 523; //ASOSA - 27/08/2014
    
    public static final FarmaColumnData[] columnsMA_CantLote =
    { new FarmaColumnData("Cantidad", 70, JLabel.RIGHT),
      new FarmaColumnData("Lote", 120, JLabel.CENTER),
      new FarmaColumnData("Fecha Vencimiento", 120, JLabel.CENTER),
      new FarmaColumnData("Fecha Ingreso", 150, JLabel.CENTER)
    };
    
    public static final Object[] defaultMA_CantLote =
    { " ", " ", " ", " ", " "," ", " ", " ", " ", " "}; 
