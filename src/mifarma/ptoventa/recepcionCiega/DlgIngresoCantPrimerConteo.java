    ...
    */  
    ...
    private void chkKeyPressed(KeyEvent e) {
            if (e.getKeyCode() == KeyEvent.VK_ENTER) {
               ...
               // boolean rpta = FarmaUtility.rptaConfirmDialog(this,"No se ingresará o Modificará este Producto, ¿Está seguro?");
                //if(rpta == true){
    ...
    private boolean datosValidados() {
        ...
        if (isInteger(txtCantidad.getText().trim())) {
            ...
            if (Integer.parseInt(txtCantidad.getText()) == 0){
                if(!VariablesRecepCiega.vIndModificarCant){
                    if(FarmaUtility.rptaConfirmDialog(this,"¿Está seguro que no desea ingresar este producto?")) {
                        System.out.println("No ingresa dato");
                        //VariablesRecepCiega.vLastCodBarra = "";                      
                        VariablesRecepCiega.vIndAgregaConteo = false;                
                        cerrarVentana(false);   
                        rpta = true;
                     ...
                     if(FarmaUtility.rptaConfirmDialog(this,"¿Está seguro que desea eliminar este producto?")) {
                         System.out.println("Eliminar");
                         //VariablesRecepCiega.vLastCodBarra = "";  
                         //VariablesRecepCiega.vIndEliminaFila = true;
                         VariablesRecepCiega.vIndAgregaConteo = false;                
                             eliminaFilaConteo();
                             System.out.println("eliminaRegistro");
