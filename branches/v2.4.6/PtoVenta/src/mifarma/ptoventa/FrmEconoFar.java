...
public class FrmEconoFar extends JFrame  {
    ...
    private void jbInit() throws Exception {
        ...
        // mnuInventario_Kardex.addActionListener(new ActionListener() {
          //       public void actionPerformed(ActionEvent e) {
            //         mnuInventario_Kardex_actionPerformed(e);              //05.08.2014
              //   }
           //  });
         ...
         mnuKardex_ConsumoInter.setText("2. Productos de insumos");
        ...
        mnuReportes_VentasConvenio.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    mnuReportesVentasConvenioActionPerformed(e);
                }
            });
        ...
        statusBar.setText("Copyright (c) 2005 - 2014");
    ...
    private void mnuInventario_Kardex_actionPerformed(ActionEvent e)
        ...
        {
          DlgKardex dlgKardex = new DlgKardex(this,"",true);
          dlgKardex.setTipo_reposicion(ConstantsCaja.TIPO_REPOSICION_INSUMOS);////05.08.2014
          dlgKardex.cargaListaProductos();  //05.08.2014 lista los productos
          dlgKardex.cargarNombre();         //08.08.2014 titulo de venta
          dlgKardex.setVisible(true);
        }
    ...
    private void mnuReportesVentasConvenioActionPerformed(ActionEvent e) {
  ...
  private void verificaRolUsuario_sinAdmin() {
    ...
    private void cargaIcono(){
        ...
        ImageIcon imageIcono = new ImageIcon(FrmEconoFar.class.getResource("/mifarma/ptoventa/imagenes/Icono"+strRutaJpg));
