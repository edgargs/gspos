...
public class Impresora {
    ...
    public static void main(String[] args) {
        ...
        impresora.imprimirGenerico(vPrint,"\\\\10.18.1.179\\BTLGUIAS");
    }

    public void imprimir(ArrayList<String> pTextos, String pRutaImpresora, boolean vImprimeTestigo, String strNumPedido, String pNumComprobante, String pIndActualizaImpr, String pRuta) {
        imprimirGenerico(pTextos, pRutaImpresora);
        if(vImprimeTestigo)
        {
            try
            {
            ...
            imprimirGenerico(pTextos, pRuta);            
        }
    }
}
