  ...
  BEGIN
    ...
    BEGIN
      ...
      SELECT 'EN|' || -- ENCABEZADO
              ...
              (select m.nom_marca from pbl_marca_grupo_cia m
...
/* **********************************************************************/
  ...
  begin
    ...
    /*if  vIsCompEmpresa_COPAGO = 'S' then
	  ...
	  update vta_comp_pago
	  set total_grav_e = VAL_NETO_COMP_PAGO - VAL_IGV_COMP_PAGO,
