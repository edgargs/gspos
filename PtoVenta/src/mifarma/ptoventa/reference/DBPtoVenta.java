...
public class DBPtoVenta {
    ...
    public static String getIndImprimirKardex() throws SQLException {
        parametros = new ArrayList();
        return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA.PTOVENTA_GRAL.GET_IND_IMPR_KARDEX", parametros);
    }
    ...
    public static String getIndImprimirDetPedido() throws SQLException {
        parametros = new ArrayList();
        return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA.PTOVENTA_GRAL.GET_IND_IMPR_DET_PEDIDO", parametros);
    }
    ...
    public static boolean isCentralizaClientes(String pCodGrupoCia, String pCodLocal)throws Exception{
        ...
        log.info("PTOVENTA.FARMA_UTILITY.F_GET_CENTRALIZA_CLIENTES(?,?) " + parametros);
        String rspta = FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA.FARMA_UTILITY.F_GET_CENTRALIZA_CLIENTES(?,?)", parametros);
    ...
    public static boolean isLocalAplicaPercepcion(String pCodGrupoCia, String pCodLocal)throws Exception{
        ...
        parametros.add(pCodGrupoCia);
        parametros.add(pCodLocal);
        log.info("PTOVENTA.FARMA_UTILITY.F_GET_LOCAL_APLICA_PERCEPCION(?,?) " + parametros);
        String rspta = FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA.FARMA_UTILITY.F_GET_LOCAL_APLICA_PERCEPCION(?,?)", parametros);
        if("S".equalsIgnoreCase(rspta)){
            return true;
        }else{
            return false;
    ...
    public static List getComprobantePago(String pCodGrupoCia, String pCodLocal, String pNumPedVta, String pSecCompPago)throws Exception{
        ...
        log.info("PTOVENTA_IMPRESION_MATRICIAL.F_GET_COMPROBANTE_PAGO(?,?,?,?)" + parametros);
     ...
     * @throws Exception
     */
    public static String getRequiereControlProducto(String pCodGrupoCia, String pCodLocal)throws Exception{
        ArrayList parametros = new ArrayList();
        parametros.add(pCodGrupoCia);
        parametros.add(pCodLocal);
        log.info("PTOVENTA_GRAL.F_NO_VALIDA_PROD_CONTROLADO(?,?)", parametros);
        return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_GRAL.F_NO_VALIDA_PROD_CONTROLADO(?,?)", parametros);
    }
}
