...
public class ConstantsRecepCiega {
    ...
    { new FarmaColumnData("Código", 50, JLabel.CENTER), new FarmaColumnData("Descripción Producto", 230, JLabel.LEFT),
    ...
    public static final FarmaColumnData[] columnsListaProductosSegundoConteoM =
    { new FarmaColumnData("Código", 50, JLabel.CENTER), new FarmaColumnData("Descripción Producto", 220, JLabel.LEFT),
      new FarmaColumnData("Unidad", 85, JLabel.LEFT), new FarmaColumnData("Laboratorio", 100, JLabel.LEFT),
      new FarmaColumnData("Lote", 60, JLabel.CENTER), new FarmaColumnData("En G/R", 45, JLabel.CENTER),
      new FarmaColumnData("Rcp.Ciega", 63, JLabel.CENTER), new FarmaColumnData("Reconteo", 63, JLabel.CENTER), 
      new FarmaColumnData("Resultado", 80, JLabel.LEFT), new FarmaColumnData("CodProd", 0, JLabel.LEFT), 
      new FarmaColumnData("SecConteo", 0, JLabel.LEFT), new FarmaColumnData("FechaVencimiento", 0, JLabel.LEFT),
      new FarmaColumnData("IndLoteMayorista", 0, JLabel.LEFT)};

    public static final Object[] defaultcolumnsListaProductosSegundoConteo =
    {"100359","EUCERIN BAÑO & SHAMPOO","FCO 250 ML","BEIERSDORF","0","1"," ","+1 Sobrante","100359","4"};
    
    public static final Object[] defaultcolumnsListaProductosSegundoConteoM =
    {"100359","EUCERIN BAÑO & SHAMPOO","FCO 250 ML","BEIERSDORF"," ","0","1"," ","+1 Sobrante","100359","4", " ", "N"};
    ...
    { new FarmaColumnData("Num. Guía", 90, JLabel.LEFT), new FarmaColumnData("Num. Entrega", 100, JLabel.LEFT),
    ...
    public static final FarmaColumnData[] columnsListaProductosFaltantes = {
        ...
        new FarmaColumnData("Código", 50, JLabel.LEFT), new FarmaColumnData("Desc. Producto", 200, JLabel.LEFT),
    ...
    { new FarmaColumnData("Descripción", 170, JLabel.LEFT), new FarmaColumnData("Unidad", 80, JLabel.LEFT),
      ...
      new FarmaColumnData("Venc. 2", 70, JLabel.LEFT), new FarmaColumnData("secAux", 0, JLabel.RIGHT), //7
        ...
        new FarmaColumnData("", 0, JLabel.RIGHT), //NroBloque  8
        new FarmaColumnData("", 0, JLabel.RIGHT) // IND_LOTE_MAYORISTA 9
        } ;
    ...
    { new FarmaColumnData("N° Ingreso", 85, JLabel.CENTER), //0
        ...
        new FarmaColumnData("Cant.Guías", 68, JLabel.CENTER), //6
    ...
    { new FarmaColumnData("Código", 60, JLabel.CENTER), new FarmaColumnData("Descripcion", 250, JLabel.LEFT),
      new FarmaColumnData("Presentación.", 100, JLabel.LEFT), new FarmaColumnData("Cantidad", 60, JLabel.CENTER),
      ...
      new FarmaColumnData("Envase Inmediato", 80, JLabel.CENTER), new FarmaColumnData("Rótulo", 80, JLabel.CENTER),
    ...
    { 
      ...
      new FarmaColumnData("Fecha Recepción", 123, JLabel.CENTER),
    ...
    public static final FarmaColumnData columnsListaIngresoBandeja[] = { 
        ...
        new FarmaColumnData("Fecha Recepción", 0, JLabel.LEFT) ,
    ...
    public static final FarmaColumnData columnsListaPorDevolver[] = { 
        ...
        new FarmaColumnData("Fecha Recepción", 130, JLabel.CENTER) ,
        new FarmaColumnData(" ", 0, JLabel.CENTER) ,
        new FarmaColumnData(" ", 0, JLabel.CENTER) ,
        new FarmaColumnData(" ", 0, JLabel.CENTER) ,
        new FarmaColumnData(" ", 0, JLabel.CENTER) 
