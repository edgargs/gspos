...
public class UtilityFidelizacion {
     ...
     * @return
     */
    private static boolean validaTarjetaMatriz(String pTarjeta, String pIndCloseConecction, String pIndLinea,
                                               Frame pParent) {
        String indExisteMatriz = "";
        boolean retorno = false;

        try {
            indExisteMatriz = DBFidelizacion.validaTarjetaMatriz(pTarjeta, pIndCloseConecction);
     ...
     * @param pParent
     */
    public static void cargoProcesoSegunIndExiste(String vIndExiste, String pTarjeta, Frame pParent, JDialog pJDialog) {
                ...
                if(UtilityPuntos.isActivoFuncionalidad()){
                    if(VariablesPuntos.frmPuntos != null && VariablesPuntos.frmPuntos.getTarjetaBean()!= null){
                        ...
                        if(FarmaPuntosConstante.EstadoTarjeta.INACTIVA.equalsIgnoreCase(tarjetaPuntos.getEstadoTarjeta()) || 
                           FarmaPuntosConstante.NO_CONEXION_ORBIS.equalsIgnoreCase(tarjetaPuntos.getEstadoOperacion())){
                            
                            String nroDocumento = FarmaUtility.getValueFieldArrayList(VariablesFidelizacion.vDataCliente, 0, 0);
                            boolean rsptaValida = UtilityPuntos.impresionVoucherAfiliacion(pParent, pJDialog, VariablesFidelizacion.vNumTarjeta, nroDocumento);
                            if(rsptaValida){
                                boolean rsptaAfialiacion = UtilityPuntos.registroAfiliadoAutomatico(nroDocumento, tarjetaPuntos.getNumeroTarjeta(), VariablesFidelizacion.vNumTarjeta);
                                ...
                                UtilityPuntos.actualizarEstadoEnvioAfiliacion(VariablesFidelizacion.vNumTarjeta, nroDocumento, indicadorLinea);
                            }else{
                            ...
                            */
                            ...
                            if(UtilityPuntos.isTarjetaValida(tarjetaPuntos.getNumeroTarjeta()) && (
                                ...
                                UtilityPuntos.actualizarEstadoEnvioAfiliacion(tarjetaPuntos.getNumeroTarjeta(), tarjetaPuntos.getDni(), ConstantsPuntos.TRSX_ORBIS_ENVIADA);
                            }
                        }
...
//                DBFidelizacion.insertarClienteFidelizacion();
    ...
    public static void validarConexionMatriz() {
        ...
        if (VariablesFidelizacion.vIndConexion.trim().equalsIgnoreCase(FarmaConstants.INDICADOR_N)) {
    ...
    */
    ...
    public static void insertarTarjetaMatriz(String vNumTarjeta, String vDNICliente) {

        validarConexionMatriz();
        if (VariablesFidelizacion.vIndConexion.equals("S")) {
            try {
                DBFidelizacion.insertarNuevaTarjetaFidelizacionMatriz(vNumTarjeta, vDNICliente,
                                                                      VariablesFidelizacion.vIndConexion);
...
DBFidelizacion.isValidaPedidoFidelizadoMatriz(pNumPed, pRuc, VariablesFidelizacion.vDniCliente);
    ...
    public static void grabaTarjetaUnica(String pTarjetaPago, String pdni, boolean bloqueo) { 
        //KMONCADA 23.07.2015 POR PROTECCION DE DATOS NO SE REGISTRARAN LAS TARJETAS DE CREDITO
        // INDICADO POR ROLANDO CASTRO.
        log.info("POR DEFINICION DE PROTECCION DE DATOS NO SE REGISTRARAN LAS TARJETAS DE CREDITO");
    }
     ...
     * @throws SQLException
     */
    public static void insertarLogOperacion(OperacionDTO operacionDTO) {
        try {
            DBFidelizacion.insertarLogOperacion(operacionDTO);
        } catch(Exception e) {
            log.error("",e);
        }
    }
     ...
     * @return
     */
    public static boolean getIndImpresionTextExpert(String numPedVta,
                                                   String secCompPago) {  
        boolean flag = false;
        String ind = "N";
        try {
     ...
     * @param secCompPago
     */
    public static void getTextExpertImpresion(String numPedVta,
                                                   String secCompPago)  {  
        String texto = "";       
