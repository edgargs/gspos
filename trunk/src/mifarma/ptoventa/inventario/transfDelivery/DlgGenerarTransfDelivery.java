...
public class DlgGenerarTransfDelivery extends JDialog {
	...
	private boolean procesarTransferencia(){
		...
		try
		{
			...
			for (int i =0; i<tblProdTransf.getRowCount();i++){
				System.err.println(" suma total : "+sumaTotal);
			...
			System.err.println("numera : "+numera);
			...
			System.err.println("VariablesCaja.vSecImprLocalGuia : "+VariablesCaja.vSecImprLocalGuia);
			...
			System.err.println(" indEstado : "+indEstado);
			/** fin validacion **/
	...
	{ 
		boolean valor = true;
		try{
			System.err.println(""+VariablesTranfDelivery.vCodProducto+"***"+Integer.parseInt(VariablesTranfDelivery.vCantProductoTransf)+"***"+
