...
public class DlgControlAsistencia extends JDialog implements Runnable {
    ...
    private boolean isDniIngreso = true;
    ...
    private void txtDni_keyPressed(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            if (!this.isDniIngreso()) {  //LECTOR DE BARRAS
                
                int maxTiempoLectora = 1500; UtilityPuntos.obtieneTiempoMaximoLectora();
        ...
        if (validaDni()) {
            ...
            try {
                ...
                if (vArrayAux.size() > 0) {
                    ...
                    //CHUANES 28/08/2015 - CAMBIO INICIAL DONDE DETERMINA QUE TIPO DE MARCACION ES  SALIDA O ENTRADA
    ...
    private boolean grabarRegisto() {
        ...
        if (buscaDni()) {
            if (existeRegistro()) {
                //CHUANES 28/08/2015 - SEGUNDO CAMBIO SE INDICA A LA VARIABLE DE TIPO SUGERIDO 
                //QUE TOMARA EL VALOR DE VariablesControlAsistencia.vSugTipo
...
*/
    ...
    public boolean isDniIngreso() {
        return isDniIngreso;
    }

    public void setDniIngreso(boolean dniIngreso) {
        isDniIngreso = dniIngreso;
    }
