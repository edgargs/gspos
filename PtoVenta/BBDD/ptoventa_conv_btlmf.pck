        ...
        IF vIndAfectaKardex = 'S' THEN
            ...
            LOOP
               ...
               BTLMF_P_ACTUALIZA_STK_PROD(cCodGrupoCia_in,
                      ...
                      --INI ASOSA - 17/10/2014 - PANHD
                      BTLMF_P_ACT_STK_PROD_COMP(cCodGrupoCia_in,
                                          cCodLocal_in,
                                          cNumPedVta_in,
                                          cCodMotKardex_in,
                                          cTipDocKardex_in,
  ...
  END IF;
    ...
    ----------- DUBILLUZ 28.11.2014 ---------------
     ----------- DUBILLUZ 28.11.2014 ---------------             
             ...
             /*SELECT COUNT(1)
             FROM VTA_COMP_PAGO CP
             WHERE CP.COD_GRUPO_CIA = ''
             AND   CP.COD_LOCAL     = ''
             AND   CP.NUM_PED_VTA   = ''
             AND   CP.TIP_COMP_PAGO = COD_TIP_COMP_FACTURA*/
...
/*   SELECT tt.descripcion_campo,tt.cod_valor_in
   ...
   WHERE  DATOS.COD_CAMPO = 'D_000' --CODIGO DNI
         ...
         IF pFlgTipoConvenio = FLG_TIP_CONV_COPAGO or pFlgTipoConvenio = FLG_TIP_CONV_CREDITO THEN
             v_NUM_COMP_PAGO  :=  BTLMF_OBT_NUM_COMP_PAGO_IMPR(cCodGrupoCia_in,cCodLocal_in,vSecImprLocal_in,pTIP_COMP_PAGO);
               ...
               ELSE
                   ----inicio
                           IF pTipoClienteConvenio = COMP_BENEFICIARIO THEN
                              -- v_Ind_comp_credito     := 'N'; KMONCADA 25.09.2014 CONVENIO MIXTO
                              BEGIN 
...
--                              v_Ind_comp_credito     := vFlagConvenioMixto;
           ...
           END IF;
            ...
            v_nSecCompPago := Farma_Utility.OBTENER_NUMERACION(cCodGrupoCia_in, cCodLocal_in, cCodNumera_in);
             v_nNumCompPago := Farma_Utility.COMPLETAR_CON_SIMBOLO(v_nSecCompPago, 10, 0, POS_INICIO,cCodLocal_in);-- LTAVARA 01.10.2014
