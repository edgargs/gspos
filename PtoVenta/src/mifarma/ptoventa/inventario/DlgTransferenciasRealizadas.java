            ...
            if (fila > -1) {
                try {
                    ...
                    String codLocalDestino =
                        VariablesInventario.vCodDestino_Transf; // tblListaTransferencias.getModel().getValueAt(fila,7).toString().trim();
                    ...
                    if (tipoOrigenTransf.equals("01")) { //si es TIPO LOCAL
                        ...
                        if (VariablesInventario.vIndLineaMatriz.equals(FarmaConstants.INDICADOR_S)) {
                            ...
                            String resultado = "N";
                            try {
                                resultado = DBInventario.realizarTransfDestino(numTransf, codLocalDestino, FarmaConstants.INDICADOR_N).trim();
