...
public class UtilityPtoVenta {
    ...
    public static boolean isLocalVentaMayorista(){
        if(VariablesPtoVenta.vTipoLocalVenta == null){
            return false;
        }
        if(ConstantsPtoVenta.TIPO_LOCAL_VTA_MAYORISTA.equalsIgnoreCase(VariablesPtoVenta.vTipoLocalVenta) || 
            ConstantsPtoVenta.TIPO_LOCAL_VTA_MAY_BOTICA.equalsIgnoreCase(VariablesPtoVenta.vTipoLocalVenta)){
            return true;
        }else{
            return false;
        }
    ...
    public static boolean isLocalVentaMayoristaBotica(){
        if(VariablesPtoVenta.vTipoLocalVenta == null){
            return false;
        }
        if(ConstantsPtoVenta.TIPO_LOCAL_VTA_MAY_BOTICA.equalsIgnoreCase(VariablesPtoVenta.vTipoLocalVenta)){
            return true;
        }else{
            return false;
        }
     ...
     * @return
     */
    public static boolean requiereControlProducto(){ 
        boolean isSolicita = true;
        try{
            String indicador = DBPtoVenta.getRequiereControlProducto(FarmaVariables.vCodGrupoCia, FarmaVariables.vCodLocal);
