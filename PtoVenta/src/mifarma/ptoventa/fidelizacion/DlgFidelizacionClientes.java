...
public class DlgFidelizacionClientes extends JDialog {
    ...
    private void initialize() {
        ...
        try {
            ...
            if(VariablesPuntos.frmPuntos!=null && VariablesPuntos.frmPuntos.getTarjetaBean()!=null){
                if(FarmaPuntosConstante.EstadoTarjeta.INACTIVA.equalsIgnoreCase(VariablesPuntos.frmPuntos.getTarjetaBean().getEstadoTarjeta())){
    ...
    private void setearAfiliado() {
        ...
        BeanAfiliado afiliado01 = new BeanAfiliado();
