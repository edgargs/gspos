  ...
  extends JDialog
{
  ...
  private void getTxtProveedor(int pRow, String pTipoCampo, String pInSoloLectura) {
    ...
    addKeyListenerToTextField2(txtProveedor,pTipoCampo,pInSoloLectura,ConstantsPtoVenta.LISTA_PROVEEDOR,vCodProveedor);
   ...
   private void addKeyListenerToTextField(final JTextField pJTextField,
     ...
     pJTextField.addKeyListener(new KeyAdapter() {
       ...
       public void keyReleased(KeyEvent e) {
         ...
         if ( e.getKeyCode()==KeyEvent.VK_F1 && pJTextField.isDisplayable() ) {
           ...
           if(codigoCampo.trim().equals(ConstantsCajaElectronica.CAMPO_NOMBRE_PROVEEDOR)){
            System.out.println("Entro keyReleased");
    ...
    pJTextField.addKeyListener(new KeyAdapter() {
      ...
      public void keyReleased(KeyEvent e) {
        if ( e.getKeyCode()==KeyEvent.VK_F1 && pJTextField.isDisplayable() ) {
          ...
          System.out.println("Tipo Maestro: "+pTipoMaestro);
          /**
           ...
           */
            if(pTipoMaestro.equals(ConstantsPtoVenta.LISTA_TRABAJADOR) ||
              ...
              if(FarmaVariables.vAceptar)
              {
                ...
                System.out.println("Codigo Maestro: "+pCodMaestro.getText());
              }                   
  ...
  private void addKeyListenerToComboBox(final JComboBox pJComboBox,
    ...
    pJComboBox.addKeyListener(new KeyAdapter() {
      ...
      public void keyReleased(KeyEvent e) {
        if ( e.getKeyCode()==KeyEvent.VK_F1 && pJComboBox.isDisplayable() ) {
    ...
    pJComboBox.addItemListener(new ItemListener(){
      ...
      System.out.println("Entro addItemListener ");
       String codigoCampo = FarmaUtility.getValueFieldJTable(tblLista, tblLista.getSelectedRow(), 2);
       System.out.println("codigoCampo : "  + codigoCampo);
       if( codigoCampo.trim().equals(ConstantsCajaElectronica.CAMPO_ENTIDAD_FINANCIERA) || 
        ...
        System.out.println("Entro addItemListener CAMPO_ENTIDAD_FINANCIERA");
       ...
       {
         System.out.println("Entro addItemListener CAMPO_TIPO_MONEDA");
         getTipoMoneda();
       }
      };
    }
  ...
  private void funcion()
  {
    if(validateMandatory())
    {
      ...
      numeroCuenta,titular,localNuevo,servicio, trabajador, proveedor,numeroDocumento;
      ...
      try
      {
        ...
        System.out.println("tipoMonedafinal : " + tipoMoneda);
  ...
  private String getNumeroDocumento()
  {
    ...
    if(numDocu.length()>8)
    {
      System.out.println("numDocu.length() : "+ numDocu.length());
      numDocu = numDocu.trim();//.substring(numDocu.length() - 8,numDocu.length());
      System.out.println("numDocu : "+ numDocu);
  ...
  {
    String codigo;
    System.out.println("entro a getCodServicio");
    try
    {
      System.out.println("index : " + cmbServicio.getSelectedIndex());
      codigo = FarmaLoadCVL.getCVLCode("CMB_SERVICIO",cmbServicio.getSelectedIndex());
      System.out.println("codigo : " + codigo);
    }catch(ArrayIndexOutOfBoundsException e)
    {
      System.out.println("se cae en codigo");
      codigo = "";
    }
  ...
  private void cargaNumeroCuenta()
  {
    ...
    try
    {
      ...
      {
        VariablesCajaElectronica.vCodEntidadFinanciera = getCodEntidadFinanciera();
        System.out.println("VariablesCajaElectronica.vCodEntidadFinanciera : " + VariablesCajaElectronica.vCodEntidadFinanciera);
        VariablesCajaElectronica.vCodTipoMoneda = getTipoMoneda();      
        ...
        if(infoCuenta.size()>0)
        {
          ...
          System.out.println("Numero de Cuenta :" + VariablesPtoVenta.vDescMaestro);  
        }        
      }
    } catch(SQLException sql)
    {
