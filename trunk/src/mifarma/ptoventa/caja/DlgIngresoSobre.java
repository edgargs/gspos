...
public class DlgIngresoSobre extends JDialog 
{
  ...
  {
    this.setSize(new Dimension(585, 290));
    ...
    btnPeriodo.setMnemonic('p');
        btnPeriodo.setForeground(new Color(255, 130, 14));
    ...
    lblRegistros1.setHorizontalAlignment(SwingConstants.RIGHT);
        ...
        jLabelFunction1.setBounds(new Rectangle(150, 240, 140, 20));
        ...
        lblNomCajero.setForeground(new Color(43, 141, 39));
        ...
        lblCaja.setForeground(new Color(43, 141, 39));
  ...
  private void chkKeyPressed(KeyEvent e)
  {
    ...
    }else if(e.getKeyCode() == KeyEvent.VK_F2)
    {
        ...
        if(ind.trim().equalsIgnoreCase("S")){
                if(FarmaUtility.rptaConfirmDialog(this, "¿Esta seguro de eliminar el sobre con código?")){
                  borrarSobre();    
                  lblRegistros.setText(tblSobres.getRowCount()+"");
                 }
         }else {
                if(FarmaUtility.rptaConfirmDialog(this, "¿Esta seguro de eliminar el sobre agregado?")){
                   borrarSobre();    
                    lblRegistros.setText(tblSobres.getRowCount()+"");
               }
         }
       ...
       if(tblSobres.getRowCount()>0){
            ...
            if(cant>0){
                if(FarmaUtility.rptaConfirmDialog(this, "¿Esta seguro de registrar los sobres agregados?")){
                    if (cargaValidaLogin()) {
                        guardarCreados();
                    }
                    else {
   ...
   /**
        ...
        if (e.getKeyCode() == KeyEvent.VK_ENTER)
            {
                ...
                FarmaUtility.moveFocus(txtMonto);
                System.out.println("COD TIPO MONEDA-->"+VariablesCaja.vCodTipoMon);
                System.out.println("DESC TIPO MONEDA-->"+VariablesCaja.vDescTipoMon);
            }
            else
              chkKeyPressed(e);
    }
    ...
    private void ingresoSobre(){
       ...
       // System.out.println("VariablesCajaElectronica.vUsuarioCajero-->"+VariablesCajaElectronica.vUsuarioCajero);
    ...
    {
    boolean valor=true;
      System.out.println("*****OBTIENE DATOS PARA INGRESAR");
      ...
      if(codMoneda.equalsIgnoreCase(FarmaConstants.CODIGO_MONEDA_SOLES))
        ...
        System.out.println(" 1.VariablesCaja.vCodFormaPagoTmp" + VariablesCaja.vCodFormaPagoTmp);
        System.out.println("2.VariablesCaja.vIndTarjetaSeleccionada" + VariablesCaja.vDescFormaPagoTmp);
        System.out.println("3.VariablesCaja.vDescFormaPagoTmp" + VariablesCaja.vCodMonedaPagoTmp);
        System.out.println("4.VariablesCaja.vIndTarjetaSeleccionada" + VariablesCaja.vDescMonedaPagoTmp);
        System.out.println("5.VariablesCaja.vValMontoPagadoTmp" +VariablesCaja.vValMontoPagadoTmp);
        System.out.println("6.VariablesCaja.vValTotalPagadoTmp"+VariablesCaja.vValTotalPagadoTmp);
        ...
        //validar monto ingresado no mayor al existente en ventas
         try{
              ...
              System.out.println("Total Acumulado: "+dTotal);
    ...
    {
      System.out.println("VariablesCaja.vIndTarjetaSeleccionada valida monto : " + VariablesCaja.vIndTarjetaSeleccionada);
    ...
    private void operaListaDetallePago()
    {
      ...
      myArray.add("");//Sec
      System.out.println("ingreso-->"+myArray);
    ...
    private void borrarSobre(){
     ...
     private void eliminaFormaPagoEntrega()
     {
       ...
       if(tieneRegistroSeleccionado(tblSobres)){
         guardaDatosDetalle();
           System.out.println("Elimina registro Seleccionado, con sobre?-->"+VariablesCaja.vIndSobreTmp.trim());
         if(VariablesCaja.vIndSobreTmp.trim().equalsIgnoreCase(FarmaConstants.INDICADOR_N))
         {
         ...
         } else
           {
             try
             {
             //  if (FarmaUtility.rptaConfirmDialog(this,"¿El sistema eliminará el registro físicamente. Desea Continuar?"))
              // {
                   //Inicio 
                   if (VariablesCaja.vIndSobreTmp.trim().equalsIgnoreCase(FarmaConstants.INDICADOR_S)) {
                      ...
                      //VariablesCaja.vSecTmp = ((String)tblSobres.getValueAt(tblSobres.getSelectedRow(),9)).trim();
                       ...
                       System.out.println("VariablesCaja.vSecMovCajaTmp->"+VariablesCaja.vSecMovCajaTmp);        
                       System.out.println("VariablesCaja.vCodFormaPagoTmp->"+VariablesCaja.vCodFormaPagoTmp);
                       System.out.println("VariablesCaja.vSecTmp->"+VariablesCaja.vSecTmp);
    ...
    private void guardaDatosDetalle()
    {
      ...
      VariablesCaja.vSecTmp=FarmaUtility.getValueFieldArrayList(tableModelLista.data,tblSobres.getSelectedRow(),9);
        ...
        System.out.println("1.VariablesCaja.vSecMovCajaTmp-->" + VariablesCaja.vSecMovCajaTmp);
        System.out.println("2.VariablesCaja.vCodFormaPagoTmp-->" + VariablesCaja.vCodFormaPagoTmp);
        System.out.println("3.VariablesCaja.vCodTipoMon-->" + VariablesCaja.vCodTipoMon);
        System.out.println("4.VariablesCaja.vIndSobreTmp-->" + VariablesCaja.vIndSobreTmp);
        System.out.println("5.VariablesCaja.vCodigoSobreTmp-->" +VariablesCaja.vCodigoSobreTmp);
        System.out.println("6.VariablesCaja.vSecTmp-->" +VariablesCaja.vSecTmp);
    }
        ...
        for(int i=0;i<tblSobres.getRowCount(); i++)
            {
             ...
             {//INICIO 
                 ...
                 System.out.println("Tipo Moneda-->"+tip); 
                 
              System.out.println("registro seleccionado-->"+i); 
              /*   
              System.out.println("FarmaUtility.getValueFieldArrayList(tableModelLista.data,tblSobres.getSelectedRow(),7):"+FarmaUtility.getValueFieldArrayList(tableModelLista.data,tblSobres.getSelectedRow(),7)); 
              ...
              */
              ...
              System.out.println("Codigo sobre-->"+pSecSobre); 
      ...
      try
           ...
           System.out.println("VariablesCaja.vSecMovCaja-->"+VariablesCaja.vSecMovCaja);
            ind=DBCaja.permiteIngreMasSobre();
               System.out.println("indPermite mas de un Sobres-->"+ind);
            if(ind.trim().equalsIgnoreCase("S")){
             valor=true;
             }
