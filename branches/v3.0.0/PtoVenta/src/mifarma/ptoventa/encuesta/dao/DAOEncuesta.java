...
public interface DAOEncuesta extends DAOTransaccion{
    ...
    public void grabaDetalleEncuesta(String pCodGrupoCia, String strCodCia, String strCodLocal,
                              int secuencial   ,
                              String pCodProd, int vencuesta, int vsecpregunta,
                              String vrespuesta ) throws Exception;
    public int grabaCabEncuesta (String pCodGrupoCia, String strCodCia, String strCodLocal,
                                 String pUsuario , String pCodProd, int vencuesta)throws Exception;;
