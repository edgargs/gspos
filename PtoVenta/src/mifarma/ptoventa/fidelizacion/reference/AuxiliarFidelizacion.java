...
public class AuxiliarFidelizacion {
    ...
    private static void mostrarBuscarTarjetaPorDNI(Frame myParentFrame, JLabel lblObj, JLabel lblCli, JDialog dlgObj,
                                                   String pTipo, JTextField txtObj) {

        DlgFidelizacionBuscarTarjetas dlgBuscar = new DlgFidelizacionBuscarTarjetas(myParentFrame, "", true);
        ...
        if (FarmaVariables.vAceptar) {
            ...
            //jcallo 02.10.2008
            lblCli.setText(VariablesFidelizacion.vNomCliente + " " + VariablesFidelizacion.vApePatCliente + " " +
                           VariablesFidelizacion.vApeMatCliente);
