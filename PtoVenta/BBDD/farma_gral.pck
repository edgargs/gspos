...
--                                 cCodCupon_in      IN CHAR,
 ...
 RETURN FarmaCursor;
  ...
  FUNCTION F_REQUIERE_CONTROL_PRODUCTO(cCodGrupoCia_in  IN PBL_LOCAL.COD_GRUPO_CIA%TYPE,
 ...
 C_FIN_MSG     VARCHAR2(2000) := '
  ...
  and    l.cod_local = cCodLocal_in;
    ...
    vFila_IMG_Cabecera_Consejo:= '<tr> <td colspan="4"><div align="center" class="style8">'||
     ...
     vFila_Cupon := ''; --ERIOS 16.02.2016 El codigo de barras se genera e imprime, con el farmaprinter.
