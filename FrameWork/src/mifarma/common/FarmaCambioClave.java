...
public class FarmaCambioClave  extends JDialog {
    private static final Logger log = LoggerFactory.getLogger(FarmaCambioClave.class);
    @SuppressWarnings("compatibility:5486317033819626180")
    private static final long serialVersionUID = -6950475109697571850L;
    ...
    public FarmaCambioClave() {
        this(null, "", false);
    }

    public FarmaCambioClave(Frame parent, String title, boolean modal) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_F1) // Reservado para ayuda
        {
            ...
            if (datosValidos()) {
                ...
                if (com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,
                    ...
                    String clave = "";
                    String neoClave = "";
                    String cantUltimaClave="";//CHUANES 12.03.2015
                    ...
                    try {
                        cantUltimaClave=BeanValidaUsuario.maxUltimasClaves().trim();
