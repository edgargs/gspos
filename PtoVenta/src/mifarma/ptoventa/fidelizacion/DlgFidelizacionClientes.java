        ...
        if (validateMandatory()) {
            try {
                ...
                if (true) { //jcortez evitar guardar dni con letras o caracteres no validos
                    ...
                    if(UtilityPuntos.isActivoFuncionalidad() && UtilityPuntos.isTarjetaValida(VariablesFidelizacion.vNumTarjeta)){
                        ...
                        if (obj != null) {
                            ...
                            if(FarmaPuntosConstante.EstadoTarjeta.INACTIVA.equalsIgnoreCase(obj.getEstadoTarjeta()) || 
                               FarmaPuntosConstante.NO_CONEXION_ORBIS.equalsIgnoreCase(obj.getEstadoOperacion())){
                                ...
                                if(UtilityPuntos.isTarjetaValida(obj.getNumeroTarjeta()) && (
                                    FarmaPuntosConstante.EstadoTarjeta.ACTIVA.equalsIgnoreCase(obj.getEstadoTarjeta()) ||
                                    FarmaPuntosConstante.EstadoTarjeta.BLOQUEADA_REDIMIR.equalsIgnoreCase(obj.getEstadoTarjeta())
                                   )){
                                    rsptaValida = true;
                                   }
                            }
                            if(rsptaValida){
                                if(UtilityPuntos.registrarCliente(obj.getNumeroTarjeta().trim(), afiliado) && 
                                    FarmaPuntosConstante.NO_CONEXION_ORBIS.equalsIgnoreCase(VariablesPuntos.frmPuntos.getTarjetaBean().getEstadoOperacion())){
                                ...
                                UtilityPuntos.actualizarEstadoEnvioAfiliacion(obj.getNumeroTarjeta(), txtNumeroDocumento.getText(), indicadorLinea);
                            }else{
                                cerrarVentana(false);
                                return ;
                            }
                    ...
                    FarmaUtility.showMessage(this, "Se registro el cliente", null);
