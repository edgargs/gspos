  ...
  utl_smtp.quit( conn );*/
   ...
   conn := ORACLE_MAIL.begin_mail(
    ...
    ORACLE_MAIL.attach_text(
      ...
      DBMS_OUTPUT.put_line('termino procedimiento farma_email.envia_correo');
exception
 when others then
...
/*begin
  ...
  BEGIN
      ...
      IF i <> 0 THEN
        cmensaje := '<H2>SE HA REALIZADO CAMBIOS EN EL LOCAL.<BR><BR>Â¡VERIFIQUE LOS CAMBIOS ADJUNTOS!</H2>
