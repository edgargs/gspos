...
public class DlgFidelizacionClientesMnto extends JDialog {

    private static final Logger log = LoggerFactory.getLogger(DlgFidelizacionClientesMnto.class);
    ...
    public DlgFidelizacionClientesMnto() {
        try {
            jbInit();
        } catch (Exception e) {
            log.error("", e);
    ...
    public DlgFidelizacionClientesMnto(Frame parent, String title, boolean modal) {
    ...
    private void jbInit() throws Exception {
        ...
        lblF3.setBounds(new Rectangle(350, 270, 180, 20));
        lblF3.setText("[ F3 ] Ingresar otro DNI");
    ...
    private void cargaLista() {
        try {
            DBFidelizacion.listarCamposFidelizacion02(tableModel);
...
*/
    ...
    private void chkKeyPressed(KeyEvent e) {
        ...
        if (UtilityPtoVenta.verificaVK_F11(e)) {
            ...
            log.info("XSIAKSO CAMBIE Y TENGA QUE VOLVER A UTILIZARLO");
            /*
            limpiarAntesDeBuscar();
    ...
    private void limpiarAntesDeBuscar() {
        ...
        FarmaLoadCVL.setSelectedValueInComboBox(cmbSexo, "CMB_SEXO", "");
        ...
        FarmaLoadCVL.setSelectedValueInComboBox(cmbDepartamento, "CMB_DEPARTAMENTO", "");
        FarmaLoadCVL.setSelectedValueInComboBox(cmbProvincia, "CMB_PROVINCIA", "");
        FarmaLoadCVL.setSelectedValueInComboBox(cmbDistrito, "CMB_DISTRITO", "");
        FarmaLoadCVL.setSelectedValueInComboBox(cmbTipoDireccion, "CMB_TIPO_DIRECCION", "");
        FarmaLoadCVL.setSelectedValueInComboBox(cmbTipoLugar, "CMB_TIPO_LUGAR", "");
        
        txtReferencias.setText("");
        
        
        int cant = tblLista.getRowCount();
        for (int c = 0; c < cant; c++) {
            tblLista.setValueAt("", c, 1);
        };
    ...
    /**
     * Pedir clave de QF para que pueda anular la recarga virtual.
     * @author ASOSA
     * @since 29/04/2015
     * @type PTOSYAYAYAYA
     * @return
                ...
                if (cargarLogeoAdminLocal()){
                    ...
                    if (true) { //jcortez evitar guardar dni con letras o caracteres no validos
                        ...
                        if(UtilityPuntos.isActivoFuncionalidad()){
                            ...
                            if(UtilityPuntos.registrarCliente(afiliado.dni, afiliado)) {
                                indicadorLinea = "E";
                            }
                    ...
                    if (vListaDatosDNI.size() > 0) {
                        ...
                        if (!vApePat.equalsIgnoreCase("N")) {
                            ...
                            if (pos >= 0) {
                                tblLista.setValueAt(vApePat, pos, 1);
                                //txtApellidoPaterno.setEditable(false);
                                txtApellidoMaterno.setText(vApePat);
                            }
                        }
