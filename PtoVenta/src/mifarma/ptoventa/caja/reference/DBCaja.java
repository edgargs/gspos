 ...
 */
  ...
  public static void getListaCabeceraPedido(FarmaTableModel pTableModel,String correlativo) throws SQLException
  {
    ...
    parametros.add(VariablesVentas.vCodTipProcPago==null?"0":VariablesVentas.vCodTipProcPago);//LTAVARA 03.09.2014 VALIDA SI EL DOCUMENTO GENERADO FUE CON EL PROCESO ELECTRONICO
  ...
  public static String agregarCabeceraNotaCredito(String numPedVta,String tipCambio,String motivoAnulacion) throws SQLException
  {
    ...
    public static String agregarDetalleNotaCredito(String numPedVta, String numera, String codProd, String cant,
        ...
        /*FarmaDBUtility.executeSQLStoredProcedure(null, "PTOVENTA_CAJ_ANUL.CAJ_AGREGAR_DET_NC(?,?,?,?,?,?,?,?,?,?)",
                                                  parametros, false);*/
        // KMONCADA 22.10.2014 DEVUELVE EL NUMERO DE LA NC GENERADA.
        log.info("PTOVENTA_CAJ_ANUL.CAJ_AGREGAR_DET_NC(?,?,?,?,?,?,?,?,?,?,?,?)"+parametros);
        return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_CAJ_ANUL.CAJ_AGREGAR_DET_NC(?,?,?,?,?,?,?,?,?,?,?,?)",parametros);
    }
...
/**@author jmiranda 
    ...
    public static void actualizaDatosDelivery(String pNumPedVta, String pEstPedVta,String CodCli,String nombreCli,
      ...
      log.info("CAJ_P_UP_DATOS_DELIVERY>"+parametros);  
...
//dubilluz 2011.09.16
    ...
    */    
    public static void grabaFormaPagoPedido(String pCodFormaPago,
                                            ...
                                            String pDNITarj,
                                            String pCodAutori,
                                            String pCodLote) throws SQLException{
...
/**
     ...
     * @throws SQLException
     */
    public static String imprVouVerifRecarga(String descProducto,
                                             String numTelefonia,
        ...
        return FarmaDBUtility.executeSQLStoredProcedureStr("Farma_Gral.F_IMPR_VOU_VERIF_RECARGA(?,?,?,?,?,?,?)",parametros);
    }
 public static void grabaProformaDelivery(String pNumPed) throws SQLException {
        ...
        FarmaDBUtility.executeSQLStoredProcedure(null,"ptoventa_del_cli.p_crea_proforma(?,?,?,?,?,?,?)",parametros,false);        
    }    
    ...
    public static void updMotorizadoDLV(String pNumPed,String pCodMoto,String pDescripMoto, String pObservPedVta,
        ...
        FarmaDBUtility.executeSQLStoredProcedure(null,"ptoventa_del_cli.P_UPD_MOTORIZADO(?,?,?,?,?,?,?,?,?,?)",parametros,false);        
    }      
    ...
    public static ArrayList obtieneComprobantePedido() throws SQLException{
        ...
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(VariablesCaja.vNumPedVta);
        FarmaDBUtility.executeSQLStoredProcedureArrayList(comprobantes,"PTOVENTA_CAJ.CAJ_NUM_COMP_PAGO_IMPR_PEDIDO(?,?,?)",parametros);
        return comprobantes;
    }
    ...
    /**
       ...
       public static void obtieneCompPagos(ArrayList pArrayList) throws SQLException {
           ...
           parametros.add(FarmaVariables.vCodLocal);
           parametros.add(VariablesCaja.vNumPedVta);
           log.debug("parametros PTOVENTA_CAJ.CAJ_F_CUR_LISTA_COMP_PAGO(?,?,?): " + 
                              parametros);
           FarmaDBUtility.executeSQLStoredProcedureArrayList(pArrayList, 
                                                             "PTOVENTA_CAJ.CAJ_F_CUR_LISTA_COMP_PAGO (?,?,?)", 
                                                             parametros);
       }
    ...
    public static boolean isConvenioMixto() throws SQLException{
        ...
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(VariablesCaja.vNumPedVta);
        log.info("PTOVENTA_CAJ.IS_CONVENIO_MIXTO(?,?,?)"+parametros);
        String resultado = FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_CAJ.IS_CONVENIO_MIXTO(?,?,?)", parametros);
    ...
    /**
        ...
        public static String getPermiteCobrarPedProdFinal(String pNumPedVta) throws SQLException{
          ...
          return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVTA_RESPALDO_STK.F_EXISTE_STK_PED_PROD_FINAL(?,?,?)",parametros);
        }
    ...
    public static String getValidaCompManual(String pTip,
                                             String pSerie,
                                             String pNumComp) throws SQLException {
        //LTERRAZOS 01.03.2013 Se agrega parametro COD_CIA.
      parametros = new ArrayList();
      parametros.add(FarmaVariables.vCodGrupoCia);
      parametros.add(FarmaVariables.vCodLocal);
      ...
      return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_CAJ.IND_VALIDA_COMP_MANUAL(?,?,?,?,?)",parametros);
    }

    public static boolean isExisteComprobanteElectronico(String pCodGrupoCia, String pCodLocal, String pTipoComprobante, String pNumComprobante) throws SQLException{
        ArrayList parametros = new ArrayList();
        parametros.add(pCodGrupoCia);
        parametros.add(pCodLocal);
        parametros.add(pTipoComprobante);
        parametros.add(pNumComprobante);
        log.info("PTOVENTA_CAJ.FN_EXISTE_COMPROBANTE_E(?,?,?,?)"+parametros);
        int resultado = FarmaDBUtility.executeSQLStoredProcedureInt("PTOVENTA_CAJ.FN_EXISTE_COMPROBANTE_E(?,?,?,?)", parametros);
        if(resultado == 0)
            return false;
        else
            return true;
    ...
    public static void actualizaFechaImpresion(String pSecCompPago,
                                               String pTipCompPago
                                                   ) throws SQLException{
      parametros = new ArrayList();
      parametros.add(FarmaVariables.vCodGrupoCia);
      ...
      parametros.add(pSecCompPago);
      parametros.add(FarmaVariables.vIdUsu);
        log.info("PTOVENTA_CAJ.P_ACT_FCH_IMPRESION(?,?,?,?,?,?)"+parametros);
      FarmaDBUtility.executeSQLStoredProcedure(null,"PTOVENTA_CAJ.P_ACT_FCH_IMPRESION(?,?,?,?,?,?)",parametros,false);
    }
    ...
    /**
       ...
       public static void obtieneCompPagos_gui(ArrayList pArrayList) throws SQLException {
           ...
           parametros.add(FarmaVariables.vCodLocal);
           parametros.add(VariablesCaja.vNumPedVta);
           log.debug("parametros PTOVENTA_CAJ.CAJ_F_CUR_LISTA_COMP_PAGO_GUI(?,?,?): " + 
                              parametros);
           FarmaDBUtility.executeSQLStoredProcedureArrayList(pArrayList, 
    ...
    public static String getNombreFileComprobante(String pCodGrupoCia, String pCodLocal, String pNumPedVta, String pSecCompPago) throws SQLException{
        ArrayList parametros =new ArrayList();
        parametros.add(pCodGrupoCia);
        parametros.add(pCodLocal);
        parametros.add(pNumPedVta);
        parametros.add(pSecCompPago);
        log.info("parametros PTOVENTA_CAJ.GET_NOMBRE_FILE_COMP_ELEC(?,?,?,?): " + parametros);
        return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_CAJ.GET_NOMBRE_FILE_COMP_ELEC(?,?,?,?)",parametros);        
    }
}