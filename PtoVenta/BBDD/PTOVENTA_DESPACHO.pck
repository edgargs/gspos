CREATE OR REPLACE PACKAGE PTOVENTA_DESPACHO AS
  ...
  FUNCTION F_GET_COMANDA_TRANSF_BOTICA_M(cCodGrupoCia_in   IN CHAR,
                                         cCodLocal_in      IN CHAR,
                                         cNumPedVta_in     IN CHAR,
                                         cNumPiso          IN CHAR,
                                         cNroComanda_in    IN CHAR,
...
CREATE OR REPLACE PACKAGE BODY PTOVENTA_DESPACHO AS
  ...
  FUNCTION F_OBTENER_IMPR_DESPACHO(cCodGrupoCia_in   IN CHAR,
    ...
    vVal VARCHAR2(100);
    vContador NUMBER;
    vIsLocalMayorista CHAR(1) := 'N';
  BEGIN
    vIsLocalMayorista := FARMA_UTILITY.F_IS_LOCAL_TIPO_VTA_M(cCodGrupoCia_in, cCodLocal_in);
  ...
  FUNCTION F_OBTENER_COMANDA_DESPACHO(cCodGrupoCia_in   IN CHAR,
    ...
    vIsLocalMayorista CHAR(1) :='N';
  BEGIN
    vIsLocalMayorista := FARMA_UTILITY.F_IS_LOCAL_TIPO_VTA_M(cCodGrupoCia_in => cCodGrupoCia_in, 
    ...
    --IF vIsLocalMayorista = 'S' THEN
    IF cTipoComanda_in = '1' THEN
    ...
    ELSIF cTipoComanda_in = '2' THEN
      RETURN F_GET_COMANDA_DESPACHO_VTA(cCodGrupoCia_in => cCodGrupoCia_in,
                                        ...
                                        cNroComanda_in => cNroComanda_in,
                                        cTotalComanda_in => cTotalComanda_in);
    ELSIF cTipoComanda_in = '3' THEN
      RETURN F_GET_COMANDA_TRANSF_BOTICA_M(cCodGrupoCia_in => cCodGrupoCia_in,
                                           cCodLocal_in => cCodLocal_in,
                                           cNumPedVta_in => cNumPedVta_in,
                                           cNumPiso => cNumPiso,
                                           cNroComanda_in => cNroComanda_in,
...
/*    FARMA_PRINTER.P_AGREGA_TEXTO(vIdDoc_in => vIdDoc, 
    ...
    FARMA_PRINTER.P_AGREGA_TEXTO(vIdDoc_in => vIdDoc, 
                                 vIpPc_in => vIpPc, 
                                 vValor_in => 'COMANDA PARA TRANSFERENCIA DE PRODUCTOS',
                                 vTamanio_in => FARMA_PRINTER.TAMANIO_1,
                                 vAlineado_in => FARMA_PRINTER.ALING_CEN,
                                 vNegrita_in => FARMA_PRINTER.BOLD_ACT);
    ...
    FARMA_PRINTER.P_AGREGA_TEXTO(vIdDoc_in => vIdDoc, 
                                 vIpPc_in => vIpPc, 
                                 vValor_in => 'DETALLE DE TRANSFERENCIA',
                                 vTamanio_in => FARMA_PRINTER.TAMANIO_1,
                                 vAlineado_in => FARMA_PRINTER.ALING_CEN);
