...
public class ConstantsCaja {
    ...
    { new FarmaColumnData("Nombre Cliente", 100, JLabel.LEFT), new FarmaColumnData("Num Ped Dia", 85, JLabel.CENTER),
      ...
      new FarmaColumnData("Total S/.", 80, JLabel.RIGHT), new FarmaColumnData("Bruto", 0, JLabel.RIGHT),
    ...
    { new FarmaColumnData("Codigo", 60, JLabel.CENTER), new FarmaColumnData("Producto", 140, JLabel.LEFT),
      new FarmaColumnData("Unidad", 120, JLabel.LEFT),
        ...
        new FarmaColumnData("P.Venta", 50, JLabel.RIGHT), new FarmaColumnData("Cantidad", 80, JLabel.RIGHT),
    ...
    { new FarmaColumnData("Pedido", 80, JLabel.CENTER), new FarmaColumnData("Fecha", 120, JLabel.LEFT),
      new FarmaColumnData("Total S/.", 80, JLabel.RIGHT), new FarmaColumnData("R.U.C.", 80, JLabel.LEFT),
    ...
    public static final FarmaColumnData[] columnsListaPendientesImpresion = {
        ...
        new FarmaColumnData("Fecha", 120, JLabel.CENTER), new FarmaColumnData("Total S/.", 90, JLabel.RIGHT),
    ...
    { new FarmaColumnData("Pedido", 90, JLabel.LEFT), new FarmaColumnData("Comp.", 85, JLabel.LEFT),
      ...
      new FarmaColumnData("Total(S/.)", 80, JLabel.RIGHT), new FarmaColumnData("Estado", 100, JLabel.LEFT),
      new FarmaColumnData("", 0, JLabel.LEFT) };
    ...
    public static final FarmaColumnData[] columnsListaFechas = {
        ...
        new FarmaColumnData("Monto Soles(S/.)", 120, JLabel.RIGHT), new FarmaColumnData("N°Sobres", 70, JLabel.CENTER),
