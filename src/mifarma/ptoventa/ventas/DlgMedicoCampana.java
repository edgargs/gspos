...
public class DlgMedicoCampana extends JDialog {
    ...
    private void initTableListaBusquedaMedico() {
        tableModelListaMedico = 
                new FarmaTableModel(ConstantsVentas.columnsListaBusquedaMedico, 
                                    ConstantsVentas.defaultValuesListaBusquedaMedico, 
                                    COL_COD);
        FarmaUtility.initSimpleList(tblMedico, tableModelListaMedico, 
                                    ConstantsVentas.columnsListaBusquedaMedico);
    }
