...
import mifarma.ptoventa.mayorista.DlgDevolucionImporteCaja;
...
import mifarma.ptoventa.reportes.DlgListaPreciosVolumen;
...
public class FrmEconoFar extends JFrame {
    ...
    private JMenuItem mnuVentas_EntregaProductos = new JMenuItem();
    ...
    private JMenuItem mnuReportes_ListaPrecioVolumen = new JMenuItem();
    ...
    private JMenuItem mnuCaja_DevolutionImport = new JMenuItem();
    ...
    private void jbInit() throws Exception {
        ...
        mnuVentas_EntregaProductos.setText("10. Entrega Productos");
        mnuVentas_EntregaProductos.setFont(new Font("SansSerif", 0, 11));
        mnuVentas_EntregaProductos.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                mnuVentas_EntregaProductos_actionPerformed(e);
            }
        });
        mnuEconoFar_Ventas.add(mnuVentas_EntregaProductos);
        ...
        mnuEconoFar_Caja.add(mnuCaja_DevolutionImport);
        ...
        mnuReportes_VentasVendedor_Gigante.setText("5. Concurso Gigante");
        ...
        mnuCaja_DevolutionImport.setText("13.Devolucion de Importe");
        mnuCaja_DevolutionImport.setFont(new Font("SansSerif", 0, 11));
        mnuCaja_DevolutionImport.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    mnuCaja_DevolutionImport_actionPerformed(e);
                }
            });
        mnuCaja_DevolutionImport.setVisible(false);
        mnuCaja_DevolutionImport.setEnabled(false);    
        ...
        mnuReportes_ListaPrecioVolumen.setText("18. Lista de Precios por Volumen");
        mnuReportes_ListaPrecioVolumen.setFont(new Font("SansSerif", 0, 11));
        mnuReportes_ListaPrecioVolumen.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    mnuReportes_ListPrecVolumen_actionPerformed(e);
                }
            });
        mnuEconoFar_Reportes.add(mnuReportes_ListaPrecioVolumen);
    ...
    private void initialize() {
        ...
        try {
            ...
            String year = fechaSistema.substring(2+1+2+1);
            statusBar.setText("Copyright (c) 2005 - "+year);
    ...
    private void mnuCaja_CobrarPedido_actionPerformed(ActionEvent e) {
        if (UtilityPtoVenta.isLocalVentaMayorista()){
            DlgUltimosPedidos dlgUltimosPedidos = new DlgUltimosPedidos(this, "Cobrar Proforma", true);
            dlgUltimosPedidos.setTipoVenta(ConstantsVentas.TIPO_PEDIDO_MESON);
            dlgUltimosPedidos.setStrategy(new FacadeMayorista(), ConstantsOperacionProforma.COBRO_PROFORMA);
    ...
    private void mnuReportes_ListPrecVolumen_actionPerformed(ActionEvent e) {
        DlgListaPreciosVolumen dlgListaPreciosVolumen = new DlgListaPreciosVolumen(this, "", true);
        dlgListaPreciosVolumen.setVisible(true);
    }    
    ...
    /**
     * Se muestra la pantalla para entrega de productos - mayorista
     * @author ERIOS
     * @since 08.01.2016
     * @param e
     */
    private void mnuVentas_EntregaProductos_actionPerformed(ActionEvent e) {
        DlgUltimosPedidos dlgUltimosPedidos = new DlgUltimosPedidos(this, "Entrega de Productos", true);
        dlgUltimosPedidos.setTipoVenta(ConstantsVentas.TIPO_PEDIDO_MESON);
        dlgUltimosPedidos.setStrategy(new FacadeMayorista(), ConstantsOperacionProforma.VERIFICA_PROD_PROFORMA);
        dlgUltimosPedidos.setVisible(true);
    }
    ...
    private void validaOpcionesMenu(boolean pValor) {
        ...
        mnuVentas_Empresa.setEnabled(pValor);
        //TODO MedidaPresion
        mnuVentas_Recargas.setEnabled(pValor);
        mnuVentas_InvDiario.setEnabled(pValor);
        mnuVentas_Digemid.setEnabled(pValor);
        mnuVentas_EntregaProductos.setEnabled(pValor);
...
DBInventario.validarAsistenteAuditoria(FarmaVariables.vCodCia, FarmaVariables.vCodLocal, FarmaVariables.vNuSecUsu);
    ...
    private void verificaRolUsuario_sinAdmin() {
        ...
        if (FarmaVariables.dlgLogin.verificaRol(FarmaConstants.ROL_DESPACHADOR)) {
            opcionesDespachador();
        }
    ...
    private void opcionesCajero() {
        ...
        if(UtilityPtoVenta.isLocalVentaMayorista()){
            ...
            mnuVentas_Empresa.setEnabled(true);
            mnuVentas_Empresa.setVisible(true);
            mnuVentas_Recargas.setEnabled(false);
            
            mnuCaja_DevolutionImport.setVisible(true);
            mnuCaja_DevolutionImport.setEnabled(true);
        }
    }
    ...
    /*
     * Descripcion: Agregar la ventana para la devolucion del Importe
     * Por: Rafael Bullon Mucha
     * Fecha: 23/02/2016
     * */
    private void mnuCaja_DevolutionImport_actionPerformed(ActionEvent e) {
        DlgDevolucionImporteCaja dlgDevolucionImporteCaja = new DlgDevolucionImporteCaja(this, "", true);
        dlgDevolucionImporteCaja.setVisible(true);
    }
    ...
    /**
     * Opciones del rol Despachador
     * @author ERIOS
     * @since 25.01.2016
     */
    private void opcionesDespachador() {
        mnuEconoFar_Ventas.setEnabled(true);
          mnuVentas_EntregaProductos.setEnabled(true);        
    }
}
