...
{  
  ...
  private void this_windowOpened(WindowEvent e)
  {
    ...
    lblCantProductosT.setText(""+tblListaProductos.getRowCount());
      System.out.println("Open - VariablesInventario.vEsModificado "+VariablesInventario.vEsModificado);
  ...
  private void chkKeyPressed(KeyEvent e)
  {
    ...
    }else if(e.getKeyCode() == KeyEvent.VK_ESCAPE)
    {
        ...
        System.out.println("VariablesInventario.vIrResumen:"+VariablesInventario.vIrResumen);
        System.out.println("VariablesInventario.vFModificar:"+VariablesInventario.vFModificar);
        System.out.println("VariablesInventario.vFNuevo:"+VariablesInventario.vFNuevo);
            ...
            if (!VariablesInventario.vIrResumen) {
                ...
                if (VariablesInventario.vFModificar) {
                        try {
                            ...
                            System.out.println("Close - VariablesInventario.vEsModificado " + 
  ...
  private void actualizarCantidad(String CodProd,String CantIngre){
   ...
   aux_CodProd=((String) ((ArrayList)  VariablesInventario.vArrayProductosDet.get(i)).get(0)).trim();
     ...
     System.out.print("VariablesInventario.vArrayProductosDet :"+VariablesInventario.vArrayProductosDet);
     }
   }
  }
  ...
  private void generaPedido(){
    ...
    try{
      ...
      if(VariablesInventario.vEsModificado){
          ...
          System.out.println("Numero de pedido generado :"+VariablesInventario.vNumPedidoEspecial);
