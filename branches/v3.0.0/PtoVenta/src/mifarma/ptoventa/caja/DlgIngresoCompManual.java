...
public class DlgIngresoCompManual extends JDialog {
    ...
    private void chkKeyPressed(KeyEvent e)
    {
        if(UtilityPtoVenta.verificaVK_F11(e))
        {
            ...
            if(vTipoComp.trim().equalsIgnoreCase("01")||vTipoComp.trim().equalsIgnoreCase("02")){
                if(validaIngreso(vTipoComp,FarmaUtility.completeWithSymbol(txtSerie.getText().trim(),3,"0","I"),
                                 FarmaUtility.completeWithSymbol(txtNroComprobante.getText().trim(),7,"0","I")) ){
                VariablesCaja.pManualSerieComprobante = FarmaUtility.completeWithSymbol(txtSerie.getText().trim(),3,"0","I") ;
                VariablesCaja.pManualNumCompPago = FarmaUtility.completeWithSymbol(txtNroComprobante.getText().trim(),7,"0","I") ;
                VariablesCaja.pManualTipCompPago = vTipoComp;
                cerrarVentana(true);
                }
                else
                  FarmaUtility.showMessage(this,"Verifique la Serie y Comprobante Ingresado.\n." +
    ...
    public boolean validaIngreso(String pTipComp,String pSerie,String pNum){
        ...
        if(pResultado.trim().equalsIgnoreCase("S"))pValor=true;
