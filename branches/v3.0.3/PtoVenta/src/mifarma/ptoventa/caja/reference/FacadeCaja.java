...
public class FacadeCaja {
    ...
    public Long registrarTrsscRecarga(String strTipMsjRecau, String strEstTrsscRecau, String strTipoTrssc,
        ...
        try {
            tmpCodigo =
                    daoCaja.registrarTrsscRecarga(FarmaVariables.vCodGrupoCia, FarmaVariables.vCodCia, FarmaVariables.vCodLocal,
                                                  strTipMsjRecau, strEstTrsscRecau, strTipoTrssc, strTipoRcd, strMonto,
                                                  strTerminal, strComercio, strUbicacion, strNroTelefono, strNumPedido,
                                                  strUsuario);
            daoCaja.commit();
        } catch (Exception e) {
            daoCaja.rollback();
    ...
    public String obtenerEstadoTrssc(String strNumPedido) {
        ...
        try {
            tmpEst =
                    daoCaja.obtenerEstadoTrssc(FarmaVariables.vCodGrupoCia, FarmaVariables.vCodCia, FarmaVariables.vCodLocal,
                                               strNumPedido);
