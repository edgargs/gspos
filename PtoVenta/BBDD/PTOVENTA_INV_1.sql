...
--------------------------------------------------------
  ...
  AS
    ...
    v_nStkFisico LGT_PROD_LOCAL.STK_FISICO%TYPE;
     ...
     vCantExceso number(9,3) := TO_NUMBER(nCantMov_in, '999,999.999') -     --ASOSA - 15/08/2014
...
--
 ...
 IS
   curLabs FarmaCursor;
 BEGIN
IF  cTipo_rep_insumo = COD_GRU_REP_INSUMO THEN
...
*/
  ...
  IS
  BEGIN
     RETURN INV_LISTA_MOT_AJUST_KRDX(cCodGrupoCia_in,null);
  END;
   /* ************************************************************************ */
  FUNCTION INV_LISTA_MOT_AJUST_KRDX(cCodGrupoCia_in IN CHAR,
                                    cTipo_rep   IN CHAR  )
