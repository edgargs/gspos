                    ...
                    //////////////////////////////////////////////////////////////////////////////////////////////
                        if (isVIndProcOrbisCobro()) {
                            ...
                            if (FarmaPuntosConstante.EXITO.equalsIgnoreCase(trnxValidaAnula.getEstadoOperacion())) {
                                ...
                                else if (FarmaPuntosConstante.TARJETA_NO_AFILIADA.equalsIgnoreCase(trnxValidaAnula.getEstadoOperacion())) {
                ...
                if (isVAnulaOnline()) {
                    ...
                    if (trnxValidaAnula == null) {
                        ...
                        if (FarmaPuntosConstante.EXITO.equalsIgnoreCase(trnxValidaAnula.getEstadoOperacion())) {
                            ...
                            if (FarmaPuntosConstante.TARJETA_NO_AFILIADA.equalsIgnoreCase(trnxValidaAnula.getEstadoOperacion())) {
                                pResultado = true;
