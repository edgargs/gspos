...
public class DlgProcesarCobroBTLMF extends JDialog {
    ...
    private static final Log log = LogFactory.getLog(DlgProcesarCobroBTLMF.class);
...
//        }
        ...
        System.out.println("VariablesCaja.vValTotalPagar:"+FarmaUtility.getDecimalNumber(VariablesCaja.vValTotalPagar));
    ...
    private void procesarBTLMF(){
    	...
    	System.out.println("<<<<<<<<<<<<<<<<<<<<<Metodo:procesarBTLMF>>>>>>>>>>>>>>>>>>>>");
       ...
       * */
        ...
        try {
            ...
            VariablesVentas.vEsPedidoConvenio =
                    (pIndPedConvenio.equals("S")) ? true : false;

            log.debug("jcallo VariablesVentas.vEsPedidoConvenio:" +
                      VariablesVentas.vEsPedidoConvenio);
            ...
            for (int i = 0; i < tblDetallePago.getRowCount(); i++) {
                ...
                DBCaja.grabaFormaPagoPedido(((String)tblDetallePago.getValueAt(i,
                                                                               0)).trim(),
		                ...
		                VariablesCaja.vDescripcionDetalleFormasPago =
		                        VariablesCaja.vDescripcionDetalleFormasPago +
		                        FarmaUtility.getValueFieldJTable(tblDetallePago, i,
		                                                         0) + " , " +
		                        FarmaUtility.getValueFieldJTable(tblDetallePago, i,
		                                                         1) + " , " +
		                        FarmaUtility.getValueFieldJTable(tblDetallePago, i,
            ...
            if (!VariablesVentas.vCod_Cli_Local.equalsIgnoreCase("")) {
                ...
                actualizaClientePedido(VariablesCaja.vNumPedVta,
                                       VariablesVentas.vCod_Cli_Local);
            }

             String resultado = "";
             String resMatriz = "";
             System.out.println("VariablesConvenioBTLMF.vFlgValidaLincreBenef"+VariablesConvenioBTLMF.vFlgValidaLincreBenef);
		            ...
		            if (indConexionRac.equals("S"))
		            {
			            //cobrar pedido DEVOLVERA EXITO. si cobro correctamente
		            	       ...
		            	       if(resultado.trim().equalsIgnoreCase("EXITO"))
		            	       {
			            	       ...
			            	       {
			            	    	   System.out.println("-------------------GRABO EXITOSAMENTE MATRIZ-------- ");
            ...
            System.out.println("Imprimiendo...VariablesCaja.vNumPedVta:" +VariablesCaja.vNumPedVta);
            ...
            if (VariablesConvenioBTLMF.vFlgValidaLincreBenef.equals("1"))
            {
            	if (!resMatriz.equals("S"))
	            {
	            	FarmaUtility.liberarTransaccion();
	            	VariablesCaja.vIndPedidoCobrado = false;
	            	System.out.println("Error al grabar datos Matriz");
	            	 FarmaUtility.showMessage(this,
        ...
        { //error inesperado
            ...
            System.err.println("cerrando conexion remota sea matriz, adm, vta institucional, etc");
    ...
    private boolean generarPedidoCupon(String NumPed) {
        ...
        try {
            ...
            valor = true;
            System.out.println("Se generaron los cupones del pedido :" +
                               NumPed);
        } catch (SQLException sql) {
            sql.printStackTrace();
            FarmaUtility.showMessage(this,
