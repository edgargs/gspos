...
public class DlgRecepcionProductosGuias extends JDialog 
{
  ...
  private JLabelFunction lblF7 = new JLabelFunction();
		...
		else if (e.getKeyCode() == KeyEvent.VK_F1) 
    {
		...
		} else if (e.getKeyCode() == KeyEvent.VK_F2) {// afectar pagina
      ...
      if(FarmaVariables.vEconoFar_Matriz)
        FarmaUtility.showMessage(this,ConstantsPtoVenta.MENSAJE_MATRIZ,txtBuscar);
			...
			if(tieneRegistroSeleccionados(tblListaGuias))      
         		if(FarmaUtility.rptaConfirmDialog(this,"¿Está seguro de afectar las Guias Seleccionadas?")){
...
//                if (!ConstantsRecepCiega.error_du) {
    ...
    //cambio de posicion
      ...
      System.out.println("GUIAS ASOCIADAS :" +VariablesInventario.lista);
    }
...
//        cargarGuiaSeleccionada(i);
    ...
    if(cantOtroTipo == 0 && cantTipoUB == 0){
        ...
        if((cantTipoZREG > 0 || cantTipoZTNL > 0 || cantTipoUBL > 0)){
            ...
            System.out.println("AFECTA cantOtroTIpo:"+cantOtroTipo);
            System.out.println("cantTipoZREG: "+cantTipoZREG);
            System.out.println("cantTipoUB: "+cantTipoUB);
            System.out.println("cantTipoUBL: "+cantTipoUBL);
            System.out.println("cantTipoZTNL: "+cantTipoZTNL);
            rpta = "1";
        }
    ...
    if(cantOtroTipo > 0 || cantTipoUB > 0 ){
        ...
        if((cantTipoZREG > 0 ||  cantTipoZTNL > 0 || cantTipoUBL > 0)){
            ...
            System.out.println("cantOtroTipo: "+cantOtroTipo);
            System.out.println("cantTipoZREG: "+cantTipoZREG);
            System.out.println("cantTipoUB: "+cantTipoUB);
            System.out.println("cantTipoUBL: "+cantTipoUBL);
            System.out.println("cantTipoZTNL: "+cantTipoZTNL);
        ...
        if(cantTipoZREG == 0 && cantTipoZTNL == 0 && cantTipoUBL == 0 ){
            //si puede afectar, pide cabecera
            System.out.println("Sí puede afectar NO existe otros tipos");
        ...
        try {
            ...
            if (FarmaVariables.vAceptar) {
                ...
                for (int i = 0; i < tblListaGuias.getRowCount(); i++) {
                    ...
                    if (check) {
                        cargarGuiaSeleccionada(i);
                        System.out.println("CARGA_GUIA,VariablesInventario.vNumEntAfectar: " + 
                ...
                System.out.println("CantGuias: " + CantGuias);
                ...
                System.out.println("Cerro ventana ");
             }
         }
