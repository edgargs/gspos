...
public class DlgLaboratoriosPorTomaDiario extends JDialog {
    ...
    private void initTableLaboratoriosToma() {
        tableModelLaboratorioTomaDiario =
                new FarmaTableModel(ConstantsInvDiario.columnsLaboratoriosToma, ConstantsInvDiario.defaultValuesLaboratoriosToma,
                                    0);
        FarmaUtility.initSimpleList(tblRelacionLaboratoriosXToma, tableModelLaboratorioTomaDiario,
                                    ConstantsInvDiario.columnsLaboratoriosToma);
    ...
    private void cargaLaboratoriosToma() {
        try {
            ...
            if (tblRelacionLaboratoriosXToma.getRowCount() > 0)
                FarmaUtility.ordenar(tblRelacionLaboratoriosXToma, tableModelLaboratorioTomaDiario, 1,
    ...
    private void imprimir() {
        ...
        try {
            ...
            vPrint.printLine("==============================================================================================",
                             true);
            vPrint.printBold("   Código        Laboratorio                                                           Estado        ",
                             true);
            vPrint.printLine("==============================================================================================",
                             true);
            ...
            vPrint.printBold("Registros Impresos: " +
                             FarmaUtility.formatNumber(tblRelacionLaboratoriosXToma.getRowCount(), ",##0") +
