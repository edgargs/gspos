...
public interface MapperRecaudacionTrsscSix {
  ...
  /**
    ...
    */     
    ...
    @Select(value =
            "{call  #{tmpCodigo, mode=OUT, jdbcType=BIGINT} := " +
            "BTLPROD.ADMCENTRAL_RECAUDACION.RCD_REGTR_PAGO_CITIBANK(" +
                    "#{cCodGrupoCia_in}," +
                    "#{cCodCia_in}," +
                    "#{cCodLocal_in}," +
    ...
    @Select(value =
            "{call  #{tmpCodigo, mode=OUT, jdbcType=BIGINT} := " +
            "BTLPROD.ADMCENTRAL_RECAUDACION.RCD_ANULR_PAGO_CITIBANK(" +
                    "#{cCodGrupoCia_in}," +
                    "#{cCodCia_in}," +
                    "#{cCodLocal_in}," +
    ...
    * @param mapParametros
    */     
    @Select(value="{call PTOVENTA.PKG_DAEMON_EXTORNO_RCD.RCD_ANUL_PAGOS(" +
                     "#{cCodGrupoCia_in}," +
                     "#{cCodLocal_in}," +   
                     "#{cCodTrssc_in}" +   
                   ")}")
