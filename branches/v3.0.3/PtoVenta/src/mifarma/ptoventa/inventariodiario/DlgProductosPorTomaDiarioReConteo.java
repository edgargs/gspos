...
public class DlgProductosPorTomaDiarioReConteo extends JDialog {
    ...
    public DlgProductosPorTomaDiarioReConteo(Frame parent, String title, boolean modal) {
    ...
    private void initTableListaProductosXLaboratorio() {
        tableModelProductosTomaDiario =
                new FarmaTableModel(ConstantsInvDiario.columnsListaProductosXLaboratorio, ConstantsInvDiario.defaultValuesListaProductosXLaboratorio,
                                    0);
        FarmaUtility.initSimpleList(tblRelacionProductos, tableModelProductosTomaDiario,
    ...
    private void this_windowOpened(WindowEvent e) {
        ...
        try {
            ...
            log.debug("Ocurrió error al actualizar IndSegConteo." + sql.getMessage());
                ...
                if (tieneRegistroSeleccionado(tblRelacionProductos)) {
                    ...
                    if (VariablesInvDiario.vMinutosTranscurridos >= tiempo) {
                        FarmaUtility.showMessage(this,
                                                 "Se excedio en el tiempo para realizar modificaciones sobre la toma",
                                                 txtProductos);
                        VariablesInvDiario.vFlagTimer = true;
                        this.setEnabled(false);
                        this.dispose();
                        DlgListaDiferenciasVer dlgListaDiferenciasVer =
                            new DlgListaDiferenciasVer(myParentFrame, "", true);
                        dlgListaDiferenciasVer.setVisible(true);
                    } else {
                        DlgIngresoCantidadInvDiarioConteo dlgIngresoCantidadInvDiario =
                            new DlgIngresoCantidadInvDiarioConteo(this.myParentFrame, "", true);
                    ...
                    if (tieneRegistros(this.tblRelacionProductos)) {
                        ...
                        if (com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,
                            ...
                            try {
                                ...
                                log.error("",sql);
                                FarmaUtility.showMessage(this,
                                                         "Ocurrió un error al completar con ceros: \n" +
                                        sql.getMessage(), txtProductos);
                            }
                        }
                    }
    ...
    private void imprimir() {
        ...
        log.debug("MARCO : ENTRO A IMPRIMIR TOMA DIARIA - SEGUNDO CONTEO" + FarmaVariables.vImprReporte);
        ...
        try {
            ...
            vPrint.printBold(FarmaPRNUtility.llenarBlancos(27) + " REPORTE DE PRODUCTOS - SEGUNDO CONTEO", true);
            ...
            vPrint.printLine("=======================================================================================================",
                             true);
            vPrint.printBold("Código  Descripcion                                 Unidad     C. Ent   C. Frac    Laboratorio   Hora   ",
                             true);
            vPrint.printLine("=======================================================================================================",
                             true);
            ...
            for (int i = 0; i < tblRelacionProductos.getRowCount(); i++) {
                ...
                vPrint.printCondensed(FarmaPRNUtility.alinearIzquierda((String)tblRelacionProductos.getValueAt(i, 0),
                        ...
                        FarmaPRNUtility.alinearIzquierda((String)tblRelacionProductos.getValueAt(i, 5), 10) +
                        "   ___:___ ", true);
            }
            vPrint.activateCondensed();
            vPrint.printLine("=======================================================================================================",
    ...
    private void cargaListaProductosXLaboratorio() {
        try {
            ...
            if (tblRelacionProductos.getRowCount() > 0)
                FarmaUtility.ordenar(tblRelacionProductos, tableModelProductosTomaDiario, 5,
    ...
    private void cargarRegistroSeleccionado() {
        ...
        VariablesInvDiario.vUnidVta =
                tblRelacionProductos.getValueAt(tblRelacionProductos.getSelectedRow(), 7).toString().trim();
