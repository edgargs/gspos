...
public class ConstantsTomaInv {
  ...
  */
    ...
    { new FarmaColumnData("Laboratorio", 160, JLabel.LEFT), new FarmaColumnData("Codigo", 65, JLabel.CENTER),
      new FarmaColumnData("Descripcion", 200, JLabel.LEFT), new FarmaColumnData("Unid Presentacion", 110, JLabel.LEFT),
      new FarmaColumnData("Stock Actual", 75, JLabel.RIGHT), new FarmaColumnData("Diferencia", 75, JLabel.RIGHT),
      new FarmaColumnData("Precio", 65, JLabel.RIGHT)
        //OCULTOS
        //codigo_de_lab
