...
public class DlgInterfacePinpad extends JDialog {
    ...
    private void jbInit() throws Exception {
        ...
        pnlInfo.setBounds(new Rectangle(5, 25, 465, 350));
        ...
        jPanel1.setBounds(new Rectangle(20, 160, 430, 175));
        ...
        pnlMensajePinpad.setBounds(new Rectangle(5, 375, 465, 65));
        ...
        lblMensajePinpad.setBounds(new Rectangle(0, 0, 465, 65));
        ...
        lblF11.setBounds(new Rectangle(340, 445, 130, 30));
