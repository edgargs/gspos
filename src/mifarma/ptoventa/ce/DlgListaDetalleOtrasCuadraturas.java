  ...
  extends JDialog
{
  ...
  {
    tableModel = new FarmaTableModel(ConstantsCajaElectronica.columsListaDetalleDineroFalso, ConstantsCajaElectronica.defaultListaDetalleDineroFalso, 0);
    FarmaUtility.initSimpleList(tblListaDetalle, tableModel,ConstantsCajaElectronica.columsListaDetalleDineroFalso);
  }
  ...
  {
    tableModel = new FarmaTableModel(ConstantsCajaElectronica.columsListaDetalleDeficitCajero, ConstantsCajaElectronica.defaultListaDetalleDeficitCajero, 0);
    FarmaUtility.initSimpleList(tblListaDetalle, tableModel,ConstantsCajaElectronica.columsListaDetalleDeficitCajero);
  }
  
  private void initTableOtrasCuadraturas()
  {
    tableModel = new FarmaTableModel(ConstantsCajaElectronica.columsListaDetalleOtrasCuadraturas, ConstantsCajaElectronica.defaultListaDetalleOtrasCuadraturas, 0);
    FarmaUtility.initSimpleList(tblListaDetalle, tableModel,ConstantsCajaElectronica.columsListaDetalleOtrasCuadraturas);
  }
