...
public class DlgTransferenciasRealizadas extends JDialog {
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(790, 403));
        ...
        lblEsc.setBounds(new Rectangle(675, 335, 90, 20));
        ...
        //gmoran 27/01/2016
        lblF9.setText("[ F9 ] Reenviar");
        lblF9.setVisible(UtilityInventario.isEnvioTransWS());
        lblF9.setBounds(new Rectangle(15, 335, 155, 20));
        //
    ...
    private void chkKeyPressed(KeyEvent e) {
        ...
        if (mifarma.ptoventa.reference.UtilityPtoVenta.verificaVK_F1(e)) {
                    ...
                    if (FarmaVariables.vAceptar) {
                        ...
                        if (VariablesInventario.vTipoDestino_Transf.equalsIgnoreCase("01")) { //solo confirmacion automatica para locales
                            if (validaGuiasEmitidas(VariablesInventario.vNumNotaEs)) {
                                ...
                                if (!FarmaVariables.dlgLogin.verificaRol(FarmaConstants.ROL_SUPERVISOR_VENTAS))
                                {
                                  UtilityInventario.confirmarTransferencia(VariablesInventario.vNumNotaEs.trim(),
                                                                           VariablesInventario.vCodDestino_Transf,
                                                                           VariablesInventario.vTipoDestino_Transf,
                                                                           this,tblListaTransferencias);
            ...
            log.debug("vCodLocal: "+FarmaVariables.vCodLocal);
            //if(UtilityInventario.isEnvioTransWS())
            //grabarReenvioTransferemcia();
        }
    }
