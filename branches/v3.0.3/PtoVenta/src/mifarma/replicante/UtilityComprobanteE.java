...
public class UtilityComprobanteE {
    ...
    public static String procesarReenvioCompE(String pCodGrupoCia, String pCodCia, String pCodLocal, String pUsuarioBD,
        ...
        try {
            List comprobantes =
                DBComprobanteElectronico.obtieneReenvioComprobantes(pCodGrupoCia, pCodCia, pCodLocal, pTipoComp,
                                                                    pSerieComp, pNumComp);
            ...
            for (int i = 0; i < comprobantes.size(); i++) {
                ...
                String rst =
                    UtilityComprobanteE.reenvioComprobanteE(pCodGrupoCia, pCodLocal, vTipComp, vNumPed, vSecComp,
