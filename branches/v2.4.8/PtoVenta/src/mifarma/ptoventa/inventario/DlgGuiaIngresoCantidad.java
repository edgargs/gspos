...
public class DlgGuiaIngresoCantidad extends JDialog 
{
  ...
  private void jbInit() throws Exception
  {
    ...
    txtPrecioUnitario.setBounds(new Rectangle(320, 40, 70, 20));
    ...
    lblPrecioUnitario_T.setBounds(new Rectangle(320, 20, 70, 15));
    lblPrecioUnitario_T.setForeground(new Color(255, 130, 14));
    txtFechaVencimiento.setBounds(new Rectangle(235, 40, 75, 20));
    ...
    lblFechaVenc_T.setBounds(new Rectangle(235, 20, 70, 15));
    lblFechaVenc_T.setForeground(new Color(255, 130, 14));
    txtLote.setBounds(new Rectangle(155, 40, 70, 20));
    ...
    lblLote.setBounds(new Rectangle(155, 20, 70, 15));
    ...
    lblFrac_T.setBounds(new Rectangle(85, 20, 50, 15));
  ...
  private boolean validaCantIngreso()
  {
    ...
    VariablesInventario.vCantIngreso = Integer.parseInt(cantidad) * Integer.parseInt(VariablesInventario.vValFrac_Guia.trim()) + Integer.parseInt(fraccion);  
