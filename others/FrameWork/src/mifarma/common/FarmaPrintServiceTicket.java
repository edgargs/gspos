...
public class FarmaPrintServiceTicket {
     ...
     */
    public FarmaPrintServiceTicket(int pLinesPerPage, String pDevicePort, 
    ...
    public boolean startPrintService() {
        ...
        try {
            ...
            valorRetorno = true;
            //Se comento para solo Capturar Exception
        /*} catch (FileNotFoundException errFileNotFound) {
            ...
            //JMIRANDA 24/07/09 Envia Error al Imprimir a Email
              enviaErrorCorreoPorDB(errException,null);
        }
        return valorRetorno;
    }

    public boolean startPrintService_DU() throws Exception {
        boolean valorRetorno = false;
        //try {
            FileOutputStream fos = new FileOutputStream(devicePort);
            ps = new PrintStream(fos);
    ...
    public void endPrintService() {
        ...
        if (includeDatePage)
            printDatePage();*/
        //jquispe 20.09.2010
        //ps.print( ""+(char)27 + "d"+(char)2);
        /*if(!FarmaVariables.vCodGrupoCia.equalsIgnoreCase(FarmaConstants.CODIGO_PAIS_PERU))
        {*/
        //  ps.print( ""+(char)29 + (char)86 + (char)0);
        ps.print( ""+(char)27 + "d"+(char)2);
          //System.out.println("ENTRO CORTAR");
        /*}else
        { 
            ps.print( ""+(char)27 + "d"+(char)2);
        }*/
    ...
    public static void enviaErrorCorreoPorDB(Exception pMessage, String pCorrelativo)  {
        ...
        FarmaUtility.enviaCorreoPorBD(FarmaVariables.vCodGrupoCia,
                                      ...
                                      "Correlativo : " + FarmaVariables.vNroPedidoNoImp + "<br>"+
