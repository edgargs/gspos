...
public class DlgListaConvenios extends JDialog 
{
  ...
  private void obtieneDatosConvenio()
  {
    if(VariablesConvenio.vArrayList_ListaConvenio.size() == 1)
    {
      ...
      System.out.println("VariablesConvenio.vNomConvenio : " + VariablesConvenio.vNomConvenio);
      System.out.println("VariablesConvenio.vPorcDctoConv : " + VariablesConvenio.vPorcDctoConv);
      System.out.println("VariablesConvenio.vPorcCoPago : " + VariablesConvenio.vPorcCoPago);
