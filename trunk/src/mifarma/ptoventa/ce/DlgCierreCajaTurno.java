...
public class DlgCierreCajaTurno extends JDialog 
{
  ...
  {
    this.setSize(new Dimension(739, 579));
    ...
    jPanelTitle1.setBounds(new Rectangle(10, 10, 710, 25));
    pnlDatosCaja.setBounds(new Rectangle(10, 35, 710, 125));
    ...
    jPanelTitle2.setBounds(new Rectangle(10, 170, 350, 20));
    jPanelTitle3.setBounds(new Rectangle(370, 170, 350, 20));
    scrFormasPago.setBounds(new Rectangle(10, 190, 350, 205));
    scrCuadraturas.setBounds(new Rectangle(370, 190, 350, 105));
    ...
    pnlTotalCuadraturas.setBounds(new Rectangle(500, 295, 220, 25));
    ...
    pnlTotalSistema.setBounds(new Rectangle(370, 330, 350, 55));
    ...
    pnlTotalFormaPago.setBounds(new Rectangle(140, 395, 220, 25));
    ...
    pnlFaltante.setBounds(new Rectangle(370, 385, 350, 35));
    ...
    lblFormasPago.setBounds(new Rectangle(10, 500, 135, 20));
    lblFormasPago.setText("[ F1 ] Formas de Pago");
    lblCuadraturas.setBounds(new Rectangle(180, 500, 145, 20));
    lblCuadraturas.setText("[ F2] Otras Cuadraturas");
    lblVBCajero.setBounds(new Rectangle(10, 525, 115, 20));
    lblVBCajero.setText("[ F8 ] VºBº Cajero");
    lblVBQF.setBounds(new Rectangle(180, 525, 105, 20));
    lblVBQF.setText("[ F9] VºBº Q.F.");
    lblEsc.setBounds(new Rectangle(640, 525, 80, 19));
    ...
    lblImprimir.setBounds(new Rectangle(345, 525, 105, 20));
    ...
    lblComprobantes_T.setBounds(new Rectangle(345, 500, 200, 20));
    lblComprobantes_T.setText("[ F3] Ingresar Comprobantes");
    scrObs.setBounds(new Rectangle(110, 5, 590, 60));
		lblCambioFormaPago.setBounds(new Rectangle(550, 500, 165, 20));
        lblCambioFormaPago.setText("[ F4 ] Cambio Foma Pago");
  ...
  private void btnBuscar_actionPerformed(ActionEvent e)
  {
    if (validaDatosIngreso())
    {
      ...
      System.out.println("VariablesCajaElectronica.vSecMovCaja : " + VariablesCajaElectronica.vSecMovCaja);
  ...
  private void chkKeyPressed(KeyEvent e)
  {
    ...
    if (VariablesCajaElectronica.vIndFuncionesHabilitadas)
    {
      if (e.getKeyCode() == KeyEvent.VK_F1){
        ...
        System.out.println("VariablesCajaElectronica.vIndVBCajero"+VariablesCajaElectronica.vIndVBCajero); 
        if(UtilityCajaElectronica.obtieneIndicadorVB_ForUpdate(VariablesCajaElectronica.vSecMovCaja, ConstantsCajaElectronica.TIPO_VB_CAJERO))
        {
        ...
        {FarmaUtility.showMessage(this,"No se pudo determinar si el movimiento de caja posee V°B° de Cajero o de Dia",null);
        }
  ...
  private void cargaLogin()
  {
    ...
    if ( FarmaVariables.vAceptar ) {
      if ( (dlgLogin.verificaRol(FarmaConstants.ROL_ADMLOCAL) && dlgLogin.verificaRol(FarmaConstants.ROL_CAJERO)) )
      {
  ...
  private void obtieneTipoCambio(String pFechaTipoCambio)
  {
    ...
    try
    {
      //FarmaVariables.vTipCambio = FarmaSearch.getTipoCambio(pFechaTipoCambio);
       FarmaVariables.vTipCambio = DBCajaElectronica.getTipoCambio(pFechaTipoCambio);
  ...
  private boolean obtieneInfoDatosCaja()
  {
    ...
    String indResultBuscar = new String();
    boolean valor = false;
    String diaVenta = txtFecha.getText().trim();
    String codCajero = txtCodigoCajero.getText().trim();
    String numeroCaja = txtCaja.getText().trim();
    String turnoCaja = FarmaLoadCVL.getCVLCode(ConstantsCajaElectronica.NOM_HASHTABLE_CMBTURNO, cmbTurno.getSelectedIndex());
    lblNombre.setText("");
    ...
    } finally
    {
      if(resultado.trim().length()>0)
      {
        ...
        } else
        {
          ...
          if( indResultBuscar.equalsIgnoreCase(ConstantsCajaElectronica.RESULT_BUSCAR_MOV_CAJA_CON_VBC) )
          {
            ...
            FarmaUtility.showMessage(this,"El movimiento de caja ya cuenta con VoBo de Cajero.",tblFormasPago);
          ...
          } else if( indResultBuscar.equalsIgnoreCase(ConstantsCajaElectronica.RESULT_BUSCAR_MOV_CAJA_CON_VBQ) )
          {
            ...
            FarmaUtility.showMessage(this,"El movimiento de caja ya cuenta con VoBo de QF.",tblFormasPago);
            verificaObservacionCierreTurno(true, false);
          } else
          {
            VariablesCajaElectronica.vIndVBCajero = FarmaConstants.INDICADOR_N;
      ...
      if(valor)
      {
          ...
          {    if(codCajero.equalsIgnoreCase(FarmaVariables.vNuSecUsu) && UtilityCajaElectronica.isAdmLocal(FarmaVariables.vNuSecUsu,this))   {         
  ...
  private void cambiaVBCajero()
  {
        ...
        VariablesCajaElectronica.vUsuarioCajero )
    {
        if(getDeter_neces_fpFSEN()){//ASOSA, 21.06.2010
          ...
          if ( FarmaUtility.rptaConfirmDialog(this, "Está seguro de otorgar el VB de Cajero?") )
          {        
               ...
               VariablesCajaElectronica.vUsuarioQF )
    {
      ...
      } else
      {
        ...
        {
          if ( FarmaUtility.rptaConfirmDialog(this, "Ya existe un registro de Cierre de Dia Local para el dia de\nventa ingresado. Está seguro de eliminar el VB de Cajero?") )
          {
            if( cargaLoginOper() )
            {
              if( actualizaIndicadorVB(VariablesCajaElectronica.vSecMovCaja,
        ...
        {
          if ( FarmaUtility.rptaConfirmDialog(this, "Está seguro de eliminar el VB de Cajero?") )
          {
  ...
  private void evaluaTotales()
  {
    ...
    montoTotalCierre = FarmaUtility.getDecimalNumber(lblSubTotalCuadraturas.getText().trim()) + FarmaUtility.getDecimalNumber(lblSubTotalFormaPago.getText().trim());
    montoTotalCierre = FarmaUtility.getDecimalNumber(FarmaUtility.formatNumber(montoTotalCierre));
    System.out.println("montoTotalCierre : " + montoTotalCierre);
  ...
  private void evaluaDeficitAsumidoCajero(String pSecMovCaja, double pMontoDeficit)
  {
    try
    {
      System.out.println("*********** faltante : " + pMontoDeficit + " *************");
  ...
  private void imprimeCierreTurno()
  {
    ...
    try{
     ...
     VariablesCajaElectronica.vNumTurno, true);*/
      ...
      {
        String descTipoComp = FarmaUtility.getValueFieldArrayList(myArrayUsuario, i, 0);
        String tipoComp = FarmaUtility.getValueFieldArrayList(myArrayUsuario, i, 4);
        String numSerie = FarmaUtility.getValueFieldArrayList(myArrayUsuario, i, 1);
        String rangoIni = FarmaUtility.getValueFieldArrayList(myArrayUsuario, i, 2);
        String rangoFin = FarmaUtility.getValueFieldArrayList(myArrayUsuario, i, 3);
  ...
  private boolean validaRangoComprobantesIngresados()
  {
    ...
    for(int i=0; i<myArrayUsuario.size(); i++)
    {
      ...
      String tipoCompTable = FarmaUtility.getValueFieldArrayList(myArrayUsuario, i, 4);
      String numSerieTable = FarmaUtility.getValueFieldArrayList(myArrayUsuario, i, 1);
      String rangoIniTable = FarmaUtility.getValueFieldArrayList(myArrayUsuario, i, 2);
      String rangoFinTable = FarmaUtility.getValueFieldArrayList(myArrayUsuario, i, 3);
  ...
  private void colocaObservacionCierreTurno(boolean pVerObs)
  {
    ...
    System.out.println("VariablesCajaElectronica.vObsCierreTurno : " + VariablesCajaElectronica.vObsCierreTurno);
    txtSObs.setText( VariablesCajaElectronica.vObsCierreTurno );
  }
  ...
  private boolean validaMontoDeclarado(){
      boolean valor=true;
      try{
          System.out.println("SEC_MOV_CAJA:::cierre"+VariablesCajaElectronica.vSecMovCaja);
          System.out.println("FECHA:::cierre"+VariablesCajaElectronica.vDiaVenta);
  ...
  {
        if (FarmaVariables.vEconoFar_Matriz) {
            FarmaUtility.showMessage(this, ConstantsPtoVenta.MENSAJE_MATRIZ, 
                                     txtFecha);
            return;
        }
  ...
  private void funcion_F9(){
    ...
    private String getFondoSencilloAsignado(){
        ...
        try{
            ...
            System.out.println("no se pudo obtener el Fondo de Sencillo"); 
           }
        return monto;
    }
