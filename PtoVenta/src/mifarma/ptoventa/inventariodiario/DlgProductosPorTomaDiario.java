...
public class DlgProductosPorTomaDiario extends JDialog {
    ...
    private void chkKeyPressed(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_ESCAPE) {
            ...
            if (FarmaVariables.vEconoFar_Matriz)
                ...
                if (tieneRegistroSeleccionado(tblRelacionProductos)) {
                    cargarRegistroSeleccionado();
                    DlgIngresoCantidadInvDiario dlgIngresoCantidadInvDiario =
                        new DlgIngresoCantidadInvDiario(this.myParentFrame, "", true);
        ...
        //funcionalidad continuar
            ...
            */
                DlgProductosPorTomaDiarioReConteo dlgProductosPorTomaDiarioReConteo =
                    new DlgProductosPorTomaDiarioReConteo(myParentFrame, " ", true);
                ...
                try {
                    ...
                    FarmaUtility.showMessage(this,
                                             "Ocurrió un error al obtener el tiempo de modificaciòn de toma : \n" +
                            sql.getMessage(), txtProductos);
                }
    ...
    private void imprimir() {
        ...
        try {
            ...
            vPrint.printBold(FarmaPRNUtility.llenarBlancos(27) + " REPORTE DE PRODUCTOS : PRIMER CONTEO", true);
