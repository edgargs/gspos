  ...
  extends JDialog
{
  ...
  { 
    ...
    System.out.println("VariablesConvenio.vCodClienteDependiente " 
                          + 
                          VariablesConvenio.vCodClienteDependiente);
                          
    System.out.println("VariablesConvenio.vCodTrabDependiente " 
                          + 
                          VariablesConvenio.vCodClienteDependiente);    
   System.out.println("VariablesConvenio.vNomTrabDependiente " 
                          + 
                         VariablesConvenio.vNomTrabDependiente);    
