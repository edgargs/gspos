...
// **************************************************************************
  ...
  private void muestraInfoDetalleProd()
  {
         ...
         // Segun gerencia se debe seguir la misma logica para todos los productos.
                if (VariablesVentas.vVentanaListadoProductos) {
                    ...
                    */
                    ...
                    double precio = FarmaUtility.getDecimalNumber(((String)((ArrayList)myArray.get(0)).get(3)).trim()) * 
    ...
    if (!VariablesVentas.existenValoresAdicionales) {    //ASOSA - 12/08/2014
        lblStock.setText("" + (Integer.parseInt(VariablesVentas.vStk_Prod) /
...
// **************************************************************************
  ...
  private boolean validaStockActual()
  {
    ...
    //}
    VariablesVentas.vStk_Prod = "" + Integer.parseInt(VariablesVentas.vStk_Prod) / 
                                Integer.parseInt(VariablesVentas.vValorMultiplicacion);
        ...
        if(!validaStockActual())
        {
          ...
          if (tipoProducto.trim().equals(ConstantsVentas.TIPO_PROD_FINAL)){
            int cantidad = (int)Integer.parseInt(txtCantidad.getText().trim());
              ...
              if(!UtilityVentas.permiteVtaNegativa(myParentFrame,this,VariablesVentas.vCod_Prod, txtCantidad.getText().trim(), VariablesVentas.vVal_Frac))
              {
