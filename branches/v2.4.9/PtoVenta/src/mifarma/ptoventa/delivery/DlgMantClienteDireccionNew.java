...
public class DlgMantClienteDireccionNew extends JDialog
{
  ...
  private void guardaValoresCliente()
  {
    ...
    VariablesDelivery.vReferencia = txtReferencia.getText();
      ...
      VariablesDelivery.vDptosCodigo = FarmaLoadCVL.getCVLCode(VariablesDelivery.vDptosInHashTable,cmbDpto.getSelectedIndex());
      VariablesDelivery.vProviCodigo = FarmaLoadCVL.getCVLCode(VariablesDelivery.vProviInHashTable,cmbProvi.getSelectedIndex());
      VariablesDelivery.vDistCodigo  = FarmaLoadCVL.getCVLCode(VariablesDelivery.vDistHashTable,cmbDist.getSelectedIndex());      
  ...
  private void cargaDatosDireccionCliente()
  {
    ...
    txtReferencia.setText(VariablesDelivery.vReferencia);
      ...
      FarmaLoadCVL.setSelectedValueInComboBox(cmbDpto,
                                              VariablesDelivery.vDptosInHashTable,
                                              VariablesDelivery.vDptosCodigo);
      
      cargaProvincias(); // carga provinvias segun dpto
      // 06-NOV-13, TCT, add combo de Provincia y Distrito
      FarmaLoadCVL.setSelectedValueInComboBox(cmbProvi,
                                              VariablesDelivery.vProviInHashTable,
                                              VariablesDelivery.vProviCodigo);
      
      cargaDistritos();
      
      FarmaLoadCVL.setSelectedValueInComboBox(cmbDist,
                                                VariablesDelivery.vDistHashTable,
                                                VariablesDelivery.vDistCodigo);
  ...
  private void txtNomCalle_focusLost(FocusEvent e)
  {
    ...
    private void cargaDptos()
    {
     ...
     FarmaLoadCVL.loadCVLFromSP(cmbDpto,
                                VariablesDelivery.vDptosInHashTable,
    ...
    private void cargaProvincias()
    {
      ...
      FarmaLoadCVL.loadCVLFromSP(cmbProvi,
                                VariablesDelivery.vProviInHashTable,
    ...
    private void cargaDistritos()
    {
      ...
      FarmaLoadCVL.loadCVLFromSP(cmbDist,
                                VariablesDelivery.vDistHashTable,
