CREATE OR REPLACE PACKAGE PTOVENTA."FARMA_UTILITY" AS
  ...
  */
  ...
  -- KMONCADA 08.09.2015 CIFRADO DE NRO DE TARJETA EN RECAUDACION
  CRYPT_RAW   RAW(2000);
  ...
  -- KMONCADA 25.05.2016
  CONST_COMP_BOLETA         CONSTANT VTA_TIP_COMP.TIP_COMP%TYPE := '01';
  CONST_COMP_FACTURA        CONSTANT VTA_TIP_COMP.TIP_COMP%TYPE := '02';
  CONST_COMP_GUIA           CONSTANT VTA_TIP_COMP.TIP_COMP%TYPE := '03';
  CONST_COMP_NOTA_CREDITO   CONSTANT VTA_TIP_COMP.TIP_COMP%TYPE := '04';
  CONST_COMP_TCK_BOLETA     CONSTANT VTA_TIP_COMP.TIP_COMP%TYPE := '05';
...
/* ****************************************************************** */
 ...
 /* ****************************************************************** */
  ...
  /* ****************************************************************** */
  --Descripcion: ENCRIPTACION DE TEXTO CON METODO DE OFUSCACION DE ORACLE
  --Fecha       Usuario        Comentario
  --07/09/2015  KMONCADA       Creacion
  FUNCTION ENCRIPTAR_TEXTO( TXT_ENCRIP VARCHAR2 ) 
    RETURN RAW;
  
  /* ****************************************************************** */
  --Descripcion: DESENCRIPTACION DE TEXTO CON METODO DE OFUSCACION DE ORACLE
  --Fecha       Usuario        Comentario
  --07/09/2015  KMONCADA       Creacion  
  FUNCTION DESCENCRIPTAR_TEXTO( TXT_DESENCRIP VARCHAR2 ) 
    RETURN VARCHAR2;

  /* ****************************************************************** */    
  --Descripcion: METODO PARA CIFRAR NRO DE TARJETA PARA CASO DE RECAUDACION
  --Fecha       Usuario        Comentario
  --07/09/2015  KMONCADA       Creacion
  FUNCTION F_GET_CIFRAR_NRO_TARJETA(vNroTarjeta_in IN VARCHAR2)
    RETURN VARCHAR2;

  /* ****************************************************************** */  
  --Descripcion: METODO PARA DESCIFRADO DE NRO DE TARJETA PARA CASO DE RECAUDACION
  --Fecha       Usuario        Comentario
  --07/09/2015  KMONCADA       Creacion
  FUNCTION F_GET_DESCIFRAR_NRO_TARJETA(vNroTarjeta_in IN VARCHAR2)
    RETURN VARCHAR2;
    
  --****************************************************************
  --** OBJETIVO             : ENCRIPTAR TEXTO CON UNA LONGITUD DEFINIDA POR EL USUARIO
  --** NOMBRE               : F_ENCRIPTAR_TEXTO_SIMPLE
  --** AUTOR                : DESARROLLO5 - ALEJANDRO NUÑEZ
  --** FECHA CREACION       : 07/10/2015
  --****************************************************************
  FUNCTION F_ENCRIPTAR_TEXTO_SIMPLE(vCadenaTexto IN VARCHAR2,
                                    vLongitud IN NUMBER)
  RETURN VARCHAR2;
  
  --****************************************************************
  --** OBJETIVO             : DESENCRIPTAR TEXTO CON FORMATO NUMERICO DE UNA LONGITUD DEFINIDA POR EL USUARIO
  --** NOMBRE               : F_DESENCRIPTAR_TEXTO_SIMPLE
  --** AUTOR                : DESARROLLO5 - ALEJANDRO NUÑEZ
  --** FECHA CREACION       : 07/10/2015
  --****************************************************************
  FUNCTION F_DESENCRIPTAR_TEXTO_SIMPLE(vCadenaTexto IN VARCHAR2)
  RETURN VARCHAR2;
  
  --****************************************************************
  --** OBJETIVO             : COMPRUEBA SI LA CADENA ES PLENAMENTE NUMERICA(ENTEROS POSITIVOS)
  --** NOMBRE               : F_IS_NUMBER
  --** AUTOR                : DESARROLLO5 - ALEJANDRO NUÑEZ
  --** FECHA CREACION       : 19/10/2015
  --****************************************************************
  FUNCTION F_IS_NUMBER(pCadena VARCHAR2)
  RETURN INT;
  
  --****************************************************************
  --** OBJETIVO             : DEVUELVE EL CARACTER EQUIVALENTE DEL LOCAL(ENTEROS POSITIVOS)
  --** NOMBRE               : F_CARACTER_EQUIVALENTE_LOCAL
  --** AUTOR                : DESARROLLO2 - JOEL CHUCO
  --** FECHA CREACION       : 07/01/2016
  --****************************************************************
  FUNCTION F_CARACTER_EQUIVALENTE_LOCAL(pCadena VARCHAR2, pPosicion INT, pCantidad INT)
  RETURN INT;

  --DECLARACION
  --****************************************************************
  --** OBJETIVO             : OBTENER EL NUMERO EQUIVALENTE DEL CODIGO DEL LOCAL
  --** NOMBRE               : F_VAR_GET_COD_LOCAL_EQUIV_NUM
  --** AUTOR                : LTAVARA
  --** FECHA CREACION       : 17/02/2016
  --****************************************************************    
      FUNCTION F_VAR_GET_COD_LOCAL_EQUIV_NUM(
  ...
  --****************************************************************
  --** OBJETIVO             : INDICA SI LOCAL ES TIPO DE VENTA M
  --** NOMBRE               : F_CARACTER_EQUIVALENTE_LOCAL
  --** AUTOR                : KMONCADA
  --** FECHA CREACION       : 15/01/2016
  --****************************************************************  
  FUNCTION F_IS_LOCAL_TIPO_VTA_M(cCodGrupoCia_in PTOVENTA.PBL_LOCAL.COD_GRUPO_CIA%TYPE,
                                 cCodLocal_in    PTOVENTA.PBL_LOCAL.COD_LOCAL%TYPE)
    RETURN CHAR;

/************************************************************************************/
	--Descripcion: INDICADOR SI LOCAL APLICA PERCEPCION 
 	--Fecha       Usuario		Comentario
  --13.04.2016  KMONCADA  Creación
  FUNCTION F_GET_LOCAL_APLICA_PERCEPCION(cCodGrupoCia_in IN CHAR,
                                         cCodLocal_in    IN CHAR)
    RETURN CHAR;

/************************************************************************************/
	--Descripcion: VALIDA SI LA CONSULTA DE CLIENTES SERA CENTRALIZADA
 	--Fecha       Usuario		Comentario
  --13.04.2016  KMONCADA  Creación
  FUNCTION F_GET_CENTRALIZA_CLIENTES(cCodGrupoCia_in IN CHAR,
                                     cCodLocal_in    IN CHAR)  
    RETURN CHAR;

/************************************************************************************/
  FUNCTION F_GET_MSJ_APLICA_PERCEPCION(cCodGrupoCia_in IN CHAR,
                                       cCodLocal_in    IN CHAR,
                                       cNumPedVta_in   IN CHAR)
    RETURN VARCHAR2;

/************************************************************************************/
	--Descripcion: VALIDA SI SOLICITARA DATOS DEL CMP EN EL PEDIDO POR CONTENER PROD FARMA
 	--Fecha       Usuario		Comentario
  --13.05.2016  KMONCADA  Creación  
  FUNCTION F_IS_REGISTRAR_CMP_PED_VTA(cCodGrupoCia_in  IN VTA_PEDIDO_VTA_CAB.COD_GRUPO_CIA%TYPE,
  ...
  /* ************************************************************************ */
    ...
    BEGIN
        ...
        */
        ...
        v_vSerie := CHR(65 + F_CARACTER_EQUIVALENTE_LOCAL(vCodLocal_in, 1, 1)) ||
                    CHR(65 + F_CARACTER_EQUIVALENTE_LOCAL(vCodLocal_in, 2, 1)) ||
                    CHR(65 + F_CARACTER_EQUIVALENTE_LOCAL(vCodLocal_in, 3, 1));
    ...
    --CREAR CUERPO MENSAJE;
      mesg_body := '<LI> <B>' || 'LOCAL: '||v_vDescLocal  ||CHR(9)||
                                       '</B><BR>'||
                                          ...
                                          '</LI>'  ;
	--ERIOS 03.07.2015 Graba log correo
	BEGIN
		INSERT INTO log_envia_mail(fech_load, proceso,descripcion,cod_local)
		   SELECT SYSDATE,vAsunto_in,vMensaje_in,cCodLocal_in
			FROM PTOVENTA.PBL_TAB_GRAL
			WHERE COD_TAB_GRAL = 'IND_LOG_CORREO'
...
FUNCTION getEmitioCOMPElectronico(cCodGrupoCia  VARCHAR2,
  ...
  BEGIN
    ...
    DBMS_OBFUSCATION_TOOLKIT.DESENCRYPT(INPUT          => PADBLOCK,
                                        KEY            => CLE,
  ...
  --------------------------------------------------------------------------
  ----------- CIFRADO DE NRO DE TARJETA PARA EL CASO DE RECAUDACION---------
  --------------------------------------------------------------------------
  
  FUNCTION F_GET_CIFRAR_NRO_TARJETA(vNroTarjeta_in IN VARCHAR2)
    RETURN VARCHAR2 IS
    vNroTarjeta PTOVENTA.RCD_RECAUDACION_CAB.NRO_TARJETA%TYPE;
    vIndicador CHAR(1) := 'N';
  BEGIN
    -- OBTIENE INDICADOR SI SE REALIZARA EL CIFRADO DE NRO DE TARJETA
    BEGIN
      SELECT NVL(LLAVE_TAB_GRAL, 'N')
        INTO vIndicador
        FROM PTOVENTA.PBL_TAB_GRAL
       WHERE ID_TAB_GRAL = 553;
    EXCEPTION
      WHEN OTHERS THEN
        vIndicador := 'N';
    END;
  
    IF vIndicador = 'S' AND LENGTH(TRIM(vNroTarjeta_in))>0 THEN
      vNroTarjeta := FARMA_UTILITY.ENCRIPTAR_TEXTO(vNroTarjeta_in);
    ELSE
      vNroTarjeta := vNroTarjeta_in;
    END IF;
    RETURN vNroTarjeta;
  END;

  --------------------------------------------------------------------------
  --------- DESCIFRADO DE NRO DE TARJETA PARA EL CASO DE RECAUDACION -------
  --------------------------------------------------------------------------
  ...
  FUNCTION F_GET_DESCIFRAR_NRO_TARJETA(vNroTarjeta_in IN VARCHAR2)
    ...
    vNroTarjeta PTOVENTA.RCD_RECAUDACION_CAB.NRO_TARJETA%TYPE;
    vIndicador CHAR(1) := 'N';
    vCantMinimaCaracteres NUMBER := 99999;
  BEGIN
    -- OBTIENE INDICADOR SI SE REALIZARA EL CIFRADO DE NRO DE TARJETA
    BEGIN
      SELECT NVL(LLAVE_TAB_GRAL, 'N')
    ...
    EXCEPTION
      WHEN OTHERS THEN
        vIndicador := 'N';
    END;
    -- OBTIENE CANTIDAD MINIMA PARA VALIDAD SI EL DATO SE ENCUENTRA CIFRADO
    BEGIN
      SELECT TO_NUMBER(NVL(LLAVE_TAB_GRAL, '0'),'999999990.00')
        INTO vCantMinimaCaracteres
        FROM PTOVENTA.PBL_TAB_GRAL
       WHERE ID_TAB_GRAL = 554;
    EXCEPTION
      WHEN OTHERS THEN
        vCantMinimaCaracteres := 9999999;
    END;
  
    IF vIndicador = 'S' AND LENGTH(TRIM(vNroTarjeta_in))>=vCantMinimaCaracteres THEN
      vNroTarjeta := FARMA_UTILITY.DESCENCRIPTAR_TEXTO(vNroTarjeta_in);
    ELSE
      vNroTarjeta := vNroTarjeta_in;
    END IF;
    RETURN vNroTarjeta;
  ...
  --****************************************************************
  --** OBJETIVO             : ENCRIPTAR TEXTO CON FORMATO NUMERICO DE UNA LONGITUD DEFINIDA POR EL USUARIO
  --** NOMBRE               : F_ENCRIPTAR_TEXTO_SIMPLE
  --** AUTOR                : DESARROLLO5 - ALEJANDRO NUÑEZ
  --** FECHA CREACION       : 07/10/2015
  --****************************************************************
  ...
  vDiferencia NUMBER;
  vDifCadena VARCHAR2(30);
  vBloques INT;
  vUltimoNumero INT;
  vVueltas INT;
  vCadenaTemp VARCHAR2(30);
  vContadorRegresivo INT;
  vIndice INT;
  vInvertir NUMBER;
  vCadenaInv VARCHAR2(30);
  
  BEGIN
       
       vDiferencia := vLongitud - LENGTH(vCadenaTexto) - 2;
       IF vDiferencia > 9 THEN
          vDifCadena := TO_CHAR(vDiferencia);
       ELSE
          vDifCadena := LPAD(TO_CHAR(vDiferencia),2,'0'); 
       END IF;
       
       vBloques := vDiferencia/9;
       vUltimoNumero := MOD(vDiferencia,9);
       
       vVueltas := vDiferencia;
       vContadorRegresivo := vUltimoNumero;
       vIndice := 1;
       
       WHILE vVueltas >= 1 LOOP
           IF LENGTH(vIndice) <= vDiferencia THEN 
               vCadenaTemp := vCadenaTemp || SUBSTR(vCadenaTexto,vIndice,1) || TO_CHAR(vContadorRegresivo);
               vIndice := vIndice + 1;
           ELSE
               vCadenaTemp := vCadenaTemp || TO_CHAR(vContadorRegresivo); 
           END IF;
           vContadorRegresivo := vContadorRegresivo - 1;
           vVueltas := vVueltas - 1;
           IF(vContadorRegresivo = 0) THEN
               vContadorRegresivo := 9;
           END IF;
       END LOOP;
       
       IF(LENGTH(vCadenaTexto) >= vDiferencia) THEN
           vCadenaTemp := vCadenaTemp || SUBSTR(vCadenaTexto,vDiferencia+1,LENGTH(vCadenaTexto) - vDiferencia);
       END IF;
       
       vInvertir := LENGTH(vCadenaTemp);
       WHILE vInvertir >= 1 LOOP
           vCadenaInv := vCadenaInv || SUBSTR(vCadenaTemp, vInvertir , 1); 
           vInvertir := vInvertir -1;
       END LOOP;
       
       vCadenaTemp := vDifCadena || vCadenaInv;
       vCadenaTemp := TRANSLATE(vCadenaTemp,'1234567890 ','ABCDEFGHKMN');
  ...
  vContadorRegresivo INT;
  vIndice INT;
  vIndiceIncremental INT;
  vInvertir NUMBER;
  vCadenaInv VARCHAR2(30);
  vBloqueInicial VARCHAR2(30);
  vCadenaReal VARCHAR2(30);
  
  BEGIN
       vCadenaTemp := TRANSLATE(vCadenaTexto,'ABCDEFGHKMN','1234567890 ');
       
       vDifCadena:= SUBSTR(vCadenaTemp,1,2);
       vCadenaTemp := SUBSTR(vCadenaTemp,3,LENGTH(vCadenaTexto)-2);
       ...
       vCadenaTemp := vCadenaInv;
       
       vDiferencia := TO_NUMBER(vDifCadena);
       
       vDifCadena := SUBSTR(vCadenaTemp,(vDiferencia*2)+1,LENGTH(vCadenaTemp)-(vDiferencia*2));
       
       vBloqueInicial := SUBSTR(vCadenaTemp,1,vDiferencia*2);
       vIndice := LENGTH(vBloqueInicial);
       vIndiceIncremental := 1;
       
       WHILE vIndiceIncremental <= vIndice LOOP
           IF MOD(vIndiceIncremental,2) <> 0 THEN
               vCadenaReal := vCadenaReal || SUBSTR(vBloqueInicial, vIndiceIncremental , 1); 
           END IF;
           
           vIndiceIncremental := vIndiceIncremental + 1;
       END LOOP;
       
       vCadenaTemp := vCadenaReal || vDifCadena;
       
       RETURN vCadenaTemp;
  END;
  
  --****************************************************************
  --** OBJETIVO             : COMPRUEBA SI LA CADENA ES PLENAMENTE NUMERICA
  --** NOMBRE               : F_IS_NUMBER
  --** AUTOR                : DESARROLLO5 - ALEJANDRO NUÑEZ
  --** FECHA CREACION       : 19/10/2015
  --****************************************************************
  ...
  newDigit INT;
  BEGIN
       newDigit := (CASE substr(pCadena, pPosicion, pCantidad) 
                              WHEN 'A' THEN 10
                              WHEN 'B' THEN 11
                              WHEN 'C' THEN 12
                              WHEN 'D' THEN 13
                              ...
                              WHEN 'O' THEN 24
                              WHEN 'P' THEN 25
                              ELSE substr(pCadena, pPosicion, pCantidad) 
                         END);
     RETURN newDigit;
     
  END F_CARACTER_EQUIVALENTE_LOCAL;
  ...
  IS
    nCodLocalEquiv VARCHAR(5);
  BEGIN
    BEGIN
      SELECT NVL(L.COD_LOCAL_EQUIVALENTE_NUM,0)
      into   nCodLocalEquiv
      FROM   PBL_LOCAL L
      WHERE  
      L.COD_GRUPO_CIA=cCodGrupoCia_in AND
      L.COD_LOCAL = cCod_Local_in AND 
      L.COD_CIA=cCodCia_in;
      
      IF nCodLocalEquiv = 0 THEN
      nCodLocalEquiv := cCod_Local_in;
        END IF;
      EXCEPTION
      WHEN OTHERS THEN
        nCodLocalEquiv := cCod_Local_in;
   ...
   RETURN nCodLocalEquiv;
   END;

  --------------------------------------------------------------------------
  --------- FUNCION QUE INDICA SI LOCAL ES TIPO DE VENTA M -----------------
  --------------------------------------------------------------------------
  ...
  FUNCTION F_IS_LOCAL_TIPO_VTA_M(cCodGrupoCia_in PTOVENTA.PBL_LOCAL.COD_GRUPO_CIA%TYPE,
    ...
    RETURN CHAR IS
    vRspta CHAR(1) := 'N';
    vCodTipLocalVta PBL_LOCAL.COD_TIP_LOCAL_VENTA%TYPE;
  BEGIN
    SELECT L.COD_TIP_LOCAL_VENTA--DECODE(L.COD_TIP_LOCAL_VENTA, PKG_CONSTANTES.LOCAL_TIPO_VTA_M, 'S', 'N')
    INTO vCodTipLocalVta
    FROM PTOVENTA.PBL_LOCAL L
    WHERE L.COD_GRUPO_CIA = cCodGrupoCia_in
    AND L.COD_LOCAL = cCodLocal_in;
    
    IF vCodTipLocalVta = PKG_CONSTANTES.LOCAL_TIPO_VTA_M OR
       vCodTipLocalVta = PKG_CONSTANTES.LOCAL_TIPO_VTA_M_BOTICA THEN
       vRspta := 'S';
    ELSE
      vRspta := 'N';
    END IF;
  ...
  EXCEPTION
    WHEN OTHERS THEN
      RAISE_APPLICATION_ERROR(-20900,'NO SE PUDO DETERMINAR TIPO DE LOCAL');
  END;                                 
/************************************************************************************/   
  ...
  FUNCTION F_GET_LOCAL_APLICA_PERCEPCION(cCodGrupoCia_in IN CHAR,
                                          cCodLocal_in    IN CHAR)
    RETURN CHAR IS
    vAgentePercepcion PBL_CIA.IND_AGENTE_PERCEPCION%TYPE;
  BEGIN
    SELECT NVL(C.IND_AGENTE_PERCEPCION,'N')
    INTO vAgentePercepcion
    FROM PBL_LOCAL L,
         PBL_CIA C
...
/************************************************************************************/
  ...
  FUNCTION F_GET_CENTRALIZA_CLIENTES(cCodGrupoCia_in IN CHAR,
    ...
    RETURN CHAR IS
    vAgentePercepcion PBL_CIA.IND_AGENTE_PERCEPCION%TYPE;
    vLocalTipoMayorista CHAR(1) := 'N';
    vResultado CHAR(1) := 'N';
  BEGIN
    vAgentePercepcion := FARMA_UTILITY.F_GET_LOCAL_APLICA_PERCEPCION(cCodGrupoCia_in, cCodLocal_in);
    vLocalTipoMayorista := FARMA_UTILITY.F_IS_LOCAL_TIPO_VTA_M(cCodGrupoCia_in, cCodLocal_in);
    IF vAgentePercepcion = 'S' OR vLocalTipoMayorista = 'S' THEN
      vResultado := 'S';
    ELSE
      vResultado := 'N';
    END IF; 
...
/************************************************************************************/
  ...
  FUNCTION F_GET_MSJ_APLICA_PERCEPCION(cCodGrupoCia_in IN CHAR,
    ...
    vPedConPercepcion CHAR(1);
    vCodCliente VTA_PEDIDO_VTA_CAB.COD_CLI_LOCAL%TYPE;
    vNumDocCliente VTA_PEDIDO_VTA_CAB.RUC_CLI_PED_VTA%TYPE;
    vPctPercepcion VARCHAR2(10);
    
  BEGIN
    vAplicaPercepcion := F_GET_LOCAL_APLICA_PERCEPCION(cCodGrupoCia_in,cCodLocal_in);
    IF vAplicaPercepcion = 'S' THEN
      SELECT CASE 
               WHEN NVL(CAB.VAL_PERCEPCION_PED_VTA,0) != 0 OR NVL(CAB.VAL_REDONDEO_PERCEPCION,0) != 0 THEN
                 'S'
               ELSE 'N'
             END,
             NVL(CAB.COD_CLI_LOCAL,NULL),
             NVL(CAB.RUC_CLI_PED_VTA,NULL),
             TRIM(TO_CHAR(MAX(NVL(DET.VAL_PCT_PERCEPCION,0)),'90.00')||'%')
      INTO vPedConPercepcion,
           vCodCliente,
           vNumDocCliente,
           vPctPercepcion
      ...
      GROUP BY CAB.VAL_PERCEPCION_PED_VTA, CAB.VAL_REDONDEO_PERCEPCION, CAB.COD_CLI_LOCAL, CAB.RUC_CLI_PED_VTA;
      ...
      IF vCodCliente IS NOT NULL THEN
        ...
        BEGIN
          SELECT 
            CASE
              WHEN NVL(P.IND_AGENTE_RETENCION,'N') = 'S' THEN
                'AGENTE DE RETENCION (APLICA '||vPctPercepcion||')'
              WHEN NVL(P.IND_AGENTE_PERCEPCION,'N') = 'S' THEN
                'AGENTE DE PERCEPCION (APLICA '||vPctPercepcion||')'
              ELSE
                'CLIENTE ACTIVO (APLICA '||vPctPercepcion||')'
            END
          INTO vMensaje
          FROM PBL_CLIENTE P
          WHERE P.DNI_CLI = vNumDocCliente
        ...
        END;
      ELSE
        IF vPedConPercepcion = 'N' THEN
          vMensaje := NULL;
        ELSE
          vMensaje := 'PEDIDO APLICA PERCEPCION ('||vPctPercepcion||')';
        END IF;
      END IF;
    ELSE
      vMensaje := NULL;
...
/*    SELECT DECODE(COUNT(1), 0, 'N', 'S')
    ...
    AND PROD.COD_GRUPO_REP_EDMUNDO = '001';*/
    BEGIN 
      SELECT DECODE(COUNT(1), 0, 'N', 'S') 
      INTO vRegistra
      FROM REL_SOL_CMP_GRUPO_REP_EDMUNDO A
      WHERE (A.COD_GRUPO_CIA, A.COD_LOCAL, A.COD_GRUPO_REP_EDMUNDO) IN
             (SELECT DET.COD_GRUPO_CIA, DET.COD_LOCAL, PROD.COD_GRUPO_REP_EDMUNDO
