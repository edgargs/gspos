...
public class DlgListaProductos extends JDialog {
        ...
        try
        {
          ...
          muestraProductosComplementarios();*/
                ...
                {   //add jcallo 15/12/2008 campanias acumuladas. 
                    ...
                    {   //toda la logica para asociar un cliente hacia campañas nuevas
                        //DUBILLUZ - 29.04.2010
          ...
          else
          {
            ...
            if(VariablesVentas.vEsPedidoConvenio)generarPedidoConvenio();
                ...
                {
                    if (VariablesVentas.vEsPedidoConvenio||(VariablesConvenioBTLMF.vCodConvenio != null && VariablesConvenioBTLMF.vCodConvenio.trim().length()>1)) {
    ...
    private void muestraIngresoCantidad() {
        ...
        if (flagContinua) {
            ...
            if (isProdInPack() && 
                VariablesPtoVenta.vIndTico.equals("S")  //ASOSA - 24/10/2014
                ) {   
                
                if (JConfirmDialog.rptaConfirmDialogDefaultNo(this, "El producto seleccionado puede comprarse en pack, \n¿Desea comprarlo en pack?")){
    ...
    private void verificaCheckJTable() {
        ...
        if (valor.booleanValue()) {
            ...
            if(!"A".equalsIgnoreCase(estadoProd)){
                FarmaUtility.showMessage(this, 
                                         "El Producto se encuentra inactivo en local.", 
                                         txtProducto);
                return ;
            }
...
*/
            ...
            if ( (VariablesVentas.vIndProdVirtual.equalsIgnoreCase(FarmaConstants.INDICADOR_S) || 
                ...
                if (VariablesVentas.vEsPedidoConvenio||(VariablesConvenioBTLMF.vCodConvenio != null && VariablesConvenioBTLMF.vCodConvenio.trim().length()>1)) {
                    ...
                    FarmaUtility.showMessage(this, 
                                             "No puede realizar recargas virtuales en " + 
                                             "pedido por convenio.", txtProducto);
                    return;
                }          
                ...
                if (VariablesVentas.vEsPedidoDelivery) {
                    ...
                    FarmaUtility.showMessage(this, 
                                             "No puede realizar recargas virtuales en " + 
                                             "pedido por delivery.", txtProducto);
                    return;
                }          
    ...
    private boolean validaStockDisponible() {
        if (FarmaUtility.isInteger(stkProd) && Integer.parseInt(stkProd) > 0)
            ...
            if(FarmaUtility.isInteger(stkProd) && Integer.parseInt(stkProd) == 0&& (VariablesVentas.vEsPedidoDelivery && UtilityVentas.getIndVtaNegativa()) )
              return true;
          else
            return false;
        }
    ...
    private void generarPedidoDelivery() {
        ...
        log.debug("Indicador Pedido Delivery-->" + 
    ...
    private void evaluaTipoProdVirtual() {
        ...
        if (tipoProdVirtual.equalsIgnoreCase(ConstantsVentas.TIPO_PROD_VIRTUAL_RECARGA)) {
            ...
            if (cantidad_ingresada != 0) {
                ...
                String 
                valorTarj = FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber(VariablesVentas.vVal_Prec_Vta), 2);
                FarmaUtility.showMessage(this, 
