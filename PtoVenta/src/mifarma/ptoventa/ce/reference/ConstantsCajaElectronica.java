...
public class ConstantsCajaElectronica {
    ...
    { new FarmaColumnData("Id.", 70, JLabel.CENTER), new FarmaColumnData("Desc. Cuadratura", 280, JLabel.LEFT),
      new FarmaColumnData("Total S/.", 76, JLabel.RIGHT), new FarmaColumnData("Tipo", 0, JLabel.CENTER) };

    public static final Object[] defaultValuesListaCuadraturas = { " ", " ", " ", " " };

    //DlgDatosCuadratura
    public static final FarmaColumnData[] columnsListaCuadraturaDat =
    { new FarmaColumnData("Desc.", 200, JLabel.LEFT), new FarmaColumnData("Dato", 170, JLabel.RIGHT),
      new FarmaColumnData("Codigo", 0, JLabel.CENTER), new FarmaColumnData("TI_DATO", 0, JLabel.CENTER),
    ...
    public static final Boolean[] editableListaCuadraturaDat =
    { new Boolean(false), new Boolean(true), new Boolean(false), new Boolean(false), new Boolean(false),
      new Boolean(false) };
    ...
    public static final Boolean[] editableListaEfectivoRendidoDat =
    { new Boolean(false), new Boolean(true), new Boolean(false), new Boolean(false), new Boolean(false),
      new Boolean(false) };
    /*------END ERIOS BLOCK------*/
    ...
    { new FarmaColumnData("Cod.", 50, JLabel.CENTER), new FarmaColumnData("Desc. Cuadratura", 205, JLabel.LEFT),
    ...
    { new FarmaColumnData("Forma Pago", 135, JLabel.LEFT), new FarmaColumnData("Moneda", 70, JLabel.LEFT),
      new FarmaColumnData("Monto", 65, JLabel.RIGHT), new FarmaColumnData("Total(S/.)", 70, JLabel.RIGHT),
    ...
    { new FarmaColumnData("Día de Cierre", 90, JLabel.CENTER), new FarmaColumnData("Usuario", 195, JLabel.LEFT),
      new FarmaColumnData("Fecha V°B°", 110, JLabel.LEFT), new FarmaColumnData("Fecha V°B° Cont.", 110, JLabel.CENTER),
      //ind VB Contable
        new FarmaColumnData("Fecha Proceso", 110, JLabel.LEFT), new FarmaColumnData("Fecha Archivo", 110, JLabel.LEFT),
    ...
    { new FarmaColumnData("Cod.", 50, JLabel.LEFT), new FarmaColumnData("Descripcion", 205, JLabel.LEFT),
    ...
    { new FarmaColumnData("Pedido", 90, JLabel.LEFT), new FarmaColumnData("Comp.", 85, JLabel.LEFT),
      ...
      new FarmaColumnData("Total(S/.)", 80, JLabel.RIGHT), new FarmaColumnData("Proveedor", 80, JLabel.LEFT),
    ...
    new FarmaColumnData("",0,JLabel.LEFT)*/
        ...
        // KMONCADA 23.09.2015 INDICADOR SE ES CP ELECTRONICO
    ...
    { new FarmaColumnData("Codigo", 50, JLabel.LEFT), new FarmaColumnData("Forma de Pago", 140, JLabel.LEFT),
      new FarmaColumnData("Cant", 40, JLabel.LEFT), new FarmaColumnData("Moneda", 75, JLabel.LEFT),
      new FarmaColumnData("Monto", 75, JLabel.RIGHT), new FarmaColumnData("Total", 75, JLabel.RIGHT),
      new FarmaColumnData("Lote", 80, JLabel.CENTER), new

        FarmaColumnData("Ind.Sobre", 60, JLabel.CENTER), new

        FarmaColumnData("Sobre", 100, JLabel.CENTER), new FarmaColumnData("", 0, JLabel.LEFT), //sec
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Tipo", 68, JLabel.LEFT),
      new FarmaColumnData("Comprobante", 80, JLabel.LEFT), new FarmaColumnData("Fecha", 120, JLabel.LEFT),
      new FarmaColumnData("Importe", 60, JLabel.RIGHT), new FarmaColumnData("Importe Total", 85, JLabel.RIGHT),
      new FarmaColumnData("Vuelto", 80, JLabel.RIGHT), new FarmaColumnData("", 0, JLabel.LEFT), //TIP
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Tipo Dinero", 100, JLabel.LEFT),
      new FarmaColumnData("Tipo Moneda", 100, JLabel.LEFT), new FarmaColumnData("Importe", 85, JLabel.RIGHT),
      new FarmaColumnData("Serie", 80, JLabel.LEFT), new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Codigo", 80, JLabel.LEFT),
      new FarmaColumnData("Descripcion", 100, JLabel.RIGHT), new FarmaColumnData("Importe", 80, JLabel.LEFT),
      new FarmaColumnData("Total", 80, JLabel.LEFT), new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //sec
        new FarmaColumnData("", 0, JLabel.LEFT), //vb
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Tipo", 80, JLabel.LEFT),
      new FarmaColumnData("Serie", 50, JLabel.RIGHT), new FarmaColumnData("Comprobante", 80, JLabel.LEFT),
      new FarmaColumnData("Importe", 80, JLabel.LEFT), new FarmaColumnData("Importe Total", 85, JLabel.LEFT),
      new FarmaColumnData("Vuelto", 80, JLabel.LEFT), new FarmaColumnData("", 0, JLabel.RIGHT), //tip
    ...
    { new FarmaColumnData("Id.", 70, JLabel.CENTER), new FarmaColumnData("Desc. Efectivo Rendido", 300, JLabel.LEFT),
      new FarmaColumnData("Total S/.", 76, JLabel.RIGHT), new FarmaColumnData("", 0, JLabel.LEFT) };
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Tipo", 85, JLabel.CENTER),
      new FarmaColumnData("Comprobante", 100, JLabel.LEFT), new FarmaColumnData("Total S/.", 80, JLabel.RIGHT),
      new FarmaColumnData("N. Guia", 80, JLabel.LEFT), new FarmaColumnData("Fecha", 90, JLabel.LEFT),
      new FarmaColumnData("Empresa", 90, JLabel.CENTER), new FarmaColumnData("", 0, JLabel.LEFT), //TipoComprobante
        } ;
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Forma Pago", 125, JLabel.LEFT),
      new FarmaColumnData("T.Moneda", 60, JLabel.LEFT), new FarmaColumnData("Importe", 80, JLabel.RIGHT),
      new FarmaColumnData("I. Total S/.", 85, JLabel.RIGHT), new FarmaColumnData("E.Financiera", 110, JLabel.CENTER),
      new FarmaColumnData("F.Operacion", 120, JLabel.LEFT), new FarmaColumnData("N.Operacion", 100, JLabel.LEFT),
      new FarmaColumnData("N.Cuenta", 120, JLabel.LEFT), new FarmaColumnData("Agencia", 90, JLabel.LEFT),
      new FarmaColumnData("Glosa", 280, JLabel.LEFT), new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.LEFT), //sec
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Servicio", 90, JLabel.LEFT),
      new FarmaColumnData("Proveedor", 120, JLabel.LEFT), new FarmaColumnData("Documento", 80, JLabel.LEFT),
      new FarmaColumnData("T.Moneda", 80, JLabel.LEFT), new FarmaColumnData("Importe", 80, JLabel.RIGHT),
      new FarmaColumnData("I. Total S/.", 85, JLabel.RIGHT), new FarmaColumnData("F.Documento", 90, JLabel.LEFT),
      new FarmaColumnData("F.Operacion", 120, JLabel.LEFT), new FarmaColumnData("F.Vencimiento", 90, JLabel.LEFT),
      new FarmaColumnData("Titular", 90, JLabel.LEFT), new FarmaColumnData("Glosa", 150, JLabel.LEFT),
      new FarmaColumnData("", 0, JLabel.LEFT), //sec
        new FarmaColumnData("", 0, JLabel.LEFT), //feccierre
        } ;
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("T.Moneda", 80, JLabel.LEFT),
      new FarmaColumnData("Importe", 80, JLabel.RIGHT), new FarmaColumnData("I. Total S/.", 85, JLabel.RIGHT),
      new FarmaColumnData("Cod.Autorizacion", 150, JLabel.LEFT), new FarmaColumnData("Glosa", 150, JLabel.LEFT),
      new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Moneda", 80, JLabel.LEFT),
      new FarmaColumnData("Importe", 80, JLabel.RIGHT), new FarmaColumnData("I. Total S/.", 85, JLabel.RIGHT),
      new FarmaColumnData("Trabajador Local", 180, JLabel.LEFT),
      new FarmaColumnData("C.Autorizacion", 120, JLabel.LEFT), new FarmaColumnData("Glosa", 150, JLabel.LEFT),
      new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Documento", 80, JLabel.LEFT),
      new FarmaColumnData("Tipo", 80, JLabel.LEFT), new FarmaColumnData("Fecha", 90, JLabel.LEFT),
      new FarmaColumnData("Total", 80, JLabel.LEFT), new FarmaColumnData("I. Total S/.", 85, JLabel.RIGHT),
      new FarmaColumnData("Glosa", 150, JLabel.LEFT), new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Moneda", 80, JLabel.LEFT),
      new FarmaColumnData("Importe", 80, JLabel.RIGHT), new FarmaColumnData("I. Total S/.", 85, JLabel.RIGHT),
      new FarmaColumnData("F.Operacion", 120, JLabel.LEFT), new FarmaColumnData("Trabajador", 180, JLabel.LEFT),
      new FarmaColumnData("C.Autorizacion", 120, JLabel.LEFT), new FarmaColumnData("Glosa", 150, JLabel.LEFT),
      new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Forma Pago", 150, JLabel.LEFT),
      new FarmaColumnData("Moneda", 80, JLabel.LEFT), new FarmaColumnData("Importe", 80, JLabel.RIGHT),
      new FarmaColumnData("I. Total S/.", 85, JLabel.RIGHT), new FarmaColumnData("Glosa.", 150, JLabel.LEFT),
      new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("T. Dinero", 80, JLabel.LEFT),
      new FarmaColumnData("T. Moneda", 80, JLabel.LEFT), new FarmaColumnData("Importe", 80, JLabel.RIGHT),
      new FarmaColumnData("I. Total S/.", 85, JLabel.RIGHT), new FarmaColumnData("Serie", 130, JLabel.LEFT),
      new FarmaColumnData("I. Parcial", 82, JLabel.RIGHT), new FarmaColumnData("Trabajador Local", 150, JLabel.LEFT),
      new FarmaColumnData("Glosa.", 150, JLabel.LEFT), new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.LEFT), //sec
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("T.Documento", 85, JLabel.CENTER),
      new FarmaColumnData("Documento", 130, JLabel.LEFT), new FarmaColumnData("T. Moneda", 80, JLabel.LEFT),
      new FarmaColumnData("Importe.", 75, JLabel.RIGHT), new FarmaColumnData("I. Total S/.", 85, JLabel.RIGHT),
      new FarmaColumnData("F.Documento", 90, JLabel.LEFT), new FarmaColumnData("F.Operacion", 120, JLabel.LEFT),
      new FarmaColumnData("Ruc", 90, JLabel.LEFT), new FarmaColumnData("Razon Social", 120, JLabel.LEFT),
      new FarmaColumnData("Glosa.", 150, JLabel.LEFT), new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.LEFT), //sec
        new FarmaColumnData("", 0, JLabel.LEFT), //feccierre
        } ;
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("T. Moneda", 80, JLabel.LEFT),
      new FarmaColumnData("Importe", 80, JLabel.RIGHT), new FarmaColumnData("I. Total S/.", 85, JLabel.RIGHT),
      new FarmaColumnData("Local", 130, JLabel.CENTER), new FarmaColumnData("C.Autorizacion", 120, JLabel.LEFT),
      new FarmaColumnData("Glosa.", 150, JLabel.LEFT), new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("T.Comprobante", 80, JLabel.LEFT),
      new FarmaColumnData("N. Pedido", 120, JLabel.LEFT), new FarmaColumnData("T. Moneda", 80, JLabel.LEFT),
      new FarmaColumnData("Importe", 80, JLabel.RIGHT), new FarmaColumnData("I. Total S/.", 85, JLabel.RIGHT),
      new FarmaColumnData("I. Parcial", 82, JLabel.RIGHT), new FarmaColumnData("Trabajador Local", 150, JLabel.LEFT),
      new FarmaColumnData("Glosa.", 150, JLabel.LEFT), new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
    ...
    { new FarmaColumnData("Usuario", 70, JLabel.CENTER), new FarmaColumnData("Nombre", 90, JLabel.CENTER),
      new FarmaColumnData("Caja", 50, JLabel.CENTER), new FarmaColumnData("Turno", 50, JLabel.CENTER),
      new FarmaColumnData("Tipo Dinero", 100, JLabel.LEFT), new FarmaColumnData("Tipo Moneda", 100, JLabel.LEFT),
      new FarmaColumnData("Importe", 85, JLabel.RIGHT), new FarmaColumnData("Importe Total S/.", 100, JLabel.RIGHT),
    ...
    { new FarmaColumnData("Usuario", 70, JLabel.CENTER), new FarmaColumnData("Nombre", 90, JLabel.CENTER),
      new FarmaColumnData("Caja", 50, JLabel.CENTER), new FarmaColumnData("Turno", 50, JLabel.CENTER),
      new FarmaColumnData("Forma Pago", 125, JLabel.LEFT), new FarmaColumnData("Importe", 80, JLabel.RIGHT),
    ...
    { new FarmaColumnData("Usuario", 70, JLabel.CENTER), new FarmaColumnData("Nombre", 90, JLabel.CENTER),
      new FarmaColumnData("Caja", 50, JLabel.CENTER), new FarmaColumnData("Turno", 50, JLabel.CENTER),
      new FarmaColumnData("Importe", 80, JLabel.RIGHT), new FarmaColumnData("Importe Total S/.", 100, JLabel.RIGHT), };
    ...
    { new FarmaColumnData("Usuario", 70, JLabel.CENTER), new FarmaColumnData("Nombre", 90, JLabel.CENTER),
      new FarmaColumnData("Caja", 50, JLabel.CENTER), new FarmaColumnData("Turno", 50, JLabel.CENTER),
      new FarmaColumnData("Tipo", 80, JLabel.LEFT), new FarmaColumnData("Serie", 50, JLabel.CENTER),
      new FarmaColumnData("Comprobante", 80, JLabel.LEFT), new FarmaColumnData("Importe", 80, JLabel.RIGHT),
      new FarmaColumnData("Importe Total S/.", 100, JLabel.RIGHT), new FarmaColumnData("Vuelto", 80, JLabel.RIGHT), };
    ...
    { new FarmaColumnData("Usuario", 50, JLabel.CENTER), new FarmaColumnData("Nombre", 90, JLabel.CENTER),
      new FarmaColumnData("Caja", 50, JLabel.CENTER), new FarmaColumnData("Turno", 50, JLabel.CENTER),
      new FarmaColumnData("Voucher", 75, JLabel.RIGHT), new FarmaColumnData("Importe", 80, JLabel.RIGHT),
      new FarmaColumnData("Importe Total S/.", 100, JLabel.RIGHT), };
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Tipo", 80, JLabel.LEFT),
      new FarmaColumnData("Comprobante", 120, JLabel.LEFT), new FarmaColumnData("T. Moneda", 80, JLabel.LEFT),
      new FarmaColumnData("Importe", 80, JLabel.RIGHT), new FarmaColumnData("I. Total S/.", 85, JLabel.RIGHT),
      new FarmaColumnData("I.Perdido S/.", 85, JLabel.RIGHT), new FarmaColumnData("Proveedor", 120, JLabel.LEFT),
      new FarmaColumnData("Glosa", 150, JLabel.LEFT), new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.LEFT), //sec
    ...
    public static final String CAMPO_TRABAJADOR_LOCAL = "028";
    ...
    { new FarmaColumnData("", 3, JLabel.CENTER), new FarmaColumnData("Descripcion", 250, JLabel.LEFT),
    ...
    { new FarmaColumnData("Nro.Pedido", 85, JLabel.CENTER), new FarmaColumnData("T", 20, JLabel.CENTER),
      new FarmaColumnData("No Comprobante", 100, JLabel.CENTER), new FarmaColumnData("Fecha", 120, JLabel.CENTER),
      new FarmaColumnData("Cliente", 180, JLabel.LEFT), new FarmaColumnData("Estado", 85, JLabel.LEFT),
    ...
    { new FarmaColumnData("Código", 60, JLabel.CENTER), new FarmaColumnData("Descripción", 180, JLabel.LEFT),
      new FarmaColumnData("Importe", 0, JLabel.RIGHT), new FarmaColumnData("Moneda", 0, JLabel.LEFT),
      new FarmaColumnData("Vuelto", 0, JLabel.RIGHT), new FarmaColumnData("Importe Total", 0, JLabel.RIGHT),
    ...
    { new FarmaColumnData("Código", 50, JLabel.CENTER), new FarmaColumnData("Descripción", 180, JLabel.LEFT),
      new FarmaColumnData("Monto", 80, JLabel.RIGHT), new FarmaColumnData("Total", 80, JLabel.LEFT) };
    ...
    public static final Object[] defaultValuesEliminacionCotizacionCompetencia_Turno =
    { " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " " }; //ASOSA, 12.08.2010
    ...
    public static final String OCURRIO_ERROR_CARGAR =
        "Ocurrió un error al cargar información. Consulte con el administrador";
    ...
    { new FarmaColumnData("Fec.Dia Vta", 70, JLabel.CENTER), new FarmaColumnData("Usuario", 70, JLabel.CENTER),
      new FarmaColumnData("Nombre", 120, JLabel.CENTER), new FarmaColumnData("Caja", 50, JLabel.CENTER),
      new FarmaColumnData("Turno", 50, JLabel.CENTER), new FarmaColumnData("Tipo", 80, JLabel.LEFT),
      new FarmaColumnData("Serie", 50, JLabel.CENTER), new FarmaColumnData("Comprobante", 80, JLabel.LEFT),
      new FarmaColumnData("Importe", 80, JLabel.RIGHT), new FarmaColumnData("Importe Total S/.", 100, JLabel.RIGHT) };
    ...
    /**
     *CHUANES -17-02-2015
     * CONSTANTES DE DOCUMENTOS ANULADOS CIERRE DE TURNO
     * */
    public static final FarmaColumnData[] columnsListaAnulados =
    { new FarmaColumnData("Nota de Credito", 120, JLabel.LEFT),
      new FarmaColumnData("Tipo Documento", 100, JLabel.LEFT),
      new FarmaColumnData("Num. Documento",120, JLabel.LEFT),
      new FarmaColumnData("Quimico",120, JLabel.LEFT),
      new FarmaColumnData("Importe(S/.)",80, JLabel.RIGHT)
      };
    ...
    /**
     *CHUANES -17-02-2015
     * CONSTANTES DE DOCUMENTOS ANULADOS CIERRE DE DIA
     * */
    public static final FarmaColumnData[] columnsListaAnulCierreDia =
    {  new FarmaColumnData("N° Caja", 60, JLabel.CENTER),
     new FarmaColumnData("Cajero", 200, JLabel.LEFT),
      new FarmaColumnData("Tipo ", 100, JLabel.CENTER),
      new FarmaColumnData("Cantidad", 80, JLabel.CENTER),
      new FarmaColumnData("Importe(S/.) ",100, JLabel.CENTER)
      
      };

    public static final FarmaColumnData[] columnsListaComprobantesDesfasados =
    { new FarmaColumnData("Tipo Comp.", 70, JLabel.CENTER), 
      new FarmaColumnData("Serie.", 90, JLabel.CENTER),
    ...
    public static final Object[] defaultValuesListaAnulCierreDia =
    { " ", " ", " ", " ", " "," " };
