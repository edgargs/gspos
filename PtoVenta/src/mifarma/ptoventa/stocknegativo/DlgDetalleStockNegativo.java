package mifarma.ptoventa.stocknegativo;
...
import mifarma.ptoventa.inventario.DlgMovimientoKardex;
import mifarma.ptoventa.inventario.reference.VariablesInventario;
import mifarma.ptoventa.reference.UtilityPtoVenta;
import mifarma.ptoventa.stocknegativo.reference.ConstantsStockNegativo;
import mifarma.ptoventa.stocknegativo.reference.FacadeStockNegativo;
...
public class DlgDetalleStockNegativo extends JDialog {
    ...
    private void initialize() {
        ftm_detStockNeg =
                new FarmaTableModel(ConstantsStockNegativo.columnsListaDetStockNeg, ConstantsStockNegativo.defaultListaDetStockNeg,
                                    0);
        FarmaUtility.initSimpleList(tbl_detStockNeg, ftm_detStockNeg, ConstantsStockNegativo.columnsListaDetStockNeg);
    ...
    private void regularizar() {
        String codProdAnt = FarmaUtility.getValueFieldJTable(tbl_detStockNeg, tbl_detStockNeg.getSelectedRow(), 0);
        String cant = FarmaUtility.getValueFieldJTable(tbl_detStockNeg, tbl_detStockNeg.getSelectedRow(), 2);
        ...
        if (FarmaVariables.vAceptar) {
            ...
            if ("0".equalsIgnoreCase(res)) {
                ...
                FarmaUtility.showMessage(this,
                                         "ERROR: No se pudo regularizar correctamente la solicitud. Intentelo nuevamente",
                                         this);
            }
        }
    }

    private void verificarRegularizar() { //Si existe un producto cruzado, desabilitar el boton F11
        String codProdReg = FarmaUtility.getValueFieldJTable(tbl_detStockNeg, tbl_detStockNeg.getSelectedRow(), 5);
