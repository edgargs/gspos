...
/**
 * Formatos para comprobantes de BTL
 * @author ERIOS
 * @since 20.01.2016
 */
public class FormatoImpresionC implements StrategyImpresion{

    private static final Logger log = LoggerFactory.getLogger(FormatoImpresionC.class);

    public FormatoImpresionC() {
        super();
    }
...
*/
            if (VariablesConvenioBTLMF.vFlgImprimeImportes.equals("1")) {
                ...
                vPrint.add(vMargen + FarmaPRNUtility.llenarBlancos(100) + "Sub Total   S/. " +
                           FarmaPRNUtility.alinearDerecha(FarmaUtility.formatNumber(SumSubTotal), 15));
                vPrint.add(vMargen + FarmaPRNUtility.llenarBlancos(100) + "Coaseguro   S/. " +
                ...
                vPrint.add(vMargen + FarmaPRNUtility.llenarBlancos(100) + "     IGV    S/. " +
                           FarmaPRNUtility.alinearDerecha(pValIgvComPago, 15));
                vPrint.add(vMargen + FarmaPRNUtility.llenarBlancos(116) +
                           FarmaPRNUtility.alinearDerecha("---------------", 15));
                vPrint.add(vMargen + FarmaPRNUtility.llenarBlancos(100) + "   TOTAL    S/. " +
            ...
            if (vEsPedidoConvenio) {
                ...
                if (VariablesVentas.vTipoPedido.equalsIgnoreCase(ConstantsVentas.TIPO_PEDIDO_INSTITUCIONAL)) { //RHERRERA 26-06-2014
                    ...
                    if (pCodTipoConvenio.equals("1") || pCodTipoConvenio.equals("3")) {
                        ...
                        if (VariablesConvenioBTLMF.vFlgImprimeImportes.equals("1")) {
                            vPorcCopago =
                                    "(" + FarmaUtility.formatNumber(porcCopagoBenef, "") + "%)" + " - " + "S/." + pValCopagoCompPago;
                        }
                        lineaReferencia =
                                "  #REF: " + vRefTipComp + " " + FarmaPRNUtility.alinearIzquierda(pNumCompCoPago +
                                                                                                  vPorcCopago, 50);
    ...
    public ArrayList<String> formatoBoleta(JDialog pJDialog, String pFechaBD, ArrayList pDetalleComprobante,
        ...
        if (vEsPedidoConvenio) {
            return formatoBoletaConvenio(pJDialog, pDetalleComprobante, pValTotalNeto, pNumComprobante, pValIgvComPago,
                                  pValCopagoCompPago, pValIgvCompCoPago, pNumCompRef, pRuta, bol, pImprDatAdic,
                                  pTipoClienteConvenio, pCodTipoConvenio, pFechaBD, pValRedondeoCompPago, margen);
        }else{
            return formatoBoletaNormal(pJDialog, pFechaBD, pDetalleComprobante, pValTotalNeto, pValRedondeo,
                                       pNumComprobante, pNomImpreso, pDirImpreso, pValTotalAhorro, pRuta, bol, margen);
        }
    }
    
    private ArrayList<String> formatoBoletaNormal(JDialog pJDialog, String pFechaBD, ArrayList pDetalleComprobante,
                                         String pValTotalNeto, String pValRedondeo, String pNumComprobante,
                                         String pNomImpreso, String pDirImpreso, String pValTotalAhorro, String pRuta,
                                         boolean bol, int margen){
        String indProdVirtual = "";
        VariablesCaja.vIndPedidoConProdVirtualImpresion = false;
        ...
        ArrayList<String> vPrint = new ArrayList<>();
            ...
            try {
                ...
                vPrint.add(vMargen + FarmaPRNUtility.llenarBlancos(40) + "   No. " + pNumComprobante.substring(0, 3) +
                                 "-" + pNumComprobante.substring(3, 10));
                ...
                if (UtilityVentas.getIndImprimeCorrelativo()) {
                    ...
                    vPrint.add(vMargen + FarmaPRNUtility.llenarBlancos(40) + pFechaBD);
                }

                vPrint.add(vMargen + FarmaPRNUtility.llenarBlancos(10) +
                                 FarmaPRNUtility.alinearIzquierda(pNomImpreso.trim(), 55));
                ...
                if (auxTotalDcto > 0 && isImprimeAhorroAntiguo) {
                    ...
                    vPrint.add(vMargen + "UD. HA AHORRADO S/. " + pValTotalAhorro + " EN ESTA COMPRA" + msgCumImpresos);
                ...
                vPrint.add(vMargen + FarmaPRNUtility.llenarBlancos(5) + VariablesPtoVenta.vDireccionCortaMatriz);
    ...
    private ArrayList<String> formatoBoletaConvenio(JDialog pJDialog, ArrayList pDetalleComprobante, String pValTotalNeto,
                                          String pNumComprobante, String pValIgvComPago, String pValCopagoCompPago,
                                          String pValIgvComCoPago, String pNumCompCoPago, String pRuta, boolean bol,
                                          String pImprDatAdic, String pTipoClienteConvenio, String pCodTipoConvenio,
                                                    String pFechaBD, String pValRedondeoComPago, int margen){
        String pNomImpreso = "";
        String pDirImpreso = "";
        ...
        ArrayList<String> vPrint = new ArrayList<String>();
            ...
            try {
                ...
                vPrint.add(vMargen + "      " + FarmaPRNUtility.alinearIzquierda(" ", 65) + " " + "    Sub Total   S/. " +
                                 FarmaPRNUtility.alinearDerecha(FarmaUtility.formatNumber(SumSubTotal), 10));

                if (pCodTipoConvenio.equals("1")) {
                    vPrint.add(vMargen + "    " + FarmaPRNUtility.alinearIzquierda(" ", 65) + " " + "  CoPago(" +
                                     FarmaUtility.formatNumber(porcCopago, 0) + "%)    S/. " +
                                     FarmaPRNUtility.alinearDerecha(pValCopagoCompPago, 10));
                ...
                vPrint.add(vMargen + "     " + FarmaPRNUtility.alinearIzquierda(" ", 65) + " " + "          IGV    S/. " +
                                 FarmaPRNUtility.alinearDerecha(FarmaUtility.formatNumber(igv), 10));
                vPrint.add(vMargen + "     " + FarmaPRNUtility.alinearIzquierda(" ", 65) + " " +
                                 "          ---------------------");
                ...
                vPrint.add(vMargen + "  Convenio: " +
                                 FarmaPRNUtility.alinearIzquierda(VariablesConvenioBTLMF.vNomConvenio.toUpperCase(),
                                                                  65));
                vPrint.add(vMargen + "  Beneficiario: " +
                                 FarmaPRNUtility.alinearIzquierda(VariablesConvenioBTLMF.vNomCliente, 65));

                if (pCodTipoConvenio.equals("1")) {
                    vPrint.add(vMargen + "  Documento de Referencia Nro " + pNumCompCoPago + ": " + " ");
                    vPrint.add(vMargen + "  Doc refe de la Empresa Monto:S/." + pValCopagoCompPago + " y (" +
    ...
    public static void main(String[] args) {
        ...
        FormatoImpresionC formatoImpresion = new FormatoImpresionC();
        ...
        ArrayList<String> vPrint =
            formatoImpresion.formatoGuia(null, pDetalleComprobante, "100.00", "5061233456", "18.00", "0.00", "XXX",
     ...
     * @param pRazonSocial
     * @param pDireccionDestino
     * @param pNumeroRUC
     * @param vPrctBeneficiario
     * @param vPrctEmpresa
     * @param margen
     * @param pValTotalBruto
     * @param pValTotalAfecto
     * @param pValTotalDescuento
     * @param numDocumento
     * @return
     */
    public ArrayList<String> formatoNotaCredito(JDialog pJDialog, ArrayList pDetalleComprobante, String pValTotalNeto,
        ...
        try {
            ...
            //FECHA
            vPrint.add(vMargen + FarmaPRNUtility.llenarBlancos(15) + dia + "               " + mesLetra + "              " + ano +
                       "     " + hora);
            ...
            for (int i = 0; i < pDetalleComprobante.size(); i++) {
                ...
                lineaDetalle = FarmaPRNUtility.llenarBlancos(3) +
                            FarmaPRNUtility.alinearIzquierda(cantVenta,6) + FarmaPRNUtility.llenarBlancos(5) +
                            FarmaPRNUtility.alinearIzquierda(descProd, 20) + "   " +
                            ...
                            FarmaPRNUtility.alinearDerecha(precioUnit, 10) + FarmaPRNUtility.llenarBlancos(8) +
                            FarmaPRNUtility.llenarBlancos(14) +
            ...
            /*******IMPRIME IGV Y MONTO NETO*******/
            vPrint.add(vMargen + FarmaPRNUtility.llenarBlancos(110) + "S/. " +
                       FarmaPRNUtility.alinearDerecha(FarmaUtility.formatNumber(neto), 15));
            vPrint.add(vMargen + " ");
            
            vPrint.add(vMargen + FarmaPRNUtility.llenarBlancos(95) + 
                       FarmaPRNUtility.alinearIzquierda("%  "+pPorcIgv, 10) +
                        FarmaPRNUtility.llenarBlancos(5) + "S/. " +
                        FarmaPRNUtility.alinearDerecha(FarmaUtility.formatNumber(SumMontoIGV), 15));
            vPrint.add(vMargen + " ");
            
            vPrint.add(vMargen + FarmaPRNUtility.llenarBlancos(110) + "S/. " +
                       FarmaPRNUtility.alinearDerecha(FarmaUtility.formatNumber(pValTotalNetoRedondeo), 15));

            vPrint.add(vMargen + FarmaPRNUtility.llenarBlancos(90) + FarmaVariables.vVersion);
