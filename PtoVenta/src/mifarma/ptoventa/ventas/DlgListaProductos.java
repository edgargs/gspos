...
public class DlgListaProductos extends JDialog {
    ...
    private void txtProducto_keyPressed(KeyEvent e) {
        ...
        if(isNumero(e.getKeyChar()) || e.getKeyCode() == KeyEvent.VK_ENTER ){
            if (txtProducto.getText().trim().equalsIgnoreCase(ConstantsRecaudacion.PALABRA_CLAVE_TELETON) &&
                UtilityInventario.obtenerParametroString(ConstantsRecaudacion.ID_IND_TELETON).trim().equals("S")) {
                ...
                if(codMarca.equals("")) {
                    ...
                    if (codMarca.equalsIgnoreCase(ConstantsVentas.COD_MARCA_MF)) {
