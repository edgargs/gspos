...
CREATE OR REPLACE PACKAGE BODY FARMA_PUNTOS is
 ...
 /* *********************************************************************** */
  ...
  BEGIN
      ...
      AND    PTOVENTA_CUPON.CUP_F_CHAR_VALIDA_EAN13(cNumTarj_in) = 'S';
...
--      vMontoNeto := TO_NUMBER(montoTotalPedido,'999999.99');
  ...
  BEGIN
    ...
    IF ptosAhorro > 0.5 THEN
      FARMA_PRINTER.P_AGREGA_TEXTO(vIdDoc_in => vIdDoc_in,
                                        vIpPc_in => vIpPc_in,
                                        vValor_in => RPAD('AHORRASTES', 30,' ')||'S/.' || LPAD(PTOVENTA_FIDELIZACION.FID_F_GET_NUM_FORMATED_02(ptosAhorro),9,' '),
