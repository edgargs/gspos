...

{
  ...
  private void recalculaMaxMin()
  {
    try
    {
      if(com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,"Se va a ejecutar el cálculo de Pedido de Reposición. \nEsta operación tardará unos minutos. ¿Desea continuar?"))
      {
  ...
  private void initMaxMin()
  {
    ...
    try
    {
      ...
      {
        if(com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,"Se va a calcular el Pedido de Reposición. \nEsta operación tardará unos minutos. ¿Desea continuar?"))
        {
          DBInventario.actualizaMaxMin();
          cargaReposicion();
