...
public class DlgMantUsuarios extends JDialog {
    ...
    txtFecNacimiento.addActionListener(new ActionListener()
      {
		...
		txtFecNacimiento.addKeyListener(new java.awt.event.KeyAdapter() {
			public void keyPressed(KeyEvent e) {
	...
	private void txtNroEmpleado_keyPressed(KeyEvent e) {
      ...
      if(txtNroEmpleado.getText().length()==0)
      {
        ...
        }else
        {
         ...
         System.out.println("Cod Trab: "+VariablesUsuarios.vCodTrab);
      }else
      {
			if (txtNroEmpleado.getText().length() > 0) {
        ...
        {
           System.out.println("El usuario no existe en maestros");
           System.out.println("Verificara si se validara al usuario");
           txtIdUsuario.setText("");
           txtClaveUsuario.setText("");
           if(!isValidarUsuario())
           {
 ...
 private void btlNumEmpleado_actionPerformed(ActionEvent e)
  ...
  private void txtFecNacimiento_actionPerformed(ActionEvent e)
  {
	...
	private void chkKeyPressed(KeyEvent e) {
      ...
      System.out.println("CodTrab a insertar: "+VariablesUsuarios.vCodTrab);
      if (datosValidados()) {
  ...
  if(!existenDatosUsuario()){
    ...
    { 
		...
		if (txtClaveUsuario.getText().toString().length() == 0) {
    ...
    System.out.println("insertarUsuario");
		DBUsuarios.ingresaUsuario(VariablesUsuarios.vCodTrab/*txtNroEmpleado.getText().trim()*/, 
                              ...
                              txtClaveUsuario.getText().toString().trim(),
  ...
  System.out.println("actualizaUsuario");
	...
	private void mostrarArray(ArrayList myArray) {
      ...
      System.out.println("Dato codTrab: "+VariablesUsuarios.vCodTrab);
			//txtNroEmpleado.setText(VariablesUsuarios.vCodTrab);
  ...
  */
  ...
  public boolean isValidoCodTrabRRHH(String codigo)
  {
    ...
    { 
      System.out.println("Primeras dos cifras : " + codigo.substring(0,2) );
