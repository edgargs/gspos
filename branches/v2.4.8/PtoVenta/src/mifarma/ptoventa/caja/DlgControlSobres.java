...
import mifarma.ptoventa.administracion.cajas.DlgCajasImpresoras;
        ...
        log.debug("ESTADO :"+estado);
         ...
         if(estado.equalsIgnoreCase("A")){
          ...
          FarmaUtility.showMessage(this,"Este sobre ya ha sido rechazado.",tblSobres);
                ...
                if(com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,"¿Esta seguro de aprobar el sobre?")){
