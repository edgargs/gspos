...
public class ImpresoraTicket {
    ...
    private void generarDocumento(JDialog pJDialog, ArrayList<String> vPrint, String pNomImpreso, String pRUCImpreso,
        ...
        // KMONCADA 12.08.2016 [PROYECTO M]
        String textoMarca = "BOTICAS ";
        ...
        vPrint.add(FarmaPRNUtility.alinearIzquierda("Vuelto" + asterix, 20) + "S/. " +
            ...
            if (!VariablesConvenioBTLMF.vCodConvenio.equals(ConstantsConvenioBTLMF.COD_CONV_COMPETENCIA)) {
                ...
                if (pCodTipoConvenio.equals("1")) {
                    ...
                    vPrint.add("#REF: " + vRefTipComp + " " + pNumCompCoPago + " " + "(" +
                               FarmaUtility.formatNumber(porcCopagoEmpresa, "") + "%)" + " - S/. " +
                               pValCopagoCompPago);
        ...
        if (FarmaVariables.vCodCia.equals(ConstantsPtoVenta.CODCIA_BTL_AMAZONIA)){
    ...
    private void datosTicketDefault(JDialog pJDialog, ArrayList<String> vPrint, String pFechaBD,
        ...
        for (int i = 0; i < pDetalleComprobante.size(); i++) {
            ...
            if(UtilityPtoVenta.isLocalVentaMayorista()){
                ...
                lineaDetalle = UtilityCaja.pFormatoLetra(cantVenta, 9, " ") + "  " +
                       FarmaPRNUtility.alinearIzquierda(descProd,27) + "       " +
                    //UNIDAD
                    FarmaPRNUtility.alinearIzquierda(unidVta,11) + " " +
                    //LAB
                    FarmaPRNUtility.alinearIzquierda(lab, 9) + " " + FarmaPRNUtility.llenarBlancos(17) + "   " +
                    FarmaPRNUtility.alinearDerecha(loteProd, 10) + " " +
                    FarmaPRNUtility.alinearDerecha(fechaVenc, 10) + " " +
                    //AHORRO
                    FarmaPRNUtility.alinearDerecha(valor, 5) + "  " +
                    //PRECIO
                    FarmaPRNUtility.alinearDerecha(precioSubTotal,
                                                   10) ;
            }else{
                lineaDetalle = UtilityCaja.pFormatoLetra(cantVenta, 9, " ") + "  " +
                       FarmaPRNUtility.alinearIzquierda(descProd,27) + "       " +
                    ...
                    FarmaPRNUtility.alinearIzquierda(unidVta,11) + " " +
                    //LAB
                    FarmaPRNUtility.alinearIzquierda(lab, 9) + " " +
                    //AHORRO
                    FarmaPRNUtility.alinearDerecha(valor, 5) + "  " +
                    //PRECIO
                    FarmaPRNUtility.alinearDerecha(precioSubTotal,
