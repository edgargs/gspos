--------------------------------------------------------
--  DDL for Package Body PTOVENTA_CAJ
--------------------------------------------------------
...
*\
  ...
  */
  ...
  IS
    curCaj FarmaCursor;
    -- dubilluz 09.06.2011
    cIndEfectivo varchar2(20);
    cIndTarjeta varchar2(20);
    cCodFormaPago varchar2(20);
  BEGIN
 ...
 END;
  ...
  BEGIN
       ...
       IF cTipMov_in=TIP_MOV_CIERRE THEN
          ...
          INSERT INTO CE_MOV_CAJA(COD_GRUPO_CIA,COD_LOCAL,SEC_MOV_CAJA,NUM_CAJA_PAGO,
                                  SEC_USU_LOCAL,SEC_MOV_CAJA_ORIGEN,TIP_MOV_CAJA,
                                  FEC_DIA_VTA,NUM_TURNO_CAJA,FEC_CREA_MOV_CAJA,
                                  USU_CREA_MOV_CAJA,CANT_BOL_EMI,MON_BOL_EMI,CANT_FACT_EMI,
                                  MON_FACT_EMI,CANT_GUIA_EMI,MON_GUIA_EMI,CANT_BOL_ANU,
                                  MON_BOL_ANU,CANT_FACT_ANU,MON_FACT_ANU,CANT_GUIA_ANU,
                                  MON_GUIA_ANU,CANT_BOL_TOT,MON_BOL_TOT,CANT_FACT_TOT,
                                  MON_FACT_TOT,CANT_GUIA_TOT,MON_GUIA_TOT,MON_TOT_GEN,
                                  MON_TOT_ANU,MON_TOT,CANT_NC_BOLETAS,MON_NC_BOLETAS,
                                  CANT_NC_FACT,MON_NC_FACT,MON_TOT_NC,Ip_Mov_Caja)
                          VALUES (cCodGrupoCia_in,cCod_Local_in,v_nNeoCod,TO_NUMBER(nNumCaj_in,'990'),
                                  cSecUsu_in,v_cSecOrigen,cTipMov_in,
                                  vFecDiaVta,v_nActTur,SYSDATE,
                                  cIdUsu_in,nCantBolEmi_in,nMonBolEmi_in,nCantFacEmi_in,
                                  nMontFacEmi_in,nCantGuiaEmi_in,nMonGuiaEmi_in,nCantBolAnu_in,
                                  nMonBolAnu_in,nCantFacAnu_in,nMonFacAnu_in,nCantGuiaAnu_in,
                                  nMonGuiaAnu_in,nCantBolTot_in,nMonBolTot_in,nCantFactTot_in,
                                  nMonFactTot_in,nCantGuiaTot_in,nMonGuiaTot_in,nMonTotGen_in,
                                  nMonTotAnu_in,nMonTot_in,ABS(nCantNCBol_in),ABS(nMonNCBol_in),
                                  ABS(nCantNCFact_in),ABS(nMonNCFact_in),ABS(nMonNCTot_in),cIpMovCaja);
       ...
       IF cTipMov_in=TIP_MOV_ARQUEO THEN
          v_nActTur:=CAJ_OBTENER_TURNO_ACTUAL_CAJA(cCodGrupoCia_in,cCod_Local_in,nNumCaj_in);
           ...
           INSERT INTO CE_MOV_CAJA (COD_GRUPO_CIA,COD_LOCAL,SEC_MOV_CAJA,NUM_CAJA_PAGO,
                                   SEC_USU_LOCAL,SEC_MOV_CAJA_ORIGEN,TIP_MOV_CAJA,
                                   FEC_DIA_VTA,NUM_TURNO_CAJA,FEC_CREA_MOV_CAJA,
                                   USU_CREA_MOV_CAJA,CANT_BOL_EMI,MON_BOL_EMI,
                                   CANT_FACT_EMI,MON_FACT_EMI,CANT_GUIA_EMI,
                                   MON_GUIA_EMI,CANT_BOL_ANU,MON_BOL_ANU,
                                   CANT_FACT_ANU,MON_FACT_ANU,CANT_GUIA_ANU,
                                   MON_GUIA_ANU,CANT_BOL_TOT,MON_BOL_TOT,
                                   CANT_FACT_TOT,MON_FACT_TOT,CANT_GUIA_TOT,
                                   MON_GUIA_TOT,MON_TOT_GEN,MON_TOT_ANU,
                                   MON_TOT,CANT_NC_BOLETAS,MON_NC_BOLETAS,
                                   CANT_NC_FACT,MON_NC_FACT,MON_TOT_NC,
                                   Ip_Mov_Caja)
                           VALUES (cCodGrupoCia_in,cCod_Local_in,v_nNeoCod,nNumCaj_in,
                                   cSecUsu_in,v_cSecOrigen,cTipMov_in,
                                   vFecDiaVta,v_nActTur,SYSDATE,
                                   cIdUsu_in,nCantBolEmi_in,nMonBolEmi_in,
                                   nCantFacEmi_in,nMontFacEmi_in,nCantGuiaEmi_in,
                                   nMonGuiaEmi_in,nCantBolAnu_in,nMonBolAnu_in,
                                   nCantFacAnu_in,nMonFacAnu_in,nCantGuiaAnu_in,
                                   nMonGuiaAnu_in,nCantBolTot_in,nMonBolTot_in,
                                   nCantFactTot_in,nMonFactTot_in,nCantGuiaTot_in,
                                   nMonGuiaTot_in,nMonTotGen_in,nMonTotAnu_in,
                                   nMonTot_in,ABS(nCantNCBol_in),ABS(nMonNCBol_in),
                                   ABS(nCantNCFact_in),ABS(nMonNCFact_in),ABS(nMonNCTot_in),
                                   cIpMovCaja);
       END IF;
  RETURN v_nNeoCod;
  END;
  ...
  BEGIN
    ...
    LOOP
      BEGIN
        ...
        AND     COM.NUM_COMP_PAGO = TRIM(TO_CHAR(comprobanteinicial,'0000000000'))
  ...
  BEGIN
    ...
    IF ( cIndDir_in = 1 ) THEN  --Se corregira ascendentemente
        LOOP
           ...
           WHERE  COM.COD_GRUPO_CIA = cCodGrupoCia_in
           AND     COM.COD_LOCAL     = cCodLocal_in
           AND     COM.NUM_COMP_PAGO = TRIM(TO_CHAR(comprobantefinal + nCant_in,'0000000000'))
           AND     COM.TIP_COMP_PAGO = cTipComp_in;
           numerocomprobante_out := 1;
           EXIT;
    ...
    ELSIF ( cIndDir_in = 2 ) THEN  --Se corregira descendentemente
      LOOP
        BEGIN
          ...
          WHERE  COM.COD_GRUPO_CIA = cCodGrupoCia_in
          AND     COM.COD_LOCAL     = cCodLocal_in
          AND     COM.NUM_COMP_PAGO = TRIM(TO_CHAR(comprobanteinicial - nCant_in,'0000000000'))
          AND     COM.TIP_COMP_PAGO = cTipComp_in;
  ...
  BEGIN
    LOOP
      BEGIN
        ...
        AND     COM.COD_LOCAL     = cCodLocal_in
        AND     COM.TIP_COMP_PAGO = cTipComp_in
        AND     COM.NUM_COMP_PAGO = TRIM(TO_CHAR(comprobanteinicialA,'0000000000'))
        AND ROWNUM=1;
         UPDATE VTA_COMP_PAGO SET FEC_MOD_COMP_PAGO = SYSDATE, USU_MOD_COMP_PAGO = cCodUsu_in,
  ...
  BEGIN
     ...
     /*   SELECT A.SEC_USU_LOCAL INTO SecUso
      ...
      LOOP
          ...
          INSERT INTO VTA_COMP_PAGO(COD_GRUPO_CIA, COD_LOCAL, NUM_PED_VTA, SEC_COMP_PAGO,
                             ...
                             VALUES(cCodGrupoCia_in, cCodLocal_in, cNumPedVta_in, v_nSecCompPago,
                                     TIPO_COMPROBANTE_99,v_nSecCompPago,
                                     cSecMovCaja_in, TO_NUMBER(totalesComprobante_rec.ITEMS,'9,990'), v_cCodCliLocal, v_cNomCliPedVta,
      ...
      IF(v_cIndGraboComp = INDICADOR_SI) THEN
         ...
         PTOVTA_RESPALDO_STK.CAJ_UPD_STK_PROD_DETALLE(cCodGrupoCia_in, cCodLocal_in, cNumPedVta_in, --ASOSA, 11.07.2010
                                        cCodMotKardex_in, cTipDocKardex_in, cCodNumeraKardex_in,
                                        cUsuCreaCompPago_in);
        ...
        END IF;  
         ...
         IF(v_cIndDelivAutomatico = INDICADOR_SI) THEN
            UPDATE TMP_VTA_PEDIDO_VTA_CAB TMP_CAB SET TMP_CAB.USU_MOD_PED_VTA_CAB = cUsuCreaCompPago_in, TMP_CAB.FEC_MOD_PED_VTA_CAB = SYSDATE,
...
/* ********************************************************************************************** */
  ...
  BEGIN
    OPEN curCaj FOR
    SELECT NVL(TIP_COMP.DESC_COMP,' ')                    || 'Ã' ||
          NVL(VTA_CAB.NUM_PED_DIARIO,' ')               || 'Ã' ||
         NVL(VTA_CAB.NUM_PED_VTA,' ')               || 'Ã' ||
         TO_CHAR(VTA_CAB.FEC_PED_VTA,'dd/MM/yyyy HH24:MI:SS') || 'Ã' ||
         TO_CHAR(VTA_CAB.VAL_NETO_PED_VTA,'999,990.00')     || 'Ã' ||
         NVL(VTA_CAB.RUC_CLI_PED_VTA,' ')           || 'Ã' ||
         (SELECT MAX(VTA_DET.SEC_GRUPO_IMPR)
          ...
          WHERE  COD_GRUPO_CIA = cCodGrupoCia_in
          AND     COD_LOCAL = cCodLocal_in
          AND     NUM_PED_VTA = VTA_CAB.NUM_PED_VTA) || 'Ã' ||
         NVL(VTA_CAB.SEC_MOV_CAJA,' ') || 'Ã' ||
         NVL(VTA_CAB.TIP_COMP_PAGO,' ') || 'Ã' ||
         VTA_CAB.VAL_TIP_CAMBIO_PED_VTA|| ' Ã ' ||
         VTA_CAB.USU_CREA_PED_VTA_CAB--' ' JMIRANDA 17/09/2009
    FROM   VTA_PEDIDO_VTA_CAB VTA_CAB,
  ...
  BEGIN
   ...
   SELECT
       ...
       TO_CHAR(NVL(MON_TICK_TOT,0),'999,990.00')
...
WHERE MCFP.COD_GRUPO_CIA  = cCodGrupoCia_in   AND
 ...
 END;
  ...
  BEGIN
    SELECT TO_NUMBER(COUNT(VTA_CAB.NUM_PED_VTA),'999990')
  INTO   v_nCantPedPend
  FROM   VTA_PEDIDO_VTA_CAB VTA_CAB
  WHERE  VTA_CAB.COD_GRUPO_CIA = cCodGrupoCia_in
  AND     VTA_CAB.COD_LOCAL = cCodLocal_in
...
*/
      ...
      codigoGenerado_SecMovCaja := CAJ_REGISTRA_ARQUEO_CAJA(
                                    cTipMov_in,
                                    cCodGrupoCia_in ,
                                      cCod_Local_in,
                                    nNumCaj_in ,
                                    ...
                                    SET
                                        (MM.CANT_BOL_EMI, MM.MON_BOL_EMI) =
                                                          (
                                                            /*SELECT
                                                                COUNT(*) CANTIDAD,
                                        ...
                                        (MM.CANT_GUIA_EMI, MM.MON_GUIA_EMI) =
                                                          (
                                                           /* SELECT
                                                                ...
                                                                AND C.EST_PED_VTA = 'C'
                                                                AND C.NUM_PED_VTA_ORIGEN IS NULL
                                                                AND C.SEC_MOV_CAJA = MM.SEC_MOV_CAJA_ORIGEN AND C.TIP_COMP_PAGO = '03'*/
                                    ...
                                    UPDATE CE_MOV_CAJA MM
                                    SET
                                        MM.MON_TOT_GEN = nvl(MM.MON_BOL_EMI,0) + nvl(MM.MON_FACT_EMI,0) + nvl(MM.MON_TICK_EMI,0)+ nvl(MM.MON_GUIA_EMI,0),
                                        MM.MON_TOT_ANU = nvl(MM.MON_BOL_ANU,0) + nvl(MM.MON_FACT_ANU,0) + nvl(MM.MON_TICK_ANU,0)+ nvl(MM.MON_GUIA_ANU,0)
                                    WHERE MM.COD_GRUPO_CIA = cCodGrupoCia_in
                                      AND MM.COD_LOCAL = cCod_Local_in
                                      AND MM.SEC_MOV_CAJA = codigoGenerado_SecMovCaja;
                                    ...
                                    UPDATE CE_MOV_CAJA MM
                                    SET
                                        MM.MON_TOT = nvl(MM.MON_TOT_GEN,0) - nvl(MM.MON_TOT_ANU,0) - nvl(MM.MON_TOT_NC,0),
   ...
   ELSIF cTipMov_in = 'U' THEN --ACTUALIZAR CIERRE DE CAJA
                          ...
                          (MM.CANT_BOL_EMI, MM.MON_BOL_EMI) =
                                            (
                                              SELECT
                                                  COUNT(*) CANTIDAD,
                                                  SUM(C.VAL_NETO_PED_VTA) TOTAL_NETO_REDONDEO
                                                  FROM VTA_PEDIDO_VTA_CAB C, VTA_PEDIDO_VTA_CAB VPC
                                                  WHERE C.COD_GRUPO_CIA = cCodGrupoCia_in
                                                  AND C.COD_LOCAL = cCod_Local_in
                                                  AND C.FEC_PED_VTA BETWEEN TO_DATE(v_vFecha || ' 00:00:00','DD/MM/YYYY HH24:MI:SS') AND
                                                                            TO_DATE(v_vFecha || ' 23:59:59','DD/MM/YYYY HH24:MI:SS')
                      ...
                      UPDATE CE_MOV_CAJA MM
                      SET
                          MM.MON_TOT_GEN = nvl(MM.MON_BOL_EMI,0) + nvl(MM.MON_FACT_EMI,0) + nvl(MM.CANT_TICK_EMI,0),
                          MM.MON_TOT_ANU = nvl(MM.MON_BOL_ANU,0) + nvl(MM.MON_FACT_ANU,0) + nvl(MM.MON_TICK_ANU,0)
                      WHERE MM.COD_GRUPO_CIA = cCodGrupoCia_in
                        AND MM.COD_LOCAL = cCod_Local_in
                        AND MM.SEC_MOV_CAJA = cSecMovCaja_in;
                      ...
                      UPDATE CE_MOV_CAJA MM
                      SET
                          MM.MON_TOT = MM.MON_TOT_GEN - MM.MON_TOT_ANU - MM.MON_TOT_NC,
                          MM.FEC_MOD_MOV_CAJA = SYSDATE
                      WHERE MM.COD_GRUPO_CIA = cCodGrupoCia_in
                        AND MM.COD_LOCAL = cCod_Local_in
                        AND MM.SEC_MOV_CAJA = cSecMovCaja_in;
       ...
       -- Suma de todos los pedidos cobrados por el cajero
          ...
          --Suma de los montos de la forma de pago que el sistema calculó
             ...
             SELECT SUM(C.IM_TOTAL) MONTO_SISTEMA
              ...
              WHERE C.COD_GRUPO_CIA = cCodGrupoCia_in
              AND   C.COD_LOCAL = cCod_Local_in
              AND   C.SEC_MOV_CAJA = (SELECT SEC_MOV_CAJA FROM  CE_MOV_CAJA
                                      WHERE COD_GRUPO_CIA = cCodGrupoCia_in AND COD_LOCAL = cCod_Local_in AND
                                      SEC_MOV_CAJA_origen = cSecMovCaja_in);


             --ASIGNANDO VALOR  A VARIABLE DE CIERRE DE CAJA
               SELECT SEC_MOV_CAJA  INTO v_codigoGenerado_SecMovCaja FROM  CE_MOV_CAJA
                                      WHERE COD_GRUPO_CIA = cCodGrupoCia_in AND COD_LOCAL = cCod_Local_in AND
                                      SEC_MOV_CAJA_origen = cSecMovCaja_in ;
       ...
       END IF;
              ...
              IF totCompras <> TOTAL_CAJA_TURNO or totCompras <> TOTAL_MONTO_SISTEMA  or TOTAL_CAJA_TURNO <> TOTAL_MONTO_SISTEMA THEN
                    ...
                    --DESCRIPCION DE LOCAL
                     ...
                     --NOMBRES Y APELLIDOS DEL CALJERO
                        select nom_usu || ' ' ||
                               ape_pat || ' ' ||
                               ape_mat  INTO v_vNombreCajero from  pbl_usu_local
                      ...
                      --FECHA DE VENTA
            SELECT to_char(fec_dia_vta,'dd/mm/yyyy') into v_vFecha FROM CE_MOV_CAJA
                      WHERE COD_GRUPO_CIA = cCodGrupoCia_in
                      AND   COD_LOCAL = cCod_Local_in
                 ...
                 INT_ENVIA_CORREO_INFORMACION(cCodGrupoCia_in,cCod_Local_in,
                                                ...
                                                'ALERTA',
                                                'EXISTEN DIFERENCIAS EN LOS MONTOS DEL CIERRE DE TURNO : '||  '<BR>' ||'</B>' || cMensaje ||
...
-----------------------------------------------------------------------------------------------
 ...
 /** **************************************************************** */
  ...
  AND A.COD_LOCAL=cCodLocal_in
  AND A.NUM_PED_VTA=cNumPedVta_in
  AND A.NUM_COMP_PAGO=cNumCompPago_in;
  ...
  SET  X.FECH_IMP_ANUL=SYSTIMESTAMP
    ...
    AND     X.COD_LOCAL         = cCodLocal_in
    AND     X.NUM_PED_VTA       = cNumPedVta_in
    AND    X.NUM_COMP_PAGO=cNumCompPago_in;
    ...
    vCodigoSobre :=  --cCodLocal_in ||'-'||
     to_char(cFecDiaVta_in, 'ddmmyyyy') || '-' ||
       ...
       */
       ...
       ,TIP_MONEDA,MON_ENTREGA,MON_ENTREGA_TOTAL,USU_CREA_SOBRE,USU_MOD_SOBRE,FEC_MOD_SOBRE,ESTADO)
        VALUES (vCodigoSobre,cCodGrupoCia_in,cCodLocal_in,TRUNC(SYSDATE),cSecMovCaja_in,v_numSec,cCodFormaPago_in,
        cTipMoneda_in,cMonEntrega_in,cMonEntregaTotal_in,cUsuCreaEntrega_in,NULL,NULL,cEstadoCreado);
/*
            Farma_Utility.ACTUALIZAR_NUMERA_SIN_COMMIT(cCodGrupoCia_in,
                                               cCodLocal_in,
                                               COD_NUM_SEC_SOBRE,
 ...
 /****************************************************************************************************************************/
  ...
  RETURN CHAR
   ...
   BEGIN
     ...
     BEGIN
      SELECT NVL(TRIM(P.IND_PROSEGUR),' ') INTO vIndProsegur
      FROM PBL_LOCAL P
