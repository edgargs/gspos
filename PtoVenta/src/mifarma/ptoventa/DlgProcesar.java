...
import com.gs.mifarma.SystemOutLogger;
  ...
  public DlgProcesar(Frame parent, String title, boolean modal)
  {
    ...
    private void cargarUsuarioRemotoRAC(){
        ...
        try {
            ...
            FarmaVariables.vIdUsuDBRac = VariablesPtoVenta.conexionRAC.getUsuarioBD();
            FarmaVariables.vClaveBDRac = VariablesPtoVenta.conexionRAC.getClaveBD();
            FarmaVariables.vIpServidorDBRac = VariablesPtoVenta.conexionRAC.getIPBD();
            FarmaVariables.vSidDBRac = VariablesPtoVenta.conexionRAC.getSID();
            //VariablesPtoVenta.conexionRAC.getPORT()
        } catch (Exception f) {
            log.error("",f);
        }                
    }
           ...
           String indPadre = "";
            ...
            if(pResultado.equals("N")) {
                ...
                FarmaVariables.vIpServidorTico =
                                DBCajaElectronica.getLocalTico();   
            }
