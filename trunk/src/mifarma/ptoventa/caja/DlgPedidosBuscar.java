...
public class DlgPedidosBuscar extends JDialog
{
  ...
  private void initCabecera()
  {
    try
    {
      ...
      VariablesCaja.vValTipoCambioPedido = FarmaSearch.getTipoCambio("")+"";
  ...
  private void chkKeyPressed(KeyEvent e)
  {
    ...
    else if(e.getKeyCode() == KeyEvent.VK_F11)
    {
      if(validarPedidos())
      {
        if(FarmaUtility.rptaConfirmDialog(this,"¿Esta seguro que desea unir los pedidos?"))
        {
          if(unirPedidos())
          {
  ...
  private void mostrarPedidoPendientes()
  {
    ...
    {
      //System.out.println(VariablesCaja.vNumPedPendiente);
      //System.out.println(VariablesCaja.vFecPedACobrar.substring(0,10));
