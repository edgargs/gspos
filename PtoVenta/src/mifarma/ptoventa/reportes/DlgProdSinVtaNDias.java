...
public class DlgProdSinVtaNDias extends JDialog {
    ...
    private void jbInit() throws Exception {
        ...
        this.setTitle("Productos Sin Ventas en " + VariablesPtoVenta.vNumeroDiasSinVentas.trim() + " Dias");
    ...
    private void initTable() {
        tableModelListado =
                new FarmaTableModel(ConstantsReporte.columnsListaProdSinVtaNDias, ConstantsReporte.defaultValuesListaProdSinVtaNDias,
                                    0);
    ...
    private void exportarDatos() {
        ...
        FarmaUtility.saveFileRuta(ruta, ConstantsReporte.columnsListaProdSinVtaNDias, tblListado,
                                  new int[] { 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20 });
