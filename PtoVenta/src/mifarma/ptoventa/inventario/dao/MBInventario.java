...
public class MBInventario implements DAOInventario {
     ...
     * @throws SQLException
     */
    public ArrayList<ArrayList<String>> listarProdOrdenCompraSobrante(String pCodOrdCompra) throws SQLException {
        HashMap<String, Object> mapParametros = new HashMap<String, Object>();
        ArrayList<ArrayList<String>> lstListado;
        mapParametros.put("vCodGrupoCia", FarmaVariables.vCodGrupoCia);
        mapParametros.put("vCodCia", FarmaVariables.vCodCia);
        ...
        try {
            ...
            mapper.getListarProdOrdenCompraSobrante(mapParametros);
        } finally {
            sqlSession.close();
        }
        List<BeanResultado> lstRetorno = (List<BeanResultado>)mapParametros.get("listado");
    ...
    public ArrayList<ArrayList<String>> getCabOrdenCompraRecep(String pCodOrdComp,
                                                               String pSecRecepcion) throws SQLException {
        HashMap<String, Object> mapParametros = new HashMap<String, Object>();
    ...
    public String grabarCabeceraNotaSalida(NotaEsCabDTO notaEsCabDTO, String oc) throws SQLException {
        Map<String, Object> mapParametros = new HashMap<String, Object>();
        mapParametros.put("cCodGrupoCia_in", FarmaVariables.vCodGrupoCia);
        mapParametros.put("cCodLocal_in", FarmaVariables.vCodLocal);
        ...
        mapParametros.put("codOc", oc);
        mapper.grabarCabeceraNotaSalida(mapParametros);
        return (String)mapParametros.get("numeroNotaES");
    }

    public void grabarDetalleNotaSalida(String pNumera, NotaEsCabDTO notaEsCabDTO,
                                        NotaEsCabDetDTO notaEsCabDetDTO) throws SQLException {
        Map<String, Object> mapParametros = new HashMap<String, Object>();
        mapParametros.put("cCodGrupoCia_in", FarmaVariables.vCodGrupoCia);
        mapParametros.put("cCodLocal_in", FarmaVariables.vCodLocal);
        ...
        mapParametros.put("cCodMotKardex_in",
                          ConstantsPtoVenta.MOT_KARDEX_SALIDA_PROVEEDOR); //MOTIVO DE KARDEX. notaEsCabDTO.getTipoMotiNotaEs()
        ...
        mapParametros.put("cantExceso", notaEsCabDetDTO.getCantExceso());
        mapParametros.put("cantUsadaExceso", notaEsCabDetDTO.getCantUsadoExceso());
        mapParametros.put("numeroOc", notaEsCabDetDTO.getCodigoOc());
        mapParametros.put("secuencialDetalle", notaEsCabDetDTO.getSecDetalle());
        log.info("PTOVTA_RESPALDO_STK.INV_AGREGA_DET_TRANSFERENCIA" + mapParametros);
    ...
    public void grabarDetRecep(String vCodGrupoCia, String vCodCia, String vCodLocal, String vIdUsu,
                               String vNumOrdenCompra, String vCodProducto, String vCantPedida, String vCantEntregada,
                               String vPrecioUnit, String vPrecioIGV, String vImportRecep, String vSegOC,
                               String vIdeDocumento, String vSerieDocument, String vNumeroDocument,
                               String vSecOC, String vLote, String vFechaVenc) throws SQLException {
        Map<String, Object> mapParametros = new HashMap<String, Object>();
        ...
        mapParametros.put("cSerie_Docm_in", vSerieDocument);
        mapParametros.put("cNumer_Docm_in", vNumeroDocument);
        mapParametros.put("nSecOCRcep", vSecOC.trim());
        mapParametros.put("cNumer_Docm_in", vNumeroDocument);
        mapParametros.put("nSecOCRcep", vSecOC.trim());
        mapParametros.put("cLote_in", (vLote == null ? "" : vLote.trim().toUpperCase()));
        mapParametros.put("cFechaVencimiento_in", (vFechaVenc == null ? "" : vFechaVenc.trim().toUpperCase()));
        log.info("grabarDetRecep AGREGA DETALLE: " + mapParametros);
        mapper.grabarDetRecep(mapParametros);
    }

    public String actualizarOrdenCompra(String vNumOrdenCompra,  ArrayList<ArrayList<String>> listaProductos) throws Exception {
        Map<String, Object> mapParametros = new HashMap<String, Object>();
        String salida = "";
        mapParametros.put("ac_Cod_OC", vNumOrdenCompra);
               
        try(SqlSession sqlAdmSession = MyBatisUtil.getAdmSqlSessionFactory().openSession();) {
            try{
                MapperInventario mapperAdm = sqlAdmSession.getMapper(MapperInventario.class);
                if (listaProductos != null && listaProductos.size() > 0) {
                    for (ArrayList<String> producto: listaProductos) {
                        String codProd = producto.get(0);
                        String cantidad = producto.get(1);
                        
                        mapParametros.put("ac_Cod_Prod", codProd);
                        mapParametros.put("an_Cant_Reci", cantidad); 
                        
                        mapperAdm.act_Deta_Ord_Comp_MD(mapParametros);
                        salida = (String)mapParametros.get("Salida");
                        
                        log.debug("resultado al actualizar la orden de compra: " + salida);
                    }
                }
                sqlAdmSession.commit();
            }catch(Exception e){
                sqlAdmSession.rollback();
                throw e;
            }
        }
        return salida;
    ...
    public String agregaCabGuiaIngreso(String CodGrupoCia, String CodLocal, String FechaGuia, String TipDoc,
        ...
        log.info("mapParametros AGREGAR GUIA: " + mapParametros);
    ...
    public void agregaDetGuiaIngreso(String CodGrupoCia, String CodLocal, String NumGuia, String TipOrigen,
                                     ...
                                     String TipDocKardex, String ValFrac, String Usuer, String cantSolicitada,
                                     //ASOSA - 15/08/2014
        String oc) //ASOSA - 24/09/2014
        throws SQLException {
        Map<String, Object> mapParametros = new HashMap<String, Object>();
        ...
        mapParametros.put("nCantSolicitado", cantSolicitada);
        mapParametros.put("nOrdenCompra", oc);

        mapper.agregaDetGuiaIngreso(mapParametros);

    }

    public String anularRecepGuiaIngreso(String CodGrupoCia, String CodLocal, String NumerGuia, String IdDocumento,
    ...
    public void anulaDocumentoRecep(String CodGrupoCia, String CodLocal, String NumerGuia, String CodMotKardex_in,
                                    String TipDocKardex_in, String User) throws SQLException {
        Map<String, Object> mapParametros = new HashMap<String, Object>();
    ...
    public void cambiaEstado(String pCodGrupoCia, String pCodCia, String pCodLocal, String pCodOC,
    ...
    public String graba_Nota_Es_Cab(String CodGrupoCia_in, String CodLocal_in, String TipDestino_in,
                                    ...
                                    String PlacaTran_in, String CantItems_in, String ValTotal_in, String Usu_in,
                                    String CodMotTransInterno_in) {
        String flag = "";
        Map<String, Object> mapParametros = new HashMap<String, Object>();
    ...
    @Override
    public void grabaCabRecep(String cCodGrupoCia, String cCodCia, String cCodLocal, String cCodOC, String cCodProv,
                              String cCantItem, String cIdUsu, String cNumNota) {
        Map<String, Object> mapParametros = new HashMap<String, Object>();
        mapParametros.put("cCodGrupoCia_in", cCodGrupoCia);
    ...
    @Override
    public String actualizarOrdenDevolucion(SqlSession sqlFasaSession, String pIndiGuia, String pCodLocal,
                                            String pNumGuia, String pNomProv, String pCodiMifarma,
                                            Integer pCantReci) throws SQLException {
