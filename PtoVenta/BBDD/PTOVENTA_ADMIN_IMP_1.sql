 ...
 /* ******************************************************************************************************* */
  ...
  BEGIN
      ...
      */
      ...
      LEFT JOIN VTA_TIP_COMP VTC_B on A.TIP_COMP = VTC_B.TIP_COMP                        --LLEIVA 03-Feb-2014
      LEFT JOIN VTA_TIP_COMP VTC_F on A.TIP_COMP_FAC = VTC_F.TIP_COMP                        --LLEIVA 03-Feb-2014
      WHERE A.COD_GRUPO_CIA = cCodGrupoCia_in
        AND A.COD_LOCAL = pCodLocal
      ORDER BY A.SEC_IP;
