...
public class DlgListaClientes extends JDialog{
    ...
    enum Accion {INSERTA_CLIENTE,MODIFICA_CLIENTE,INSERTA_DIRECCION,MODIFICA_DIRECCION,INSERTA_DIRECCON_CLIENTE};
  ...
  private void jbInit() throws Exception
  {
    ...
    private void initTableDirecciones() {
        tableModelDirecciones = new FarmaTableModel(ConstantsDelivery.columnsListaDireccionesConsulta, ConstantsDelivery.defaultValuesListaDireccionesConsulta,0);
        FarmaUtility.initSimpleList(tblListaDirecciones, tableModelDirecciones, ConstantsDelivery.columnsListaDireccionesConsulta);        
    }
    
    private void initTableClientes() {
        tableModelClientes = new FarmaTableModel(ConstantsDelivery.columnsListaClientes, ConstantsDelivery.defaultValuesListaClientes,0);
  ...
  private void chkKeyPressed(KeyEvent e)
  {
    ...
    {
      if(tblListaDirecciones.getRowCount() <= 0) return;
...
//Valida exista direccion seleccionada
    ...
    {      
          ...
          VariablesDelivery.vCodCli = FarmaUtility.getValueFieldArrayList(tableModelClientes.data, 
                                                                               tblListaClientes.getSelectedRow(),
                                                                               0);        
          VariablesDelivery.vNombreCliente = FarmaUtility.getValueFieldArrayList(tableModelClientes.data, 
                                                                                 tblListaClientes.getSelectedRow(),
                                                                                 1);
        ...
        private void modificaDireccion()
      {
        ...
        VariablesDelivery.vCodigoDireccion = ((String)tblListaDirecciones.getValueAt(tblListaDirecciones.getSelectedRow(),3)).trim();
        VariablesDelivery.vDireccion = ((String)tblListaDirecciones.getValueAt(tblListaDirecciones.getSelectedRow(),1)).trim();
        VariablesDelivery.vReferencia = ((String)tblListaDirecciones.getValueAt(tblListaDirecciones.getSelectedRow(),8)).trim();
        
          VariablesDelivery.vDptosCodigo = ((String)tblListaDirecciones.getValueAt(tblListaDirecciones.getSelectedRow(),16)).trim();
          VariablesDelivery.vProviCodigo = ((String)tblListaDirecciones.getValueAt(tblListaDirecciones.getSelectedRow(),17)).trim();
          VariablesDelivery.vDistCodigo = ((String)tblListaDirecciones.getValueAt(tblListaDirecciones.getSelectedRow(),18)).trim();
          VariablesDelivery.vUrbanCodigo = ((String)tblListaDirecciones.getValueAt(tblListaDirecciones.getSelectedRow(),19)).trim();
          VariablesDelivery.vUrbanizacion = ((String)tblListaDirecciones.getValueAt(tblListaDirecciones.getSelectedRow(),15)).trim();
    ...
    public void cargaListaDirecciones() {
        if(tblListaClientes.getRowCount()>0){
            String pCodCli = FarmaUtility.getValueFieldArrayList(tableModelClientes.data,tblListaClientes.getSelectedRow(),0);
            try {
                DBDelivery.obtieneTelefonoDireccion(tableModelDirecciones, VariablesDelivery.vNumeroTelefono,VariablesDelivery.vCampo,pCodCli);
    ...
    private void cargaCabeceraDireccionTelefono() {
        ...
        VariablesDelivery.vNumeroTelefonoCabecera=((String)tblListaDirecciones.getValueAt(tblListaDirecciones.getSelectedRow(),0)).trim();  
        VariablesDelivery.vDireccion = ((String)tblListaDirecciones.getValueAt(tblListaDirecciones.getSelectedRow(),1)).trim();  
        VariablesDelivery.vReferencia = ((String)tblListaDirecciones.getValueAt(tblListaDirecciones.getSelectedRow(),8)).trim();
        VariablesDelivery.vCodigoDireccion = ((String)tblListaDirecciones.getValueAt(tblListaDirecciones.getSelectedRow(),3)).trim();
        VariablesDelivery.vNombreCalle            = ((String)tblListaDirecciones.getValueAt(tblListaDirecciones.getSelectedRow(),4)).trim();
  ...
  private void cargaDatosCliente()
  {
    ...
    VariablesDelivery.vCodCli = ((String)tblListaClientes.getValueAt(tblListaClientes.getSelectedRow(),0)).trim();
    VariablesDelivery.vObsCli = ((String)tblListaClientes.getValueAt(tblListaClientes.getSelectedRow(),7)).trim();
    VariablesVentas.vNom_Cli_Ped= VariablesDelivery.vNombreCliente.toUpperCase().trim() + " " + VariablesDelivery.vApellidoPaterno.toUpperCase().trim() + " " + VariablesDelivery.vApellidoMaterno.toUpperCase().trim();
  }
  ...
  private void limpiaVariables(){
    ...
    private boolean telefonoExiste() {
        ...
        try {
            valida = DBDelivery.buscaTelefono(VariablesDelivery.vNumeroTelefono,
                                           VariablesDelivery.vCampo);
    ...
    private void cambioDirPrincipalCliente(){
      ...
      if (tblListaClientes.getRowCount()>0&&
          tblListaDirecciones.getRowCount()>0
          ) {
            int pCli = tblListaClientes.getSelectedRow();
            int pDir = tblListaDirecciones.getSelectedRow();
            try {
                String pCodDireccion = FarmaUtility.getValueFieldArrayList(tableModelDirecciones.data,
                                                                           pDir,
                                                                           3);
                String pCodCli = FarmaUtility.getValueFieldArrayList(tableModelClientes.data,
                                                                           pCli,
                                                                           0);
