...
public class DlgMantClienteDireccion extends JDialog
{
	...
	private void this_windowOpened(WindowEvent e)
  {
    ...
    System.out.println("VariablesDelivery.vTipoAccion = "+VariablesDelivery.vTipoAccion);
    System.out.println("VariablesDelivery.vTipoAccionInsertarSoloCliente = "+VariablesDelivery.vTipoAccionInsertarSoloCliente);
     System.out.println("VariablesDelivery.vTipoAccionDireccion = "+VariablesDelivery.vTipoAccionDireccion);
  ...
  private void cerrarVentana(boolean pAceptar)
    ...
    //VariablesDelivery.vTipoAccionDireccion="";
    VariablesDelivery.vTipoAccion = "";
    System.out.println("Variable nula : " + VariablesDelivery.vTipoAccionDireccion);
    System.out.println("Variable nula : " + VariablesDelivery.vTipoAccion);
  }
  ...
  if(e.getKeyCode() == KeyEvent.VK_ENTER)
    {
      ...
      System.out.println("Tipo Calle : " + VariablesDelivery.vTipoCalle);
      FarmaUtility.moveFocus(txtNomCalle);
    }else
      chkKeyPressed(e);
  ...
  private void guardaValoresCliente()
  {
    ...
    System.out.println(VariablesDelivery.vNombreCliente);
    System.out.println(VariablesDelivery.vApellidoPaterno);
    System.out.println(VariablesDelivery.vApellidoMaterno);
    System.out.println(VariablesDelivery.vTipoDocumento);
    System.out.println(VariablesDelivery.vTipoCliente);
    System.out.println(VariablesDelivery.vNumeroDocumento);
    System.out.println(VariablesDelivery.vNombreCalle);
    System.out.println(VariablesDelivery.vNumeroCalle);
    System.out.println(VariablesDelivery.vNombreInterior);
    System.out.println(VariablesDelivery.vNombreUrbanizacion);
    System.out.println(VariablesDelivery.vNombreDistrito);
    System.out.println(VariablesDelivery.vReferencia);
