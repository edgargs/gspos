...
public class TestConvenioBTLMF {
    ...
    public static void main(String[] args) {
        ...
        btnMensaje.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                DlgMsjeImpresionCompBTLMF dlgLogin =
                    new DlgMsjeImpresionCompBTLMF(frame, ConstantsPtoVenta.MENSAJE_LOGIN, true);
        ...
        btnOpcConvenio.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        btnDatosConvenio.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                DlgDatosConvenioBTLMF d =
                    new DlgDatosConvenioBTLMF(frame, "Datos del Convenio: RIMAC TELEFÓNICA", true);
        ...
        btnDatosCovertura.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        btnDatosRetencion.addActionListener(new
