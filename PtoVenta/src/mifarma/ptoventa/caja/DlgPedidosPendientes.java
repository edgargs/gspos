...
public class DlgPedidosPendientes extends JDialog {
 ...
 private void btnPedidosPendeintes_actionPerformed(ActionEvent e)
  ...
  private void anularPedidoPendiente()
  {
    ...
    {
      if (com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,"¿Está seguro que desea efectuar la operación?")) 
      {
        try{
          cargarRegSeleccionado();
              ...
              FarmaUtility.showMessage(this, "El pedido ya fue anulado!!!", null); 
                ...
                if(ex.getErrorCode()==20003)
                  FarmaUtility.showMessage(this, "El pedido ya fue cobrado!!!", null); 
                    ...
                    if(ex.getErrorCode()==20222)
                      FarmaUtility.showMessage(this, "NO SE PUEDE ANULAR UN PEDIDO DE RECARGA.!!!"+VariablesCaja.vNumPedVta +"-"+VariablesCaja.vNumPedVtaOrigenCOBRO, null); 
                    else    
  ...
  public boolean  permiteAnularPedidoRecarga(){
      ...
      //CARGANDO PARAMETROS
      String pNumPedVta = tblListaPendientes.getValueAt(tblListaPendientes.getSelectedRow(), 2).toString().trim();
      String pFecha     = tblListaPendientes.getValueAt(tblListaPendientes.getSelectedRow(), 3).toString().trim().substring(0,10);
      String pRpta = "";
      ...
      if(isPedidoRecarga(pNumPedVta)) {
            ...
            FarmaUtility.showMessage(this,
                                     "No se Puede Conectar para revisar la Recarga.",
                                     null);  
        }
      else
          return true;
