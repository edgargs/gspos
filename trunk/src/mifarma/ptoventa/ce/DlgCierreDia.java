...
import mifarma.ptoventa.ce.DlgCierreDia.*;
...
public class DlgCierreDia extends JDialog 
{
  ...
  private void cargaInfoCierreDia()
  {
    ...
    String montoTotalSistema = new String();
    cargaFormasPago();
    cargaCuadraturas();
    cargaEfectivoRecaudado();
    cargaEfectivoRendido();
    montoTotalSistema = obtieneMontoTotalSistemaCierreDia();
    lblMontoRegistradoSistema.setText(FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber(montoTotalSistema.trim())));
    evaluaTotales();
  ...
  private void evaluaTotales()
  {
    ...
    System.out.println("montoTotalCierreTurnos : " + montoTotalCierreTurnos);
    ...
    System.out.println("montoTotalEfecRecaudado : " + montoTotalEfecRecaudado);
    //suma de total efectivo rendido
    montoTotalEfecRendido = FarmaUtility.getDecimalNumber(lblSubTotalEfecRendido.getText().trim());
    System.out.println("montoTotalEfecRendido : " + montoTotalEfecRendido);
    ...
    System.out.println("montoDiferenciaSistCierreTurno_CD : " + montoDiferenciaSistCierreTurno_CD);
    ...
    System.out.println("montoDiferenciaCD : " + montoDiferenciaCD);
  ...
  private void cambiaVBCierreDia()
  {
    ...
    if( VariablesCajaElectronica.vIndVBCierreDia.equalsIgnoreCase(FarmaConstants.INDICADOR_N) ) {
      ...
      {
        if ( FarmaUtility.rptaConfirmDialog(this, "Existe diferencia entre Efectivo Recaudado y Efectivo Rendido.\nEstá seguro de otorgar el VB de Cierre de Dia y asumir el deficit?") ){
    ...
    {
      if ( FarmaUtility.rptaConfirmDialog(this, "Esta seguro de eliminar el VB de Cierre de Dia?") ){
        if( cargaLoginOper() )
        {
          if( actualizaIndicadorVBCierreDia(VariablesCajaElectronica.vFechaCierreDia,
                                            FarmaConstants.INDICADOR_N,
  ...
  private void colocaInfoCierreDia(boolean pLeerBD)
  {
    ...
    System.out.println("VariablesCajaElectronica.vObsCierreDia : " + VariablesCajaElectronica.vObsCierreDia);
    System.out.println("VariablesCajaElectronica.vNombreUsuarioVBCierreDia : " + VariablesCajaElectronica.vNombreUsuarioVBCierreDia);
  ...
  private void cambiaVBContable()
  {
    ...
    {
      if(FarmaUtility.rptaConfirmDialog(this,"Esta seguro de asignar el VB Contable?")){
  ...
  {
    VariablesCajaElectronica.vTipCompDia = FarmaUtility.getValueFieldArrayList(VariablesCajaElectronica.vRangoCompIngresadosCierreDia, pRow, 4);
    VariablesCajaElectronica.vNumSerieDia = FarmaUtility.getValueFieldArrayList(VariablesCajaElectronica.vRangoCompIngresadosCierreDia, pRow, 1);
    VariablesCajaElectronica.vNumeroMinDia = FarmaUtility.getValueFieldArrayList(VariablesCajaElectronica.vRangoCompIngresadosCierreDia, pRow, 2);
    VariablesCajaElectronica.vNumeroMaxDia = FarmaUtility.getValueFieldArrayList(VariablesCajaElectronica.vRangoCompIngresadosCierreDia, pRow, 3);
    VariablesCajaElectronica.vIndRangoGrabado = FarmaUtility.getValueFieldArrayList(VariablesCajaElectronica.vRangoCompIngresadosCierreDia, pRow, 5);
  }
  ...
  private boolean validaMontoRecRen(){
      System.out.println("HOHOHOHOHOHOLALALALALALALLAJIJIJIJIJIJIJIAHHAHAHAHEHEHEHHEHE");
      boolean flag=true;
      String ind="";
      try{
