...
import mifarma.ptoventa.delivery.DlgMantMotorizados;
...
private String  vEstado = "A";
  ...
  {
    tableModelListaMot = new FarmaTableModel(ConstantsMotorizados.columnsListaMotorizados,
                                             ConstantsMotorizados.defaultValuesListaMotorizados,
                                             0);
    FarmaUtility.initSimpleList(tblListaMot,
                                tableModelListaMot,
                                ConstantsMotorizados.columnsListaMotorizados);
  }
  ...
  private void txtApePaterno_keyPressed(KeyEvent e)
  {
    ...
    if (e.getKeyCode() == KeyEvent.VK_ENTER) {
			...
			if (tblListaMot.getSelectedRow() >= 0) {
				if (!(FarmaUtility.findTextInJTable(tblListaMot,
          txtApePatMot.getText().trim(), 0, 1))) {
          FarmaUtility.showMessage(this,
                                   "Motorizado no encontrado según el criterio de búsqueda.",
                                   txtApePatMot);
          return;
				}
			}
  ...
  private void chkKeyPressed(KeyEvent e)
  {
    ...
    else if(e.getKeyCode()==KeyEvent.VK_F2)
    {
      ...
      limpiaVariables();
      DlgMantMotorizados dlgMantMot = new DlgMantMotorizados(myParentFrame,"Mantenimiento de Motorizados",true);
   ...
   }else if(UtilityPtoVenta.verificaVK_F11(e))
    {
        ...
        if (JConfirmDialog.rptaConfirmDialog(this,"¿Está seguro que desea Seleccionar al Motorizado?")){           //
            try {
                ...
                String pNam = FarmaUtility.getValueFieldArrayList(tableModelListaMot.data, sel,3).trim()+" "+
                ...
                DBCaja.updMotorizadoDLV(VariablesDelivery.vNumeroPedido,pDni,pNam,"","","","","");
