...
public class DBCajaElectronica
{
 ...
 public static void eliminaFormaPagoEntegaSL(String pSecMovCaja,
                                       ...
                                       String pSecCuadratura)throws SQLException
  {
    ...
    System.out.println("elimina cuadratura " + parametros);
  ...
  public static int validacionEliminacion(String pCodCuadratura,
    ...
    parametros.add(pSecCuadratura);
    parametros.add(pCodCuadratura);
    System.out.println("arreglo " + parametros);
  ...
  public static void agregaDatosCuadratura(String serie, String tipoComp, String numeroComp, 
                                           ...
                                           String tipoMoneda, String formaPago, String serieBillete) throws SQLException
  {
    parametros = new ArrayList();
    parametros.add(FarmaVariables.vCodGrupoCia);
    parametros.add(FarmaVariables.vCodLocal);
  ...
  String fechaVencimiento,String serieDocumento,double montoPerdido, String numeroPedido) throws SQLException
  {
  ...
  public static void evaluaDeficitAsumidoQF(String pFechaCierreDia,
    ...
    parametros.add(FarmaVariables.vCodLocal);
    parametros.add(pFechaCierreDia);
    System.out.println("pFechaCierreDia : " + pFechaCierreDia);
    parametros.add(new Double(pMontoDeficit));
    parametros.add(FarmaVariables.vNuSecUsu);
    parametros.add(FarmaVariables.vIdUsu);
  ...
  public static void insertaRangoCompMovCaja(String pSecMovCaja) throws SQLException{
    ...
    parametros.add(FarmaVariables.vIdUsu);
    System.out.println("PTOVENTA_CE_LMR.CE_INSERTA_RANGO_COMP_MOV_CAJ(?,?,?,?,?,?,?,?)\n"+parametros);
  ...
  public static String getIndCESeguridad(String pCodigoFormaPago) throws SQLException {
    ...
    System.out.println("indProsegur:"+parametros);  
    return FarmaDBUtility.executeSQLStoredProcedureStr(
  ...
  /**
                                         ...
                                         String CodSobre)throws SQLException
    {
      ...
      System.out.println("Agrega Sobre:" + parametros);
     ...
     * */     
     public static double getTipoCambio(String pDiaVenta) throws SQLException {
        ...
        return FarmaDBUtility.executeSQLStoredProcedureDouble("FARMA_UTILITY.OBTIENE_TIPO_CAMBIO2(?,?)", parameters);
     }
    ...
    /*****************************CAMBIO DE FORMA DE PAGO**************************************************/
      ...
      * */     
      public static void cargaListaRegistroVentas(FarmaTableModel pTableModel,
       ...
       System.out.println("PTOVENTA_CE.CE_REGISTRO_VENTAS(?,?,?,?,?,?,?,?):"+parametros);
    ...
    /*****************************CAMBIO DE FORMA DE PAGO**************************************************/
      ...
      * */     
      public static void cargaListaRegVentas(FarmaTableModel pTableModel,
       ...
       parametros.add(tipPago);
       System.out.println("PTOVENTA_CE.CE_LIST_DET_VENTAS(?,?,?,?,?,?):"+parametros);
...
/** Se guarda la nueva forma de pago
    ...
    public static void validaMontoDeclarado(String pSecMovCajaCierre,
      ...
      System.out.println(":::parametros validaMontoDeclarado: "+parametros);
    ...
    public static String getSobreAprobado(String pCodigoSobre,
      ...
      System.out.println("Prosegur: "+parametros);  
    ...
    public static String getExistSobreRemito(String diaCierre,
      ...
      System.out.println("getExistSobreRemito : "+parametros);  
    ...
    public static String getIND_PROSEGUR()throws SQLException{
        ...
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
        System.out.println("parametros getIND_PROSEGUR: "+parametros);
    ...
    public static void getLISTA_SOBRE_AS(FarmaTableModel ftable, 
        ...
        System.out.println("parametros getLISTA_SOBRE_AS: "+parametros);
    ...
    public static String getValidarMontoRecRen(String cierredia)throws SQLException{
        ...
        System.out.println("parametros PTOVENTA_CE.CE_F_VALIDAR_MONTO_SD: "+parametros);
...
/**
    ...
    public static String validarLongitudTarj(String pNroTarj)  throws SQLException   
    {
        ...
        System.out.println("PTOVENTA_CE.CE_P_VERIFICAR_LONGITUD(?,?,?):"+parametros);
        return FarmaDBUtility.executeSQLStoredProcedureStr(
    ...
    public static void obtienePedidoaCambiar(ArrayList pArrayList,
      ...
      System.out.println("PTOVENTA_CE.CE_CAMBIO_FORMA_PAGO(?,?,?,?):"+parametros);
    ...
    public static void grabarSobresAutomaticamente(String secMovCaja)throws SQLException{
        ...
        parametros.add(FarmaVariables.vIdUsu);
        System.out.println("PARAMETROS grabarSobresAutomaticamente: "+parametros);
 ...
 /**
      * Salvo las antiguas forma de pago pedido para el cambio de forma de pago.
      * @author JQUISPE
      * @since 03.06.2010
      */
     public static void grabaFormaPagoPedidoSave() throws SQLException{
         parametros = new ArrayList();
         parametros.add(FarmaVariables.vCodGrupoCia);
         parametros.add(FarmaVariables.vCodLocal);        
         parametros.add(VariablesNewCobro.numpedvta);        
         FarmaDBUtility.executeSQLStoredProcedure(null,"PTOVTA_GEN_COBRO_PED.PVTA_P_SAVE_FORM_PAGO_PED(?,?,?)",parametros,false);
     }
 
    /**
         * Delete las antiguas forma de pago pedido para el cambio de forma de pago.
         * @author JQUISPE
         * @since 03.06.2010
         */
        public static void delFormaPagoPedidoSave() throws SQLException{
            parametros = new ArrayList();
            parametros.add(FarmaVariables.vCodGrupoCia);
            parametros.add(FarmaVariables.vCodLocal);        
            parametros.add(VariablesNewCobro.numpedvta);        
            FarmaDBUtility.executeSQLStoredProcedure(null,"PTOVTA_GEN_COBRO_PED.PVTA_P_DEL_FORM_PAGO_PED(?,?,?)",parametros,false);
        }
    
    
    /**
     * Grabar forma de pago pedido para el cambio de forma de pago.
     * @author JQUISPE
     * @since 03.06.2010
     * @param pCodFormaPago
     * @param pImPago
     */
    public static void grabaFormaPagoPedidoChange(String pCodFormaPago,
                                            String pImPago,
                                            String pTipMoneda,
                                            String pTipoCambio,
                                            String pVuelto,
        ...
        parametros.add(lote);
        FarmaDBUtility.executeSQLStoredProcedure(null,"PTOVTA_GEN_COBRO_PED.PVTA_P_CHANGE_FORM_PAGO_PED(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",parametros,false);
    }
    ...
    */
    ...
    public static void aprobarSobres(String pSecMovCaja, 
      ...
      System.out.println("parametros aprobarSobres: "+parametros);
    ...
    parametros.add(secMovCaja.trim());
    System.out.println("agregaCotizacionCompetencia de cierre turno PTOVENTA_CE_ERN.CE_P_INS_CUADRA_COTI_COMP: "+parametros);
    ...
    {    
        ...
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);        
        System.out.println("parametros PTOVENTA_CE.GET_IND_CIERRE_CAJ_QF: "+parametros);
    ...
    {    
        ...
        parametros.add(FarmaVariables.vCodLocal); 
        parametros.add(pSecUsu);         
        System.out.println("parametros PTOVENTA_CE.IS_ADMIN_CAJ_QF: "+parametros);
    ...
    public static String getDatosRemitoMatricial(String pCodRemito) throws SQLException{
        ...
        System.out.println("parametros PTOVENTA_CE_REMITO.GET_DAT_RMT_MATRICIAL: "+parametros);
    ...
    public static String getIndImpreRemitoMatricial() throws SQLException{
        ...
        parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        System.out.println("parametros PTOVENTA_CE_REMITO.GET_IND_IMPR_MATRI: "+parametros);
