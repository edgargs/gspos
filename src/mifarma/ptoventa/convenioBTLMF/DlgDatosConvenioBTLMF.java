...
public class DlgDatosConvenioBTLMF extends JDialog {
	...
	private static final Log log = LogFactory.getLog(DlgDatosConvenioBTLMF.class);
    ...
    ********************************
    ...
    public Container getPanelNorte()
    {
        ...
        if (VariablesConvenioBTLMF.vDatosConvenio != null)
        {
          ...
          for (int j = 0; j < VariablesConvenioBTLMF.vDatosConvenio.size(); j++)
          {
             ...
             System.out.println("codTipoCampo :"+codTipoCampo);
             System.out.println("flgLista     :"+flgLista);
    ...
    private void txtBusquedaKeyPressed(KeyEvent e)
    {
        ...
        System.out.println("metodo:txtBusquedaKeyPressed");
        ...
        System.out.println("textoSeleccionado::::>"+textoSeleccionado);
        ...
        if(e.getKeyCode() == KeyEvent.VK_DOWN)
          {
             ...
             {
            	   System.out.println("pTipoObjeto : "+pTipoObjeto);
            	   System.out.println("codTipoCampo: "+codTipoCampo);
        ...
        if(e.getKeyCode() == KeyEvent.VK_ENTER && txtBusqueda.getSelectedText() != null && txtBusqueda.getSelectedText().trim().equalsIgnoreCase(textoSeleccionado.trim()))
           {
                ...
                if(verificarIngresoDatoFinal(convenio2))
                {
                    ...
                    {
                           //en construccion
                        System.out.println("Cerrammos la ventana de convenio");
                    	if(FarmaUtility.rptaConfirmDialog(this,"Ingreso todo los datos, desea Guardar?"))
                    	{
                         cerrarVentana(true);
                  ...
                  if(validarDato(convenio))
                  {
                     ...
                     else
                     {
                         ...
                         else
                         {
                             ...
                             {
                                 nuevoBenificiario();
                                 System.out.println("Benificiario:::"+VariablesConvenioBTLMF.vAceptar);
                                 if(VariablesConvenioBTLMF.vAceptar &&
                                    (VariablesConvenioBTLMF.vFlgCreacionCliente != null && VariablesConvenioBTLMF.vFlgCreacionCliente.trim().equals(ConstantsConvenioBTLMF.FLG_CREACION_BENIF))
                                    )
                                 {
                                	 System.out.println("CodCliente:::"+VariablesConvenioBTLMF.vCodCliente);
                       ...
                       )
                    {
                      if(validarDato(convenio))
                      {
                         ...
                         else
                         {
                             ...
                             System.out.println("Medico:::"+VariablesConvenioBTLMF.vAceptar);
                             VariablesConvenioBTLMF.vAceptar = false;
                         }
                       ...
                       )
                    {
                      if(validarDato(convenio))
                      {
                         ...
                         else
                         {
                             ...
                             System.out.println("Diagnostico:::"+VariablesConvenioBTLMF.vAceptar);
                             VariablesConvenioBTLMF.vAceptar = false;
                         }
        ...
        if(e.getKeyCode() == KeyEvent.VK_F12)
        {
                ...
                {
                     System.out.println(">>>>>>>>>>>Muestra una Nueva Pantalla<<<<<<<<<<<"+flgLista);
	                  ...
	                  if(codTipoCampo.equals(ConstantsConvenioBTLMF.COD_DATO_CONV_BENIFICIARIO))
	              	   {
		                  ...
		                  System.out.println("Busqueda::"+VariablesConvenioBTLMF.vBuscarNombreBenif);
		                  ...
		                  else
		                  {
	                       ...
	                       DlgListaPantallaBTLMF dlg = new DlgListaPantallaBTLMF(this," ",true);
	                       dlg.setVisible(true);
		                  }
	              	   }
	                   else
    ...
    private void txtIngresoTextoKeyPressed(KeyEvent e)
    {
        ...
        if(e.getKeyCode() == KeyEvent.VK_DOWN)
        {
            ...
            System.out.println("Pagina Actual:"+VariablesConvenioBTLMF.vPaginaActual) ;
    ...
    private void cargaPrimerDato() {
    	 System.out.println(">>>>>>>>>Metodo: cargaPrimerDato<<<<<<<<");
    ...
    private void cargarSiguienteDato()
    {
        ...
        System.out.println(">>>>>>>>>Metodo: cargarSiguienteDato<<<<<<<<");
        pagInicio = pagInicio + 1;
        VariablesConvenioBTLMF.vPaginaActual = pagInicio;
        System.out.println("pagInicio:"+pagInicio+"pagFinal:"+pagFinal);
    ...
    {
        System.out.println(">>>>>>>>>Metodo: cargarAnteriorDato<<<<<<<<");
        int paginaActual = 0;
    ...
    private void cargarListaCombox(String pCodigoCampo)
    {
        ...
        System.out.println("PTOVENTA_CONV_BTLMF.BTLMF_F_CUR_LISTA_DATO("+parametros+")");
        System.out.println("cboLista = "+cboLista);
    ...
    {
    	 System.out.println(">>>>>>>>>Metodo: cargaPanelIngresoDatos<<<<<<<<");
        ...
        System.out.println("pTipoCampo:"+pTipoCampo);
        System.out.println("pFlg_lista:"+pFlg_lista);
        ...
        pnlObjetoIngreso.setBounds(new Rectangle(25,30,592,40));
        ...
        if(pTipoObjeto.equalsIgnoreCase(ConstantsConvenioBTLMF.OBJ_LISTA_PANTALLA))
        {
            ...
            txtBusqueda.setBounds(new Rectangle(50,10,200,20));
            txtBusqueda.setFont(new Font("SansSerif", 0, 11));
            pnlObjetoIngreso.add(txtBusqueda);
            lblInstruccion.setText(pCampoMsj);
    ...
    public void actualizaTamanoPantalla()
    {
        ...
        System.out.println(">>>>>>>>>Metodo: actualizaTamanoPantalla<<<<<<<<");
    ...
    {
        System.out.println(">>>>>>>>>Metodo: cargarPantalla<<<<<<<<");
        Map convenio;
    ...
    private void ingresarDatos(Map convenio)
    {
        ...
        System.out.println(">>>>>>>>>Metodo: ingresarDatos<<<<<<<<");
           ...
           if(map.get(ConstantsConvenioBTLMF.COL_CODIGO_CAMPO).equals(VariablesConvenioBTLMF.vCodTipoCampo))
            {
                ...
                {
                      map.put(ConstantsConvenioBTLMF.COL_VALOR_IN,VariablesConvenioBTLMF.vDescripcion);
    ...
    {
        System.out.println(">>>>>>>>>Metodo: validarDato<<<<<<<<");
        boolean result = true;
        if (convenio.get(ConstantsConvenioBTLMF.COL_TIPO_OBJ).equals(ConstantsConvenioBTLMF.OBJ_LISTA_PANTALLA) &&
            ...
            && txtBusqueda.getText().length() <= 11)
         {
	         ...
	         if (txtBusqueda.getText().length() < 3)
	      	 {
	      		FarmaUtility.showMessage(this, "Ingresar al menos tres números de DNI/RUC ",txtBusqueda);
		        return  result = false;
        	 ...
        	 {
               FarmaUtility.showMessage(this, "Invalido DNI/RUC ",txtBusqueda);
                return result = false;
        	 }
         }
        else
       ...
       private void editarDato()
    {
          ...
          System.out.println(">>>>>>>>>Metodo: editarDato<<<<<<<<");
    ...
    private void seleccionarItemCombox(String descripcion)
    {
      ...
      System.out.println("seleccionarItemCombox:");
      // Get number of items
   ...
   private boolean existeBenificiario()
   {
       ...
       System.out.println("BenifDNI:"+benif.get(ConstantsConvenioBTLMF.COL_DNI));
   ...
   {
       System.out.println("<<<<<<<<<<<<Metodo: existeMedico>>>>>>>>>>>>");
       Map benif = null;
       boolean retorno = false;
   ...
   {
       System.out.println("<<<<<<<<<<<<Metodo: cargarMedico>>>>>>>>>>>>");
   ...
   {
       System.out.println("<<<<<<<<<<<<Metodo: existeDiagnostico>>>>>>>>>>>>");
       Map benif = null;
       boolean retorno = false;
       ...
       if(benif.get(ConstantsConvenioBTLMF.COL_COD_CIE_10) != null)
       {
           ...
           //VariablesConvenioBTLMF.vDescDiagnostico = (String)benif.get(ConstantsConvenioBTLMF.COL_DES_DIAGNOSTICO);
           VariablesConvenioBTLMF.vDescDiagnostico = VariablesConvenioBTLMF.vCodCIE10;
   ...
   {
       System.out.println("<<<<<<<<<<<<Metodo: cargarDiagnostico>>>>>>>>>>>>"+VariablesConvenioBTLMF.vCodCIE10);
       FarmaUtility.showMessage(this,
               "Diagnóstico \n" +
               VariablesConvenioBTLMF.vDescDiagnostico+" \n"+
               "CIE 10: " + VariablesConvenioBTLMF.vCodCIE10,
               null);
   ...
   private void cargarBenificiario()
   {
      ...
      else
      {
          FarmaUtility.showMessage(this,
           ...
           txtIngresoTexto.setText(VariablesConvenioBTLMF.vNombre +" "+VariablesConvenioBTLMF.vApellidoPat);
      }
   ...
   private void nuevoBenificiario()
   {
        ...
        DlgDatoBenificiarioBTLMF benifi = new DlgDatoBenificiarioBTLMF(this,"",true);
           ...
           System.out.println("Nombre::"+VariablesConvenioBTLMF.vNombre +" "+VariablesConvenioBTLMF.vApellidoPat);
           VariablesConvenioBTLMF.vDescripcion = VariablesConvenioBTLMF.vNombre +" "+VariablesConvenioBTLMF.vApellidoPat;
   ...
   private boolean verificarIngresoDato(Map conv)
   {
       ...
       System.out.println("<<<<<<<<<<<<Metodo: verificarIngresoDato>>>>>>>>>>>>");

       boolean retorno = true;

       System.out.println("CONVENIO:"+conv);
       System.out.println("COL_TIPO_OBJ:"+conv.get(ConstantsConvenioBTLMF.COL_TIPO_OBJ));
       System.out.println("COL_VALOR_IN:"+conv.get(ConstantsConvenioBTLMF.COL_VALOR_IN));
   ...
   private boolean verificarIngresoDatoFinal(Map conv)
   {
           ...
           System.out.println("<<<<<<<<<<<<Metodo: verificarIngresoDatoFinal>>>>>>>>>>>>");
	      ...
	      System.out.println("pagFinal			: "+pagFinal);
	      System.out.println("cantDatoIngresados: "+cantDatoIngresados);
   ...
   {
     System.out.println("<<<<<<<<Metodo:actualizaBenificiario>>>>>>>");
   ...
   private void consultarSaldoCreditoBenif()
   {
       ...
       System.out.println("<<<<<<<<Metodo:consultarSaldoCreditoBenif>>>>>>>");
       ...
       System.out.println("Inicio de Fin");
