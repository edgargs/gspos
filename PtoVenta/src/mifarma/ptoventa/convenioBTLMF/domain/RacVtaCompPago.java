...
public class RacVtaCompPago {
    ...
    private Integer pct_beneficiario;
    private Integer pct_empresa;
    ...
    public void setPct_beneficiario(Integer pct_beneficiario) {
        this.pct_beneficiario = pct_beneficiario;
    }

    public Integer getPct_beneficiario() {
        return pct_beneficiario;
    }

    public void setPct_empresa(Integer pct_empresa) {
        this.pct_empresa = pct_empresa;
    }

    public Integer getPct_empresa() {
        return pct_empresa;
    }
