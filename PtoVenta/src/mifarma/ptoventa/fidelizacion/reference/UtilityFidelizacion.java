...
DBFidelizacion.isValidaPedidoFidelizadoMatriz(pNumPed, pRuc, VariablesFidelizacion.vDniCliente);
    ...
    public static String getApellidos(String nombreCompleto) {  
        ...
        try {
            ...
            log.info("ERROR en getApellidos: " + e.getMessage());
            apellidos = "ERROR";
        } finally{
            return apellidos;
        }        
    ...
    public static void insertarLogOperacion(OperacionDTO operacionDTO) {
        try {
            ...
            log.info("ERROR en insertarClienteFidelizacion: " + e.getMessage());
        }
    }
    ...
    public static boolean getIndImpresionTextExpert(String numPedVta,
        ...
        try {
            ...
            log.info("ERORR en getIndImpresionTextExpert: " + e.getMessage());
        } finally {
            return flag;
        }
    }
    ...
    public static void getTextExpertImpresion(String numPedVta,
        ...
        try {
            ...
            log.debug("ERROr en getTextExpertImpresion" + e.getMessage());
        }
    }
    ...
    public static List getDatosImpresionExpert(String numPedVta,
        ...
        try {
            ...
            log.info("ERORR en getDatosImpresionExpert: " + e.getMessage());
        } finally {
            return listComanda;
        }
    }
     ...
     */
    public static void imprimirVoucherFid(String dniCli) {
        try {
            String textoTotal = DBFidelizacion.obtieneImprVoucherFid(dniCli);
            ...
            log.info("ERROR en  imprimirVoucherFid: " + e.getMessage());
        }        
    }
