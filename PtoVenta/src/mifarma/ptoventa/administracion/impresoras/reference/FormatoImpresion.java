           ...
           try
            {
               ...
               /*12*/vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(10) +
                ...
                for (int i=0; i<pDetalleComprobante.size(); i++)
                {
                    ...
                    String lineaDetalle;
                    if(VariablesVentas.vTipoPedido.equalsIgnoreCase(ConstantsVentas.TIPO_PEDIDO_INSTITUCIONAL)){
                        lineaDetalle = FarmaPRNUtility.llenarBlancos(10) +
                            FarmaPRNUtility.alinearIzquierda(codigoProd,11) + FarmaPRNUtility.llenarBlancos(1) +
                            FarmaPRNUtility.alinearIzquierda(lab,7) + FarmaPRNUtility.llenarBlancos(1) +
...
*/
        ...
        if (VariablesVentas.vTipoPedido.equalsIgnoreCase(ConstantsVentas.TIPO_PEDIDO_INSTITUCIONAL)){
            ...
            for (int j=linea; j<5+6+5; j++){  vPrint.add(vMargen+" ");  linea += 1;}
            linea = linea-17;
                ...
                vPrint.add(vMargen+" "); 
                //vPrint.add(vMargen+" ");
                vPrint.add(vMargen+"      "+VariablesVentas.vMensajeBotiquinBTLVtaInstitucional); //kmoncada 10.07.14 impresion de poliza en vta empresa
                vPrint.add(vMargen+" ");                
        ...
        if (pRefTipComp.equals(ConstantsVentas.TIPO_COMP_TICKET)) vRefTipComp = "TKB";  
          ...
          log.debug("Imprimiendo Numero de Comprobante: " + pNumComprobante); 
              ...
              try {
                  ...
                  //FECHA 
                  vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(15)+ dia + " de " + mesLetra + " del " + ano + "     " + hora);
                  
                  //SENORES Y NUMERO DE DOCUMENTO
                  vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(15) + FarmaPRNUtility.alinearIzquierda(pNomImpreso.trim(),60)+FarmaPRNUtility.llenarBlancos(10)+ "No. " + pNumComprobante.substring(0,3) + "-" + pNumComprobante.substring(3,10));
                  ...
                  //RUC Y OC
                  vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(15) + pNumDocImpreso.trim()+FarmaPRNUtility.alinearIzquierda("",60)+FarmaPRNUtility.llenarBlancos(15)+vOC);
                  ...
                  vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(15) + FarmaPRNUtility.alinearIzquierda(pDirImpreso.trim(),60)+FarmaPRNUtility.llenarBlancos(26)+vGuia);
         ...
         //*************************************INFORMACION DEL CONVENIO***********************************************//
            ...
            if (VariablesVentas.vTipoPedido.equalsIgnoreCase(ConstantsVentas.TIPO_PEDIDO_INSTITUCIONAL)) {
              neto =    FarmaUtility.getDecimalNumber(pValTotalNeto)-FarmaUtility.getDecimalNumber(pValIgvComPago)
                        +FarmaUtility.getDecimalNumber(pValRedondeoComPago); //RHERRERA 04-08-2014
              ...
              if (VariablesVentas.vTipoPedido.equalsIgnoreCase(ConstantsVentas.TIPO_PEDIDO_INSTITUCIONAL)){ //RHERRERA 26-06-2014
                ...
                if(pCodTipoConvenio.equals("1") || pCodTipoConvenio.equals("3")){
                    vLinea =  FarmaPRNUtility.llenarBlancos(85)+"            "+
                             "Coaseguro("+FarmaUtility.formatNumber(porcCopagoBenef,2)+"%)    S/. " + FarmaPRNUtility.alinearDerecha(FarmaUtility.formatNumber(ValCopagoCompPagoSinIGV),10);
                    ...
                    lineaReferencia = "  #REF: "+vRefTipComp+" " + FarmaPRNUtility.alinearIzquierda(pNumCompCoPago+vPorcCopago,50);
                ...
                for (int j=linea; j<3; j++)  vPrint.add(vMargen+" "); 
                       ...
                       VariablesVentas.vTipoPedido.equalsIgnoreCase(ConstantsVentas.TIPO_PEDIDO_INSTITUCIONAL) )
              {
                  ...
                  VariablesVentas.vTituloDelivery = "";//" - PEDIDO DELIVERY - " ; //ERIOS 2.4.7 No se imprime referencia a Delivery
              }
              ...
              neto = pValTotalNetoRedondeo-SumMontoIGV;
                  ...
                  vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(15)+
                          FarmaPRNUtility.alinearDerecha("S/. " +FarmaUtility.formatNumber(neto),15) +
                           FarmaPRNUtility.llenarBlancos(40) +
                                   "S/. " + FarmaPRNUtility.alinearDerecha(FarmaUtility.formatNumber(SumMontoIGV),10) + FarmaPRNUtility.llenarBlancos(35) +
                                   "S/. " + FarmaPRNUtility.alinearDerecha(FarmaUtility.formatNumber(pValTotalNetoRedondeo),10));
...
false, "1", "CLI", "04", "10/01/2010 12:09:23", "BOL", "0.05",
     ...
     * @return
     */
    private String muestraBeneficiario() {
        String lineaBeneficiario;
