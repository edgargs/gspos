...
public class JInputDialog extends JDialog {
    ...
    private void jbInit() throws Exception {
        ...
        jPanel3.add(jTextPane1, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(0, 0, 0, 0), 129, 58));
        jPanel3.add(jTextField1, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
    ...
    private boolean validaDT() {
        ...
        try{
            ...
            case "NM": bValida = FarmaUtility.isInteger(jTextField1.getText().trim()); 
                if(!bValida){
