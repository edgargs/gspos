...
public interface MapperComprobanteElectronico {
    ...
    @Select(value="{call #{listado, mode=OUT, jdbcType=CURSOR, resultMap=resultado} := " +
                  "FARMA_EPOS.FN_IMPRIMIR_CABECERA(" + 
                    "#{cGrupoCia},"+
                    "#{cCodLocal},"+                  
                    "#{cNumPedidoVta}," + 
                    "#{cSecCompPago}," +
     ...
     */   
    @Select(value="{call #{listado, mode=OUT, jdbcType=CURSOR, resultMap=resultado} := "+ 
                  "FARMA_EPOS.FN_IMPRIMIR_DETALLE(" + 
                    "#{cGrupoCia},"+
                    "#{cCodLocal},"+                  
                    "#{cNumPedidoVta}," + 
                    "#{cSecCompPago}," +
     ...
     */   
    @Select(value="{call #{listado, mode=OUT, jdbcType=CURSOR, resultMap=resultado} := "+ 
                  "FARMA_EPOS.FN_IMPRIMIR_MONTOS_GLOBAL(" + 
                    "#{cGrupoCia},"+
                    "#{cCodLocal},"+                  
                    "#{cNumPedidoVta}," + 
                    "#{cSecCompPago}" +
     ...
     * @Fecha:21 /08/2014
     */   
    @Select(value="{call #{listado, mode=OUT, jdbcType=CHAR} := "+ 
                  "FARMA_EPOS.FN_IMPRIMIR_MENSAJE_CONVENIO(" + 
                    "#{cGrupoCia},"+
                    "#{cCodLocal},"+
                    "#{cNumPedidoVta},"+ 
                    "#{cSecCompPago}," + 
     ...
     */   
    @Select(value="{call #{listado, mode=OUT,jdbcType=CHAR} := "+ 
                  "FARMA_EPOS.FN_IMPRIMIR_PIE_PAGINA(" + 
                    "#{cGrupoCia},"+
                    "#{cCodLocal}"+
                     ")}")
    @Options(statementType = StatementType.CALLABLE)
     ...
     */   
    @Select(value="{call #{listado, mode=OUT, jdbcType=CURSOR, resultMap=resultado} := "+ 
                  "FARMA_EPOS.IMPRIME_DATOS_DELIVERY(" + 
                    "#{cCodGrupoCia},"+
                    "#{cCodLocal},"+                  
                    "#{cNumPedidoVta}" + 
                     ")}")
     ...
     */   
    @Select(value="{call #{listado, mode=OUT, jdbcType=CURSOR, resultMap=resultado} := "+ 
                  "FARMA_EPOS.IMPRIME_DATOS_EMPRESA(" + 
                    "#{cCodGrupoCia},"+
                    "#{cCodLocal},"+                  
                    "#{cNumPedidoVta}" + 
                     ")}")
