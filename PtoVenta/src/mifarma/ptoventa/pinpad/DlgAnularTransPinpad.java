...
public class DlgAnularTransPinpad extends JDialog {
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(571, 386));
        ...
        lblF11.setBounds(new Rectangle(435, 325, 115, 30));
        lblF11.setFocusable(false);
        lblF11.setEnabled(false);
        lblEsc.setText("[ ESC ] Cancelar");
        lblEsc.setBounds(new Rectangle(10, 325, 120, 30));
        ...
        pnlMensajePinpad.setBounds(new Rectangle(10, 260, 540, 55));
        lblMensajePinpad.setBounds(new Rectangle(0, 0, 540, 55));
        ...
        lblF5.setBounds(new Rectangle(160, 325, 245, 30));
