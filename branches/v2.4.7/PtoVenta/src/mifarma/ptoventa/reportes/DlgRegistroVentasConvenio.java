...
public class DlgRegistroVentasConvenio extends JDialog {
    ...
    private void initialize() {
        FarmaColumnData columnsListaRegistroVentas[] = { new FarmaColumnData("Convenio", 360, JLabel.LEFT), 
                                                         new FarmaColumnData("T", 80, JLabel.CENTER),
        ...
        tableModelRegistroVentas = new FarmaTableModel(columnsListaRegistroVentas, defaultValuesListaRegistroVentas, 0);
    ...
    private void cargaRegistroVentas(String codConvs) {
        try {
            ...
            DBReportes.cargaListaRegistroVentasConvenio(tableModelRegistroVentas, VariablesReporte.vFechaInicio,
                                                VariablesReporte.vFechaFin, codConvs);
            if (tblRegistroVentas.getRowCount() <= 0) {
    ...
    private void imprimir() {
        ...
        try {
            ...
            vPrint.printBold("RANGO DE FECHAS: " + VariablesReporte.vFechaInicio + " AL " +VariablesReporte.vFechaFin, true);
            ...
            vPrint.printBold(FarmaPRNUtility.alinearIzquierda("CONVENIO",64) + " " +
                            ...
                            FarmaPRNUtility.alinearIzquierda("FECHA DOC.",20),
                             true);
            vPrint.printLine("=========================================================================================================================",
                             true);
            ...
            for (int i = 0; i < tblRegistroVentas.getRowCount(); i++) {
                ...
                vPrint.printCondensed(
                                        FarmaPRNUtility.alinearIzquierda((String)tblRegistroVentas.getValueAt(i, 0),64) + " " +
