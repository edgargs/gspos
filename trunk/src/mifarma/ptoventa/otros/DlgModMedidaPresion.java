...
public class DlgModMedidaPresion extends JDialog 
{
  ...
  private void cargaRangoValoresValidos()
  {
      ...
      System.err.println("rango de valores validos : "+VariablesOtros.vValMPValidos);
  }
  ...
  private void chkKeyPressed(KeyEvent e)
  {
    ...
    if(e.getKeyCode() == KeyEvent.VK_F11){
        if(validarDatos()){
        	...
        	if(FarmaUtility.rptaConfirmDialog(this, "Desea Actualizar Datos de la Medida Presion ?")){
