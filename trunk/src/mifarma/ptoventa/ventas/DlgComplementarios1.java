  ...
  private void listaProductosComplementarios() {
    try {
      ...
      VariablesVentas.vEsProdOferta=true;
        ...
        DBVentas.cargaListaProductosOferta(tableModelListaComplementarios,VariablesVentas.vCodProdOrigen_Comple1);      
...
/* ************************************************************************** */
  ...
  private void this_windowOpened(WindowEvent e)
  {
    ...
    System.out.println("Productos pedido : "+VariablesVentas.vArrayList_PedidoVenta);
...
/* ************************************************************************** */
  ...
  private void obtieneInfoProdEnArrayList(ArrayList pArrayList)
  {
    ...
    {
      if(!VariablesVentas.vEsProdOferta){
        System.out.println("BUSCA PRODUCTOS INFO");
        ...
        System.out.println("BUSCA PRODUCTOS INFOR OFERTA ");
  ...
  private void muestraInfoProd()
  {
    ...
    System.out.print("VariablesVentas.vEsProdOferta : "+VariablesVentas.vEsProdOferta);
    
    if(!VariablesVentas.vEsProdOferta){
      obtieneInfoProdPadreComple(myArray2);
     
    System.out.print("obtieneInfoProdPadreComple : "+myArray2);
    ...
    //System.out.println("Tamaño en muestra info" + myArray.size());
     if (myArray.size() == 1)
    {
    ...
    System.out.println("valPrecVtaReal :"+valPrecVtaReal);
    System.out.println("valPrecVta DESC :"+tblProductos.getValueAt(tblProductos.getSelectedRow(),6).toString());
    System.out.println("valAhorro :"+valAhorro);
  ...
  private void muestraIngresoCantidad()
  {
    ...
    if(VariablesVentas.vIndOrigenProdVta.equals(ConstantsVentas.IND_ORIGEN_OFER))
    {
      ...
      VariablesVentas.vVal_Prec_Vta = FarmaUtility.getValueFieldJTable(tblProductos,vFila,COL_PREC_VTA); //((String)(tblProductos.getValueAt(filaActual,6))).trim();
      ...
      System.out.println("VariablesVentas.vPorc_Dcto_1 : "+VariablesVentas.vPorc_Dcto_1);
      System.out.println("VariablesVentas.vPorc_Dcto_2 : "+VariablesVentas.vPorc_Dcto_2);
    }    
  ...
  private void verificaCheckJTable()
  {
    ...
    else
    {
      ...
      //System.out.println("VariablesVentas.vIndPedConProdVirtual " + VariablesVentas.vIndPedConProdVirtual);
          ...
          VariablesVentas.vIndPedConProdVirtual)
      {
        ...
        {
          //System.out.println("Se esta validando por compra ");
          FarmaUtility.showMessage(this, 
  ...
  private void seleccionaProducto()
  {
    ...
    /*System.out.println(VariablesVentas.vVal_Prec_Vta + " y  " + 
  ...
  private void guardaInfoProdVariables()
  {
    ...
    private boolean validaLoginVendedor()
    {
      ...
      try{
        ...
        System.out.println("FarnaVariables.NumSec: "+FarmaVariables.vNuSecUsu);
      if(FarmaVariables.vAceptar){    
