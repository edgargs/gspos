...
public class DBTomaInv {
     ...
     */
     ...
     System.out.println("valor "+parametros);
     ...
     */
     parametros.add(pIdUsu.trim());    
     System.out.println("valor "+parametros + pIdUsu);
		//parametros.add(FarmaVariables.vIdUsu.trim());
   ...
   */
    ...
    public static void getInfoProd(ArrayList pArrayList,
      ...
      System.out.println("load PTOVENTA_TOMA_INV.TI_F_VAR_DATOS_PROD(?,?,?) :"+parametros);
    ...
    public static void enviaCorreoCodBarraNoExiste(String pSecTomaInv,String pCodBarra,String pGlosa)throws SQLException
    {
        ...
        System.out.println("PTOVENTA_TOMA_INV.TI_P_ENVIA_EMAIL_NO_FOUND(?,?,?,?,?,?):" + parametros);
    ...
    {
        parametros = new ArrayList();
        System.out.println("Ptoventa_Toma_Inv_AUX.ti_p_actualiza_indices:" + parametros);
