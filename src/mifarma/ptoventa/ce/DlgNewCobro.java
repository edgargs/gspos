...
import mifarma.ptoventa.ce.DlgNewDetaPed;
import mifarma.ptoventa.ce.DlgTarjeCred;
import mifarma.ptoventa.ce.reference.DBCajaElectronica;
import mifarma.ptoventa.ce.reference.UtilityNewCobro;
...
public class DlgNewCobro extends JDialog {
    ...
    */
    ...
    private void initialize(){
        ...
        lbltelf.setVisible(false);
        lblmsgrec.setVisible(false);
        //ADIOS
        ...
        VariablesNewCobro.montoTarj_02=0;
    ...
    private void this_windowOpened(WindowEvent e) {
        ...
        VariablesCajaElectronica.vIndPedidoConProdVirtual = false;
        //VariablesFidelizacion.vRecalculaAhorroPedido = false;
        VariablesCajaElectronica.arrayDetFPCredito = new ArrayList();
        VariablesCajaElectronica.cobro_Pedido_Conv_Credito     = "N";
        VariablesCajaElectronica.uso_Credito_Pedido_N_Delivery = "N";
        VariablesCajaElectronica.arrayPedidoDelivery = new ArrayList();
        VariablesCajaElectronica.usoConvenioCredito = "";
        VariablesCajaElectronica.valorCredito_de_PedActual = 0.0;
        VariablesCajaElectronica.monto_forma_credito_ingresado = "0.00";
        /********ADIOSSSSSSSSSSSSSS******************************/
    ...
    private void buscaPedidoDiario()
    {
      ...
      try
      {
        ...
        //DBCaja.obtienePedidoaCambiar(myArray, VariablesCajaElectronica.vNumPedVta, VariablesCaja.vFecPedACobrar);       
        validaInfoPedido(myArray);
    ...
    private void muestraInfoPedido(ArrayList pArrayList)
    {
        ...
        if(!UtilityCaja.verificaEstadoPedido(this, VariablesNewCobro.numpedvta, ConstantsCaja.ESTADO_COBRADO, txtsol))
        {
            VariablesNewCobro.indPedidoEncontrado = FarmaConstants.INDICADOR_N;
            return;
        }
   ...
   /* private int cantidadProductosVirtualesPedido(String pNumPedido)
    ...
    private void agregarDetalle(String codFP, 
        ...
        //cambio para agregar el vuelto
        //VariablesNewCobro.vuelto="0.0";
        //Variable
        VariablesNewCobro.listDeta.add(objDPB);
        System.out.println("VariablesNewCobro.listDeta.size():  "+VariablesNewCobro.listDeta.size());
        //VariablesNewCobro.listDeta.add(objDPB);
        VariablesNewCobro.montoIngreso=VariablesNewCobro.montoSoles+VariablesNewCobro.montoDolares+VariablesNewCobro.montoTarj;        
        VariablesNewCobro.saldo=FarmaUtility.getDecimalNumber(FarmaUtility.formatNumber(VariablesNewCobro.montoTotal-VariablesNewCobro.montoIngreso));
        verificaMontoPagadoPedido();
        ...
        if(e.getKeyCode() == KeyEvent.VK_ENTER){
            if(FarmaUtility.isDouble(txttarj.getText())){
                ...
                if(monto==0){
                    ...
                    monto=plata;                    
                    DlgTarjeCred objTC=new DlgTarjeCred(myParentFrame,"",true,moneda); //ASOSA, 11.06.2010                    
    ...
    * */
    ...
    private void cobrarPedido()
    {
        ...
        cajita.setText(VariablesNewCobro.numpeddiario);
          ...
          if (!FarmaVariables.vAceptar) {
              System.out.println("VariablesNewCobro.listDeta: "+VariablesNewCobro.listDeta);
              VariablesNewCobro.listDeta.clear();              
          }
