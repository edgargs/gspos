...
public class DlgFormaPagoEntrega extends JDialog 
{
  ...
  private boolean validaMontoIngresado()
  {
    ...
    if(FarmaUtility.getDecimalNumber(monto) < 0)
    {
      if(com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this, "El monto ingresado es negativo. Está seguro de adicionar?"))
        return true;
      else
        return false;
    }
      ...
      if(VariablesCajaElectronica.vIndEliminacion.equalsIgnoreCase(FarmaConstants.INDICADOR_N))
      {
      ...
      } else
        {
          try
          {
            ...
            if (com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,"¿El sistema eliminará la forma de pago físicamente. Desea Continuar?"))
            {
                       ...
                       //RHERRERA 18.09.2014
                            try {
                                ...
                                if (res.equals("N")){
                                            FarmaUtility.showMessage(this, 
                                                    "No se puede eliminar el sobre.\n" +
                                                    "Porque el local FARMA lo esta visualizando",
                                                    null);
                                            FarmaUtility.liberarTransaccion();
                                            return;
                                        }
