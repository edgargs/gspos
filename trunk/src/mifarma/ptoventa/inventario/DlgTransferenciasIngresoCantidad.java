...
public class DlgTransferenciasIngresoCantidad extends JDialog
{
  ...
  private void aceptaCantidadIngresada()
  {
    if(validarCampos())
    {
      System.out.println("Validar Campos OK");  
      ...
      System.out.println("Antes Cargar Datos OK"); 
      //if(FarmaUtility.rptaConfirmDialog(this,"¿Está seguro de guardar los datos?"))
      {
        cargarDatos();
          System.out.println("Despues Cargar Datos OK"); 
        cerrarVentana(true);
      }
    }
  }
  ...
  private boolean validaStockActual()
  {
    ...
    System.out.println("VariablesInventario.vCant_Transf : " + VariablesInventario.vCant_Transf);
    System.out.println(" cantInic : " +  cantInic);
    System.out.println("VariablesInventario.vCantIngreso : " + VariablesInventario.vCantIngreso);
    int ss = (Integer.parseInt(VariablesInventario.vStk_Prod) + cantInic);
    System.out.println("Suma : " + ss);
    System.out.println("VariablesInventario.vCantIngreso : "+VariablesInventario.vCantIngreso);
