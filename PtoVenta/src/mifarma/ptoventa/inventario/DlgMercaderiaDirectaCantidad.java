...
public class DlgMercaderiaDirectaCantidad extends JDialog 
{
  ...
  private void aceptaCantidadIngresada() {
      ...
      precepTotal    = Integer.parseInt(VariablesInventario.vCantPedida); // + cantAdicPermitidaOCProd; ASOSA - 28/08/2014
         ...
         FarmaUtility.showMessage(this, "Debe ingresar una cantidad igual o menor a " + (precepTotal - cantAdicPermitidaOCProd) + " unidades", null);
          ...
          if(valInnerPackProd > 1){
              ...
              if(cantPaquetes > 0){
                  ...
                  if((ptotalProd / cantPedida) <= cantMultWithIP ) {   //ASOSA - 28/08/2014
                      setDetalleOrdenCompraRecep();
                      //FarmaUtility.showMessage(this, "Se agrego correctamente ", null);
                      cerrarVentana(true);
                  } else {
                      FarmaUtility.showMessage(this, "Máximo puede recepcionarse la cantidad pedida X " + 
                                                     cantMultWithIP + 
                                                     "\n En este caso maximo " + 
                                                     (cantPedida * cantMultWithIP), null);
                      FarmaUtility.moveFocus(txtEntero);
                  }
              ...
              int cantidadMaxExceso = (int)(ptotalProd * cantMultWithoutIP);
              if (ptotalProd <= cantidadMaxExceso) {
                  setDetalleOrdenCompraRecep();                  
                  cerrarVentana(true);
              } else {
                  FarmaUtility.showMessage(this, "Máximo puede recepcionarse " + 
                                                 cantidadMaxExceso + 
                                                 " Unidades", null);
                  FarmaUtility.moveFocus(txtEntero);
              }
