 ...
 *
 */
public class DlgDatosEfectivoRendido extends JDialog {
    /* ********************************************************************** */
    ...
    private void initTable() {
        ...
        tableModel =
                new FarmaTableModel(ConstantsCajaElectronica.columnsListaEfectivoRendidoDat, ConstantsCajaElectronica.defaultValuesListaEfectivoRendidoDat,
                                    0, ConstantsCajaElectronica.editableListaEfectivoRendidoDat, null);
        ...
        for (int k = 0; k < tableModel.getColumnCount(); k++) {
            TableColumn column =
                new TableColumn(k, ConstantsCajaElectronica.columnsListaEfectivoRendidoDat[k].m_width);
    ...
    private void setTipoCampo() {
        ...
        for (int i = 0; i < tblLista.getRowCount(); i++) {
            ...
            else if (codigoCampo.equals(ConstantsCajaElectronica.CAMPO_TRABAJADOR_LOCAL))
    ...
    private void getTxtTrabajador(int pRow, String pTipoCampo, String pInSoloLectura) {
        ...
        addKeyListenerToTextField2(txtTrabajador, pTipoCampo, pInSoloLectura, ConstantsPtoVenta.LISTA_TRABAJADOR,
                                   vCodTrabajador);
    ...
    private void getTxtTrabajadorLocal(int pRow, String pTipoCampo, String pInSoloLectura) {
        ...
        addKeyListenerToTextField2(txtTrabajadorLocal, pTipoCampo, pInSoloLectura,
                                   ConstantsPtoVenta.LISTA_TRABAJADOR_LOCAL, vCodTrabajadorLocal);
    ...
    private void getTxtCajero(int pRow, String pTipoCampo, String pInSoloLectura) {
        ...
        addKeyListenerToTextField2(txtCajero, pTipoCampo, pInSoloLectura, ConstantsPtoVenta.LISTA_TRABAJADOR_LOCAL,
                                   vCodCajero);
    ...
    private void getCmbNombreTitular(int pRow, String pInSoloLectura) {
        createJComboBox(cmbNomTitular, "CMB_NOMBRE_TITULAR", compValNomTitular, compDescNomTitular, pRow,
                        pInSoloLectura);
    }
    ...
    private void funcion() {
        if (validateMandatory()) {
            String serie, tipoComp, tipoBillete, tipoMoneda, formaPago, serieDocumento, numeroCuenta, titular, localNuevo, servicio, trabajador, proveedor, numeroDocumento;
            ...
            try {
                ...
                if (getMonto() && getMontoParcial() && getRuc() && getFechaHora() && getFechaEmision() &&
                    getCodAutorizacion() && getFechaVencimiento() && getMontoPerdido()) {
                    DBCajaElectronica.agregaDatosEfectivoRendido(tipoMoneda, monto, numeroCuenta, fechaOperacion,
                                                                 txtNumeroOperacion.getText().trim(),
                                                                 txtNombreAgencia.getText().trim(), fechaEmision,
                                                                 serie, tipoComp, txtNumeroComp.getText().trim(),
                                                                 titular, codAutorizacion, trabajador,
                                                                 txtMotivo.getText().trim(), formaPago,
                                                                 txtSerieBillete.getText().trim(), tipoBillete,
                                                                 montoParcial, ruc, txtRazonSocial.getText().trim(),
                                                                 localNuevo, servicio, numeroDocumento, proveedor,
                                                                 fechaVencimiento, serieDocumento, montoPerdido,
                                                                 txtNumeroPedido.getText().trim());
        ...
        for (int i = 0; i < tblLista.getRowCount(); i++) {
            if (((String)tblLista.getValueAt(i, 5)).trim().equalsIgnoreCase("S")) {
                if (((String)tblLista.getValueAt(i,
                                                 2)).trim().equalsIgnoreCase(ConstantsCajaElectronica.CAMPO_FORMA_PAGO)) {
                    String formaPago = getFormaPago();
                    String tipMoneda = getTipoMoneda();
                    if ((formaPago.equals(ConstantsCaja.FORMA_PAGO_EFECTIVO_SOLES) &&
                         !tipMoneda.equalsIgnoreCase(FarmaConstants.MONEDA_SOLES)) ||
                        (formaPago.equals(ConstantsCaja.FORMA_PAGO_EFECTIVO_DOLARES) &&
                         !tipMoneda.equalsIgnoreCase(FarmaConstants.MONEDA_DOLARES))) {
                        dataExists = false;
                        moveFocusTo(i);
                        FarmaUtility.showMessage(this,
                                                 "La forma de pago no coincide con el tipo de moneda. Verifique!!!",
                                                 null);
                        break;
                    } else
                        continue;
                ...
                if (((String)tblLista.getValueAt(i,
                                                 2)).trim().equalsIgnoreCase(ConstantsCajaElectronica.CAMPO_NUMERO_CUENTA)) {
                ...
                if (((String)tblLista.getValueAt(i,
                                                 2)).trim().equalsIgnoreCase(ConstantsCajaElectronica.CAMPO_RAZON_SOCIAL)) {
    ...
    private boolean getFechaHora() {
        ...
        if (txtFecha.length() == 0) {
            ...
            retorno = false;
            FarmaUtility.showMessage(this,
                                     "Debe ingresar la fecha de operación en el siguiente formato: dd/MM/yyyy HH24:mm:ss",
                                     tblLista);
    ...
    private boolean getFechaEmision() {
        ...
        if (txtFecha.length() == 0) {
            ...
            retorno = false;
            FarmaUtility.showMessage(this, "Debe ingresar la fecha de emisión en el siguiente formato: dd/MM/yyyy",
                                     tblLista);
