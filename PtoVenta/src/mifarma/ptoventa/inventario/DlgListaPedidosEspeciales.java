...
public class DlgListaPedidosEspeciales extends JDialog {
    ...
    private void initTable() {
        tableModel =
                new FarmaTableModel(ConstantsInventario.columnsListaPedidosEspeciales, ConstantsInventario.columnsListaPedidosEspeciales,
                                    0);
        ...
        if (validarFechas()) {
            ...
            if (FechaInicio.length() > 0 || FechaFin.length() > 0) {
                ...
                if (!Character.isLetter(primerkeyCharFI) && !Character.isLetter(ultimokeyCharFI) &&
                    ...
                    FarmaUtility.showMessage(this, "Ingrese un formato valido de fechas", txtFecIni);
            } else
                FarmaUtility.showMessage(this, "Ingrese datos para la busqueda", txtFecIni);
        ...
        if (vEstado.equals(ConstantsInventario.ESTADO_PENDIENTE_PEDIDO_ESPECIAL) ||
            ...
            try {
                ...
                DBInventario.setEstadoPedidoEspecial(VariablesInventario.vNumPedidoEspecial,
                                                     ConstantsInventario.EST_MODIFICADO);
                DlgResumenPedidoEspecial dglResuPedidoEspecial = new DlgResumenPedidoEspecial(myParentFrame, "", true);
                dglResuPedidoEspecial.setVisible(true);
