...
public class DBFidelizacion {
    ...
    public static void listarCamposFidelizacion(FarmaTableModel pTableModel) throws SQLException {
        parametros = new ArrayList();
        FarmaDBUtility.executeSQLStoredProcedure(pTableModel, "PTOVENTA_FIDELIZACION.FID_F_CUR_LISTA_FIDELIZACION",
                                                 parametros, false);
    }
    ...
    public static void buscarTarjetasXDNI(FarmaTableModel pTableModel, String pDni) throws SQLException {
        pTableModel.clearTable();
        parametros = new ArrayList();
        parametros.add(pDni);
        parametros.add(FarmaVariables.vCodLocal);
        ...
        FarmaDBUtility.executeSQLStoredProcedure(pTableModel, "PTOVENTA_FIDELIZACION.FID_F_CUR_TARJETA_X_DNI(?,?)",
                                                 parametros, false);
