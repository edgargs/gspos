...
public class DlgListaImpresoraMaquina extends JDialog {
    ...
    private void cargaLista() {
        try {
            DBImpresoras.getListaImpr(tableModel,VariablesImpresoras.vSecIP);
    ...
    private void actualizarlistaRolesSeleccion() {
        ...
        VariablesImpresoras.vTipoComp = tblLista.getValueAt(tblLista.getSelectedRow(), 5).toString().trim();  
          ...
          try{
            DBImpresoras.actualizaRelacion(VariablesImpresoras.vSecIP, VariablesImpresoras.vSecImpr,VariablesImpresoras.vNumSerie,
