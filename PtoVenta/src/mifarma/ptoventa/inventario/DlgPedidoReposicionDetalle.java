...
public class DlgPedidoReposicionDetalle extends JDialog {
    ...
    private void initTable() {
        tableModel =
                new FarmaTableModel(ConstantsInventario.columnsListaProductosPedidoReposicionDetalle, ConstantsInventario.defaultValuesListaProductosPedidoReposicionDetalle,
                                    0);
        FarmaUtility.initSimpleList(tblListaProductos, tableModel,
                                    ConstantsInventario.columnsListaProductosPedidoReposicionDetalle);
        cargaListaProductos();
    ...
    private void cargaListaProductosFiltro() {
        try {
            DBInventario.cargaDetallePedidoReposicionFiltro(tableModel, lblPedido.getText(),
    ...
    private void ingresarCantidad() {
         ...
         * */
                ...
                DlgPedidoReposicionCantidadMatriz dlgPedidoReposicionCantidadMatriz =
                    new DlgPedidoReposicionCantidadMatriz(myParentFrame, "", true);
    ...
    private void muestraDetalleOrd() {
        ...
        FarmaLoadCVL.loadCVLfromArrays(dlgOrdenar.getCmbCampo(), VariablesInventario.vNombreInHashtable,
                                       ConstantsInventario.vCodCampoPedRep, ConstantsInventario.vDescCampoPedRep,
                                       true);
