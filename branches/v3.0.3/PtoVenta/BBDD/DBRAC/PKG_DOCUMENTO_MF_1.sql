    ...
    CURSOR C_CABECERA_NC IS
      SELECT T.*,(T.MTO_TOTAL-T.MTO_EXONERADO-T.MTO_IMPUESTO) MTO_BASE_IMP
        ...
        nvl(D.PORC_DCTO_CALC, 0) PCT_DESCUENTO,
          ...
          -- KMONCADA 17.10.2014 VALIDA DETALLE DE DOCUMENTO
...
*/
               ...
               --ERIOS 14.10.2014 Logica de AESCATE
               CASE WHEN reg_cab.num_documento_ref IS NULL THEN 100
               ELSE reg_cab.pct_beneficiario END, --22
