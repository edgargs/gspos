  ...
  private void btnDetallePedido_actionPerformed(ActionEvent e)
  {
	...
	private void chkKeyPressed(KeyEvent e) {
			...
			if(tblListaDetallePedido.getRowCount() > 0)
      {
          ...
          if(FarmaUtility.rptaConfirmDialog(this,"Está seguro de generar el pedido institucional?"))
            cerrarVentana(true);
      }
...
// **************************************************************************
  ...
  private void verificaCheckJTable()
  {
    ...
    {
      if(FarmaUtility.rptaConfirmDialog(this,"Esta acción eliminará todas las cantidades seleccionadas.\nEstá seguro de eliminar?"))
  ...
  private boolean isContieneLotesDetallePedidos(){
      String pResultado = "N";
        try {
                System.err.println("VariablesDelivery.vNumeroPedido_bk:"+VariablesDelivery.vNumeroPedido_bk);
                System.err.println("VariablesDelivery.vCodLocal_bk:"+VariablesDelivery.vCodLocal_bk);
                pResultado = DBDelivery.isContienLotesProductos(VariablesDelivery.vCodLocal_bk,
                                                                VariablesDelivery.vNumeroPedido_bk);
            
            System.err.println("isContieneLotesDetallePedidos():"+pResultado);
            } catch (Exception e) {
            pResultado = "N";      
            System.err.println("Error al obtener ind Productos x Lote del Pedido:"+e.getMessage());
        }
