    ...
    private void reimprimirPedido() {
        ...
        try {
            ...
            try {
                ...
                if("1".equalsIgnoreCase(indComprElectronico) && !"0".equalsIgnoreCase(VariablesCaja.vNumComp)){
                    flag = electronico.printDocumento(VariablesCaja.vNumPedVta, VariablesCaja.vSecComprobante, true, true);  
                    if (flag) {
                    ...
                    if ("S".equalsIgnoreCase(DBCaja.getIndPedConvenio(VariablesCaja.vNumPedVta))) {
                        ...
                        if (!"0".equalsIgnoreCase(VariablesCaja.vNumComp) ||
                            ConstantsVentas.TIPO_COMP_NOTA_CREDITO.equalsIgnoreCase(VariablesVentas.vTip_Comp_Ped)) {
                            //if (indicElectronico.equalsIgnoreCase(ConstantesDocElectronico.INDELECTRONICO)) {
                            //KMONCADA
                            if (indElectronico.equalsIgnoreCase(ConstantesDocElectronico.IND_COMPROBANTE_ELECTRONICO)) {
