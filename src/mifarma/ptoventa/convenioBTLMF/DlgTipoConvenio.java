...
public  class DlgTipoConvenio extends JDialog {
	...
	private void chkKeyPressed(KeyEvent e)
	{
		...
		System.out.println("Evento:" +e.getKeyCode());

		if (e.getKeyCode() == KeyEvent.VK_ESCAPE)
		{
		   System.out.println("Cerramos la ventana");
	    ...
	    {
	    	System.out.println("Ingresamos a la patantalla de datos");
	    	...
	    	System.out.println("VariablesConvenioBTLMF.vFlgTipoConvenio :" +VariablesConvenioBTLMF.vFlgTipoConvenio);
            ...
            System.out.println("VariablesConvenioBTLMF.vFlgTipoConvenioRel :" +VariablesConvenioBTLMF.vFlgTipoConvenioRel);
            System.out.println("vTipoConvenio :" +vTipoConvenio);
	    	...
	    	if( vTipoConvenio.equals(ConstantsConvenioBTLMF.FLG_TIP_CONV_CONTADO))
	    	{
	    		...
	    		{
	    			System.out.println("SELECCIONAMOS AL CONTADO");
	    	...
	    	if(vTipoConvenio.equals(ConstantsConvenioBTLMF.FLG_TIP_CONV_CREDITO))
	    	{
	    		...
	    		{
	    			System.out.println("SELECCIONAMOS AL CREDITO");
	...
	private void inicializaFocus()
	{
		...
		VariablesConvenioBTLMF.vFlgTipoConvenio    = UtilityConvenioBTLMF.obtieneTipoConvenio(this, null, VariablesConvenioBTLMF.vCodConvenio);
		System.out.print("metodo:inicializaFocus"+VariablesConvenioBTLMF.vFlgTipoConvenio);
		if(VariablesConvenioBTLMF.vFlgTipoConvenio.equals(ConstantsConvenioBTLMF.FLG_TIP_CONV_CREDITO))
		{
