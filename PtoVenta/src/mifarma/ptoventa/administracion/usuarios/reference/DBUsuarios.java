...
public class DBUsuarios {
    ...
    public static void getListaUsuarios(FarmaTableModel pTableModel, String pActivo) throws SQLException {
        ...
        FarmaDBUtility.executeSQLStoredProcedure(pTableModel, "PTOVENTA_ADMIN_USU.USU_LISTA_USUARIOS_LOCAL(?,?,?)",
                                                 parametros, false);
    }
    ...
    public static void ingresaUsuario(String pCodTrab, String pNomUsu, String pApePat, String pApeMat,
                                      String pLoginUsu, String pClaveUsu, String pTelefUsu, String pDireccUsu,
                                      String pFecNac, String pDni, String pCodRRHH) throws SQLException {
        parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        ...
        FarmaDBUtility.executeSQLStoredProcedure(null,
                                                 "PTOVENTA_ADMIN_USU.USU_INGRESA_USUARIO(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                                                 parametros, false);
    }

    public static void actualizaUsuario(String pSecUsuLocal, String pCodTrab, String pNomUsu, String pApePat,
                                        String pApeMat, String pLoginUsu, String pClaveUsu, String pTelefUsu,
                                        String pDireccUsu, String pFecNac, String pDni) throws SQLException {
        parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
        ...
        FarmaDBUtility.executeSQLStoredProcedure(null,
                                                 "PTOVENTA_ADMIN_USU.USU_MODIFICA_USUARIO(?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                                                 parametros, false);
    }
    ...
    public static void eliminaUsuario(String pSecUsuLocal) throws SQLException {
        ...
        parametros.add(pSecUsuLocal);
        parametros.add(FarmaVariables.vIdUsu);
        FarmaDBUtility.executeSQLStoredProcedure(null, "PTOVENTA_ADMIN_USU.USU_CAMBIA_ESTADO_USU(?,?,?,?)", parametros,
                                                 false);
    }
    ...
    public static void getListaRolesAsignados(FarmaTableModel pTableModel) throws SQLException {
        ...
        FarmaDBUtility.executeSQLStoredProcedure(pTableModel, "PTOVENTA_ADMIN_USU.USU_LISTA_ROLES_USUARIO(?,?,?)",
                                                 parametros, false);
    }

    public static void getListaRoles(FarmaTableModel pTableModel) throws SQLException {
        pTableModel.clearTable();
        parametros = new ArrayList();

        FarmaDBUtility.executeSQLStoredProcedure(pTableModel, "PTOVENTA_ADMIN_USU.USU_LISTA_ROLES", parametros, true);
    }
    ...
    public static void limpiaAsignacionUsuario(String pSecUsuLocal) throws SQLException {
        ...
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(pSecUsuLocal);
        FarmaDBUtility.executeSQLStoredProcedure(null, "PTOVENTA_ADMIN_USU.USU_LIMPIA_ROLES_USUARIO(?,?,?)",
                                                 parametros, false);

    }

    public static void agregaAsignacionUsuario(String pSecUsuLocal, String pCodRol) throws SQLException {
        parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(pSecUsuLocal);
        ...
        parametros.add(FarmaVariables.vIdUsu);
        FarmaDBUtility.executeSQLStoredProcedure(null, "PTOVENTA_ADMIN_USU.USU_AGREGA_ROL_USUARIO(?,?,?,?,?)",
                                                 parametros, false);
    }
    ...
    public static void getDatosTrab(ArrayList datosUsuario) throws SQLException {
        ...
        FarmaDBUtility.executeSQLStoredProcedureArrayList(datosUsuario,
                                                          "PTOVENTA_ADMIN_USU.USU_OBTIENE_DATA_TRABAJADOR(?,?)",
                                                          parametros);
    ...
    public static String verificaDuplicidadNumUsuario(String pCodTrab) throws SQLException {
        ...
        rpta =
FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_ADMIN_USU.USU_EXISTE_DUPLICADO(?,?,?)", parametros);
        return rpta;
    ...
    public static String verificaDuplicidadLoginUsuario(String pCodTrab) throws SQLException {
        ...
        parametros.add(pCodTrab);
        rpta =
FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_ADMIN_USU.USU_EXISTE_LOGIN_DUPLICADO(?,?,?)", parametros);
        return rpta;
    ...
    public static void obtieneListaTrabajadores(FarmaTableModel pTableModel) throws SQLException {
        ...
        FarmaDBUtility.executeSQLStoredProcedure(pTableModel, "PTOVENTA_ADMIN_USU.USU_LISTA_TRABAJADORES(?)",
                                                 parametros, false);
    }
    ...
    public static void obtieneListaTrabajadoresLocal(FarmaTableModel pTableModel) throws SQLException {
        ...
        FarmaDBUtility.executeSQLStoredProcedure(pTableModel, "PTOVENTA_ADMIN_USU.USU_LISTA_TRABAJADORES_LOCAL(?,?)",
                                                 parametros, false);
    }
    ...
    public static String buscaCajaAsignada(String sec_usuario) throws SQLException {
        ...
        return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_ADMIN_USU.USU_EXISTE_CAJA(?,?,?)",
                                                           parametros).trim();
    }
    ...
    public static String buscaUsuSinCajaAsignada() throws SQLException {
        ...
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
        return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_ADMIN_USU.USU_EXISTE_USU_SIN_CAJA(?,?)",
                                                           parametros).trim();
    }
    ...
    public static void cambiaEstadoCaja(String pNumCaja) throws SQLException {
        ...
        parametros.add(FarmaVariables.vIdUsu);
        FarmaDBUtility.executeSQLStoredProcedure(null, "PTOVENTA_ADMIN_CAJA.CAJ_CAMBIAESTADO_CAJA(?,?,?,?)",
                                                 parametros, false);
    }
    ...
    public static String obtieneEstadoCaja(String pNumCaja) throws SQLException {
        ...
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(new Integer(pNumCaja.trim()));
        return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_ADMIN_CAJA.CAJ_OBTIENE_ESTADO_CAJA(?,?,?)",
                                                           parametros).trim();
    }
    ...
    public static String validaDiasMaximos(String vLogin) throws SQLException {
        ...
        rspt =
FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_ADMIN_USU.USU_VALIDA_ACTULIZACION(?,?,?)", parametros);
        return rspt;
    }
    ...
    public static void getMensajeUsuario(ArrayList pArray, String pSecUsu) throws SQLException {
        ...
        FarmaDBUtility.executeSQLStoredProcedureArrayList(pArray, "PTOVENTA_ADMIN_USU.GET_MENSAJE_USU(?,?,?)",
                                                          parametros);
    }
    ...
    public static void actCantVeces(String pSecUsu) throws SQLException {
        ...
        parametros.add(pSecUsu);
        parametros.add(FarmaVariables.vIdUsu);
        FarmaDBUtility.executeSQLStoredProcedure(null, "PTOVENTA_ADMIN_USU.ACT_MENSAJE_USU(?,?,?,?)", parametros,
                                                 false);
    }
    ...
    public static void getDatosTrabLocal(ArrayList datosUsuario) throws SQLException {
        ...
        FarmaDBUtility.executeSQLStoredProcedureArrayList(datosUsuario,
                                                          "PTOVENTA_ADMIN_USU.USU_OBTIENE_DATA_TRAB_LOCAL(?,?,?,?)",
                                                          parametros);
    ...
    public static String verificaExistenciaUsuarioCarne(String pCodTrab) throws SQLException {
        ...
        rpta =
FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_ADMIN_USU.USU_EXISTE_USUARIO_CARNE(?,?,?)", parametros);
        return rpta;
    ...
    public static void insertarCarneUsuario() throws SQLException {
        ...
        parametros.add(FarmaVariables.vIdUsu);//CHUANES -08/04/2015

        log.debug("****///////Antes de Actualizar" + parametros);
        FarmaDBUtility.executeSQLStoredProcedure(null, "PTOVENTA_ADMIN_USU.USU_INGRESA_CARNE_USUARIO(?,?,?,?,?,?,?,?,?)",
                                                 parametros, false);
    }
    ...
    public static void enviaAlertaRegistroCarneUsuario() throws SQLException {
        ...
        FarmaDBUtility.executeSQLStoredProcedure(null,
                                                 "PTOVENTA_ADMIN_USU.USU_ALERTA_INSR_CARNE_USUARIO(?,?,?,?,?,?,?,?)",
                                                 parametros, false);
    }
...
FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_ADMIN_USU.USU_OBTIENE_FECVENC_PROX(?,?,?)", parametros);
    ...
    public static String verificaUsuarioCarnedUPLICADO(String pCodTrabRRhh, String pNumCarne) throws SQLException {
        ...
        rpta =
FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_ADMIN_USU.USU_EXISTE_DUPLICADO_CARNE(?,?,?,?)", parametros);
        return rpta;
