...
public class FormatoImpresion {
    ...
    public ArrayList<String> formatoGuiaBTL(JDialog   pJDialog,
                                        ...
                                        String    pValRedondeoComPago,
                                            String pRazonSocial,
                                            String pDireccionDestino,
                                            String pNumeroRUC,
                                            String vPrctBeneficiario,
                                            String vPrctEmpresa,
                                            int margen){
           ...
           try
            {
                ...
                if(VariablesPtoVenta.vIndDirLocal){     
                    lineaDirecLocal = FarmaPRNUtility.alinearIzquierda("NUEVA DIR: "+FarmaVariables.vDescCortaDirLocal, 69);
                } 
                ...
                String lineaDatosDestino = FarmaPRNUtility.llenarBlancos(15)+
                                           FarmaPRNUtility.alinearIzquierda(VariablesConvenioBTLMF.vCodConvenio+"-"+pRazonSocial,70)+FarmaPRNUtility.llenarBlancos(15);
               ...
               if (VariablesVentas.vTipoPedido.equalsIgnoreCase("03")){ //RHERRERA 26-06-2014
                   ...
                   /*7*/vPrint.add(vMargen+lineaDatosDestino + "No. " + pNumComprobante.substring(0,3) + "-" + pNumComprobante.substring(3,10));
                   //NOMBRE O RAZON SOCIAL
                   /*8*/vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(22) + pRazonSocial);
                   //DIRECCION  DEL PUNTO DE LLEGADA
                   /*9*/vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(26) + FarmaPRNUtility.alinearIzquierda(VariablesConvenioBTLMF.vPuntoLlegada,60)
                                    +FarmaPRNUtility.llenarBlancos(20) +vRefTipComp+":"+pNumCompCoPago.substring(0,3)+"-"+pNumCompCoPago.substring(3,10));
                   //NUMERO DE RUC Y MOTIVO (TODO)
                   /*10*/
                       //RHERRERA
                        vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(10) + pNumeroRUC+FarmaPRNUtility.llenarBlancos(40)+
                ...
                /*8*/vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(22) + pRazonSocial);
                //DIRECCION  DEL PUNTO DE LLEGADA
                /*9*/vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(26) + FarmaPRNUtility.alinearIzquierda(pDireccionDestino,60));
                //NUMERO DE RUC Y MOTIVO (TODO)
                /*10*/
               ...
               /*12*/vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(10) +
                ...
                for (int i=0; i<pDetalleComprobante.size(); i++)
                {
                    ...
                    if(VariablesVentas.vTipoPedido.equalsIgnoreCase("03")){
                    colSubTotal = ((String)((ArrayList)pDetalleComprobante.get(i)).get(20)).trim(); // hace referencia al FECHA VENCIMIENTO
                    punitario =   ((String)((ArrayList)pDetalleComprobante.get(i)).get(19)).trim(); // HACE REFERENCIA AL LOTE DEL PROD.
                    }
                    else {// PROCESO NORMAL
                    ...
                    String lineaDetalle = FarmaPRNUtility.llenarBlancos(10) +
                        FarmaPRNUtility.alinearIzquierda(codigoProd,15) + FarmaPRNUtility.llenarBlancos(5) +
                        FarmaPRNUtility.alinearIzquierda(descProd,35) + FarmaPRNUtility.llenarBlancos(5) +
                        FarmaPRNUtility.alinearIzquierda(cantVenta,10) + FarmaPRNUtility.llenarBlancos(20) +
                        FarmaPRNUtility.alinearDerecha(precioUnit,15) + FarmaPRNUtility.llenarBlancos(1) +
                        FarmaPRNUtility.alinearDerecha(precioSubTotal,15) ;
               ...
               for (int j=linea; j<5; j++){  vPrint.add(vMargen+" ");  linea += 1;}
               ...
               /*if(pTipoClienteConvenio.equals("1")){
                ...
                ValCopagoCompPagoSinIGV = FarmaUtility.getDecimalNumber(pValCopagoCompPago)-FarmaUtility.getDecimalNumber(pValIgvComCoPago);
...
*/
                if (VariablesConvenioBTLMF.vFlgImprimeImportes.equals("1"))
                {
                    ...
                    vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(100) + 
                                    "Sub Total   S/. " + FarmaPRNUtility.alinearDerecha(FarmaUtility.formatNumber(SumSubTotal),15));
                    vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(100) + 
                                    "Coaseguro   S/. " + FarmaPRNUtility.alinearDerecha("-"+FarmaUtility.formatNumber(ValCopagoCompPagoSinIGV),15));
                    vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(100) + 
                                    "SUB TOTAL   S/. " + FarmaPRNUtility.alinearDerecha(FarmaUtility.formatNumber(neto),15));
                    vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(100) + 
                                    "     IGV    S/. " + FarmaPRNUtility.alinearDerecha(pValIgvComPago,15));
                    vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(116) + 
                            FarmaPRNUtility.alinearDerecha("---------------",15)); 
                    vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(100) + 
                                    "   TOTAL    S/. " + FarmaPRNUtility.alinearDerecha(FarmaUtility.formatNumber(pValTotalNetoRedondeo),15));
                }else{
                    for (int j=linea; j<5+7; j++){  vPrint.add(vMargen+" ");  linea += 1;}
                }
               ...
               String lineaInstitucion = "";
                ...
                if(pCodTipoConvenio.equals("1") || pCodTipoConvenio.equals("3"))
                {
                    ...
                    lineaInstitucion = lineaInstitucion+
                    ...
                    if(vRefTipComp != null && !vRefTipComp.trim().equals("")){
                        ...
                        //if (VariablesConvenioBTLMF.vFlgImprimeImportes.equals("1")){
                            ...
                            lineaReferencia = "  #REF: "+vRefTipComp+" " + FarmaPRNUtility.alinearIzquierda(pNumCompCoPago+ " ("+FarmaUtility.formatNumber(porcCopagoEmpresa,"")+"%)"+
        ...
        if (VariablesVentas.vTipoPedido.equalsIgnoreCase(ConstantsVentas.TIPO_PEDIDO_INSTITUCIONAL)){
            ...
            for (int j=linea; j<5+7+5; j++){  vPrint.add(vMargen+" ");  linea += 1;}
            linea = linea-17;
                ...
                if (pImprDatAdic.equals("1")){
                    linea = imprimeDatosAdicionales(vPrint, vMargen);
                }                
                ...
                /*vPrint.add(" SON:" + FarmaPRNUtility.alinearIzquierda(FarmaPRNUtility.montoEnLetras(pValTotalNetoRedondeo).trim(),65) + "" +
                                ...
                                "    S/. " + FarmaPRNUtility.alinearDerecha(FarmaUtility.formatNumber(ValCopagoCompPagoSinIGV),10)+"");*/
                vPrint.add(vMargen+" "); 
                //vPrint.add(vMargen+" ");
                vPrint.add("      "+VariablesVentas.vMensajeBotiquinBTLVtaInstitucional); //kmoncada 10.07.14 impresion de poliza en vta empresa
                vPrint.add(vMargen+" ");                
                vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(132)+"X");
                vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(105)+"Vta. Sujeta a Confirmacion");
                vPrint.add(vMargen+" ");                
                vPrint.add(vMargen+" ");                                
                vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(100)+VariablesPtoVenta.vVersion);
    ...
    public ArrayList<String>  formatoFacturaBTL(JDialog   pJDialog,
						        ArrayList pDetalleComprobante,
						        String    pValTotalNeto,
						        String    pNumComprobante,
						        String    pValIgvComPago,
        ...
        if (pRefTipComp.equals(ConstantsVentas.TIPO_COMP_TICKET)) vRefTipComp = "TKB";  
          ...
          log.debug("Imprimiendo Numero de Comprobante: " + pNumComprobante); 
              ...
              try {
                  ...
                  String lineaDirecLocal = "";
                  if(VariablesPtoVenta.vIndDirLocal){     
                      lineaDirecLocal = FarmaPRNUtility.alinearIzquierda("NUEVA DIR: "+FarmaVariables.vDescCortaDirLocal, 42);
                  }
                  ...
                  String lineaDirecMatriz = "";
                  if(VariablesPtoVenta.vIndDirMatriz){
                    lineaDirecMatriz = FarmaPRNUtility.llenarBlancos(20)+FarmaPRNUtility.alinearIzquierda(VariablesPtoVenta.vDireccionMatriz,69);                
                  }
                  vPrint.add(vMargen+lineaDirecMatriz);
                  
                  //FECHA Y NUMERO DE DOCUMENTO
                  vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(15)+ dia + " de " + mesLetra + " del " + ano + "     " + hora +FarmaPRNUtility.llenarBlancos(55)+ "No. " + pNumComprobante.substring(0,3) + "-" + pNumComprobante.substring(3,10));
                  
                  //SENORES     
                  vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(15) + FarmaPRNUtility.alinearIzquierda(pNomImpreso.trim(),60));
                  ...
                  //RUC Y OC
                  vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(15) + pNumDocImpreso.trim()+FarmaPRNUtility.alinearIzquierda("",60)+FarmaPRNUtility.llenarBlancos(10)+vOC);
                  ...
                  vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(15) + FarmaPRNUtility.alinearIzquierda(pDirImpreso.trim(),60)+FarmaPRNUtility.llenarBlancos(19)+vGuia);
            ...
            for (int i = 0; i < pDetalleComprobante.size(); i++) {
                ...
                vPrint.add(vMargen + FarmaPRNUtility.llenarBlancos(3) +
                           FarmaPRNUtility.alinearIzquierda(((String)((ArrayList)pDetalleComprobante.get(i)).get(0)).trim(),6) + 
                           ...
                           FarmaPRNUtility.alinearIzquierda(((String)((ArrayList)pDetalleComprobante.get(i)).get(1)).trim() +
                                                            ...
                                                            60) + 
                           FarmaPRNUtility.llenarBlancos(9) +
                           FarmaPRNUtility.alinearDerecha(((String)((ArrayList)pDetalleComprobante.get(i)).get(4)).trim(),11) + 
                           FarmaPRNUtility.llenarBlancos(8) + 
         ...
         //*************************************INFORMACION DEL CONVENIO***********************************************//
            if (vEsPedidoConvenio) {
              ...
              neto = SumSubTotal-ValCopagoCompPagoSinIGV;
              ...
              pValTotalNetoRedondeo  = FarmaUtility.getDecimalNumber(pValTotalNeto)+
                                              FarmaUtility.getDecimalNumber(pValRedondeoComPago);
              ...
              if (VariablesVentas.vTipoPedido.equalsIgnoreCase(ConstantsVentas.TIPO_PEDIDO_INSTITUCIONAL)){ //RHERRERA 26-06-2014
                  ...
                  for (int j=linea; j<10; j++){  vPrint.add(vMargen+" "); linea++;}
                  linea = linea - 10;
              } else {    
                ...
                if(pCodTipoConvenio.equals("1") || pCodTipoConvenio.equals("3")){
                    vLinea =  FarmaPRNUtility.llenarBlancos(85)+"            "+
                             "Coaseguro("+FarmaUtility.formatNumber(porcCopagoBenef,0)+"%)    S/. " + FarmaPRNUtility.alinearDerecha(FarmaUtility.formatNumber(ValCopagoCompPagoSinIGV),10);
                    vPrint.add(vMargen+vLinea);
                       
                    String vPorcCopago = "";
                    if (VariablesConvenioBTLMF.vFlgImprimeImportes.equals("1")){                     
                        vPorcCopago = "("+FarmaUtility.formatNumber(porcCopagoBenef,"")+"%)"+" - " + "S/."+pValCopagoCompPago;
                    }
                    lineaReferencia = "  #REF: "+vRefTipComp+" " + FarmaPRNUtility.alinearIzquierda(pNumCompCoPago+vPorcCopago,65);
                ...
                for (int j=linea; j<2; j++)  vPrint.add(vMargen+" "); 
                  
            }//FIN DEL PROCESO VALIDACION RHERRERA 26062014
        }else{
              for (int j=linea; j<5+5; j++){  vPrint.add(vMargen+" "); linea++;}
              //Ahorro
                       ...
                       VariablesVentas.vTipoPedido.equalsIgnoreCase(ConstantsVentas.TIPO_PEDIDO_INSTITUCIONAL) )
              {
                  ...
                  VariablesVentas.vTituloDelivery = " - PEDIDO DELIVERY - " ;
              }
              
              String datoAdic = " REDO:" + pValRedondeoComPago +
              " CAJERO:" + VariablesCaja.vNomCajeroImpreso + " " + VariablesCaja.vApePatCajeroImpreso + " " +
              " CAJA:" + VariablesCaja.vNumCajaImpreso +
              " TURNO:" + VariablesCaja.vNumTurnoCajaImpreso +
              " VEND:" + VariablesCaja.vNomVendedorImpreso + " " +VariablesCaja.vApePatVendedorImpreso;
              ...
              neto = pValTotalNetoRedondeo-SumMontoIGV;
                  ...
                  vPrint.add("      "+VariablesVentas.vMensajeBotiquinBTLVtaInstitucional);
                  vPrint.add(vMargen);
                  
                  /*****IMPRIME EL MONTO TOTAL EL LETRAS******/
                  String  vLinea = " SON: " + FarmaPRNUtility.alinearIzquierda(FarmaPRNUtility.montoEnLetras(pValTotalNetoRedondeo),85);
                  vPrint.add(vMargen+vLinea);
                  
          
                  /*******IMPRIME IGV Y MONTO NETO*******/
                      vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(8)+ FarmaPRNUtility.llenarBlancos(10) +                            
                                        FarmaPRNUtility.llenarBlancos(40) +
                                       "%   " + FarmaPRNUtility.alinearDerecha(pPorcIgv,10)); 
                  vPrint.add(vMargen+FarmaPRNUtility.llenarBlancos(15)+
                          FarmaPRNUtility.alinearDerecha(FarmaUtility.formatNumber(neto),10) +
                           FarmaPRNUtility.llenarBlancos(40) +
                                   "S/. " + FarmaPRNUtility.alinearDerecha(FarmaUtility.formatNumber(SumMontoIGV),10) + FarmaPRNUtility.llenarBlancos(40) +
                                   "S/. " + FarmaPRNUtility.alinearDerecha(pValTotalNetoRedondeo,10));
    ...
    public static void main(String[] args) {
        ...
        VariablesPtoVenta.vVersion = "v2.4.3";
            
        FormatoImpresion formatoImpresion = new FormatoImpresion();
        Impresora impresora = new Impresora();
        VariablesPtoVenta.vDireccionMatriz = "Calle Victor Alzamora 1340, Urb. la anpilla , La votria lima, peru tierra solas";
        ArrayList<String> vPrint = formatoImpresion.formatoGuiaBTL(null, pDetalleComprobante, "100.00", 
"5061233456", "18.00", "0.00", "XXX", "num", "C:\\RUTA.TXT", 
false, "1", "CLI", "04", "10/01/2010 12:09:23", "BOL", "0.05",
                                                                   VariablesConvenioBTLMF.vInstitucion.trim(),
                                                                   VariablesConvenioBTLMF.vDireccion.trim(),
        VariablesConvenioBTLMF.vRuc.trim(),
                                                                   "0","100",0
                                                                   );
        impresora.imprimir(vPrint,"\\\\10.18.1.179\\GUIAS",false,"","","","");        
        //impresora.imprimir(vPrint,"C:\\GUIAS.TXT");        
    }

    private int imprimeDatosAdicionales(ArrayList<String> vPrint, String vMargen) {
        int linea = 0;
