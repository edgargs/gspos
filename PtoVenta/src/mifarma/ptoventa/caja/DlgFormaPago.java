...
// **************************************************************************
  ...
  private void this_windowOpened(WindowEvent e)
  {
    ...
    log.debug("<<<<<<<<<<indPedirLogueo>>>>>>>>>>>:"+indPedirLogueo);
                ...
                //JCORTEZ 03.11.09 Se valida ingreso de sobre
                 log.debug("VariablesCaja.vSecMovCaja-->"+VariablesCaja.vSecMovCaja);
                    if(validaIngresoSobre()){
                        ...
                        if(com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this, "Ha excedido el importe máximo de dinero en su caja. \n" + 
