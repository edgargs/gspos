...
public class ConstantsFondoSencillo {
    ...
    { new FarmaColumnData("Sec. Usu.", 65, JLabel.LEFT), //0
        ...
        new FarmaColumnData("Ape. Paterno", 115, JLabel.LEFT), new FarmaColumnData("Ape. Materno", 115, JLabel.LEFT),
    ...
    public static final FarmaColumnData columnsListaHistorico[] = { new FarmaColumnData("Fecha", 125, JLabel.LEFT),
        //new FarmaColumnData( "Sec. Fondo.", 80, JLabel.CENTER),
        new FarmaColumnData("Tipo", 75, JLabel.LEFT), new FarmaColumnData("Usu. Origen", 165, JLabel.LEFT),
        new FarmaColumnData("Usu. Destino", 165, JLabel.LEFT),
        // new FarmaColumnData( "Login Usu.", 100, JLabel.LEFT ),
        new FarmaColumnData("Monto", 55, JLabel.RIGHT), new FarmaColumnData("Estado", 80, JLabel.LEFT),
        new FarmaColumnData("Caja", 40, JLabel.CENTER), new FarmaColumnData("Turno", 45, JLabel.CENTER)
        //sec_fondo_sen 8
        //SEC_USU_destino 9
        //SEC_USU_origen 10
