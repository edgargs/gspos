...
import mifarma.ptoventa.inventario.DlgTransferenciasPorConfirmar;
		...
		try
		{
			...
			if ( VariablesInventario.vIndLineaMatriz.equals(FarmaConstants.INDICADOR_S)){
			    ...
			    //si ocurriera algun error, se realizara solo la confirmacion en local origen
                            String resultado = "N";
                            try{
                                resultado = DBInventario.realizarTransfDestino( numera, VariablesTranfDelivery.vCodLocalDestino, FarmaConstants.INDICADOR_N).trim();
