...
/*
  ...
  */
  ...
  public static void obtieneInfoProducto(ArrayList pArrayList, String pCodProd) throws SQLException {
    ...
    FarmaDBUtility.executeSQLStoredProcedureArrayList(pArrayList,"PTOVENTA_VTA.VTA_OBTIENE_INFO_PROD(?,?,?)",parametros);
  }
  ...
  public static void grabarCabeceraPedido() throws SQLException {
    parametros = new ArrayList();
    parametros.add(FarmaVariables.vCodGrupoCia);
    parametros.add(FarmaVariables.vCodLocal);
    ...
    /**NUEVO. Quitar el 'TMP_'! y actualizar el procedure en el paquete PTOVENTA_VTA*/
        log.debug("invocando a PTOVENTA_VTA.VTA_GRABAR_PEDIDO_VTA_CAB(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?):" + parametros);
        FarmaDBUtility.executeSQLStoredProcedure(null,"PTOVENTA_VTA.VTA_GRABAR_PEDIDO_VTA_CAB(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",                                parametros, false);
  }
  /**
  ...
  public static void grabarDetallePedido() throws SQLException {
    ...
    parametros.add(VariablesVentas.vCod_Prod);
        System.out.println("grabarDetallePedido:::>"+VariablesVentas.vCod_Prod);
   ...
   * @since   14.06.2007
   */
  public static void listaPromociones(FarmaTableModel pTableModel)throws SQLException
  {
    pTableModel.clearTable();
    parametros = new ArrayList();
  ...
  */
  ...
  public static String verificaCuponMatriz(String pCupon,String indMultiUso,
                                           String pIndCloseConecction) throws SQLException
  {
      System.out.println("15/07/09 verifica CUPON");
    parametros = new ArrayList();
    parametros.add(FarmaVariables.vCodGrupoCia);
    parametros.add(FarmaVariables.vCodLocal);
    parametros.add(pCupon);
...
*/
        ...
        cCodGrupoCia_in   IN CHAR,
                                             ...
                                             cUsuCrea_in       IN CHAR
         * */
        //System.err.println("inserta acumulado " + parametros);
    ...
    public static List prodsCampaniasAplicables(List listProds, List listCamps) throws SQLException
    {
    	String selectSQL = "";
        String codProds = "";
        String p1=    "select cc.COD_PROD,cc.COD_CAMP_CUPON,cc.IND_EXCLUYE_ACUM_AHORRO " + 
        "from (SELECT U.IND_EXCLUYE_ACUM_AHORRO,COD_PROD, v.COD_REAL as \"COD_CAMP_CUPON\" ,V.MONT_MIN_USO, "+
        ...
        String p4=        " ( SELECT NVL(CP.COD_CAMP_CUPON_PROD_USO,CP.COD_CAMP_CUPON) COD_CAMPANA,CP.COD_CAMP_CUPON COD_REAL," +
                                                    //agregado 04.03.2010
                                                    "cp.prioridad,cp.ranking,CP.MONT_MIN_USO "+
...
/**
    ...
    **/
    ...
    public static String ObtieneDirectorioLog() throws SQLException
    {
     parametros = new ArrayList();
     log.debug("invocando a PTOVENTA_VTA.F_OBT_RUTA_DIRECTORIO_LOG():"+parametros);
     return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_VTA.F_OBT_RUTA_DIRECTORIO_LOG",parametros);
    }
    /**
    ...
    **/
    ...
    public static String getMensajeComsumidor()throws SQLException{
        ...
        System.out.println("getMensajeComsumidor: "+parametros);
    ...
    public static String getNumCaracteres()throws SQLException{
        parametros = new ArrayList();
        System.out.println("getNumCaracteres: "+parametros);
    ...
    public static String getMensajeRptaRecarga(String codmsg)throws SQLException{
        ...
        System.out.println("parametros getMensajeRptaRecarga: "+parametros);
    ...
    public static String getIND_LABEL(String codmsg)throws SQLException{
        parametros=new ArrayList();
        parametros.add(codmsg.trim());
        System.out.println("parametros getIND_LABEL: "+parametros);
    ...
    public static String operarResStkAntesDeCobrar(String codprod,
        ...
        parametros.add(FarmaVariables.vIdUsu);
        System.out.println("parametros operarResStk PTOVTA_RESPALDO_STK.PVTA_F_INS_DEL_UPD_STK_RES(?,?,?,?,?,?,?,?): "+parametros);
    ...
    */
    ...
    public static String getIndProdFarma(String pCodProd) throws SQLException{
        ...
        parametros.add(FarmaVariables.vCodGrupoCia);        
        parametros.add(pCodProd.trim());        
        System.out.println("parametros PTOVENTA_VTA_LISTA_AS.VTA_F_IND_PROD_FARMA(?,?): "+parametros);
    ...
    public static String getIndImprimirCorrelativo() throws SQLException{
        parametros=new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        System.out.println("parametros PTOVENTA_VTA.F_GET_IND_IMP_CORRELATIVO(?): "+parametros);
    ...
    public static String getIndImprimirCorrelativo(String pTipoComp,
        ...
        System.out.println("parametros PTOVENTA_VTA.F_GET_CORRELATIVO_MONTO_NETO(?,?,?,?,?): "+parametros);
    ...
    public static void getDatosRegaloxMonto(ArrayList pArray ,String pCodEncarte,
        ...
        System.out.println("parametros Farma_Gral.F_EMITE_REGALO_X_MONTO(?,?,?,?): "+parametros);
    ...
    public static String getStockProdRegalo(String cod_prod) throws SQLException{
        ...
        System.out.println("parametros PTOVENTA_VTA.F_GETSTOCK_PROD_REGALO(?,?,?): "+parametros);
        //FarmaDBUtility.executeSQLStoredProcedureArrayList(pArray,"Farma_Gral.F_EMITE_REGALO_X_MONTO(?,?,?,?)",parametros);
    ...
    public static void getEncarteAplica(ArrayList pArrayList , double Monto , String cod_encarte) throws SQLException{
        ...
        System.out.println("parametros PTOVENTA_VTA.F_GETDATOS_ENCARTE_AP(?,?,?,?): "+parametros);
        //FarmaDBUtility.executeSQLStoredProcedureArrayList(pArray,"Farma_Gral.F_EMITE_REGALO_X_MONTO(?,?,?,?)",parametros);
        //return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_VTA.F_GETSTOCK_PROD_REGALO(?,?,?)",parametros);
