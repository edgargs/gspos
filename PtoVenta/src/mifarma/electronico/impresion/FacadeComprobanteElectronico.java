package mifarma.electronico.impresion;
...
import mifarma.electronico.impresion.dao.DAOComprobanteElectronico;
import mifarma.electronico.impresion.dao.FactoryDocumentoElectronico;
...
public class FacadeComprobanteElectronico {
    ...
    public FacadeComprobanteElectronico() {
        super();
        daoDocElectronico = FactoryDocumentoElectronico.getDAOComprobanteElectronico(mifarma.electronico.impresion.dao.FactoryDocumentoElectronico.Tipo.MYBATIS);
    }

    public ArrayList<ArrayList<String>> imprimeCabecera(String NumPedidoVta,String SecCompPago,String TipoDocumento )
    throws Exception
    {
           ...
           public ArrayList<ArrayList<String>> imprimeDetalle(String NumPedidoVta,String SecCompPago,String TipoClienteConvenio){
             ArrayList<ArrayList<String>> lstListado = null;       
             try{
             ...
             public ArrayList<ArrayList<String>> imprimeMontos(String NumPedidoVta,String SecCompPago)
             throws  Exception
             {
             ArrayList<ArrayList<String>> lstListado = null;       
             //try{
        ...
        public String imprimeDatosConvenio(String NumPedidoVta, String SecCompPago,
                                                                   String TipoDocumento,String  TipoClienteConvenio) {     
        ...
        public ArrayList<ArrayList<String>> imprimeNotas(String NumPedidoVta,String SecCompPago,String TipoDocumento )
    throws Exception
        {
             ArrayList<ArrayList<String>> lstListado = null;       
             //try{
    ...
    public ArrayList<ArrayList<String>> imprimeFormaPago(String NumPedidoVta)
    throws Exception
    {
         ArrayList<ArrayList<String>> lstListado = null;       
         //try{
    ...
    public ArrayList<ArrayList<String>> imprimeDatosDelivery(String NumPedidoVta)
    throws Exception
    {
         ArrayList<ArrayList<String>> lstListado = null;       
         //try{
    ...
    public Map<String, Object> obtieneDatosImpresion(String pNumPedidoVta, String pSecCompPago, String pTipoDocumento, String pTipoClienteConvenio,
                               ArrayList<String> lstPiePag,
