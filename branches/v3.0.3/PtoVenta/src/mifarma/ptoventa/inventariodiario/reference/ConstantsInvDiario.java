...
public class ConstantsInvDiario {
    ...
    { new FarmaColumnData("Codigo", 50, JLabel.CENTER), new FarmaColumnData("Descripcion", 200, JLabel.LEFT),
      new FarmaColumnData("Laboratorio", 150, JLabel.LEFT), new FarmaColumnData("Presentacion", 100, JLabel.LEFT),
    ...
    { new FarmaColumnData("Sel.", 30, JLabel.CENTER), new FarmaColumnData("Codigo", 50, JLabel.CENTER),
      ...
      new FarmaColumnData("Unid. Venta", 100, JLabel.LEFT), new FarmaColumnData("Stock", 75, JLabel.RIGHT),
        //new FarmaColumnData("U. Vends.", 50, JLabel.RIGHT),
        //new FarmaColumnData("Monto Tot.", 70, JLabel.RIGHT),
        new FarmaColumnData("CodLab", 0, JLabel.RIGHT), new FarmaColumnData("ValFrac", 0, JLabel.RIGHT) };
    ...
    { new FarmaColumnData("Sel.", 30, JLabel.CENTER), new FarmaColumnData("Codigo", 55, JLabel.CENTER),
      new FarmaColumnData("Descripcion", 195, JLabel.LEFT), new FarmaColumnData("Unid Pres.", 105, JLabel.LEFT),
      new FarmaColumnData("Dif.", 60, JLabel.RIGHT), new FarmaColumnData("Stk Fis.", 40, JLabel.RIGHT),
      new FarmaColumnData("Precio", 55, JLabel.RIGHT), new FarmaColumnData("Laboratorio", 70, JLabel.LEFT),
      new FarmaColumnData("Fecha", 55, JLabel.LEFT), new FarmaColumnData("Stk Act.", 55, JLabel.RIGHT)
        //ocultas
        /*
    ...
    { new FarmaColumnData("Nro Toma", 65, JLabel.LEFT), new FarmaColumnData("Tipo Toma", 90, JLabel.LEFT),
      new FarmaColumnData("Fecha Inicio", 125, JLabel.LEFT), new FarmaColumnData("Estado", 90, JLabel.LEFT),
    ...
    { new FarmaColumnData("Codigo", 80, JLabel.LEFT), new FarmaColumnData("Laboratorio", 250, JLabel.LEFT),
    ...
    { new FarmaColumnData("Codigo", 70, JLabel.CENTER), new FarmaColumnData("Descripcion", 220, JLabel.LEFT),
      new FarmaColumnData("Unid. Presentacion", 120, JLabel.LEFT), new FarmaColumnData("C. Ent", 40, JLabel.RIGHT),
      new FarmaColumnData("C. Frac", 40, JLabel.RIGHT), new FarmaColumnData("Laboratorio", 150, JLabel.LEFT),
      new FarmaColumnData("Valor Frac", 0, JLabel.RIGHT), new FarmaColumnData("Unid. Venta", 0, JLabel.RIGHT), };
    ...
    { new FarmaColumnData("Fecha", 110, JLabel.CENTER), new FarmaColumnData("Descripcion", 182, JLabel.LEFT),
      new FarmaColumnData("Tip. Doc", 60, JLabel.LEFT), new FarmaColumnData("Num. Doc.", 90, JLabel.CENTER),
      new FarmaColumnData("Mov", 40, JLabel.RIGHT), new FarmaColumnData("Val. Fracc.", 60, JLabel.RIGHT) };
    ...
    { new FarmaColumnData("DNI", 70, JLabel.CENTER), //DNI
        ...
        new FarmaColumnData("NombreCompleto", 220, JLabel.LEFT), new FarmaColumnData("Monto", 100, JLabel.RIGHT)
        //codigo local
        } ;
    ...
    { new FarmaColumnData("DNI", 70, JLabel.CENTER), new FarmaColumnData("Descripcion", 250, JLabel.LEFT),
      new FarmaColumnData("Codigo", 70, JLabel.CENTER) //CODIGO RRHH
    ...
    { new FarmaColumnData("Codigo", 60, JLabel.LEFT), new FarmaColumnData("Descripcion", 225, JLabel.LEFT),
      new FarmaColumnData("Unidad", 88, JLabel.LEFT), new FarmaColumnData("Precio Venta", 78, JLabel.RIGHT),
      new FarmaColumnData("Cantidad", 60, JLabel.RIGHT), new FarmaColumnData("Total", 68, JLabel.RIGHT)
        // Val Fraccion
        } ;
    ...
    { new FarmaColumnData("Codigo", 60, JLabel.CENTER), new FarmaColumnData("Producto", 140, JLabel.LEFT),
      new FarmaColumnData("Unidad", 120, JLabel.LEFT), new FarmaColumnData("P.Venta", 100, JLabel.RIGHT),
