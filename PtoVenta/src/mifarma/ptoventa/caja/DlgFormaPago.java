...
public class DlgFormaPago extends JDialog {
    ...
    private void jbInit() throws Exception {
        ...
        lblTotalPagar.setText("TOTAL VENTA : S/.");
   ...
   */
    ...
    private void this_windowOpened(WindowEvent e) {
        ...
        if(bEntregaProforma){
            ...
            this.setTitle("Impresión de comprobantes.");
        }        
        ...
        if (indPedirLogueo) {
            ...
            if (!UtilityCaja.existeCajaUsuarioImpresora(this, null, bEntregaProforma) ||
    ...
    private void muestraInfoPedido(ArrayList pArrayList) {
      ...
      */
        ...
        if (VariablesCaja.vIndDeliveryAutomatico.equalsIgnoreCase(FarmaConstants.INDICADOR_S) || bEntregaProforma) {
    ...
    /*private void procesoCobroDelivery()
  {
    ...
    public void pedidoCobrado() {
        ...
        if (VariablesCaja.vIndPedidoCobrado) {
            ...
            if (FarmaVariables.vTipCaja.equalsIgnoreCase(ConstantsPtoVenta.TIP_CAJA_MULTIFUNCIONAL) ||
                ...
                if (!bEntregaProforma && validaIngresoSobre()) {
                    //dubilluz 20.07.2010
            ...
            if (indCerrarPantallaAnularPed &&
                ...
                if (VariablesCaja.vIndDeliveryAutomatico.trim().equalsIgnoreCase(FarmaConstants.INDICADOR_S)) {
                    ...
                    try {
                        ...
                        DBCaja.anularPedidoPendienteSinRespaldo_02(this,VariablesCaja.vNumPedVta); //ASOSA, 13.07.2010
        ...
        if (validaFormasPago()) {
            ...
            if (pValidaImpresoras()) {
                ...
                if (pValorSaldo == 0) {
                    ...
                    dlgNuevoCobro.setEntregaProforma(bEntregaProforma);
                    ...
                    if (isContinuarCobro) {
                        ...
                        if (VariablesVentas.vEsPedidoDelivery &&
                            ...
                            UtilityCaja.grabarNuevoCobro(dlgNuevoCobro, this, myParentFrame, bEntregaProforma);
                            verificaMontoPagadoPedido();
                        }
    ...
    private void ejecutarFuncionF11(){
        ...
        * */
        ...
        if (!UtilityCaja.existeStockPedido(this, VariablesCaja.vNumPedVta, bEntregaProforma))
            return;
