...
public class DlgReciboPagoSencillo extends JDialog {
    ...
    private void cargaCombo(int idxSel) {
        FarmaLoadCVL.loadCVLfromArrays(cmbTipoComp, ConstantsCajaElectronica.HASHTABLE_TIPOS_ETV,
                                       ConstantsCajaElectronica.TIPOS_ETV_CODIGO,
                                       ConstantsCajaElectronica.TIPOS_ETV_DESCRIPCION, true);
        cmbTipoComp.setSelectedIndex(idxSel);
        etv = FarmaLoadCVL.getCVLCode(ConstantsCajaElectronica.HASHTABLE_TIPOS_ETV, cmbTipoComp.getSelectedIndex()).charAt(0);
    }
