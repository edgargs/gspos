...
public class DlgValidaDocumento extends JDialog {
    ...
    private void jbInit() throws Exception {
        ...
        txtNroDocumento.setBounds(new Rectangle(115, 5, 160, 20));
        ...
        btnNroDocumento.setText("Ingrese DNI o CE: ");
        btnNroDocumento.setBounds(new Rectangle(10, 5, 100, 20));
    ...
    private void txtProducto_keyPressed(KeyEvent e) {
        ...
        if(isNumero(e.getKeyChar()) || e.getKeyCode() == KeyEvent.VK_ENTER ){
            ...
            if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                ...
                if ((tiempoTeclaFinal - tiempoTeclaInicial) <= maxTiempoLectora && textNroDocumento.length() > 0 && validaFinal) {
                    isLectoraLaser = true;
