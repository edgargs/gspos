...
public class UtilityEposTrx {
    ...
    public static String getNumCompPagoE(String tipoCompPago, String numPedidoVta, String SecCompPago,
        ...
        String[] listaRespuesta =
            getNumCompPagoE(tipoCompPago, numPedidoVta, SecCompPago, tipClientConvenio, isValidaRAC, true, true);
    ...
    public static String[] getNumCompPagoE(String tipoCompPago, String numPedidoVta, String SecCompPago,
        ...
        if (mensaje.startsWith(EposConstante.MSJ_EXITO)) {
            ...
            */
            ...
            FarmaVentaCnxUtility.enviaCorreoPorCnx(FarmaVariables.vCodCia, FarmaVariables.vCodLocal, emailEnvio,
                                                   "ERROR DE SERVIDOR EPOS", "ERROR DE COMUNICACION CON SERVIDOR EPOS",
                                                   "Error en conexion con servidor EPOS<br>" + "Mensaje:<br>" +
