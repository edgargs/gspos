...
public class DlgMovimientoKardex extends JDialog {
    ...
    // gmoran ** se agrega el label de lote    
    private JLabelWhite lblLote = new JLabelWhite();
    private JLabelWhite lblFecLote = new JLabelWhite();
    private JLabelWhite lblLote_Desc = new JLabelWhite();
    private JLabelWhite lblFecLote_Desc = new JLabelWhite();
    private JTextFieldSanSerif textLote_temp = new JTextFieldSanSerif();
    ...
    private void jbInit() throws Exception {
        ...
        lblStock_T.setBounds(new Rectangle(430, 35, 35, 20));
        ...
        lblStockEntero.setBounds(new Rectangle(470, 35, 55, 20));
        ...
        txtFechaInicio.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    txtFechaInicio_actionPerformed(e);
                }
            });
        ...
        lblUnidadFraccion.setBounds(new Rectangle(435, 55, 75, 20));
        ...
        pnlHeader1.add(lblLote, null);
        pnlHeader1.add(lblFecLote, null);
        pnlHeader1.add(lblLote_Desc, null);
        pnlHeader1.add(lblFecLote_Desc, null);
        ...
        lblLote.setBounds(new Rectangle(525, 35, 35, 20));
        
        lblFecLote.setText("Fecha Lote:");
        lblFecLote.setBounds(new Rectangle(525, 55, 70, 20));
        
        lblLote_Desc.setBounds(new Rectangle(560, 35, 195, 20));
        lblFecLote_Desc.setBounds(new Rectangle(595, 55, 155, 20));
    }
    ...
    private void chkKeyPressed(KeyEvent e) {
        ...
        if (tblListaMovs.getRowCount() > 0) {
            /*FarmaGridUtils.aceptarTeclaPresionada(e, tblListaMovs, txtLote_Desc, 1);
            FarmaGridUtils.aceptarTeclaPresionada(e, tblListaMovs, txtFecLote_Desc, 2);*/
            lblLote_Desc_keyPressed(e);
        }
    }
    
    // **************************************************************************
    private void lblLote_Desc_keyPressed(KeyEvent e){
            log.debug("evento LOTE");
            if (tblListaMovs.getRowCount() > 0) {
                FarmaGridUtils.aceptarTeclaPresionada(e, tblListaMovs, textLote_temp, 15);
                String loteDesc = FarmaUtility.getValueFieldJTable(tblListaMovs, tblListaMovs.getSelectedRow(), 10);
                String fecVenc = FarmaUtility.getValueFieldJTable(tblListaMovs, tblListaMovs.getSelectedRow(),16);
                log.debug("textLote_temp: "+textLote_temp.getText());
                lblLote_Desc.setText(textLote_temp.getText());
                lblFecLote_Desc.setText(fecVenc);
            }
        }
    ...
    private void cargaListaMovimientos() {
        try {
            ...
            if (tblListaMovs.getRowCount() > 0) {
                ...
                String loteDesc = FarmaUtility.getValueFieldJTable(tblListaMovs, tblListaMovs.getSelectedRow(), 15);
                String fecVenc = FarmaUtility.getValueFieldJTable(tblListaMovs, tblListaMovs.getSelectedRow(),16);
                log.debug("textLote_temp: "+textLote_temp.getText());
                lblLote_Desc.setText(loteDesc);
                lblFecLote_Desc.setText(fecVenc);
            }
    ...
    private void imprimir() {
        ...
        if (!vPrint.startPrintService()) {
            FarmaUtility.showMessage(this, "No se pudo inicializar el proceso de impresión", txtFechaInicio);
            return;
        }
        try {
            ...
            vPrint.printBold(FarmaPRNUtility.llenarBlancos(27) + " REPORTE MOVIMIENTOS DE KARDEX " +
                             FarmaPRNUtility.llenarBlancos(20) + "Fecha de Emision : " + fechaActual, true);
            ...
            vPrint.printBold("Periodo          : " + VariablesInventario.vFecIniMovKardex + " - " +
                             VariablesInventario.vFecFinMovKardex, true);

            vPrint.printBold(" ", true);
            vPrint.printLine("===========================================================================================================================",
                             true);
            vPrint.printBold("Fecha              Descripcion              Tipo   Num Doc    Stk Ant      Mov  Stk Act Val Frac Usuario   Glosa",
                             true);
            vPrint.printLine("===========================================================================================================================",
                             true);
            ...
            for (int i = 0; i < tblListaMovs.getRowCount(); i++) {
                ...
                vPrint.printCondensed(FarmaPRNUtility.alinearIzquierda((String)tblListaMovs.getValueAt(i, 0), 18) +
                                      " " +
                                      ...
                                      "  " +
                                      FarmaPRNUtility.alinearIzquierda((String)tblListaMovs.getValueAt(i, 9), 10) +
                                      " ", true);
            }
            vPrint.activateCondensed();
            vPrint.printLine("===========================================================================================================================",
                             true);
            vPrint.printBold("Registros Impresos: " + FarmaUtility.formatNumber(tblListaMovs.getRowCount(), ",##0") +
    ...
    private void listaFiltroKardex() {
        DlgFiltroDescripcionMovKardex dlgFiltroDescripcionMovKardex =
            new DlgFiltroDescripcionMovKardex(myParentFrame, "", true);
    ...
    private void txtFechaInicio_actionPerformed(ActionEvent e) {
    }
}
