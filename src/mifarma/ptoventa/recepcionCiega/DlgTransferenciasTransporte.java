...
public class DlgTransferenciasTransporte extends JDialog 
{
  ...
  private void initCmbMotivo()
  {
   ...
   private void initDestino(){
       if (cmbTipo.getSelectedItem().toString().equalsIgnoreCase("MATRIZ")){
           try
           {
             ...
             if(array.size()==1)
             {
               ...
               System.out.println("txtCodigoDestino: "+array.get(0).toString()+"\ntxtDestino"+array.get(1).toString());
             }
    ...
    if(e.getKeyCode() == KeyEvent.VK_F11)
    {
      if(validarCampos())
      {
        ...
        if(VariablesRecepCiega.vMotivo_Transf.trim().length()>0){
            System.err.println("VariablesRecepCiega.vMotivo_Transf:"+VariablesRecepCiega.vMotivo_Transf);
            cerrarVentana(true);        
  ...
  private void cargarCabecera()
  {
    ...
    if (VariablesRecepCiega.vMotivoTransferencia.equalsIgnoreCase("F2")){
     ...
     ///
      ...
      ArrayList listaMotivos = new ArrayList();
        try {
            FarmaDBUtility.executeSQLStoredProcedureArrayList(listaMotivos, 
                                                              ...
                                                              p);
            System.out.println("listaMotivos: " + listaMotivos);
      ...
      VariablesRecepCiega.vDescMotivo_Transf_Larga = obtieneDescripcionLarga(VariablesRecepCiega.vMotivo_Transf.trim(),VariablesRecepCiega.vDescMotivo_Transf.trim());
        System.out.println("Corta: "+VariablesInventario.vDescMotivo_Transf+
                  " Larga: "+VariablesInventario.vDescMotivo_Transf_Larga);
      System.out.println("Corta2: "+VariablesRecepCiega.vDescMotivo_Transf+
    ...
    System.out.println("VariablesInventario.vTransfMatriz "+ VariablesRecepCiega.vTransfMatriz);      
    System.out.println("VariablesInventario.vTipoDestino_Transf "+ VariablesRecepCiega.vTipoDestino_Transf);      
