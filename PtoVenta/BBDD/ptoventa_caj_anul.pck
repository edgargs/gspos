    ...
    IF vMontoPercepcion != 0 THEN
      ...
      EXCEPTION 
        WHEN NO_DATA_FOUND THEN
          ...
          EXCEPTION
            WHEN NO_DATA_FOUND THEN
              RAISE_APPLICATION_ERROR(-21000,'ERROR AL REGISTRAR LA FORMA DE PAGO'||CHR(13)||
  ...
  OPEN curProd;
   LOOP
    ...
    IF vTipoComprobantePago <> '03' THEN
     ...
     v_nNumCompPago := Farma_Utility.COMPLETAR_CON_SIMBOLO(v_nSecCompPago, 10, 0, 'I',cCodLocal_in);--LTAVARA 01.10.2014
