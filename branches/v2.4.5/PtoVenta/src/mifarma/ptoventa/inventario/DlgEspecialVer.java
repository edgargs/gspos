  ...
  private void chkKeyPressed(KeyEvent e)
  {
    ...
    if(mifarma.ptoventa.reference.UtilityPtoVenta.verificaVK_F2(e))
    {
     // if(FarmaVariables.vEconoFar_Matriz){
        ...
        //&& FarmaVariables.dlgLogin.verificaRol(FarmaConstants.ROL_INVENTARIADOR)){
         if(com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,"Esta seguro de anular el pedido?"))
          {
            //anularProducto();
            anularPedido();
          }
    ...
    }else if(mifarma.ptoventa.reference.UtilityPtoVenta.verificaVK_F11(e))
    {
      if(FarmaVariables.vEconoFar_Matriz){
        if(VariablesInventario.vEstCab_esp.equalsIgnoreCase(ConstantsInventario.EST_PENDIENTE)&&
         FarmaVariables.dlgLogin.verificaRol(FarmaConstants.ROL_INVENTARIADOR)){
          if(com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,"Esta seguro de confirmar el pedido?"))
          {
             confimarPedido();
          }
        }else{
