...
public class FacadeRecaudacion {
  ...
  public ArrayList listarRcdCanceladas(String strCodGrupoCia, String strCodCia, String strCodLocal, String pCodRcd, String pMonRcd, String pTipocobro){
    ...
    */    
    ...
    public void imprimirComprobantePagoRecaudacion(String pNumeroRecaudacion){
       String CompPagoCiti;
        try {
            CompPagoCiti = daoRecaudacion.impCompPagoRecaudacion(FarmaVariables.vCodGrupoCia,FarmaVariables.vCodCia,FarmaVariables.vCodLocal,pNumeroRecaudacion);
            log.debug("Comprobante Recaudacion:");
            log.debug(CompPagoCiti);
            //Impresion Original
     ...
     * @since 20.08.2013
     */
    public void imprimirComprobantePagoRecauVentaCMR(String pNumeroRecaudacion, String strNumCuotas, String strMontoPagarCuota, String strFechaVencCuota, String strCodAutorizacion){
       String templHtmlVentaCMROriginal = "";
       String templHtmlVentaCMRCopia = "";
        try {
            
            templHtmlVentaCMROriginal = daoRecaudacion.getCompPagoRecauVentaCMR(FarmaVariables.vCodGrupoCia,FarmaVariables.vCodCia,FarmaVariables.vCodLocal,
                                                                   pNumeroRecaudacion, strNumCuotas, strMontoPagarCuota, strFechaVencCuota, strCodAutorizacion, VariablesCaja.vNumCaja, ConstantsRecaudacion.COD_COMPROBANTE_ORIGINAL);
    ...
    public boolean obtieneEstadoImpresionRacaudacion(String pNumeroRecaudacion){
       ...
       boolean estado=false;
        try {
            EstImpRec = daoRecaudacion.getEstadoImpRecaudacion(FarmaVariables.vCodGrupoCia,FarmaVariables.vCodCia,FarmaVariables.vCodLocal,pNumeroRecaudacion).trim();
    ...
    */ 
    ...
    public ArrayList obtenerRespuestaSix(String modo, String operacion, Long codTrssc) {
        ...
        if(UtilityRecaudacion.consultarEstadoTrsscSix(codTrssc, modo).equals(ConstantsRecaudacion.ESTADO_FIN_TAREA)) {              
            ...
            rpt = true;
            datosRespSix = obtenerDatosTrsscSix(codTrssc, modo); 
            
            if(ConstantsRecaudacion.RCD_MODO_PAGO_SIX.equals(modo) || ConstantsRecaudacion.RCD_MODO_CONSULTA_SIX.equals(modo) || 
            ...
            if(ConstantsRecaudacion.COD_SOLICITUD_EXITOSA.equals(strResponseCode)){
                log.info(operacion + codTrssc + ConstantsRecaudacion.RCD_PAGO_SIX_CONCAT + ConstantsRecaudacion.RCD_SIX_RESP_OK +strResponseCode);
            }else{
                log.info(operacion + codTrssc + ConstantsRecaudacion.RCD_PAGO_SIX_CONCAT + ConstantsRecaudacion.RCD_SIX_RESP_ERROR +strResponseCode);
                msj = true; //FarmaUtility.showMessage(this, ConstantsRecaudacion.RCD_PAGO_SIX_MSJ_COBRO , null);
            }                                                                                  
        }
