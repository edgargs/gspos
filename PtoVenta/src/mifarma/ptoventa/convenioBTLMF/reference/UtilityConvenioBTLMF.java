...
*/
                                              ...
                                              ) throws Exception
    {
        ...
        if (pTipCompPago.equalsIgnoreCase(ConstantsVentas.TIPO_COMP_BOLETA) )
        {
            ...
            muestraMensajeImpresion(pJDialog,ConstantsVentas.TIPO_COMP_BOLETA,++acumuCorreBol,pNumComprobante);
        ...
        {
            muestraMensajeImpresion(pJDialog,ConstantsVentas.TIPO_COMP_TICKET,++acumuCorreTik,pNumComprobante);
        ...
        {
            muestraMensajeImpresion(pJDialog,ConstantsVentas.TIPO_COMP_GUIA,++acumuCorreGuia,pNumComprobante);
        ...
        {
            muestraMensajeImpresion(pJDialog,ConstantsVentas.TIPO_COMP_FACTURA,++acumuCorreFac,pNumComprobante);
...
//				sql.getMessage(), pObjeto);
    ...
    public static void muestraMensajeImpresion(JDialog pJDialog, String pTipoComprobante, int pCantDoc,String pNumDocImpresion) {
