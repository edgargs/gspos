...
public interface DAOCajaElectronica extends DAOTransaccion {
    ...
    public int grabarReciboPagoSencillo(String folio, BigDecimal pTotal, BigDecimal pMonto, BigDecimal pDiferencia,
                                        char pTipFondoSencillo, char pCodETV) throws SQLException;
