 ...
 *
 */
public class DlgDevolucionProductos extends JDialog implements KeyListener{
    ...
    private void btnRelacionProductos_actionPerformed(ActionEvent e){
      FarmaUtility.moveFocus(tblListaProductosDev);
    }    
    ...
    //GFonseca 16.12.2013 seleccionar fila de la grilla
    FarmaGridUtils.aceptarTeclaPresionada(e, tblListaProductosDev, txtBuscar, 1);
        ...
        if(e.getKeyCode() == KeyEvent.VK_F3){
              ...
              if(tblListaProductosDev.getSelectedRow()>-1){
                 if (com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this, "Esta seguro de borrar el producto?"))
                      borrarProducto();
                 }else{
            ...
            mostrarCabecera(false);
              ...
              if(indCabecera){
                    if(validaDatos()){
                      if (com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this, "¿Está seguro de generar la devolucion?")) {
                      FarmaVariables.vAceptar=false;
    ...
    private void actualizarProducto(){
        ((ArrayList)(VariablesInventario.vArrayTransferenciaProductos.get(tblListaProductosDev.getSelectedRow()))).set(4,VariablesInventario.vCant_Transf);
        ((ArrayList)(VariablesInventario.vArrayTransferenciaProductos.get(tblListaProductosDev.getSelectedRow()))).set(7,VariablesInventario.vLote_Transf);
        ((ArrayList)(VariablesInventario.vArrayTransferenciaProductos.get(tblListaProductosDev.getSelectedRow()))).set(6,VariablesInventario.vFechaVec_Transf);
        ((ArrayList)(VariablesInventario.vArrayTransferenciaProductos.get(tblListaProductosDev.getSelectedRow()))).set(10,VariablesInventario.vTotal_Transf);
        //seleccionaProducto(tblListaProductosDev.getSelectedRow());  
        cargaListaProductos();        
    }

    private void borrarProducto() {
        //String cod = tblListaProductosDev.getValueAt(tblListaProductosDev.getSelectedRow(), 0).toString();

        //GFonseca 17.12.2013 se elimina los datos del array
          ...
          String numera;    
            ...
            try {
                ...
                if(!numera.equals("")){
                        ...
                        facadeInventario.confirmarDevolucion(numera);
                    }
            } catch (Exception e) {
                log.error("",e);
