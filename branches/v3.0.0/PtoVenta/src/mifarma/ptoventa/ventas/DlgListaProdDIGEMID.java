...
public class DlgListaProdDIGEMID extends JDialog {
    ...
    private void modificar(){
        ...
        if(!DlgProcesar.cargaIndMostrarColumnasDesc()){
            ...
            FarmaUtility.initSimpleListCleanColumns(tblProds,
                                        tabmodProds,
                                        ConstantsVentas.columnsListProds, 
    ...
    private void initTableListaPreciosProductos()
    {
        ...
        tabmodProds=new FarmaTableModel(ConstantsVentas.columnsListProds,
                                        ConstantsVentas.defaultValuesListProds,
                                        0);
    ...
    {
      FarmaLoadCVL.loadCVLfromArrays(cmbTipo,ConstantsVentas.HASHTABLE_TIP_DIGEMID,ConstantsVentas.TIP_DIGEMID_COD,ConstantsVentas.TIP_DIGEMID_DESC,true);
    }
