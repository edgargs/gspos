...
public class DlgListaPantallaBTLMF extends JDialog {
    ...
    public static int COLUMN_LINEA_CREDITO = 2;
    ...
    private void jbInit() throws Exception {
        ...
        lblF11.setBounds(new Rectangle(25, 315, 105, 20));
    ...
    private void initTableLista() {
        ...
        } else if (VariablesConvenioBTLMF.vCodTipoCampo.equals(ConstantsConvenioBTLMF.COD_DATO_CONV_DIAGNOSTICO_UIE)) {
            initTableListaDiagnostico();
            cargaListaDatos(true);
        } else if (VariablesConvenioBTLMF.vCodTipoCampo.equals(ConstantsConvenioBTLMF.COD_DATO_CONV_BENIFICIARIO)) {
            VariablesConvenioBTLMF.vDescDiagnostico = VariablesConvenioBTLMF.vBuscarNombreBenif;
            initTableListaBenificiario();
            cargaListaDatos(false);
        } else if (VariablesConvenioBTLMF.vCodTipoCampo.equals(ConstantsConvenioBTLMF.COD_DATO_CONV_REPARTIDOR)) {
            initTableListaRepartidor();
            cargaListaDatos(false);
        } else if (VariablesConvenioBTLMF.vCodTipoCampo.equals(ConstantsConvenioBTLMF.COD_DATO_CONV_MEDICO)) {
            initTableListaMedico();
            cargaListaDatos(false);
        } else if (VariablesConvenioBTLMF.vCodTipoCampo.equals(ConstantsConvenioBTLMF.COD_DATO_CONV_ORIG_RECETA)) {
    ...
    private void initTableListaBenificiario() {
        ...
        if (tableModelListaDatos == null) {
            tableModelListaDatos =
                    new FarmaTableModel(ConstantsConvenioBTLMF.columnsListaBenificiario, ConstantsConvenioBTLMF.defaultValuesListaBenificiario,
                                        0);
            FarmaUtility.initSimpleList(tblDatos, tableModelListaDatos,
                                        ConstantsConvenioBTLMF.columnsListaBenificiario);
    ...
    private void initTableListaDiagnostico() {
        ...
        if (tableModelListaDatos == null) {
            tableModelListaDatos =
                    new FarmaTableModel(ConstantsConvenioBTLMF.columnsListaDiagnostico, ConstantsConvenioBTLMF.defaultValuesListaDiagnostico,
                                        0);
            FarmaUtility.initSelectList(tblDatos, tableModelListaDatos,
                                        ConstantsConvenioBTLMF.columnsListaDiagnostico);
        }
    ...
    private void initTableListaMedico() {
        ...
        if (tableModelListaDatos == null) {
            tableModelListaDatos =
                    new FarmaTableModel(ConstantsConvenioBTLMF.columnsListaMedico, ConstantsConvenioBTLMF.defaultValuesListaMedico,
                                        0);
    ...
    private void initTableListaClinica() {
        ...
        if (tableModelListaDatos == null) {
            tableModelListaDatos =
                    new FarmaTableModel(ConstantsConvenioBTLMF.columnsListaClinica, ConstantsConvenioBTLMF.defaultValuesListaClinica,
                                        0);
    ...
    private void initTableListaRepartidor() {
        ...
        if (tableModelListaDatos == null) {
            tableModelListaDatos =
                    new FarmaTableModel(ConstantsConvenioBTLMF.columnsListaRepartidor, ConstantsConvenioBTLMF.defaultValuesListaRepartidor,
                                        0);
    ...
    private void initTableListaAdicional() {
        ...
        if (tableModelListaDatos == null) {
            tableModelListaDatos =
                    new FarmaTableModel(ConstantsConvenioBTLMF.columnsListaDatosAdic, ConstantsConvenioBTLMF.defaultValuesListaDatosAdic,
                                        0);
    ...
    private void chkKeyPressed(KeyEvent e) {
        ...
        if (vFila > -1) {
            ...
            descripcionTemp =
                    FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos, 0, COLUMN_DESCRIPCION);
        }
        ...
        if (false && UtilityPtoVenta.verificaVK_F12(e) &&
            VariablesConvenioBTLMF.vCodTipoCampo.equals(ConstantsConvenioBTLMF.COD_DATO_CONV_BENIFICIARIO)) {
            nuevoBenificiario();

            //e.setKeyChar('S');
            //e.setKeyCode(KeyEvent.VK_ENTER);
            //buscaPorDescripcion(e);
        } else if (e.getKeyCode() == KeyEvent.VK_ENTER && txtNombre.getSelectedText() != null &&
                   txtNombre.getSelectedText().equalsIgnoreCase(descripcionTemp.trim())) {
            if (VariablesConvenioBTLMF.vCodTipoCampo.equals(ConstantsConvenioBTLMF.COD_DATO_CONV_DIAGNOSTICO_UIE)) {
                seleccionaDiagnostico();
            } else {
                guardarRegistroSeleccionado();
            }
        } else if (lblF11.isVisible() && UtilityPtoVenta.verificaVK_F11(e)) {
            guardarRegistroSeleccionado();
    ...
    private void chkKeyReleased(KeyEvent e) {
        ...
        if (e.getKeyCode() != KeyEvent.VK_ENTER && e.getKeyCode() != KeyEvent.VK_LEFT &&
            ...
            if (FarmaGridUtils.buscarDescripcion(e, tblDatos, txtNombre, colSel + 1)) {
    ...
    private void cargaListaDatos(boolean pConCheck) {
        ...
        try {
            DlgProcesarDatosConvenio dlgProcesarDatosConvenio =
                new DlgProcesarDatosConvenio(myParentFrame, "TERRA", true);
    ...
    private void guardarRegistroSeleccionado() {
        ...
        int vFila = tblDatos.getSelectedRow();
        // KMONCADA 10.10.2014 VERIFICA QUE LA TABLA CONTENGA DATOS POR SELECCIONAR.
        if (vFila == -1) {
            FarmaUtility.showMessage(this, "No existen datos para seleccionar, verifique.", null);
            return;
        }
        if (vFila > -1) {
            VariablesConvenioBTLMF.listaDatos.clear();
            ...
            if (VariablesConvenioBTLMF.vCodTipoCampo.equals(ConstantsConvenioBTLMF.COD_DATO_CONV_DIAGNOSTICO_UIE)) {
                ...
                int colSel = 1;
                for (int i = 0; i < tableModelListaDatos.data.size(); i++) {
                    ArrayList row = (ArrayList)tableModelListaDatos.data.get(i);
                    if (((Boolean)row.get(0)).booleanValue()) {
                        cadenaCodigos =
                                cadenaCodigos + (cadenaCodigos.equals("") ? "" : "|") + row.get(colSel + COLUMN_CODIGO);
                    }
                }
                if (cadenaCodigos.equals("")) {
                    FarmaUtility.showMessage(this, "Debe seleccionar al menos un diagnostico.", null);
                    return;
                }
                VariablesConvenioBTLMF.vCodigo =
                        cadenaCodigos; //FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos,0,COLUMN_CODIGO);
                VariablesConvenioBTLMF.vDescripcion =
                        cadenaCodigos; //FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos,0,COLUMN_CODIGO);
                VariablesConvenioBTLMF.vCodigoAux =
                        FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos, 0,
                                                            colSel + COLUMN_CODIGO_AUX);
            } else if (VariablesConvenioBTLMF.vCodTipoCampo.equals(ConstantsConvenioBTLMF.COD_DATO_CONV_MEDICO)) {
                //ERIOS 2.4.7 Se graba el codigo de medico
                VariablesConvenioBTLMF.vCodigo =
                        FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos, 0, COLUMN_CODIGO);
                VariablesConvenioBTLMF.vDescripcion =
                        FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos, 0, COLUMN_DESCRIPCION);
                VariablesConvenioBTLMF.vCodigoAux =
                        FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos, 0, COLUMN_CODIGO_AUX);
            } else {
                VariablesConvenioBTLMF.vCodigo =
                        FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos, 0, COLUMN_CODIGO);
                VariablesConvenioBTLMF.vDescripcion =
            ...
            if (VariablesConvenioBTLMF.vCodTipoCampo.equals(ConstantsConvenioBTLMF.COD_DATO_CONV_BENIFICIARIO)) {
                ...
                String nombreCliente =
                    FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos, 0, COLUMN_NOMBRE_CLIENTE);

                VariablesConvenioBTLMF.vLineaCredito =
                        FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos, 0,
                                                            COLUMN_LINEA_CREDITO);

                String numPoliza =
                    FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos, 0, COLUMN_NUM_POLIZA);
                String numPlan =
                    FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos, 0, COLUMN_NUM_PLAN);
                String codAsegurado =
                    FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos, 0, COLUMN_COD_ASEGURADO);
                String numItem =
                    FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos, 0, COLUMN_NUM_ITEM);
                String prt = FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos, 0, COLUMN_PRT);
                String numContrado =
                    FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos, 0, COLUMN_NUM_CONTRATO);
                String tipoAsegurado =
                    FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos, 0, COLUMN_TIPO_ASEGURADO);
                String codCliente =
                    FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos, 0, COLUMN_COD_CLIENTE);
                ...
                VariablesConvenioBTLMF.listaDatosNoEditables.put(ConstantsConvenioBTLMF.CODIGO_NUM_CONTRATO,
                                                                 numContrado);
    ...
    private void obtieneBenificiario() {
        ...
        Map benif = null;
        benif =
                UtilityConvenioBTLMF.obtieneBenificiario(VariablesConvenioBTLMF.vCodConvenio, VariablesConvenioBTLMF.vCodigo.trim(),
                                                         this);
    ...
    private boolean esCodigoUIE(String cadena) {
        ...
        if (cadena != null && !cadena.trim().equals("") && cadena.trim().length() >= 3) {
            ...
            if (esLetra(primerCaracter) && esNumerico(segundoCaracter) && esNumerico(ultimoCaracter)) {
                retorno = true;
            }
        }
        return retorno;
    ...
    public void buscaPorDescripcion(KeyEvent evento) {
        ...
        UtilityConvenioBTLMF.filtraDescripcion2(evento, tableModelListaDatos, listaTodo, txtNombre, 1);
        ...
        jScrollPane1.getViewport().add(tblDatos, null);
        FarmaUtility.moveFocus(txtNombre);
        // kmoncada controla que cuando no hay data
        if (tblDatos.getRowCount() != 0) {
            FarmaGridUtils.showCell(tblDatos, 0, 0);
        }
    ...
    public ArrayList listaTodo(FarmaTableModel tableModelListaconvenios) {
        ...
        for (int k = 0; k < tableModelListaconvenios.getRowCount(); k++) {
            ...
            dato[COLUMN_CODIGO] = FarmaUtility.getValueFieldArrayList(listaTemp, 0, colSel + COLUMN_CODIGO);
            dato[COLUMN_DESCRIPCION] = FarmaUtility.getValueFieldArrayList(listaTemp, 0, colSel + COLUMN_DESCRIPCION);
            dato[COLUMN_LINEA_CREDITO] =
                    FarmaUtility.getValueFieldArrayList(listaTemp, 0, colSel + COLUMN_LINEA_CREDITO);
            dato[COLUMN_ESTADO] = FarmaUtility.getValueFieldArrayList(listaTemp, 0, colSel + COLUMN_ESTADO);
            dato[COLUMN_NOMBRE_CLIENTE] =
                    FarmaUtility.getValueFieldArrayList(listaTemp, 0, colSel + COLUMN_NOMBRE_CLIENTE);
            dato[COLUMN_NUM_POLIZA] = FarmaUtility.getValueFieldArrayList(listaTemp, 0, colSel + COLUMN_NUM_POLIZA);
            dato[COLUMN_NUM_PLAN] = FarmaUtility.getValueFieldArrayList(listaTemp, 0, colSel + COLUMN_NUM_PLAN);
            dato[COLUMN_COD_ASEGURADO] =
                    FarmaUtility.getValueFieldArrayList(listaTemp, 0, colSel + COLUMN_COD_ASEGURADO);
            dato[COLUMN_NUM_ITEM] = FarmaUtility.getValueFieldArrayList(listaTemp, 0, colSel + COLUMN_NUM_ITEM);
            dato[COLUMN_PRT] = FarmaUtility.getValueFieldArrayList(listaTemp, 0, colSel + COLUMN_PRT);
            dato[COLUMN_NUM_CONTRATO] =
                    FarmaUtility.getValueFieldArrayList(listaTemp, 0, colSel + COLUMN_NUM_CONTRATO);
            dato[COLUMN_TIPO_ASEGURADO] =
                    FarmaUtility.getValueFieldArrayList(listaTemp, 0, colSel + COLUMN_TIPO_ASEGURADO);
            dato[COLUMN_COD_CLIENTE] = FarmaUtility.getValueFieldArrayList(listaTemp, 0, colSel + COLUMN_COD_CLIENTE);
    ...
    private void nuevoBenificiario() {
        ...
        cargaListaDatos(false);
        txtNombre.setText((VariablesConvenioBTLMF.vNombre + " " + VariablesConvenioBTLMF.vApellidoPat + " " +
                           VariablesConvenioBTLMF.vApellidoMat).trim());
    ...
    private void seleccionaDiagnostico() {
        FarmaUtility.setCheckValue(tblDatos, false);
        FarmaUtility.moveFocus(txtNombre);
    }
}
