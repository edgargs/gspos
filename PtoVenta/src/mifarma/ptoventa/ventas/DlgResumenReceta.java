 ...
 *
 */
public class DlgResumenReceta extends JDialog {
    ...
    private void initTableResumenPedido() {
        tableModelResumenReceta =
                new FarmaTableModel(ConstantsVentas.columnsListaResumenPedido, ConstantsVentas.defaultValuesListaResumenPedido,
                                    0);
        FarmaUtility.initSimpleList(tblProductos, tableModelResumenReceta, ConstantsVentas.columnsListaResumenPedido);
    }
    ...
    private void agregarProducto() {
        DlgListaProductosReceta dlgListaProductosReceta = new DlgListaProductosReceta(myParentFrame, "", true);
    ...
    private void calculaTotalesPedido() {
        ...
        for (int i = 0; i < VariablesReceta.vArrayList_ResumenReceta.size(); i++) {
            ...
            totalBruto +=
                    FarmaUtility.getDecimalNumber((String)((ArrayList)VariablesReceta.vArrayList_ResumenReceta.get(i)).get(3)) *
                    cantidad;
            totalIGV +=
                    FarmaUtility.getDecimalNumber((String)((ArrayList)VariablesReceta.vArrayList_ResumenReceta.get(i)).get(12));
            totalNeto +=
                    FarmaUtility.getDecimalNumber((String)((ArrayList)VariablesReceta.vArrayList_ResumenReceta.get(i)).get(7));
        }
    ...
    private void muestraIngresoCantidad() {
        ...
        VariablesReceta.vCod_Prod = ((String)(tblProductos.getValueAt(filaActual, 0))).trim();
        VariablesReceta.vDesc_Prod = ((String)(tblProductos.getValueAt(filaActual, 1))).trim();
        VariablesReceta.vNom_Lab = ((String)(tblProductos.getValueAt(filaActual, 9))).trim();
        VariablesReceta.vCant_Ingresada_Temp = ((String)(tblProductos.getValueAt(filaActual, 4))).trim();
        VariablesReceta.vVal_Frac = ((String)(tblProductos.getValueAt(filaActual, 10))).trim();
        VariablesReceta.vPorc_Igv_Prod = ((String)(tblProductos.getValueAt(filaActual, 11))).trim();
        VariablesReceta.vPorc_Dcto_1 = ((String)(tblProductos.getValueAt(filaActual, 5))).trim();
        VariablesReceta.vVal_Prec_Vta = ((String)(tblProductos.getValueAt(filaActual, 6))).trim();
        //log.debug("VariablesReceta.vPorc_Igv_Prod : " + VariablesReceta.vPorc_Igv_Prod);
        DlgIngresoCantidadReceta dlgIngresoCantidadReceta = new DlgIngresoCantidadReceta(myParentFrame, "", true);
    ...
    private void seleccionaProducto(int pFila) {
        VariablesReceta.vTotalPrecVtaProd =
                (FarmaUtility.getDecimalNumber(VariablesReceta.vCant_Ingresada) * FarmaUtility.getDecimalNumber(VariablesReceta.vVal_Prec_Vta));
    ...
    private void operaProductoEnJTable(int pFila) {
        tblProductos.setValueAt(VariablesReceta.vCant_Ingresada, pFila, 4); //cantidad ingresada
        ...
        tblProductos.setValueAt(FarmaUtility.formatNumber(VariablesReceta.vTotalPrecVtaProd, 2), pFila,
                                7); //Total Precio Vta
        String valIgv =
            FarmaUtility.formatNumber((FarmaUtility.getDecimalNumber(VariablesReceta.vVal_Prec_Vta) - (FarmaUtility.getDecimalNumber(VariablesReceta.vVal_Prec_Vta) /
                                                                                                       (1 +
                                                                                                        (FarmaUtility.getDecimalNumber(VariablesReceta.vPorc_Igv_Prod) /
                                                                                                         100)))) *
    ...
    private void operaProductoEnArrayList(int pFila) {
        ...
        ((ArrayList)VariablesReceta.vArrayList_ResumenReceta.get(pFila)).set(5,
                                                                             FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber(VariablesReceta.vPorc_Dcto_1),
                                                                                                       2));
        ((ArrayList)VariablesReceta.vArrayList_ResumenReceta.get(pFila)).set(6,
                                                                             FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber(VariablesReceta.vVal_Prec_Vta),
                                                                                                       3));
        ((ArrayList)VariablesReceta.vArrayList_ResumenReceta.get(pFila)).set(7,
                                                                             FarmaUtility.formatNumber(VariablesReceta.vTotalPrecVtaProd,
                                                                                                       2));
        ((ArrayList)VariablesReceta.vArrayList_ResumenReceta.get(pFila)).set(12,
                                                                             FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber(VariablesReceta.vVal_Igv_Prod),
                                                                                                       2));
    }
    ...
    private synchronized void grabarReceta() {
        ...
        try {
            ...
            log.debug("VariablesReceta.vNum_Ped_Rec : " + VariablesReceta.vNum_Ped_Rec);
    ...
    private void grabarDetallePedido(int pFila) throws Exception {
        VariablesReceta.vSec_Ped_Vta_Det = String.valueOf(pFila + 1);
        VariablesReceta.vCod_Prod =
                ((String)((ArrayList)VariablesReceta.vArrayList_ResumenReceta.get(pFila)).get(0)).trim();
        VariablesReceta.vCant_Ingresada =
                String.valueOf(FarmaUtility.trunc(FarmaUtility.getDecimalNumber(((String)((ArrayList)VariablesReceta.vArrayList_ResumenReceta.get(pFila)).get(4)).trim())));
        VariablesReceta.vVal_Prec_Vta =
                ((String)((ArrayList)VariablesReceta.vArrayList_ResumenReceta.get(pFila)).get(6)).trim();
        VariablesReceta.vTotalPrecVtaProd =
                FarmaUtility.getDecimalNumber(((String)((ArrayList)VariablesReceta.vArrayList_ResumenReceta.get(pFila)).get(7)).trim());
        VariablesReceta.vPorc_Dcto_1 =
                String.valueOf(FarmaUtility.getDecimalNumber(((String)((ArrayList)VariablesReceta.vArrayList_ResumenReceta.get(pFila)).get(5)).trim()));
        VariablesReceta.vPorc_Dcto_Total =
                VariablesReceta.vPorc_Dcto_1; //cuando es pedido normal, el descuento total siempre es el descuento 1
        VariablesReceta.vVal_Frac =
                ((String)((ArrayList)VariablesReceta.vArrayList_ResumenReceta.get(pFila)).get(10)).trim();
        VariablesReceta.vEst_Ped_Vta_Det = ConstantsVentas.ESTADO_PEDIDO_DETALLE_ACTIVO;
        VariablesReceta.vVal_Prec_Lista =
                String.valueOf(FarmaUtility.getDecimalNumber(((String)((ArrayList)VariablesReceta.vArrayList_ResumenReceta.get(pFila)).get(3)).trim()));
        VariablesReceta.vVal_Igv_Prod =
                ((String)((ArrayList)VariablesReceta.vArrayList_ResumenReceta.get(pFila)).get(11)).trim();
        VariablesReceta.vUnid_Vta =
                ((String)((ArrayList)VariablesReceta.vArrayList_ResumenReceta.get(pFila)).get(2)).trim();
