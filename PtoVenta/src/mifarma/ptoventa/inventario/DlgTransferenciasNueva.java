...
public class DlgTransferenciasNueva extends JDialog {
    ...
    private void initTable() {
        tableModel =
                new FarmaTableModel(ConstantsInventario.columnsListaProductosTransferenciasNueva, ConstantsInventario.defaultValuesListaProductosTransferenciasNueva,
                                    0);
        FarmaUtility.initSimpleList(tblListaProductos, tableModel,
                                    ConstantsInventario.columnsListaProductosTransferenciasNueva);
    ...
    private void mostrarListadoProductos() {
        ...
        if (verListaProductos) {
            DlgTransferenciasListaProductos dlgTransferenciasListaProductos =
                new DlgTransferenciasListaProductos(myParentFrame, "", true);
  ...
  */
    ...
    private void borrarProducto() {
        ...
        String secRespaldo =
            ((ArrayList)tableModel.data.get(tblListaProductos.getSelectedRow())).get(12).toString().trim();
        ...
        if ( /*actualizaStkComprometidoProd(cod,
            ...
            if (!UtilityInventario.indNuevaTransf()) {
                ...
                tableModel.deleteRow(tblListaProductos.getSelectedRow());
                tblListaProductos.repaint();
                if(tblListaProductos.getRowCount()>0){ // KMONCADA 17.03.2016 CONTROL DE ERROR TABLA SIN DATA
                    FarmaGridUtils.moveRowSelection(tblListaProductos, 0);
                }
            }
    ...
    private void cargarCabecera() {
        VariablesInventario.vCodProd_Transf =
                tblListaProductos.getValueAt(tblListaProductos.getSelectedRow(), 0).toString();
        ...
        VariablesInventario.vFechaHora_Transf =
                tblListaProductos.getValueAt(tblListaProductos.getSelectedRow(), 11).toString();

        VariablesInventario.vCant_Ingresada_Temp =
                tblListaProductos.getValueAt(tblListaProductos.getSelectedRow(), 4).toString();
    }

    private void actualizarProducto() {
        if (UtilityInventario.indNuevaTransf()) {
            ((ArrayList)(tableModel.data.get(tblListaProductos.getSelectedRow()))).set(4,
                                                                                       VariablesInventario.vCant_Transf);
            ((ArrayList)(tableModel.data.get(tblListaProductos.getSelectedRow()))).set(7,
                                                                                       VariablesInventario.vLote_Transf);
            ((ArrayList)(tableModel.data.get(tblListaProductos.getSelectedRow()))).set(6,
                                                                                       VariablesInventario.vFechaVec_Transf);
            ((ArrayList)(tableModel.data.get(tblListaProductos.getSelectedRow()))).set(10,
                                                                                       VariablesInventario.vTotal_Transf);
            log.debug("1. Antes Actualizar Productos OK");
            seleccionaProducto(tblListaProductos.getSelectedRow());
            tblListaProductos.repaint();
        } else {
            ((ArrayList)(VariablesInventario.vArrayTransferenciaProductos.get(tblListaProductos.getSelectedRow()))).set(4,
                                                                                                                        VariablesInventario.vCant_Transf);
            ((ArrayList)(VariablesInventario.vArrayTransferenciaProductos.get(tblListaProductos.getSelectedRow()))).set(7,
                                                                                                                        VariablesInventario.vLote_Transf);
            ((ArrayList)(VariablesInventario.vArrayTransferenciaProductos.get(tblListaProductos.getSelectedRow()))).set(6,
                                                                                                                        VariablesInventario.vFechaVec_Transf);
            ((ArrayList)(VariablesInventario.vArrayTransferenciaProductos.get(tblListaProductos.getSelectedRow()))).set(10,
                                                                                                                        VariablesInventario.vTotal_Transf);
            seleccionaProducto(tblListaProductos.getSelectedRow());
            cargaListaProductos();
        }
    ...
    private boolean grabar() {
        ...
        String indLoteMaestro = "";
        try {
            //Ingresa ala validacion del Stock Disponible---Cesar Huanes
            for (int k = 0; k < tblListaProductos.getRowCount(); k++) {
                String mensaje =
                    DBInventario.getStockProducto(tblListaProductos.getValueAt(k, 0).toString(), tblListaProductos.getValueAt(k,
                                                                                                                              4).toString());
            ...
            String numera =
                DBInventario.agregarCabeceraTransferencia(VariablesInventario.vTipoDestino_Transf, VariablesInventario.vCodDestino_Transf,
                    ...
                    tblListaProductos.getRowCount() + "", FarmaUtility.sumColumTable(tblListaProductos, 10) + "",
            ...
            for (int i = 0; i < tblListaProductos.getRowCount(); i++) {
                ...
                if (VariablesInventario.vTipoDestino_Transf.equals("01")) { //si la transferencia es local
                    ...
                    indFraccionamiento =
                            DBInventario.obtieneIndFraccLocalDestino(VariablesInventario.vCodDestino_Transf,
                                                                     tblListaProductos.getValueAt(i, 0).toString(),
                                                                     tblListaProductos.getValueAt(i, 4).toString(),
                                                                     valFracProd, FarmaConstants.INDICADOR_N);
                    if (indFraccionamiento.equals("V")) {
                        FarmaUtility.liberarTransaccion();
                        FarmaUtility.showMessage(this,
                                                 "Ha ocurrido un error, algunos productos no pueden ser transferidos debido a la fraccion actual del local destino.\n",
                                                 null);
                        retorno = false;
                        return retorno;
                    }
                ...
                DBInventario.agregarDetalleTransferencia_02(numera, tblListaProductos.getValueAt(i, 0).toString(),
                                                            tblListaProductos.getValueAt(i, 5).toString(),
                                                            tblListaProductos.getValueAt(i, 10).toString(),
                                                            tblListaProductos.getValueAt(i, 4).toString(),
                                                            tblListaProductos.getValueAt(i, 6).toString(),
                                                            tblListaProductos.getValueAt(i, 7).toString(),
                                                            VariablesInventario.vTipoDestino_Transf,
                                                            VariablesInventario.vCodDestino_Transf,
                                                            tblListaProductos.getValueAt(i, 9).toString(),
                                                            indFraccionamiento, VariablesInventario.vMotivo_Transf,
                                                            secRespaldo, indLoteMaestro); //ASOSA, 15.07.2010, secRespaldo
            ...
            DBInventario.grabaInicioFinCreaTransferencia(numera,
                                                         "F"); //JCHAVEZ 10122009 registra fecha fin de creacion de transferencia

            log.debug("VariablesInventario.vTipoFormatoImpresion : " + VariablesInventario.vTipoFormatoImpresion);

            DBInventario.grabaInicioFinGuiasTransferencia(numera,
                                                          "I"); //JCHAVEZ 10122009 registra fecha inicio de generar guias e imprimirlas
            DBInventario.generarGuiasTransferencia(numera, VariablesInventario.vTipoFormatoImpresion,
            ...
            // JQUISPE 11.05.2010
            UtilityInventario.procesoImpresionGuias(this, tblListaProductos,
                                                    VariablesInventario.vTipoFormatoImpresion);
            log.debug("ERRRRRRRRRRRRR f");
            DBInventario.grabaInicioFinGuiasTransferencia(numera,
                                                          "F"); //JCHAVEZ 10122009 registra fecha fin de generar guias e imprimirlas
    ...
    private void seleccionaProducto(int pFila) {
        ...
        int cantIngresada_old =
            FarmaUtility.trunc(FarmaUtility.getDecimalNumber(VariablesInventario.vCant_Ingresada_Temp));
        String secRespaldo = "";
        if (UtilityInventario.indNuevaTransf()) {
            secRespaldo =
                    ((ArrayList)(tableModel.data.get(tblListaProductos.getSelectedRow()))).get(12).toString(); //JMIRANDA 16.09.2010
        } else {
            secRespaldo =
                    ((ArrayList)VariablesInventario.vArrayTransferenciaProductos.get(pFila)).get(12).toString(); //ASOSA, 14.07.2010
        }
        ...
        if (cantIngresada_old > cantIngresada) {
            ...
            valor = actualizaStkComprometidoProd_02(VariablesInventario.vCodProd_Transf, //-ASOSA, 14.07.2010
                        cantIngresada, ConstantsInventario.INDICADOR_D,
                        ConstantsInventario.TIP_OPERACION_RESPALDO_ACTUALIZAR, cantIngresada, secRespaldo);
            if (!valor)
                btnRelacionProductos.doClick();
            ...
            if (FarmaUtility.trunc(FarmaUtility.getDecimalNumber(VariablesInventario.vStk_Prod)) == 0)
                ...
                valor = actualizaStkComprometidoProd_02(VariablesInventario.vCodProd_Transf, //-ASOSA, 14.07.2010
                            cantIngresada, ConstantsInventario.INDICADOR_A,
                            ConstantsInventario.TIP_OPERACION_RESPALDO_ACTUALIZAR, cantIngresada, secRespaldo);
                if (!valor)
                    btnRelacionProductos.doClick();
            }
    ...
    private void actualizaStkComprometidoProd_sinCommit(String pCodigoProducto, int pCantidadStk,
                                                        String pTipoStkComprometido, String pTipoRespaldoStock,
                                                        int pCantidadRespaldo) throws SQLException {
        DBInventario.actualizaStkComprometidoProd(pCodigoProducto, pCantidadStk, pTipoStkComprometido);
        DBPtoVenta.ejecutaRespaldoStock(pCodigoProducto, "", pTipoRespaldoStock, pCantidadRespaldo,
                                        Integer.parseInt(VariablesInventario.vValFrac_Transf),
                                        ConstantsPtoVenta.MODULO_TRANSFERENCIA);
    ...
    private void mostrarCabecera() {
        if (!indCabecera) {
            VariablesInventario.vIndTextFraccion = "";
            DlgTransferenciasTransporte dlgTransferenciasTransporte =
                new DlgTransferenciasTransporte(myParentFrame, "", true);
    ...
    private boolean validaStkLocal() {
        ...
        for (int i = 0; i < tableModel.data.size(); i++) {
            ...
            if (posExiste < 0)
                ...
                double pCantidadActual =
                    FarmaUtility.getDecimalNumber(((ArrayList)(pTotal.get(posExiste))).get(2).toString());
        ...
        for (int j = 0; j < pTotal.size(); j++) {
            ...
            double pCantidad_in =
                FarmaUtility.getDecimalNumber(FarmaUtility.getValueFieldArrayList(pTotal, j, 2).toString().trim());
    ...
    private boolean permiteStock(String pCodigoProd, double pCantidad) {
        ...
        try {
            //ERIOS 2.4.0 No valida fraccion sugerida
            DBVentas.obtieneInfoDetalleProducto(pArrayList, pCodigoProd);
            double pStkFisico =
                FarmaUtility.getDecimalNumber(FarmaUtility.getValueFieldArrayList(pArrayList, 0, 0).toString().trim());
