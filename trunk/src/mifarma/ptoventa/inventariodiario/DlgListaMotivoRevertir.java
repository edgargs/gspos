...
public class DlgListaMotivoRevertir extends JDialog {
    ...
    private void obtieneMotivo() {
        ...
        System.out.println("VariablesInvDiario.vCodMotivoRevertir: "+ VariablesInvDiario.vCodMotivoRevertir);
        System.out.println("VariablesInvDiario.vCodMotivoAjuste: "+ VariablesInvDiario.vCodMotivoAjuste);
        cerrarVentana(true);
    }
