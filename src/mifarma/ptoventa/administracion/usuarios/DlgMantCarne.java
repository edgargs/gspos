...
public class DlgMantCarne extends JDialog {
        ...
        FarmaUtility.showMessage(this," Ingrese el Nro de Empleado", txtNroEmpleado);
           ...
           {   if (txtNroEmpleado.getText().length() > 0) {
             ...
             if(existeUsuario(VariablesUsuarios.vSecTrab)){
                System.err.println("El usuario existe en maestros");
            //metodo que verifica que el usuario no tiene carne
             ...
             else
             {
                ...
                System.out.println("Verifica si se validara al usuario");
                    ...
                    {   
                        if(IngresarCarneSanidad()) {
                          ...
                          if (EnviaAlertaRegistro())
                            ...
                            System.err.println("No se envió la alerta ");
    ...
    public boolean isValidoCodTrabRRHH(String codigo) {
        ...
        if (codigo.length() != 6)
            ...
            System.out.println("Primeras dos cifras : " + 
    ...
    System.err.println("Obteniendo datos de usuario");
            try {
    ...
    System.out.println("Dato vCodTrab_RRHH: "+VariablesUsuarios.vCodTrab_RRHH);
                 ...
                 System.err.println(" Nro elementos del arreglo :" +  myArray2.size());
                 System.err.println(" VariablesUsuarios.vNroCarne :" +  VariablesUsuarios.vNroCarne);
                 System.err.println(" VariablesUsuarios.vFechaExpedicion :" +  VariablesUsuarios.vFechaExpedicion);
   ...
   // private void IngresarCarneSanidad() throws SQLException {
        ...
        System.out.println("insertarCarne");
