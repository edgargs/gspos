...
public class DlgListaProdDigemidDCI extends JDialog {
    ...
    public DlgListaProdDigemidDCI(Frame parent, String title, boolean modal) {
    ...
    private void initTableListaDCI() {
        ...
        tableModelListaCDI =
                new FarmaTableModel(ConstantsVentas.columnsListProdsCDI, ConstantsVentas.defaultValuesListProdsCDI, 0);
        FarmaUtility.initSimpleList(tblListaDCI, tableModelListaCDI, ConstantsVentas.columnsListProdsCDI);
    ...
    private void cargalistaProductosDCI() {
        try {
            DBVentas.cargaListaProductosDCI(tableModelListaCDI, VariablesVentas.vCodProdDCI);
    ...
    private void this_windowClosing(WindowEvent e) {
        FarmaUtility.showMessage(this, "Debe presionar la tecla ESC para cerrar la ventana.", txtProducto);
    }
    ...
    private void this_windowOpened(WindowEvent e) {
        ...
        if (!DlgProcesar.cargaIndMostrarColumnasDesc()) {
            ConstantsVentas.columnsListProdsCDI[4].m_width = 0;
            ConstantsVentas.columnsListProdsCDI[5].m_width = 0;
            FarmaUtility.initSimpleListCleanColumns(tblListaDCI, tableModelListaCDI,
                                                    ConstantsVentas.columnsListProdsCDI, new ArrayList(), null, null,
                                                    false);
        }
        cargalistaProductosDCI();
        if (tableModelListaCDI.getRowCount() > 0) {
