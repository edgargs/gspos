...
public class DlgDevolucionNueva extends JDialog implements KeyListener {
    ...
    private void initCmbMotivo() {
        ...
        FarmaLoadCVL.loadCVLFromArrayList(cmbMotivo, ConstantsInventario.NOM_HASHTABLE_CMBMOTIVO_DEVOLUCION,
                                          dataArrayList, true);
    }
    ...
    private void cargarCabecera() {
        ...
        //TODO para que?
        notaEsCabDTO.setMotivodescCorta(FarmaLoadCVL.getCVLDescription(ConstantsInventario.NOM_HASHTABLE_CMBMOTIVO_DEVOLUCION,
                                                                       notaEsCabDTO.getTipoMotiNotaEs()));
        //TODO para que?
        notaEsCabDTO.setMotivodescLarga(obtieneDescripcionLarga(notaEsCabDTO.getTipoMotiNotaEs().trim(),
                                                                notaEsCabDTO.getMotivodescCorta().trim()));
    ...
    private void mostrarDatosProvedor() {
        if (!FarmaLoadCVL.getCVLCode(ConstantsInventario.NOM_HASHTABLE_CMBMOTIVO_DEVOLUCION,
                                     cmbMotivo.getSelectedIndex()).equals(ConstantsPtoVenta.LISTA_MAESTRO_PROVEEDOR)) {
            try {
                ArrayList array = new ArrayList();
    ...
    private void mostrarDatosCabecera() {
        if (notaEsCabDTO.getTipoMotiNotaEs() != null) {
            ...
            FarmaLoadCVL.setSelectedValueInComboBox(cmbMotivo, ConstantsInventario.NOM_HASHTABLE_CMBMOTIVO_DEVOLUCION,
                                                    notaEsCabDTO.getTipoMotiNotaEs());
