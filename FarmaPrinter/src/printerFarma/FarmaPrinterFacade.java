...
FarmaPrinterEpsonFacade epson;
 public FarmaPrinterFacade(){
   ...
   @Override
    ...
    /**
     * Metodo para pruebas de abrir Gabeta
    ...
    public void printMap(Map vFilaMap){
        if (this.getModelo().equalsIgnoreCase(FarmaPrinterConstants.MODELOEPSON)) {
            epson.printMap(vFilaMap);
        }
        else
        if (this.getModelo().equalsIgnoreCase(FarmaPrinterConstants.MODELOSTAR)) {
            star.printMap(vFilaMap);
        }        
    ...
    @Override
    public void printImagenGeneral(String codMarca, String ruta) {
        if(this.getModelo().equalsIgnoreCase(FarmaPrinterConstants.MODELOEPSON)){   
            getEpson().printImagenEpsonGeneral(ruta);
        }
        if(this.getModelo().equalsIgnoreCase(FarmaPrinterConstants.MODELOSTAR)){
            getStar().printImagenStarGeneral(ruta);
        }
    }
}