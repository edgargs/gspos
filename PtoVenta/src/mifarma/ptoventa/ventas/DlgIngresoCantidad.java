...
import mifarma.ptoventa.mayorista.DlgListaPrecioDscto;
...
public class DlgIngresoCantidad extends JDialog {
    ...
    private boolean isTieneDsctoMayorista = false;
    private ArrayList lstDsctoPrecioVtaMayorista = new ArrayList();
    private JLabelOrange lblMsjDsctoPrecioVtaMayorista = new JLabelOrange();
    ...
    private void jbInit() throws Exception {
        ...
        jContentPane.setBorder(BorderFactory.createLineBorder(SystemColor.windowText, 1));
        ...
        lblMsjDsctoPrecioVtaMayorista.setVisible(false);
        lblMsjDsctoPrecioVtaMayorista.setFont(new Font("SansSerif", 1, 15));
        lblMsjDsctoPrecioVtaMayorista.setText("Presione [F1] para listar precios de venta al por mayor.");
        ...
        pnlDetalleProducto.add(lblMsjDsctoPrecioVtaMayorista, new XYConstraints(4, 219, 490, 25));
    ...
    private void muestraInfoDetalleProd() {
        ...
        if (myArray.size() == 1) {
            ...
            isTieneDsctoMayorista = false;
            lstDsctoPrecioVtaMayorista = UtilityVentas.obtenerListaDsctoPrecioMayorista(this, VariablesVentas.vCod_Prod);
            if(lstDsctoPrecioVtaMayorista != null && lstDsctoPrecioVtaMayorista.size()>0){
                isTieneDsctoMayorista = true;
            }
            lblMsjDsctoPrecioVtaMayorista.setVisible(isTieneDsctoMayorista);
            //DUBILLUZ 24.07.2014
    ...
    private void chkKeyPressed(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_ESCAPE) {
            ...
            if(UtilityPtoVenta.verificaVK_F1(e) && isTieneDsctoMayorista){
                mostrarListaDsctoMayorista();
            }
        }
    }
   ...
   * */
    ...
    private void mostrarListaDsctoMayorista() {
    
        boolean flagAceptar = FarmaVariables.vAceptar;
        DlgListaPrecioDscto dlgListaDscto = new DlgListaPrecioDscto(myParentFrame, "", true);
        dlgListaDscto.cargarListaProducto(lstDsctoPrecioVtaMayorista);
        dlgListaDscto.setStockProducto(Integer.parseInt(VariablesVentas.vStk_Prod));
        dlgListaDscto.setVisible(true);
        if(FarmaVariables.vAceptar){
            VariablesVentas.vValPrecVtaMayoreo = dlgListaDscto.obtenerNuevoPrecioAcordado();
            String cantidad = dlgListaDscto.obtenerCantidadAcordada();
            txtCantidad.setText(cantidad);
            aceptaCantidadIngresada();
            /*String nuevoPrecionUnit = dlgListaDscto.obtenerNuevoPrecioAcordado();
            String cantidad = dlgListaDscto.obtenerCantidadAcordada();
            boolean continua = true;
            double precVtaRedondeadoNum = 0;
            try{
                precVtaRedondeadoNum = DBVentas.getPrecioRedondeado(FarmaUtility.getDecimalNumber(nuevoPrecionUnit)); //ASOSA, 18.06.2010
            }catch(Exception ex){
                continua = false;
            }*/
            /*if(continua){
                VariablesVentas.vVal_Prec_Vta = nuevoPrecionUnit;
                txtPrecioVenta.setText(VariablesVentas.vVal_Prec_Vta);
                txtCantidad.setText(cantidad);
                String precVtaRedondeadoStr = FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber("" + precVtaRedondeadoNum), 3);
                this.txtPrecioVentaRedondeado.setText(precVtaRedondeadoStr);
                FarmaVariables.vAceptar = flagAceptar;
                
            }*/
        }else{
            VariablesVentas.vValPrecVtaMayoreo = "";
        }
