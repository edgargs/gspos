...
public class DlgIngresoCantidadCruce extends JDialog {
       ...
       int  ValFracMax2=0;
        ...
        if (e.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            try {
              ...
              //System.out.println("ValFracMax1" + ValFracMax1);
              //System.out.println("ValFracMax2" + ValFracMax2);
    ...
    private void mostrarDatos() {
        ...
        String stockusadoprod2 = DBInvDiario.obtenerStockUsadoCruce(VariablesInvDiario.vCodigoAux);
            ...
            //System.out.println(" stock de producto a cargar D : " + VariablesInvDiario.vStockProdD);
            //System.out.println(" stock usado D : " + Double.parseDouble(stockusadoprod1));
            //System.out.println(" suma D : " + (VariablesInvDiario.vStockProdD - Double.parseDouble(stockusadoprod1)));
         ...
         {
                System.out.println("No hay stock disponible para cruce");
         }   
    ...
    private void ingresarCantidad() throws SQLException {
        ...
        String indStocComp="";
         ...
         System.out.println("TOMA INVENTARIO DIARIO: ENTRO AGREGA CRUCE" + VariablesInvDiario.vCodProd);
