...
public class DlgRegistroVentas extends JDialog {
    private static final Logger log = LoggerFactory.getLogger(DlgRegistroVentas.class);
    ...
    private void initTableListaRegistroVentas() {
        tableModelRegistroVentas =
                new FarmaTableModel(ConstantsReporte.columnsListaRegistroVentas, ConstantsReporte.defaultValuesListaRegistroVentas,
                                    0);
    ...
    private void cargaRegistroVentas() {
        try {
            ...
            DBReportes.cargaListaRegistroVentas(tableModelRegistroVentas, VariablesReporte.vFechaInicio,
