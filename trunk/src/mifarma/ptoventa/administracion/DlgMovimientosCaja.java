...
//**************************************************************************
	...
	private void initTable() {
		tableModel = new FarmaTableModel(ConstantsPtoVenta.columnsListaMovimientos, ConstantsPtoVenta.defaultValuesListaMovimientos, 0);
		FarmaUtility.initSimpleList(tblListaMovimientos, tableModel,
  ...
  private boolean datosValidados() {
		...
		if (!FarmaUtility.validaFecha(txtDiaVenta.getText(), "dd/MM/yyyy")
			...
			FarmaUtility.showMessage(this,
					"Ingrese la Fecha correctamente", txtDiaVenta);
			return false;
		}
