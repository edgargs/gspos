...
BEGIN
 ...
 --Limpiando las tablas
  ...
  DELETE  FROM FID_TARJETA A WHERE A.DNI_CLI  NOT LIKE 'CP%';
    ...
    --ERIOS 21.07.2016 Nuevas Tablas v3.5.10.A
	EXECUTE IMMEDIATE 'TRUNCATE TABLE PTOVENTA.PROG_RENTABLES_PPTO DROP STORAGE';		
	EXECUTE IMMEDIATE 'TRUNCATE TABLE PTOVENTA.PROG_RENTABLES_PPTO_LOC DROP STORAGE';		
	EXECUTE IMMEDIATE 'TRUNCATE TABLE PTOVENTA.PROG_RENTABLES_PPTO_HIST DROP STORAGE';		
	--ERIOS 23.08.2016 Nuevas Tablas v3.5.11.A
	EXECUTE IMMEDIATE 'TRUNCATE TABLE PTOVENTA.VTA_INSUMO DROP STORAGE';		
	EXECUTE IMMEDIATE 'TRUNCATE TABLE PTOVENTA.VTA_INSUMO_AUX DROP STORAGE';		
