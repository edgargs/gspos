...
public class VariablesRecepCiega {
    ...
    /**
     * Variables Recepcion de Productos
     * @author JCORTEZ
     * @since 16.11.09
     * */
    ...
    public static String vLastLote = "";
    public static String vLastFechaVenc = "";
    public static String vLastIndLoteMayorista = "";
    ...
    public static boolean isActivoNewRecepCiega = false;
    public static String vCodBulto = "";
    public static String vCorrBulto = "";
    public static String vIndLectoraBulto = "N";
    public static String codigoBultoAuxPucha = "";
    
    public static boolean isLocalBeepBios = false;  //ASOSA - 22/06/2015 - RCIEGAMCHANGES01
