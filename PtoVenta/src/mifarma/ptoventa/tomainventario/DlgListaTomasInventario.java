        ...
        if (e.getKeyCode() == KeyEvent.VK_ESCAPE) {
            ...
            if (FarmaVariables.vEconoFar_Matriz)
                ...
                if (cargaLogin()) {
                    ...
                    if (idUsuarioToma_Creacion.equalsIgnoreCase(VariablesTomaInv.vIdUsu_Toma.trim())) {
                                ...
                                if (com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,
                                   ...
                                   // try {
                                        if (obtieneIndicadorProceso_ForUpdate(VariablesTomaInv.vSecToma,
                                           ...
                                           // cargarToma(); //LTAVARA XXX
                                           DlgCargarTomaInventarioProgress cargarToma = new DlgCargarTomaInventarioProgress(myParentFrame, "", true);
                                           cargarToma.mostrar();
                                           //PROYECTO MONEDERO
                        ...
                        FarmaUtility.showMessage(this,
                                                 "Solo el usuario " + idUsuarioToma_Creacion + " quien inicio la Toma puede cargar la Toma. Verifique!",
                                                 tblRelacionTomas);
                    }
                }
            }
            ...
            if (FarmaVariables.vEconoFar_Matriz)
                ...
                if (cargaLogin()) {
                    ...
                    if (idUsuarioToma_Creacion.equalsIgnoreCase(VariablesTomaInv.vIdUsu_Toma.trim())) {
                        ...
                        FarmaUtility.showMessage(this,
                                                 "Solo el usuario " + idUsuarioToma_Creacion + " quien inicio la Toma puede eliminar la Toma. Verifique!",
                                                 tblRelacionTomas);
                }
            }
        }
    ...
    private void cargaTomasInventario() {
        try {
            ...
            if (tblRelacionTomas.getRowCount() > 0)
                FarmaUtility.ordenar(tblRelacionTomas, tableModelTomasInventario, 0, FarmaConstants.ORDEN_DESCENDENTE);
    ...
    private boolean esTomaValida() {
        ...
        if (indTomaInc.equals("1")) {
            ...
            try {
                ...
                FarmaUtility.moveFocus(tblRelacionTomas); //ltavara 11.02.16
