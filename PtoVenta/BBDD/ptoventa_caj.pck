         ...
         SELECT VTA_CAB.NUM_PED_VTA || 'Ã' ||
               ...
               (CASE
                 -- dubilluz 15.09.2014
                  ...
                  ELSE to_char(VTA_CAB.PCT_BENEFICIARIO,'99999990.00') END) || 'Ã'||
             ...
             TO_CHAR(
               CASE 
                ...
                END
             ,'999,990.00') || 'Ã'||
             TO_CHAR(NVL(VTA_CAB.VAL_REDONDEO_PERCEPCION*(-1),0),'999,990.00') || 'Ã'||
             NVL(FARMA_UTILITY.F_GET_MSJ_APLICA_PERCEPCION(cCodGrupoCia_in, cCodLocal_in, VTA_CAB.NUM_PED_VTA),' ')
