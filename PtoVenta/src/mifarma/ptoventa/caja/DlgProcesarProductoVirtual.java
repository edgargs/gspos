            ...
            if (VariablesCaja.vIndLinea != null &&
                ...
                try {
                    ...
                    JMessageAlert.showMessage(myParentFrame, "Recarga Virtual",
                                              ...
                                              e.getMessage() + "@" + "Error en la Recarga Virtual",
                ...
                FarmaUtility.enviaCorreoPorBD(FarmaVariables.vCodGrupoCia, FarmaVariables.vCodLocal,
                                              VariablesPtoVenta.vDestEmailErrorCobro, "Error de Conexion Matriz",
                                              "Error de Comunicacion BBDD",
                                              "El pedido no puede ser cobrado." + "<br>" + "No hay linea con matriz." +
                                              "<br>" + "Inténtelo nuevamente." + "<br>" + "IP PC: " +
                                              FarmaVariables.vIpPc + "<br>" + "Error: " + "Conexion", "");
                vProcesoRecarga = false;
            }
        }
    }
    ...
    private void procesaPedidoVirtual() throws Exception { //ERIOS 30.05.2013 Envia el pedido de preparado hacia el sistema Recetario Magistral
        ...
        if (ConstantsVentas.TIPO_PROD_VIRTUAL_RECARGA.equalsIgnoreCase(VariablesCaja.vTipoProdVirtual) ||
            ...
            if (1 == 2) {
                ...
                String codProd =
                    FarmaUtility.getValueFieldArrayList(VariablesVirtual.vArrayList_InfoProdVirtual, 0, 0);
                ...
                String comercio =
                    ConstantsRecaudacion.ID_RECARGAS + "" + facadeRecaudacion.getCodLocalMigra().substring(1); //FarmaVariables.vDescCortaLocal;
                ...
                if (ConstantsVentas.TARJ_RECARGA_MOVISTAR_VIRTUAL.equals(codProd)) {
                    codTrssc =
                            facadeCaja.registrarTrsscRecarga(ConstantsRecaudacion.MSJ_SIX_PETICION_TRSSC_200, ConstantsRecaudacion.ESTADO_SIX_PENDIENTE,
                                                             ConstantsRecaudacion.TRNS_RECARGA,
                                                             ConstantsRecaudacion.TIPO_REC_MOVISTAR, monto, terminal,
                    ...
                    rptSix =
                            facadeRecaudacion.obtenerRespuestaSix(ConstantsRecaudacion.RCD_MODO_RECARGA_SIX, ConstantsRecaudacion.RCD_PAGO_SIX_RECARGA_VIRTUAL_MOVISTAR,
                                                                  codTrssc);
                    ...
                    codTrssc =
                            facadeCaja.registrarTrsscRecarga(ConstantsRecaudacion.MSJ_SIX_PETICION_TRSSC_200, ConstantsRecaudacion.ESTADO_SIX_PENDIENTE,
                                                             ConstantsRecaudacion.TRNS_RECARGA,
                                                             ConstantsRecaudacion.TIPO_REC_CLARO, monto, terminal,
                                                             comercio, ubicacion, telefono, VariablesCaja.vNumPedVta,
                                                             FarmaVariables.vIdUsu);
                    //GFonseca 21/11/2013 Si falla el insert de la peticion, ya no continua con el pago
                    if (codTrssc == null) {
                    ...
                    rptSix =
                            facadeRecaudacion.obtenerRespuestaSix(ConstantsRecaudacion.RCD_MODO_RECARGA_SIX, ConstantsRecaudacion.RCD_PAGO_SIX_RECARGA_VIRTUAL_CLARO,
                                                                  codTrssc);
                ...
                if (bRpt && ConstantsRecaudacion.COD_SOLICITUD_EXITOSA.equals(strResponseCode)) {
                    try {
                        ...
                        String vSalida =
                            facadeRecaudacion.guardaLogConciliacionRecargas(PCL_COD_ID_CONCENTRADOR, PCL_NUMERO_TELEFONO,
                                                                            PCL_COD_AUTORIZACION, PCL_COD_VENDEDOR,
                                                                            PCL_FECHA_VENTA, PCL_HORA_VENTA,
                                                                            PCL_NUMERO_DOCUMENTO, PCL_COD_COMERCIO,
                                                                            PCL_COD_TERMINAL, PCL_MONTO_VENTA,
                                                                            PCL_ID_TRANSACCION);
