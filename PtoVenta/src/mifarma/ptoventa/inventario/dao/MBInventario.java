...
public class MBInventario implements DAOInventario {
    ...
    public String actualizarOrdenCompra_OLD(String vNumOrdenCompra, String vCodProducto,
    ...
    /**--------------------------------------------------------------------------------------------------------------------------
     GOAL : Actualizar detalle de Orden Compra en Apps
     Hist : 05-NOV-14  TCT  Create
    ----------------------------------------------------------------------------------------------------------------------------*/
    public String actualizarOrdenCompra(String vNumOrdenCompra, String vCodProducto,
        ...
        mapParametros.put("ac_Cod_Prod", vCodProducto);
        mapParametros.put("an_Cant_Reci", vCantEntregada);
        SqlSession sqlAdmSession = MyBatisUtil.getAdmSqlSessionFactory().openSession();
        try {
            MapperInventario mapperAdm = sqlAdmSession.getMapper(MapperInventario.class);
            //log.debug("<<TCT 10 > Call SP en ADM: "+mapParametros);
