...
// **************************************************************************
  ...
  public void cargaClienteJuridico()
  {
    try
    {
      System.out.println(VariablesCliente.vRuc_RazSoc_Busqueda);
      System.out.println(VariablesCliente.vTipoBusqueda);
      DBCliente.cargaListaClienteJuridico(tableModelListaClienteJuridico,VariablesCliente.vRuc_RazSoc_Busqueda, VariablesCliente.vTipoBusqueda);
      FarmaUtility.ordenar(tblClienteJuridico, tableModelListaClienteJuridico, 2, FarmaConstants.ORDEN_ASCENDENTE);
      if(tblClienteJuridico.getRowCount() > 0) FarmaUtility.setearPrimerRegistro(tblClienteJuridico, txtClienteJuridico, 2);
      else
...
// **************************************************************************
  ...
  FarmaGridUtils.aceptarTeclaPresionada(e, tblClienteJuridico, txtClienteJuridico, 2);
    ...
    if (e.getKeyCode() == KeyEvent.VK_ENTER)
    {
        ...
        else  FarmaUtility.showMessage(this, "Ingrese 3 caracteres como minimo para realizar la busqueda", txtClienteJuridico);
      }       
