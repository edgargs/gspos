...
public class DlgIngresoCodigoBarra extends JDialog {
    ...
    */
    ...
    private static final int Col_lote = 9;
    private static final int Col_fecha_lote = 10;
    ...
    private void ingresaProducto() {
        ...
        try {
            DBTomaInv.insertAuxConteo(VariablesTomaInv.vSecToma, VariablesTomaInv.vSecAuxConteo,
                                      ...
                                      VariablesTomaInv.vIndProcesoToma,VariablesTomaInv.vLoteIngresado );
    ...
    */
    ...
    private void muestraInfoProd(String pIndNuevoIngreso) {
        ...
        if (pIndNuevoIngreso.trim().equalsIgnoreCase(FarmaConstants.INDICADOR_S)) {
            ...
            if (pDatos.size() == 1) {
                ...
                log.debug("VariablesTomaInv.vIndLoteMayorista :" + VariablesTomaInv.vIndLoteMayorista);
        ...
        // llamar a la pantalla de mayorista
    ...
    private void getDatosModificar() {
        ...
        VariablesTomaInv.vLoteIngresadoTemp=
            FarmaUtility.getValueFieldArrayList(tableModelProductosConteo.data, vFila, Col_lote);
        VariablesTomaInv.vFechaLoteIngresadoTemp=
            FarmaUtility.getValueFieldArrayList(tableModelProductosConteo.data, vFila, Col_fecha_lote);
    ...
    private void updateDatosConteo() throws SQLException {
        ...
        DBTomaInv.updateProdConteo(VariablesTomaInv.vSecToma, VariablesTomaInv.vSecAuxConteoTemp.trim(),
                                   VariablesTomaInv.vCantEnteraIngresada, VariablesTomaInv.vCantFracIngresada,
                                   VariablesTomaInv.vLoteIngresado);
        /*}
        catch (SQLException sql){
            log.error("",sql);
            FarmaUtility.liberarTransaccion();
    ...
    private void limpiarVariables() {
        ...
        VariablesTomaInv.vIndLoteMayorista ="";//LTAVARA 15/01/16 PROYECTO M
        VariablesTomaInv.vValFracMasterPack=0;//LTAVARA 15/01/16 PROYECTO M
        VariablesTomaInv.vLoteIngresado="";//LTAVARA 15/01/16 PROYECTO M
    }
