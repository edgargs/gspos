...
public class DocumentRendererMedPresion implements Printable {
    private static final Logger log = LoggerFactory.getLogger(DocumentRendererMedPresion.class);
...
*/
    ...
    public DocumentRendererMedPresion() {
        pFormat = new PageFormat();
        pJob = PrinterJob.getPrinterJob();
    }

    public DocumentRendererMedPresion(PrintService pImpresora) {
        pFormat = new PageFormat();
        pJob = PrinterJob.getPrinterJob();
        try {
