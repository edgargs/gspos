...
*/
    ...
    private static void ventaRecargaVirtualTX(String pCodComercioCia,
        ...
        //ERIOS 22.04.2016 Bitel va por el Demonio de recagas. Se debe parametrizar.
        boolean recBitel = VariablesCaja.vTipoRcd.equals("12");
        
        UtilityRecargaVirtual utilRecaVirtual = new UtilityRecargaVirtual();
        if(!recBitel && "S".equals(DlgProcesar.getIndGestorTx(false))){
