...
///******
  ...
  { //ERIOS 30.05.2013 Envia el pedido de preparado hacia el sistema Recetario Magistral
    ...
    if(VariablesCaja.vTipoProdVirtual.equalsIgnoreCase(ConstantsVentas.TIPO_PROD_VIRTUAL_RECARGA) ||
       VariablesCaja.vTipoProdVirtual.equalsIgnoreCase(ConstantsVentas.TIPO_PROD_VIRTUAL_TARJETA)   )
    {   
    ...
    }else if(VariablesCaja.vTipoProdVirtual.equalsIgnoreCase(ConstantsVentas.TIPO_PROD_VIRTUAL_MAGISTRAL) &&
