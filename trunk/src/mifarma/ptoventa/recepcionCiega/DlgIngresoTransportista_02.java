...
public class DlgIngresoTransportista_02 extends JDialog {
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(493, 260));
        ...
        pnlTitle1.setBounds(new Rectangle(5, 10, 475, 195));
        ...
        txtBultos.setBounds(new Rectangle(155, 100, 120, 20));
        ...
        lblValor_T.setBounds(new Rectangle(10, 130, 115, 20));
        ...
        txtNombre.setBounds(new Rectangle(155, 40, 265, 20));
        ...
        lblFechaFinal_T.setBounds(new Rectangle(10, 100, 110, 20));
        ...
        txtPlaca.setBounds(new Rectangle(155, 70, 175, 20));
        ...
        txtGlosa.setBounds(new Rectangle(155, 160, 305, 20));
        ...
        txtcodtrans.setBounds(new Rectangle(155, 15, 35, 20));
        txtcodtrans.addKeyListener(new KeyAdapter() {
                    public void keyPressed(KeyEvent e) {
                        txtcodtrans_keyPressed(e);
                    }
                });
        txtnomtrans.setBounds(new Rectangle(195, 15, 185, 20));
    ...
    private boolean datosValidados() {
        ...
        if(txtcodtrans.getText().trim().length()<1 || txtnomtrans.getText().trim().length()<1){// , 22.04.2010
            FarmaUtility.showMessage(this,"Ingrese codigo de empresa de transporte",txtcodtrans);
            retorno=false;
        }else if(!verificarCodigo()){// , 22.04.2010
            retorno=false;
