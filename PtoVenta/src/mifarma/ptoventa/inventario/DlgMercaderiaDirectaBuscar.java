        ...
        if (selectedRow >= 0) {
            try {
                VariablesInventario.vNumOrdenCompra =
                        FarmaUtility.getValueFieldArrayList(tableModel.data, selectedRow, 0);
                VariablesInventario.vImporteTotal =
                        FarmaUtility.getValueFieldArrayList(tableModel.data, selectedRow, 5);
                VariablesInventario.vCodProveedor =
                        FarmaUtility.getValueFieldArrayList(tableModel.data, selectedRow, 8);
                VariablesInventario.vDescProveedor =
                        FarmaUtility.getValueFieldArrayList(tableModel.data, selectedRow, 3);
                VariablesInventario.vCodFormaPago =
                        FarmaUtility.getValueFieldArrayList(tableModel.data, selectedRow, 9);
                VariablesInventario.vDescFormaPago =
                        FarmaUtility.getValueFieldArrayList(tableModel.data, selectedRow, 10);
                VariablesInventario.vRUCProveedor =
                        FarmaUtility.getValueFieldArrayList(tableModel.data, selectedRow, 11);
                VariablesInventario.vEstadoOrdComp =
                        FarmaUtility.getValueFieldArrayList(tableModel.data, selectedRow, 12);
                ...
                if ("T".equalsIgnoreCase(VariablesInventario.vEstadoOrdComp)) {
                    FarmaUtility.showMessage(this,
                                             "La Ord. de Compra " + VariablesInventario.vNumOrdenCompra + " completo la recepción de productos y se encuentra cerrada.",
                                             null);
                } else {
