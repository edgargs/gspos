...
public class DlgPedidosPendientesImpresion extends JDialog
{
  ...
  private JLabelFunction jLabelFunction1 = new JLabelFunction();
    ...
    private final int COL_IND_DELIVERY = 19;
  ...
  private String obtieneNumeroPedido()
  {
    ...
    private void reimprimirPedido()
    {
        ...
        try
        {
            ...
            VariablesVentas.vTip_Comp_Ped = ((String)tblListaPendientes.getValueAt(filaActual, 8)).trim();
            ...
            try
            {
                ...
                if("S".equalsIgnoreCase(DBCaja.getIndPedConvenio(VariablesCaja.vNumPedVta))){
                    ...
                    if(ConstantsVentas.TIPO_PEDIDO_INSTITUCIONAL.equals(VariablesVentas.vTipoPedido)){
                        ...
                        VariablesConvenioBTLMF.vInstitucion     = ((String)tblListaPendientes.getValueAt(filaActual, 13)).trim();
                        VariablesConvenioBTLMF.vDireccion       = ((String)tblListaPendientes.getValueAt(filaActual, 14)).trim();
                        VariablesConvenioBTLMF.vRuc             = ((String)tblListaPendientes.getValueAt(filaActual, 15)).trim();
                        VariablesConvenioBTLMF.vNumOrdeCompra   = ((String)tblListaPendientes.getValueAt(filaActual, 16)).trim();
                        VariablesConvenioBTLMF.vPuntoLlegada    = ((String)tblListaPendientes.getValueAt(filaActual, 17)).trim();
                        VariablesVentas.vMensajeBotiquinBTLVtaInstitucional = ((String)tblListaPendientes.getValueAt(filaActual, 18)).trim();
                    }else{
