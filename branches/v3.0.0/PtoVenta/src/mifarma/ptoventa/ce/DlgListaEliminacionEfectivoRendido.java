...
import mifarma.ptoventa.recepcionCiega.DlgIngresoProdTransferencia;
  ...
  extends JDialog
{
  ...
  private void eliminacionMultiple()
  {
    ...
    try 
    {
      if (com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,"¿Esta seguro de eliminar los efectivos rendidos ?"))
      {
