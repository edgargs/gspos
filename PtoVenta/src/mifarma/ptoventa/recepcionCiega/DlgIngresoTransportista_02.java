...
public class DlgIngresoTransportista_02 extends JDialog {
    ...
    private void jbInit() throws Exception {
        ...
        */
        ...
        lblHojaRes.setBounds(new Rectangle(10, 220, 135, 15));
    ...
    */
    ...
    private void initTableListaBandejas() {
        tableModelBandejas = 
                new FarmaTableModel(ConstantsVentas.columnsListaBandejas, 
                                    ConstantsVentas.defaultValuesListaBandejas, 
                                    0);

        tableModelHojaRes = 
                new FarmaTableModel(ConstantsVentas.columnsListaHoja, 
                                    ConstantsVentas.defaultValuesListaHoja, 
                                    0);
        
        FarmaUtility.initSimpleList(tblBandejas, 
                                    tableModelBandejas, 
                                    ConstantsVentas.columnsListaBandejas);
        tblBandejas.setName(ConstantsVentas.NAME_TABLA_BANDEJAS);
        if (tableModelBandejas.getRowCount() > 0)
            FarmaUtility.ordenar(tblBandejas, tableModelBandejas, 
                                 COL_ORD_LISTA, 
    ...
    private void chkKeyPressed(KeyEvent e) {
        if (UtilityPtoVenta.verificaVK_F11(e)) {
            //obtiene datos
            if (datosValidados() && 
                validarCantidadBultos() //ASOSA - 21/07/2014
                ) {
                if (JConfirmDialog.rptaConfirmDialog(this, 
                    ...
                    try{
                            ...
                            String vNroRecep = DBRecepCiega.ingresaDatosTrans_02("0",txtcodtrans.getText().trim(),
                                                                                 txtHojaRes.getText().trim(), //ASOSA - 24/07/2014
                            ...
                            UtilityRecepCiega.imprimeVoucherTransportista_02(this,vNroRecep,txtNombre);    //ASOSA - 24/07/2014
                            ...
                            log.error("",sql);
                            FarmaUtility.showMessage(this,"Error al ingresar los Datos del Transportista: " + sql.getMessage().substring(9, sql.getMessage().indexOf("ORA", 2)),txtNombre);
                        }
    ...
    */
    ...
    private void txtHojaRes_keyPressed(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_ENTER) {
            if (existeTextoCajaTexto(txtHojaRes.getText())) {
                if (validarNuevoIngresoHojaRes()){
                    if (!existsHojaResumen()) {
                        if(validarCodigoHojaRes()){
                            ...
                            if (cont == 0) {
                                String texto = FarmaUtility.ShowInput(this, 
                                                         "Ingrese nuevamente el código de Hoja Resumen");
                                if (texto.equalsIgnoreCase(txtHojaRes.getText())) {
                                    ...
                                    txtHojaRes.setText("");
                                    FarmaUtility.showMessage(this, 
                                                 "Número incorrecto, comience ingresando de nuevo", 
                                                 txtHojaRes);
                                    cont = 0;
                                }
                            } else {
                        ...
                        FarmaUtility.showMessage(this, 
                                     "El nro. de Hoja de Resumen ya existe, verifique sus datos.", 
                                     txtHojaRes);
                    }                    
                } else {
                    FarmaUtility.moveFocus(txtNroBandeja);
                ...
                FarmaUtility.showMessage(this, 
                             "Ingrese nro. de Hoja de Resumen", 
                             txtHojaRes);
            }
        } else {
            chkKeyPressed(e);
    ...
    private boolean validarNuevoIngresoHojaRes(){
        ...
        if (flagExisteHojaResumen || cont==1) {
            flag = JConfirmDialog.rptaConfirmDialogDefaultNo(this, "La hoja de resumen ya fue ingresada, ¿Desea cambiarla?");
        }
        if (flag) {
            limpiarLista();
        }
    ...
    private void eliminarUltimoRegistro() {
        ...
        if (cantidad > 0) {
            ...
            FarmaUtility.showMessage(this, 
                         "No hay bandejas para eliminar de la lista", 
                         null);
        }        
    }
                        ...
                        if(!validarRepetidos()){
                            if (flagExisteHojaResumen){
                                if (validarCodigoBandeja()) {
                                    ...
                                    FarmaUtility.showMessage(this, 
                                                 "El número de bandeja no existe para la Hoja de Resumen ingresada", 
                                                 txtNroBandeja);
                                }
                            } else {
                                agregarCodigoBandeja();
                            ...
                            FarmaUtility.showMessage(this, 
                                         "El número de bandeja ya fue ingresado", 
                                         txtNroBandeja);
                        }
                    }else{
                        FarmaUtility.showMessage(this, 
                                     "Ingrese número de Hoja de Resumen", 
                                     txtHojaRes);
                    }  
                }else{
                    FarmaUtility.showMessage(this, 
                                 "El numero de bandeja debe tener " + MAX_DIGITOS + " digitos", 
                                 txtNroBandeja);
                }
            }else {
                FarmaUtility.showMessage(this, 
                             "Ingrese número de Bandeja", 
                             txtNroBandeja);
            }
        }
        chkKeyPressed(e);
    ...
    private boolean validarCodigoHojaRes(){
        ...
        try {
            ...
            log.error("ERROR validarCodigoHojaRes: " + e.getMessage());
        }
        return flag;
    }
    ...
    private boolean validarCodigoBandeja(){
        ...
        try {
            ...
            log.error("ERROR validarCodigoBandeja: " + e.getMessage());
        }
        return flag;
    }
    ...
    private boolean existsHojaResumen(){
        ...
        try {
            flag = UtilityRecepCiega.buscarHojaResumenGrabada(nroHojaRes);
        }catch(SQLException e){
            log.error("ERROR existsHojaResumen: " + e.getMessage());
        }
        return flag;
    }
    ...
    private boolean validarCodigoValija() {
        ...
        if (codigo.length() != 0) { //si no ingrese valija paso al siguiente campo porque no es obligatorio.
            if (codigo.length() == LENGTH_COD_VALIJA_01 || codigo.length() == LENGTH_COD_VALIJA_02) {
                ...
                FarmaUtility.showMessage(this,
                                         "El código de valija debe de tener " + LENGTH_COD_VALIJA_01 + " o " + LENGTH_COD_VALIJA_02 + " dígitos",
                                         txtCodValija);
            }
        } else {
            flag = true;
