...
// **************************************************************************
  ...
  private void cargaListaCompetencias()
  {
   try
    ...
    {
      System.out.println("error al cargar lista de competencias : " + e);
    }
  }
 ...
 private void guardaValores()
 {
   ...
   System.out.println("Competencia Seleccionada : ");
   System.out.println("" + VariablesInventario.vDescripcionCompetencia + " ");
   System.out.println("" + VariablesInventario.vRucCompetencia);
  }
