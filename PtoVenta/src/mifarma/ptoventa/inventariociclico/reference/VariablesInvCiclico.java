...
public class VariablesInvCiclico {
    ...
    /**Almacena la el estado si requiere lote S=si requiere lote, N caso contrario
     */
    public static String vReqLote = "";
    ...
    /**Almacena el flag de seleccion de modificar la cantidad de un daterminado lote*/
    public static int vActionAdd = 0;  
    
    /**Almacena el flag de seleccion de modificar la cantidad de un daterminado lote*/
    public static int vIndTipoVentaMayorista = 0;
