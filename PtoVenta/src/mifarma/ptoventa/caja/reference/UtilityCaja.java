    ...
    */
    ...
    public static ArrayList getDetaVentaRimac(String pNumPedVenta){
        ...
        try{
            ...
            log.info("ERROR en getDetaVentaRimac: " + e.getMessage());
            list = null;
        } finally {
            return list;
        }        
    ...
    public static String insertVentaRimacMatriz(PedVtaRimacDTO pedVtaRimacDTO,
        ...
        try {
            ...
            log.info("ERROR en insertVentaRimacMatriz: " + e.getMessage());
            rpta = "N";
        } finally {
            return rpta;
        }        
    ...
    public static boolean get_ind_prod_rimac_activo(String num_ped_vta){
        ...
        try {
            ...
            log.info("ERROR en get_ind_prod_rimac_activo: " + e.getMessage());
            flag = false;
        } finally {
            return flag;
        }        
    ...
    public static boolean get_ind_ped_con_rimac(String num_ped_vta){
        ...
        try {
            ...
            log.info("ERROR en get_ind_ped_con_rimac: " + e.getMessage());
            flag = false;
        } finally {
            return flag;
        }        
