...
// **************************************************************************
  ...
  {
    codigoProductoOrigen = VariablesVentas.vCodProdOrigen_Comple;
    descripcionProductoOrigen = VariablesVentas.vDescProdOrigen_Comple;
...
// **************************************************************************
  ...
  {
    tableModelProductosComplementarios = new FarmaTableModel(ConstantsVentas.columnsListaProductosComplementarios,ConstantsVentas.defaultValuesListaProductosComplementarios,0);
    FarmaUtility.initSimpleList(tblProductosComplementarios,tableModelProductosComplementarios,ConstantsVentas.columnsListaProductosComplementarios);
  }
  
  private void initTableAccTerap()
  {
    tableModelRelacionAccTerap = new FarmaTableModel(ConstantsVentas.columnsListaRelacionAccTerap,ConstantsVentas.defaultValuesListaRelacionAccTerap,0);
    FarmaUtility.initSimpleList(tblPrincAct,tableModelRelacionAccTerap,ConstantsVentas.columnsListaRelacionAccTerap);
    cargaListaAccTerap();
  }
  ...
  private void cargaListaAccTerap()
  {
    try
    {
      DBVentas.cargaListaRelacionAccionTerap(tableModelRelacionAccTerap, codigoProductoOrigen);
  ...
  private void cargaListaProdComplementarios(String pCodPrincAct)
  {
    try
    {
      DBVentas.cargaListaProductosComplementarios(tableModelProductosComplementarios, codigoProductoOrigen, pCodPrincAct);
...
// **************************************************************************
  ...
  private void btnBuscar_actionPerformed(ActionEvent e)
  {
    ...
    VariablesVentas.vCodProdComplementario = ((String)tblProductosComplementarios.getValueAt(tblProductosComplementarios.getSelectedRow(), 0)).trim();
    cerrarVentana(true);
  }
  ...
  private void txtProducto_keyReleased(KeyEvent e)
  {
    if(tblProductosComplementarios.getRowCount()>0)
    {
      ...
      if ( !(e.getKeyCode()==KeyEvent.VK_ESCAPE) )
        if ( myJTable.getName().equalsIgnoreCase(ConstantsVentas.NAME_TABLA_PROD_PRINC_ACT) ){
          String codAccTerap = ((String)tblPrincAct.getValueAt(tblPrincAct.getSelectedRow(), 0)).trim();
          cargaListaProdComplementarios(codAccTerap);
        }
    }
...
// **************************************************************************
  ...
  {
    if(tblProductosComplementarios.getRowCount() == 0) return;
    VariablesVentas.vCod_Prod = ((String)(tblProductosComplementarios.getValueAt(tblProductosComplementarios.getSelectedRow(),1))).trim();
    VariablesVentas.vDesc_Prod = ((String)(tblProductosComplementarios.getValueAt(tblProductosComplementarios.getSelectedRow(),2))).trim();
    VariablesVentas.vNom_Lab = ((String)(tblProductosComplementarios.getValueAt(tblProductosComplementarios.getSelectedRow(),4))).trim();
