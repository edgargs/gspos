                    ...
                    if (tblRelacionProductos.getSelectedRow() >= 0) {
                        if (!(FarmaUtility.findTextInJTable(tblRelacionProductos, txtProductos.getText().trim(), 0,
                            ...
                            if (tieneRegistroSeleccionado(tblRelacionProductos)) {
                                ...
                                //LTAVARA 05.02.16 PROYECTO MAYORISTA
                                if(UtilityPtoVenta.isLocalVentaMayorista()){
                                    DlgIngresoCantidadTomaLote dlgIngresoCantidadTomaLote =
                                    new DlgIngresoCantidadTomaLote(this.myParentFrame, "", true);
                                    dlgIngresoCantidadTomaLote.setVisible(true);
                                }else{
