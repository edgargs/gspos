...
public class DlgFiltro extends JDialog
{
  ...
  private void cmbTipo_keyPressed(KeyEvent e)
  {
    ...
    {
      VariablesProducto.vIndNuevo = FarmaLoadCVL.getCVLCode(ConstantsProducto.NOM_HASTABLE_CMBFILTROPROD,cmbTipo.getSelectedIndex());
      System.out.println("filtro : "+VariablesProducto.vIndNuevo);
      cerrarVentana(true);
