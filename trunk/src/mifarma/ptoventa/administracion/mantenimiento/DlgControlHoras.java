...
import mifarma.ptoventa.administracion.mantenimiento.reference.*;
...
// **************************************************************************
  ...
  private void funcion_F11()
  {
    ...
    {
      if(FarmaUtility.rptaConfirmDialog(this,"¿Está seguro que desea ingresar este motivo?"))
      {
        try
        {
  ...
  private void cargaLogin()
  {
    ...
    try
    {
      ...
      if(FarmaVariables.vAceptar)
      {
        ...
        System.out.println("FarmaVariables.vIdUsu: "+FarmaVariables.vIdUsu);
      }
      else
        cerrarVentana(false);
    }
