...
public class DlgBuscaDni extends JDialog
{
    ...
    if(e.getKeyCode() == KeyEvent.VK_F11||e.getKeyCode() == KeyEvent.VK_ENTER)
    {
      ...
      if(textoBusqueda.length()>=3 ) {
        ...
        if ( !Character.isLetter(primerkeyChar) && !Character.isLetter(ultimokeyChar) && textoBusqueda.length() > 7 ){
          ...
          System.out.println(ConstantsDelivery.CANTIDADMENOR1);
        } else{
          ...
          System.out.println(ConstantsDelivery.CANTIDADMAYOR1);
        }
  ...
  {
    System.out.println("VariablesDelivery.vCodCli : " + VariablesDelivery.vCodCli);
    ...
    try {
       System.out.println("VariablesDelivery.vDni_Apellido_Busqueda : " + VariablesDelivery.vDni_Apellido_Busqueda);
       System.out.println("VariablesDelivery.vTipoBusqueda" + VariablesDelivery.vTipoBusqueda);
       ...
       System.out.println("VariablesDelivery.vCodCli : " + VariablesDelivery.vCodCli);
       System.out.println("Arreglo" + VariablesDelivery.vInfoClienteBusqueda);
