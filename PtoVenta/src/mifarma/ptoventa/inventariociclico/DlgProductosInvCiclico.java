 ...
 *
 */
public class DlgProductosInvCiclico extends JDialog {
    /* ************************************************************************ */
    ...
    private void initTableListaProductos() {
        tableModelProductos =
                new FarmaTableModel(ConstantsInvCiclico.columnsListaProductosInv, ConstantsInvCiclico.defaultValuesListaProductosInv,
                                    0);
                ...
                try {
                    for (int i = 0; i < tblRelacionProductos.getRowCount(); i++) {
                        ...
                        if (valor.booleanValue()) {
                            codProd = tblRelacionProductos.getValueAt(i, 1).toString().trim();
                            unids = "";
                            //tblRelacionProductos.getValueAt(i, 5).toString().trim();
                            monto = "";
                            //tblRelacionProductos.getValueAt(i, 6).toString().trim();
                            lab = tblRelacionProductos.getValueAt(i, 6).toString().trim();
