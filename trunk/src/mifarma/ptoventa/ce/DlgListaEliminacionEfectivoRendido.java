  ...
  extends JDialog
{
  ...
  private void eliminaCuadratura() throws SQLException
  {
    /*try
    {
      if (FarmaUtility.rptaConfirmDialog(this,"¿Esta seguro de eliminar la cuadratura?"))
      {*/
    ...
    for(int i=0; i<tblListaEliminacion.getRowCount(); i++)
    {
      ...
      for(int j=0; j<tblListaEliminacion.getRowCount(); j++)
      {
        ...
        if( tipComprobante_aux.equalsIgnoreCase(tipComprobante) && numComprobante_aux.equalsIgnoreCase(numComprobante) )
        {
          ...
          System.out.println("montoParcial : " + montoParcial + " : " + j);
        }
        tipComprobante_aux = tipComprobante;
        numComprobante_aux = numComprobante;
      }
      //System.out.println("montoParcial : " + montoParcial);
  ...
  private void verificaCheckJTable()
  {
    ...
    System.out.println("indice de Toma : "+pValorBoleta.indexOf("-INV_D"));
  ...
  private void operaRegistroSeleccionadoEnArrayList(Boolean valor)
  {
    ...
    System.out.println("size : " + VariablesCajaElectronica.vArrayListEliminacionEfectivoRendido.size());
    System.out.println("array : " + VariablesCajaElectronica.vArrayListEliminacionEfectivoRendido);
  }
  ...
  private void eliminacionMultiple()
  {
    ...
    try 
    {
      if (FarmaUtility.rptaConfirmDialog(this,"¿Esta seguro de eliminar los efectivos rendidos ?"))
      {
