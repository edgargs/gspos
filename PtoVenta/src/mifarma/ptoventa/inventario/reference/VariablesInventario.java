...
public class VariablesInventario {
     ...
     *
     */
    public static FarmaTableModel tableModelEspecial =
        new FarmaTableModel(ConstantsInventario.columnsListaProductosEspeciales,
    ...
    public static String vEstadoItem = ""; //ASOSA - 24/09/2014

    public static String vImagen = ""; //CLARICO - 19/12/2014
    public static File   vFileImagen ;   //CLARICO - 19/12/2014
    public static String vNumNotaCompetencia="";//CLARICO - 19/12/2014
    public static String vMotivoNoImagen="";//CLARICO - 22/12/2014
    public static String vTipoDocCotizado="";//CLARICO - 22/12/2014
    public static String vNumDocCotizado="";//CLARICO - 22/12/2014
    public static String vFecGuiaCotizado="";//CLARICO - 22/12/2014
