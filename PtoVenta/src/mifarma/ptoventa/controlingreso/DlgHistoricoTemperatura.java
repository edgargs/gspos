   ...
   * ****************************************************** */
    ...
    */
    ...
    private void initTable() {
        tableModel =
                new FarmaTableModel(ConstantsControlIngreso.columnsListaHistTemp, ConstantsControlIngreso.defaultValuesListaHistTemp,
                                    0);
    ...
    private void exportar() {
        ...
        FarmaUtility.saveFileRuta(ruta, ConstantsControlIngreso.columnsListaHistTemp, tblHistorico,
    ...
    private boolean ValidaRolQF() {
        ...
        try {
            result =
                    DBControlIngreso.verificaRolUsuario(FarmaVariables.vNuSecUsu, ConstantsControlIngreso.ROL_QF_ADMINLOCAL);
