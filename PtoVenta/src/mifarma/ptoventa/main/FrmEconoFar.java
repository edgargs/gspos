...
public class FrmEconoFar extends JFrame {
    ...
    private void mnuMarcacionSalida_actionPerformed(ActionEvent e){
        //INI ASOSA - 22/09/2015 - CTRLASIST
        UtilityControlAsistencia.determinarMarcacionGeneral(this,
                                                            ConstantsControlAsistencia.ID_SALIDA);
        UtilityControlAsistencia.determinarMarcacionGeneral(this,
                                                            ConstantsControlAsistencia.ID_ENTRADA);
        //FIN ASOSA - 24/09/2015 - CTRLASIST
    }
    private void mnuSolicitud_actionPerformed(ActionEvent e){
        DlgListadoSolicitud mnuSolicitud=new DlgListadoSolicitud(this,"",true);
        mnuSolicitud.setVisible(true);
    }
  
  

    
    private void mmuTurno_actionPerformed(ActionEvent e) {
