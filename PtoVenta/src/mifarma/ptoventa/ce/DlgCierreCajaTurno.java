...
public class DlgCierreCajaTurno extends JDialog 
{
  ...
  private boolean obtieneInfoDatosCaja()
  {
    ...
    } finally
    {
      ...
      if(valor)
      {
       ...
       System.out.println("VariablesCajaElectronica.indUsu_Cierre_Caj_QF>"+VariablesCajaElectronica.indUsu_Cierre_Caj_QF+"<");
  ...
  private void cargaListaCuadraturasCierre()
  {
    ...
    {   FacadeRecaudacion facade = new FacadeRecaudacion();
        ...
        {   ftm_tableModelRecaudaciones.clearTable();
            ArrayList<ArrayList<String>> resultado = facade.listarReporteCierreTurno(VariablesCajaElectronica.vSecMovCaja);
  ...
  private void cambiaVBCajero()
  {
        ...
        VariablesCajaElectronica.vUsuarioCajero )
    {
        if(getDeter_neces_fpFSEN()){//ASOSA, 21.06.2010
          ...
          if ( com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this, "Está seguro de otorgar el VB de Cajero?") )
          {        
               ...
               VariablesCajaElectronica.vUsuarioQF )
    {
      ...
      } else
      {
        ...
        {
          if ( com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this, "Ya existe un registro de Cierre de Dia Local para el dia de\nventa ingresado. Está seguro de eliminar el VB de Cajero?") )
          {
            if( cargaLoginOper() )
            {
              if( actualizaIndicadorVB(VariablesCajaElectronica.vSecMovCaja,
  ...
  private void evaluaTotales()
  {
    ...
    String montoTotalRecaudacion_S = new String();
