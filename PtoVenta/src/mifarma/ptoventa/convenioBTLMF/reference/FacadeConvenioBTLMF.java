...
public class FacadeConvenioBTLMF {
    ...
    public boolean validacionProformaRAC(String pCodLocal, String pNumPedVta, String pCodConvenio,
                                              String pCodCliente, String pTipoDoc, double pMonto,
                                              String pVtaFin) throws Exception {
        return validacionPedidoRAC(pCodLocal, pNumPedVta, pCodConvenio, pCodCliente, pTipoDoc, pMonto, pVtaFin, "S");
    }
    
    public boolean validacionPedidoRAC(String pCodLocal, String pNumPedVta, String pCodConvenio,
                                              String pCodCliente, String pTipoDoc, double pMonto,
                                              String pVtaFin) throws Exception {
        return validacionPedidoRAC(pCodLocal, pNumPedVta, pCodConvenio, pCodCliente, pTipoDoc, pMonto, pVtaFin, "N");
    }
    
    private boolean validacionPedidoRAC(String pCodLocal, String pNumPedVta, String pCodConvenio,
                                              String pCodCliente, String pTipoDoc, double pMonto,
                                              String pVtaFin, String indSoloValida) throws Exception {
        String resultado;
        boolean bRetorno;
        TipoImplementacionDAO tipo = TipoImplementacionDAO.FRAMEWORK;
        //ERIOS 07.10.2015 Determina si esta activo el Gestor
        ...
        try {
            ...
            resultado = daoRACConvenioBTLMF.validacionPedidoRAC(pCodLocal, pNumPedVta, pCodConvenio,
                                              pCodCliente, pTipoDoc, pMonto, pVtaFin, indSoloValida);
            daoRACConvenioBTLMF.commit();
