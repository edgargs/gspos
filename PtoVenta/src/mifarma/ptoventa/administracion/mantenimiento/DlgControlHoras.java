...
import mifarma.ptoventa.administracion.mantenimiento.reference.ContantsMantenimiento;
...
public class DlgControlHoras extends JDialog {
    ...
    private void initTableControlHoras() {
        tableModel =
                new FarmaTableModel(ContantsMantenimiento.columnsListaControlHoras, ContantsMantenimiento.defaultValuesListaControlHoras,
                                    0);
