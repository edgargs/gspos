...
public class DlgIngresoMonto extends JDialog {
    ...
    private void initialize() {
        ...
        tableModelFormaPago =
                new FarmaTableModel(ConstantsCajaElectronica.columnsListaFormasPago2, ConstantsCajaElectronica.defaultValuesListaFormasPago2,
                                    0);
        FarmaUtility.initSimpleList(tblFormaPago, tableModelFormaPago,
                                    ConstantsCajaElectronica.columnsListaFormasPago2);
    };
    ...
    private void chkKeyPressed(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_ESCAPE) {
            ...
            if (com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,
                                                                            "Está seguro de cambiar la forma de pago?")) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_ENTER) {
            if (txtDolares.getText().length() > 0) {
                ...
                if (!FarmaUtility.isDouble((String.valueOf((txtDolares.getText().trim())))))
                    ...
                    String Total =
                        FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber(Monto) * FarmaUtility.getDecimalNumber(lblTipCambio.getText().trim()));
                    operaListaDetallePago(codFormaPago, Descrip, Monto, Total);
                    verificaMontoPagadoPedido();
    ...
    private void verificaMontoPagadoPedido() {
        ...
        if (FarmaUtility.getDecimalNumber(VariablesCajaElectronica.vMontPago) > montoTotal) {
            ...
            VariablesCajaElectronica.vSaldoPago =
                    FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber(VariablesCajaElectronica.vMontPago) -
                                              montoTotal);
            ...
            VariablesCajaElectronica.vValVuelto =
                    FarmaUtility.formatNumber(montoTotal - FarmaUtility.getDecimalNumber(VariablesCajaElectronica.vMontPago));
        }
    ...
    private void ProcesarFormaPago() {
        ...
        for (int i = 0; i < tblFormaPago.getRowCount(); i++) {
          ...
          montoTotal = montoTotal + montoFormaPago;*/
            ...
            grabarFormaPagoPedido(cod, VariablesCajaElectronica.vNumPedVta, monto, tipMoneda,
                                  FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber(VariablesCajaElectronica.vTipCambio),
                                                            3),
                                  FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber(vuelto), 3), total, "", "",
                                  "", "", "", "", "0");
        }
    }

    private void grabarFormaPagoPedidoBackup(String pCodFormaPago, String pNumPedVta) {
        try {
            ...
            FarmaUtility.showMessage(this, "Error al grabar backup de forma de pago del pedido." + e.getMessage(),
                                     tblFormaPago);
    ...
    private void grabarFormaPagoPedido(String pCodFormaPago, String pNumPedVta, String pImPago, String pTipMoneda,
                                       ...
                                       String pFecVencTarj, String pNomCliTarj, String pdnix, String pCodvou,
                                       String pLote, String pCantCupon) {
        try {
            DBCajaElectronica.grabaNuevaFormaPagoPedido(pCodFormaPago, pNumPedVta, pImPago, pTipMoneda, pTipoCambio,
                                                        pVuelto, pImTotalPago, pNumTarj, pFecVencTarj, pNomCliTarj,
                                                        pdnix, pCodvou, pLote, pCantCupon);
            FarmaUtility.aceptarTransaccion();
        } catch (SQLException e) {
            log.error("", e);
            FarmaUtility.liberarTransaccion();
            FarmaUtility.showMessage(this, "Error al grabar nueva forma de pago del pedido." + e.getMessage(),
                                     tblFormaPago);
            //FarmaUtility.moveFocusJTable(tblProductos);
            FarmaUtility.moveFocus(tblFormaPago);
        }
