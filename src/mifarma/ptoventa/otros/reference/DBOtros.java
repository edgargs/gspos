...
public class DBOtros 
{
  ...
  throws SQLException{
	...
	System.out.println("invocando a PTOVENTA_CLI_MED_PRESION.MP_F_CUR_HIST_MP(?,?,?) params: "+parametros);
  ...
  public static void inactivarMedidaPresionEnLocal()throws SQLException{
      ...
      parametros.add(VariablesOtros.vDniCliente.trim());            
      parametros.add(FarmaVariables.vIdUsu.trim());      
      System.err.println("inactivar medida de presion :"+parametros);
  ...
  throws SQLException{
	  ...
	  System.err.println("PTOVENTA_MATRIZ_CLI_MP.MP_F_CUR_HIST_MP(?,?,?):"+parametros);
  ...
  throws SQLException{
	  ...
	  System.err.println("PTOVENTA_CLI_MED_PRESION.MP_F_VAR_IMP_CAB_HIST(?,?,?):"+parametros);
  ...
  throws SQLException{
	  ...
	  System.err.println("PTOVENTA_CLI_MED_PRESION.MP_F_VAR_IMP_PIE_HIST():"+parametros);
  ...
  throws SQLException{
	  ...
	  System.err.println("PTOVENTA_CLI_MED_PRESION.MP_F_VAR_MAX_ITEMS_IMP():"+parametros);
    ...
    throws SQLException{
            ...
            System.err.println("PTOVENTA_CLI_MED_PRESION.MP_F_VAR_MAX_MIN_VAL_MP():"+parametros);
