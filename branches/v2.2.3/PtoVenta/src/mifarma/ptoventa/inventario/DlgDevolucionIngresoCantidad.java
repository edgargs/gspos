...
public class DlgDevolucionIngresoCantidad extends JDialog implements KeyListener{
    ...
    private void jbInit() throws Exception {
        ...
        lblDescripcion.setBounds(new Rectangle(15, 40, 70, 15));
        ...
        lblFraccion.setBounds(new Rectangle(195, 130, 60, 15));
        lblFraccion.setForeground(new Color(255, 130, 14));
        
        
        txtFraccion.setLengthText(6);  
        txtFraccion.setBounds(new Rectangle(195, 150, 60, 20));
        ...
        lblLote.setBounds(new Rectangle(95, 130, 60, 15));
        lblLote.setForeground(new Color(255, 130, 14));
        
        txtLote.setLengthText(15);
        txtLote.setBounds(new Rectangle(90, 150, 95, 20));
    ...
    private void initCabecera(){
        ...
        if(!notaEsCabDetDTO.getValFracTransfFrm().equals("1")){
        ...
        if(productoFraccionado){
          ...
          int frac = Integer.parseInt(notaEsCabDetDTO.getValFracTransfFrm());
