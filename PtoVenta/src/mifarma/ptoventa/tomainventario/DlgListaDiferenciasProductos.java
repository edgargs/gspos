...
public class DlgListaDiferenciasProductos extends JDialog {
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(733, 393));
        ...
        jPanelHeader1.setBounds(new Rectangle(15, 10, 695, 30));
        jPanelHeader1.setLayout(null);
        jPanelTitle1.setBounds(new Rectangle(15, 45, 695, 25));
        jPanelTitle1.setLayout(null);
        jScrollPane1.setBounds(new Rectangle(15, 70, 695, 260));
        ...
        txtProductos.setBounds(new Rectangle(115, 5, 375, 20));
    ...
    private void initTableListaDiferenciasProductos() {
        tableModelDiferenciasProductos =
                new FarmaTableModel(ConstantsTomaInv.columnsListaDiferenciasProductos, ConstantsTomaInv.defaultValuesListaDiferenciasProductos,
                                    0);
