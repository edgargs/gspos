...
public class DlgCotizacionCompetencia extends JDialog 
{
  ...
  private void tblLista_keyPressed(KeyEvent e)
  {
    if (e.getKeyCode() == KeyEvent.VK_ENTER) {
      ...
      System.out.println("XXXXXX VariablesCajaElectronica.vIndVBCierreDia: "+VariablesCajaElectronica.vIndVBCierreDia);
  ...
  private void operaRegistroSeleccionadoEnArrayList(Boolean valor)
  {
    ...
    System.out.println("size : " + VariablesCajaElectronica.vArrayListInsertarCotizacion.size());
    System.out.println("array : " + VariablesCajaElectronica.vArrayListInsertarCotizacion);
  }
  ...
  private void insercionMultiple()
  {
    ...
    try 
    {
      if (FarmaUtility.rptaConfirmDialog(this,"¿Esta seguro de agregar la(s) cotizaciones de competencia(s) ?"))
      {
