...
public class DlgGuiasPendientes extends JDialog {
    ...
    private void initialize() {
        System.out.println("TipoEntrega :"+VariablesRecepCiega.vTipoIngrEntrega);
    ...
    if(VariablesRecepCiega.vTipoIngrEntrega.trim().equalsIgnoreCase("01")){
        ...
        System.out.println("VariablesRecepCiega.vNumNotaEst "+VariablesRecepCiega.vNumNotaEst);
        System.out.println("VariablesRecepCiega.vNumGuia "+VariablesRecepCiega.vNumGuia);
    }else if(VariablesRecepCiega.vTipoIngrEntrega.trim().equalsIgnoreCase("02")){
         VariablesRecepCiega.vNumNotaEst=
    ...
    private void verDetalleGuia() {
        ...
        System.out.println("DETALLE GUIA");
    ...
    private void SeleccionarGuia(int pFila) {
        ...
        if (!seleccion) {
            borrarGuia_DU(pFila);
            cargarGuia_DU(pFila);
            System.out.println("GUIAS SELECCIONADAS :" + 
                               VariablesRecepCiega.vArrayListaGuias);
  ...
  //cambio de posicion
    ...
    System.out.println("GUIAS ASOCIADAS :" +VariablesRecepCiega.vArrayListaGuias);
  }
  */
    ...
    private void cargarGuia_DU(int pFila) {
        ...
        array.add("A");
        VariablesRecepCiega.vArrayListaGuias.add(array);
        System.out.println("GUIAS ASOCIADAS :" + 
                           VariablesRecepCiega.vArrayListaGuias);
    }
    ...
    private void asignarGuias(int pCantGuias) {
        ...
        try {            
            ...
            if  (UtilityRecepCiega.indHabDatosTransp()){
                ...
                System.out.println("Nueva Recepcion :" + nroRecep);
                DBRecepCiega.asignarGuias(VariablesRecepCiega.vArrayListaGuias, 
                                          nroRecep);
            }
 ...
 * */
    ...
    private void cargarGuias() {
        ...
        System.out.println("GUIAS ALMACENADAS: " + 
                           VariablesRecepCiega.vArrayListaGuias);
    ...
    private void funcionF11(){
        System.out.println("seleccion todos-->" + todos);
        System.out.println("En arreglo cant-->" + 
                           VariablesRecepCiega.vArrayListaGuias.size());
        ...
        if (VariablesRecepCiega.vArrayListaGuias.size() > 0 || todos) {
            ...
            if(FarmaUtility.rptaConfirmDialog(this,"Esta seguro de asociar "+ cantAsoc +" entrega(s)?"))
            {      
                if (todos) {
                    cargarGuias(); //todos seleccionados
                }
                System.out.println("GUIAS ALMACENADOS: " + 
                                   VariablesRecepCiega.vArrayListaGuias);
                System.out.println("CANTIDAD : " + 
                                   VariablesRecepCiega.vArrayListaGuias.size());
