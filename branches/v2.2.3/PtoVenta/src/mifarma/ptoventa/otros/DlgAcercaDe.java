...
public class DlgAcercaDe extends JDialog {
    ...
    private void jbInit() throws Exception {
        ...
        jLabelOrange1.setText("FarmaVenta");
        jLabelOrange1.setBounds(new Rectangle(50, 10, 170, 35));
        jLabelOrange1.setFont(new Font("SansSerif", 1, 19));
        ...
        jLabel3.setText("Copyright (c) 2007,2013 MIFARMA S.A.C.");
    ...
    private void mostrarVersion(){
        String[] base = FrmEconoFar.tituloBaseFrame.split("-");
        lblVersion.setText(base[1].trim());
        lblCompilacion.setText(base[2].trim());
    }
