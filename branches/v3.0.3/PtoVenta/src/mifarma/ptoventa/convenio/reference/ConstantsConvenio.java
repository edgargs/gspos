...
public class ConstantsConvenio {
    ...
    { new FarmaColumnData("Codigo", 100, JLabel.CENTER), new FarmaColumnData("Descripcion", 250, JLabel.LEFT),
    ...
    { new FarmaColumnData("Desc.", 200, JLabel.LEFT), new FarmaColumnData("Dato", 300, JLabel.RIGHT),
      ...
      new FarmaColumnData("IN_OBLIGATORIO", 0, JLabel.CENTER), new FarmaColumnData("IND_BUSQUEDA", 0, JLabel.CENTER) };
    ...
    { new FarmaColumnData("Codigo", 80, JLabel.LEFT), new FarmaColumnData("Codigo Trab.", 80, JLabel.LEFT),
      new FarmaColumnData("Descripcion", 300, JLabel.LEFT), new FarmaColumnData("Doc. Ident.", 90, JLabel.LEFT),
