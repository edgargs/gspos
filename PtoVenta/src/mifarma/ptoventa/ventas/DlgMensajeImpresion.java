...
public class DlgMensajeImpresion extends JDialog {
   ...
   // **************************************************************************
	...
	public DlgMensajeImpresion(Frame parent, String title, boolean modal) {
    ...
    private void chkKeyPressed(KeyEvent e)
    {
        ...
        if(e.getKeyCode() == KeyEvent.VK_ENTER){
        	...
        	if(com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,"Esta seguro que va imprimir Factura?"))
        	{
               cerrarVentana(true);
            }
...

   {
            ...
            Object pObjeto)
    {
                        ...
                        try
                        {
                                resTipo = DBVentas.obtieneMsgImpFactura();
