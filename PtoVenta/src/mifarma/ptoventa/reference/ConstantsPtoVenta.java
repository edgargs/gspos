...
public class ConstantsPtoVenta {
    ...
    public static final String CODCIA_MAYORISTA = "006";
    ...
    // TIPO LOCAL DE VENTA
    public static final String TIPO_LOCAL_VTA_FARMA = "001";
    public static final String TIPO_LOCAL_VTA_TICO = "002";
    public static final String TIPO_LOCAL_VTA_MAYORISTA = "003";
    public static final String TIPO_LOCAL_VTA_CENTRO_MEDICO = "004";
    public static final String TIPO_LOCAL_VTA_MAY_BOTICA = "005";
}
