...
*/     
  ...
  private void verConteoRecepcion(){
   ...
   //**
        ...
        System.out.println("VariablesRecepCiega.vFechIngreso :"+VariablesRecepCiega.vFechIngreso);
        System.out.println("VariablesRecepCiega.vCantGuias :"+VariablesRecepCiega.vCantGuias);
        System.out.println("VariablesRecepCiega.vTipoIngrEntrega :"+VariablesRecepCiega.vTipoIngrEntrega);        
        ...
        System.out.println("VariablesRecepCiega.vCod_Estado: "+VariablesRecepCiega.vCod_Estado);
                            ...
                            if (FarmaVariables.vAceptar) {
                                ...
                                pEstado = 
                                        UtilityRecepCiega.pEstadoRecepcion(FarmaUtility.getValueFieldJTable(tblRecepcion, 
                                                                                                            row, 
                                                                                                            0).trim());
                                System.err.println("Consulta Estado :"+pEstado);
                                    ...
                                    if (pEstado.trim().equalsIgnoreCase(ConstantsRecepCiega.EstadoEspera) || 
                                        ...
                                        System.err.println("Esto es para liberar el bloqueo...de Estado.");
                                        FarmaUtility.liberarTransaccion();
                                        if (pEstado.trim().equalsIgnoreCase(ConstantsRecepCiega.EstadoRevisado))
                                            FarmaUtility.showMessage(this, 
    ...
    private void cambiarMensajeLabel(){
        ...
        //System.out.println("vCantGuias: "+vCantGuias);
