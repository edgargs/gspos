 ...
 * @since  15/08/2014
 */
public interface FarmaPrinterStarInterface {
  /**Verifica que se inicialice la impresion
    ...
    /**Reseta la impresora y establece los valores por default*/
    public void inicializate(); 
     
   public void printLogo(String codMarca);
   /**Imprime el logo a nivel de pixeles*/ 
    ...
    /**
     * imprime una imagen en la impresora termica star
     * @author ASOSA
     * @since 10/03/2015
     * @kind PTOSYAYAYAYA
     * @param codMarca
