...
public class ConstantsReporte {
    ...
    public static final FarmaColumnData columnsListaPuntosRentables[] = {
        ...
        new FarmaColumnData("Mto. Total", 80, JLabel.RIGHT), // 9
        new FarmaColumnData("Mto. Rent", 80, JLabel.RIGHT), // 10
 ...
 * */
     ...
     *@Fecha: 26/01/2016
     */
    //LIsta de Precios de productos por volumen
    public static final FarmaColumnData columnsListaPrecProdVolumen[] =
    {
      ...
      new FarmaColumnData("PrecioVenta", 80, JLabel.RIGHT), 
      new FarmaColumnData("PrecioMinimo", 75, JLabel.RIGHT)};


    public static final Object[] defaultValuesListaProdPrecVolumen =
    { " ", " ", " ", " ", " ", " ", " "};
