 ...
 *
 */
public class DlgInicioInvCiclico extends JDialog {
    /* ************************************************************************ */
    ...
    private void initTableListaProductos() {
        tableModelProductosToma =
                new FarmaTableModel(ConstantsInvCiclico.columnsListaProductosInicio, ConstantsInvCiclico.defaultValuesListaProductosInicio,
                                    0);
    ...
    private void insertar() {
        DlgProductosInvCiclico dlgProductosInvCiclico = new DlgProductosInvCiclico(myParentFrame, "", true);
    ...
    private void aceptar() {
        if (com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,
            ...
            try {
                ...
                FarmaUtility.aceptarTransaccion();
                FarmaUtility.showMessage(this, "El inventario se grabó correctamente.", txtProductos);
                cerrarVentana(true);
            } catch (SQLException e) {
                FarmaUtility.liberarTransaccion();
                log.error("", e);
    ...
    private void imprimir() {
        ...
        try {
            ...
            vPrint.printBold(FarmaPRNUtility.llenarBlancos(27) + " REPORTE DE PRODUCTOS PARA INVENTARIO CICLICO",
                             true);
