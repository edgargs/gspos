...
public class DlgVentasPorVendedor extends JDialog {
    ...
    private void initTableListaVentasVendedor() {
        tableModelVentasVendedor =
                new FarmaTableModel(ConstantsReporte.columnsListaVentasVendedor, ConstantsReporte.defaultValuesListaVentasVendedor,
                                    0);
            ...
            if (tblVentasVendedor.getRowCount() > 0) {
                ...
                for (int i = 0; i < tblVentasVendedor.getRowCount(); i++) {
                    if (FarmaUtility.getValueFieldJTable(tblVentasVendedor, i,
                        ...
                        T_GG =
FarmaUtility.getDecimalNumber(FarmaUtility.getValueFieldJTable(tblVentasVendedor, i, COL_GG).toString().trim());
                        T_G =
FarmaUtility.getDecimalNumber(FarmaUtility.getValueFieldJTable(tblVentasVendedor, i, COL_G).toString().trim());
                        T_GP =
FarmaUtility.getDecimalNumber(FarmaUtility.getValueFieldJTable(tblVentasVendedor, i, COL_GP).toString().trim());
