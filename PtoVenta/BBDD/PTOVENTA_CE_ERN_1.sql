--------------------------------------------------------
--  DDL for Package Body PTOVENTA_CE_ERN
--------------------------------------------------------
  ...
  BEGIN
    ...
    FROM   CE_CUADRATURA,
          (SELECT CUADRATURA_CAJA.COD_CUADRATURA CODIGO,
                  ...
                  TO_CHAR(SUM(CUADRATURA_CAJA.MON_TOTAL) * CUADRATURA.VAL_SIGNO,'999,999,990.00') SUMA
  ...
  AS
    ...
    v_cNumComp VTA_COMP_PAGO.Num_Comp_Pago%TYPE;
