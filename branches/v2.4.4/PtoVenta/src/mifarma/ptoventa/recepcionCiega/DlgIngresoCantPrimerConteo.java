    ...
    */  
    ...
    private void chkKeyPressed(KeyEvent e) {
            if (e.getKeyCode() == KeyEvent.VK_ENTER) {
               ...
               // boolean rpta = com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,"No se ingresará o Modificará este Producto, ¿Está seguro?");
                //if(rpta == true){
    ...
    private boolean datosValidados() {
        ...
        if (isInteger(txtCantidad.getText().trim())) {
            ...
            if (Integer.parseInt(txtCantidad.getText()) == 0){
                if(!VariablesRecepCiega.vIndModificarCant){
                    if(com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,"¿Está seguro que no desea ingresar este producto?")) {
                     ...
                     if(com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,"¿Está seguro que desea eliminar este producto?")) {
                         log.debug("Eliminar");
                         //VariablesRecepCiega.vLastCodBarra = "";  
