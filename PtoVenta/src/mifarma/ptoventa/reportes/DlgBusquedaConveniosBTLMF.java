...
import mifarma.ptoventa.convenioBTLMF.DlgDatosConvenioBTLMF;
import mifarma.ptoventa.convenioBTLMF.DlgListaConveniosBTLMF;
import mifarma.ptoventa.convenioBTLMF.DlgMensajeBTLMF;
import mifarma.ptoventa.convenioBTLMF.DlgTipoConvenio;
...
public class DlgBusquedaConveniosBTLMF extends JDialog {
    ...
    private void initTableListaConvenios() {
        FarmaColumnData columnsListaConvenios[] = { new FarmaColumnData("Sel", 20, JLabel.CENTER), 
