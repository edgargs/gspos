...
public class DlgPedidoDiario extends JDialog {
    ...
    private void operaTotales()
    {
        ...
        {
            System.out.println(VariablesInvDiario.vListaTrabParaDescuento.get(i));
        ...
        totalNetoRedondeado = UtilityVentas.Redondear(dTotalVenta, 2);//redondeo a 2 cifras pero no a ajustado a .05 o 0.00
        System.out.println("redondeando a 2 cifras totalNetoRedondeado:"+totalNetoRedondeado);
        ...
        System.out.println("ajustando monto a 2 cifras totalNetoRedondeado:"+totalNetoRedondeado);
        
        dRedondeo =  totalNetoRedondeado - dTotalVenta;
        lblRedondeo.setText(FarmaUtility.formatNumber(dRedondeo));
        System.out.println("totalNetoRedondeado:"+totalNetoRedondeado);
        System.out.println("dTotalVenta:"+dTotalVenta);
    ...
    public void eliminaProducto(){
        if(tblListaProductosPedido.getRowCount()>0){
            ...
            if(FarmaUtility.rptaConfirmDialog(this, "¿Seguro de quitar el producto del pedido?"))
            {
    ...
    public void eliminaPedidoTemporal(){
        if(FarmaUtility.rptaConfirmDialog(this, "¿Seguro que desea salir del pedido?"))
        {
            try {
