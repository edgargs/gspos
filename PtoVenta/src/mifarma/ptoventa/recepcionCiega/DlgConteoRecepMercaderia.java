...
public class DlgConteoRecepMercaderia extends JDialog {
    ...
    private static final int Col_Ind_Lote_Mayorista = 10;
    ...
    public DlgConteoRecepMercaderia(Frame parent, String title, boolean modal) {
    ...
    private void initTableListaProdConteo() {
        tableModelProductosConteo =
                new FarmaTableModel(ConstantsRecepCiega.columnsListaProductosConteo, ConstantsRecepCiega.defaultValuesListaProductosConteo,
                                    0);
    ...
    private void chkKeyPressed(KeyEvent e) {
        ...
        */
        if (e.getKeyCode() == KeyEvent.VK_ESCAPE) {
            boolean mensSalida =
                com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this, "¿Está seguro que desea Salir?");
            if (mensSalida) {
                try {
                    //Limpiar Variables
                    VariablesRecepCiega.vNroBloque = "";
    ...
    */
    ...
    private void ingresaProducto(String vCodBarra) {
        ...
        String auxCodProd = validaCodBarra(vCodBarra);
        boolean indLoteMayorista = evaluaLoteMayorista(auxCodProd);
        //ERIOS 14.03.2016 Para local e indicador de lote mayorista
        if(UtilityPtoVenta.isLocalVentaMayorista() && indLoteMayorista){
            
            VariablesRecepCiega.vLastIndLoteMayorista = "S";
        ...
        try {
            ...
            if (VariablesRecepCiega.vIndAgregaConteo) {
                ...
                //inserto a BD
                DBRecepCiega.insertAuxConteo(VariablesRecepCiega.vSecRecepGuia, VariablesRecepCiega.contadorFila,
                                             ...
                                             VariablesRecepCiega.vIndNoFound, VariablesRecepCiega.vLote,
                                             VariablesRecepCiega.vFechaVcto);
    ...
    private String validaCodBarra(String vCodBarra) {
        String auxCodProd="";
        ...
        try {
            auxCodProd = DBRecepCiega.obtieneCodigoProductoBarra(vCodBarra.trim());
        ...
        if (auxCodProd.trim().equalsIgnoreCase("000000")) {
    ...
    private void muestraInfoProd() {
        ...
        VariablesRecepCiega.vLastIndLoteMayorista = FarmaUtility.getValueFieldJTable(tblRelacionProductosConteo, vFila, Col_Ind_Lote_Mayorista);
        ...
        if (!VariablesRecepCiega.vIndModificoCantActivo) {
            ...
            if (VariablesRecepCiega.vLastCodBarra.trim().equalsIgnoreCase(VariablesRecepCiega.vTempCodBarra.trim()) &&
                ...
                mostrarIngresoCantPrimerConteo();
                actualizaListaPrimerConteo();
                //VariablesRecepCiega.vIndModificoCantActivo = tr2ue;  //YA MODIFICO, YA NO PODRA MODIFICAR
                //VariablesRecepCiega.vLastCant
    ...
    private void actualizaListaPrimerConteo() {
        ...
        try {
            DBRecepCiega.obtieneListaPrimerConteo(tableModelProductosConteo, VariablesRecepCiega.vSecRecepGuia,
                                                  VariablesRecepCiega.vNroBloque);
                ...
                if (indNoContado.trim().equalsIgnoreCase("S")) {
                    ...
                    if (FarmaVariables.vAceptar) {
                        if (com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,
                            ...
                            FarmaUtility.aceptarTransaccion();
                            FarmaUtility.showMessage(this, "Se Ha Finalizado el Conteo con éxito!", txtBuscar);
                            cerrarVentana(true);
                        } else {
                            return;
                        }
     ...
     * @return
     */
    private boolean evaluaLoteMayorista(String pAuxCodProd) {
        String strIndLoteMayorista = "";
        ArrayList<ArrayList<String>> pArrayList = new ArrayList<>();
        try {
            DBRecepCiega.obtieneInfoProductoConteo(pArrayList, pAuxCodProd);
            strIndLoteMayorista = pArrayList.get(0).get(4);
        } catch (SQLException e) {
            log.error("",e);
            FarmaUtility.showMessage(this, "Error al obtener indicador de lote", null);
        }        
        return strIndLoteMayorista.equals("S");
    }
}
