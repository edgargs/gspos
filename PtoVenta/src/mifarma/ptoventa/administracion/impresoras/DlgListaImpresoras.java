...
public class DlgListaImpresoras extends JDialog {
    ...
    private void jbInit() throws Exception {
        ...
        lblCrear.setBounds(new Rectangle(155, 260, 90, 20));
        lblCrear.setText("[F2] Crear");
        lblModificar.setBounds(new Rectangle(265, 260, 105, 20));
        ...
        jLabelFunction2.setBounds(new Rectangle(385, 260, 155, 20));
    ...
    private void initTable() {
        tableModel =
                new FarmaTableModel(ConstantsImpresoras.columnsListaImpresoras, ConstantsImpresoras.defaultValuesListaImpresoras,
                                    0);
        FarmaUtility.initSimpleList(tblListaImpresoras, tableModel, ConstantsImpresoras.columnsListaImpresoras);
        ...
        if (!VariablesPtoVenta.vEjecutaAccionTecla) {
            ...
            if (UtilityPtoVenta.verificaVK_F1(e)) {
                ...
                if (tipComp.trim().equalsIgnoreCase(ConstantsPtoVenta.TIP_COMP_TICKET) ||
                    ...
                    String ruta =
                        tblListaImpresoras.getValueAt(tblListaImpresoras.getSelectedRow(), 5).toString().trim();
                    String descImpr =
    ...
    private void jButton1_actionPerformed(ActionEvent e) {
        PopupAlert f =
            new PopupAlert(new PopupConstants().NOTIFICACION, "¡ Alerta Delivery !", 5, myParentFrame, true);
        f.addMsg("Se tiene 4 Pedidos Pendientes");
        f.addMsg("Para cobrar");
        f.open();
    }
}
