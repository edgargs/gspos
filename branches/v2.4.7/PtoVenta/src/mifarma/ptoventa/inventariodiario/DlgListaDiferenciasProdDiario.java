...
public class DlgListaDiferenciasProdDiario extends JDialog {
  ...
  private JLabelFunction lblF12 = new JLabelFunction();
	...
	public DlgListaDiferenciasProdDiario(Frame parent, String title,
			boolean modal) {
	...
	private void initTableListaDiferenciasProductos() {
		tableModelDiferenciasProductos = new FarmaTableModel(
				...
				ConstantsInvDiario.defaultValuesListaDiferenciasProductos, 0);
	...
	private void cargaListaDiferenciasProductos() {
      ...
      if (tblRelacionDiferenciasProductos.getRowCount() > 0)
        FarmaUtility.ordenar(tblRelacionDiferenciasProductos, tableModelDiferenciasProductos, 1, FarmaConstants.ORDEN_ASCENDENTE);
