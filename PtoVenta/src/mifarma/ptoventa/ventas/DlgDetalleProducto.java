...
// **************************************************************************
  ...
  {
    tableModelPrincActProd = new FarmaTableModel(ConstantsVentas.columnsListaPrincipiosActivos,ConstantsVentas.defaultValuesListaPrincipiosActivos,0);
    FarmaUtility.initSimpleList(tblListaPrincipiosActivos,tableModelPrincActProd,ConstantsVentas.columnsListaPrincipiosActivos);
  }
  
   private void initTableAccTerapProd()
  {
    tableModelAcciTerap = new FarmaTableModel(ConstantsVentas.columnsListaAccionesTerapeuticas,ConstantsVentas.defaultValuesListaAccionesTerapeuticas,0);
    FarmaUtility.initSimpleList(tblListaAccionTerapeutica,tableModelAcciTerap,ConstantsVentas.columnsListaAccionesTerapeuticas);
  }
