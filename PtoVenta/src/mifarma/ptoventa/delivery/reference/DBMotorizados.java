...
public class DBMotorizados extends JDialog 
{
  ...
  public static String ingresaMotorizado(String pNomMot,
                                      String pApePat,
                                      String pApeMat,
                                      String pDNI,
                                      String pPlaca,
                                      ...
                                      ) throws SQLException
  {
    ...
    return FarmaDBUtility.executeSQLStoredProcedureStr("DELIVERY_MOTORIZADO.MOT_AGREGA_MOTORIZADO(?,?,?,?,?,?,?,?,?,?,?,?,?,?)",parametros);
  }
  
  public static void modificaMotorizado(String pCodMot,
                                        String pNomMot,
                                        String pApePat,
                                        String pApeMat,
                                        String pDNI,
  ...
  /**
    ...
    parametros.add(pAlias.trim());
    parametros.add(pCodLocal.trim());
    FarmaDBUtility.executeSQLStoredProcedure(null,"DELIVERY_MOTORIZADO.MOT_MODIFICA_MOTORIZADO(?,?,?,?,?,?,?,?,?,?,?,?,?,?)",parametros,false);
  }

  public static void actualizaEstadoMot(String pCodMot,
                                        String pEstMot) throws SQLException
  {
    parametros = new ArrayList();
    parametros.add(FarmaVariables.vCodGrupoCia);
    parametros.add(FarmaVariables.vCodLocal);
    ...
    FarmaDBUtility.executeSQLStoredProcedure(null,"DELIVERY_MOTORIZADO.MOT_ACTUALIZA_ESTADO_MOT(?,?,?,?,?)",parametros,false);      
  }
  ...
  public static void obtieneInfoMotorizado(ArrayList pArrayList) throws SQLException
  {
    ...
    FarmaDBUtility.executeSQLStoredProcedureArrayList(pArrayList,"DELIVERY_MOTORIZADO.MOT_OBTIENE_INFO_MOTORIZADO(?,?,?)",parametros);
  }
  /**
  ...
  public static void obtieneLocal(ArrayList pArrayList,String pCodlocal_referencia) throws SQLException
  {
    ...
    FarmaDBUtility.executeSQLStoredProcedureArrayList(pArrayList,"DELIVERY_MOTORIZADO.MOT_BUSCA_LOCAL(?,?)",parametros);
  }  
}