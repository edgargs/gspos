...
public class DlgDevolucionNueva extends JDialog implements KeyListener{
    ...
    private void initCmbMotivo(){
      ...
      cmbMotivo.removeAllItems();
        ...
        data.add("DEVOLUCION AL PROVEEDOR");
        dataArrayList.add(data);
        FarmaLoadCVL.loadCVLFromArrayList(cmbMotivo, 
                                            ConstantsInventario.NOM_HASHTABLE_CMBMOTIVO_TRANSF, 
                                            dataArrayList, 
                                            true);
    }
   ...
   @Override
    ...
    private void cargarCabecera(){
      ...
      notaEsCabDTO.setPlacaTransp(txtPlaca.getText());
        //TODO para que?
      notaEsCabDTO.setMotivodescCorta(FarmaLoadCVL.getCVLDescription(ConstantsInventario.NOM_HASHTABLE_CMBMOTIVO_TRANSF,notaEsCabDTO.getTipoMotiNotaEs()));
      //TODO para que?
    ...
    private void mostrarDatosCabecera() {
        if(notaEsCabDTO.getTipoMotiNotaEs() != null){
            ...
            FarmaLoadCVL.setSelectedValueInComboBox(cmbMotivo, ConstantsInventario.NOM_HASHTABLE_CMBMOTIVO_TRANSF, notaEsCabDTO.getTipoMotiNotaEs());
