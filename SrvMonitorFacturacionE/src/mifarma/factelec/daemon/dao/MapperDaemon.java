...
public interface MapperDaemon {
    ...
    @SelectProvider(type = SQLDaemonProvider.class, method = "updateMonVtaCompPagoEPend")
    public List<MonVtaCompPagoE> updateMonVtaCompPagoEPend(Map<String, Object> object);
    
    @InsertProvider(type = SQLDaemonProvider.class, method = "mergeMonVtaCompPagoE")
    public void mergeDocumentoE(MonVtaCompPagoE monVtaCompPagoE);
}
