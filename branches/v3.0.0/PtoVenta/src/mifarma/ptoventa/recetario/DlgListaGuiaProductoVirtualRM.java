...
public class DlgListaGuiaProductoVirtualRM extends JDialog {
    ...
    {   ftm_productoVirtual = new FarmaTableModel(ConstantsVentas.columnsListaProductos, 
        ...
        {   e.consume();
            ...
            {   String rm = grabarGuiaRM();
                ...
                {   String[] valores = rm.split("Ã");
                    ...
                    VariablesVentas.vCod_Prod = FarmaUtility.getValueFieldJTable(tbl_productoVirtual, fila_seleccionada, COL_COD);
                    VariablesVentas.vDesc_Prod = FarmaUtility.getValueFieldJTable(tbl_productoVirtual, fila_seleccionada, 2);
                    VariablesVentas.vNom_Lab = FarmaUtility.getValueFieldJTable(tbl_productoVirtual, fila_seleccionada, 4);
                    VariablesVentas.vUnid_Vta = FarmaUtility.getValueFieldJTable(tbl_productoVirtual, fila_seleccionada, 3);
                    VariablesVentas.vVal_Prec_Lista = valores[1]; //FarmaUtility.getValueFieldJTable(tbl_productoVirtual, fila_seleccionada, 10);
                    VariablesVentas.vVal_Bono = FarmaUtility.getValueFieldJTable(tbl_productoVirtual, fila_seleccionada, 7);
                    VariablesVentas.vPorc_Igv_Prod = FarmaUtility.getValueFieldJTable(tbl_productoVirtual, fila_seleccionada, 11);
                    VariablesVentas.vTipoProductoVirtual = FarmaUtility.getValueFieldJTable(tbl_productoVirtual, fila_seleccionada, 14);
                    VariablesVentas.vMontoARecargar_Temp = "0";
                    VariablesVentas.vNumeroARecargar = "";
                    VariablesVentas.vIndOrigenProdVta = FarmaUtility.getValueFieldJTable(tbl_productoVirtual, fila_seleccionada, COL_ORIG_PROD);
