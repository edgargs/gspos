...
public class DlgSeleccionTipoComprobante extends JDialog 
{
    ...
    private void jbInit() throws Exception
    {
        ...
        txtRUC.setNextFocusableComponent(txtDireccionCliente);
        ...
        txtDireccionCliente.setNextFocusableComponent(txtCliente);
        ...
        txtCliente.setNextFocusableComponent(txtRUC);
