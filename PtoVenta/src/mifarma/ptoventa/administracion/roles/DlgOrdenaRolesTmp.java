...
public class DlgOrdenaRolesTmp extends JDialog {
    /* ************************************************************************ */
    /*                          DECLARACION PROPIEDADES                         */
    /* ************************************************************************ */
    private static final Logger log = LoggerFactory.getLogger(DlgOrdenaRolesTmp.class);
    ...
    private int indOrigenReporte;

    /* ************************************************************************ */
    /*                          CONSTRUCTORES                                   */
    /* ************************************************************************ */

    public DlgOrdenaRolesTmp(Frame parent, String title, boolean modal) {
    ...
    private void chkKeyPressed(KeyEvent e) {
        if (mifarma.ptoventa.reference.UtilityPtoVenta.verificaVK_F11(e)) {
            VariablesRolesTmp.vColumna =
                FarmaLoadCVL.getCVLCode(ConstantsRolesTmp.NOM_HASTABLE_CMBCOLUMNAROL, cmbColumna.getSelectedIndex());
            VariablesRolesTmp.vOrden =
                    FarmaLoadCVL.getCVLCode(ConstantsRolesTmp.NOM_HASTABLE_CMBORDENROL, cmbOrden.getSelectedIndex());
    ...
    public JComboBox getCmbOrden() {
        return this.cmbOrden;
    }

    public void setIndOrigenReporte(int indOrigenReporte) {
        this.indOrigenReporte = indOrigenReporte;
    }
    ...
    private void cargaCombos() {
        ...
        FarmaLoadCVL.loadCVLfromArrays(cmbColumna, ConstantsRolesTmp.NOM_HASTABLE_CMBCOLUMNAROL, ConstantsRolesTmp.vDescColum, ConstantsRolesTmp.vCodColum, true);

        FarmaLoadCVL.loadCVLfromArrays(cmbOrden, ConstantsRolesTmp.NOM_HASTABLE_CMBORDENROL, ConstantsRolesTmp.vDescOrdenRol, ConstantsRolesTmp.vCodOrdenRol, true);
    }
