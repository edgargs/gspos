...
public class DlgEditarIPSImpresora extends JDialog {
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(591, 321));
        ...
        pnlBody.setBounds(new Rectangle(10, 35, 565, 215));
        pnlBody.setFocusable(false);
        lblEsc.setText("[ ESC ] Cerrar");
        lblEsc.setBounds(new Rectangle(440, 265, 135, 25));
        lblEsc.setFocusable(false);
        lblF11.setText("[ Enter ] Cambiar"); // kmoncada cambia tecla de seleccion de campo
        lblF11.setBounds(new Rectangle(10, 265, 125, 25));
        ...
        lblF5.setBounds(new Rectangle(145, 265, 125, 25));
