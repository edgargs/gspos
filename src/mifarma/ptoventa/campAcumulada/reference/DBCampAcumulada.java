...
public class DBCampAcumulada {
    ...
    throws SQLException{
          ...
          System.out.println("invocando a PTOVENTA_CA_CLIENTE.CA_F_CUR_LISTA_CAMPANIAS(?,?,?) params: "+parametros);
    ...
    throws SQLException{
        ...
        System.out.println("invocando a PTOVENTA_CA_CLIENTE.CA_F_CUR_CAMP_CLIENTE(?,?,?) params: "+parametros);
    ...
    public static void insertarCliente()throws SQLException{
        ...
        System.err.println("INSERTANDO CLIENTE PTOVENTA_CA_CLIENTE.CA_P_INSERT_CLIENTE(?,?,?,?,?,?,?,?,?,?,?,?,?) :"+parametros);
    ...
    public static void insertarClienteMatriz()throws SQLException{
        ...
        parametros.add(FarmaVariables.vIdUsu.trim());
        parametros.add(VariablesCampAcumulada.vIndEstado.trim());        
        System.err.println("INSERTANDO CLIENTE PTOVENTA_MATRIZ_CA_CLI.CA_P_INSERT_CLIENTE_MATRIZ(?,?,?,?,?,?,?,?,?,?,?,?,?) :"+parametros);
        /*
    ...
    public static void getTarjetasClienteLocal(ArrayList array,String pDNI)throws SQLException{
        ...
        System.err.println("obteniendo tarjetas del cliente en local PTOVENTA_CA_CLIENTE.CA_F_CUR_TARJETAS_CLI(?) :"+parametros);
    ...
    public static void getTarjetasClienteMatriz(ArrayList array,String pDNI,String pIndCloseConecction)throws SQLException{
        ...
        System.err.println("obteniendo tarjetas del cliente en matriz PTOVENTA_CA_CLIENTE.CA_F_CUR_TARJETAS_CLI(?) :"+parametros);
    ...
    public static void asociarClienteConTarjeta(String pDNI, String pNroTarjeta)throws SQLException{
        ...
        parametros.add(FarmaVariables.vCodLocal.trim());
        parametros.add(FarmaVariables.vIdUsu.trim());        
        System.err.println("INSERTANDO CLIENTE PTOVENTA_CA_CLIENTE.CA_P_UPD_TARJETA_CLIENTE(?,?,?,?) :"+parametros);
    ...
    public static void asociarClienteConCampania(String pDNI, String pCodCampania)throws SQLException{
        ...
        parametros.add(pDNI);        
        parametros.add(FarmaVariables.vIdUsu.trim());        
        System.err.println("INSERTANDO CLIENTE PTOVENTA_CA_CLIENTE.CA_P_INSERT_CLI_CAMPANIA(?,?,?,?) :"+parametros);
    ...
    public static void asociarClienteConCampaniaMatriz(String pDNI, String pCodCampania)throws SQLException{
        ...
        parametros.add(pDNI);        
        parametros.add(FarmaVariables.vIdUsu.trim());        
        System.err.println("INSERTANDO CLIENTE PTOVENTA_MATRIZ_CA_CLI.CA_P_INSERT_CLI_CAMPANIA(?,?,?,?) :"+parametros);
        /*
        FarmaDBUtilityRemoto.executeSQLStoredProcedure(null,
