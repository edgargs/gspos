...
/*
  ...
  */
  ...
  public static void grabarCabeceraPedido(boolean indCompIngManual,
  ...
  */
    ...
    throws SQLException
  {
    ...
    parametros.add(pCodProd);
      ...
      System.err.println("antes " +Calendar.getInstance().getTime()+" - "+parametros);
    FarmaDBUtility.executeSQLStoredProcedure(pTableModel, 
                                             "PTOVENTA_VTA_LISTA.VTA_LISTA_PROD_SUSTITUTOS(?,?,?)", 
                                             parametros, true);
      System.err.println("despuest "+Calendar.getInstance().getTime()+" - "+parametros);
  }
         ...
         */
         ...
         String pQuitaCampanaAcumulada = "";
                 if(VariablesVentas.vEsPedidoDelivery){
                    ...
                    pQuitaCampanaAcumulada = "  and v.cod_real in ( " +
                        " select tt.Cod_Camp_Cupon from PTOVENTA.VTA_CAMPANA_DLV tt " +
                        " )  ";
                 }    
    ...
    */
    ...
    public static void grabaPedidoAntiguoMigracion(
     ...
     /**
          ...
          * @since   31.01.2014
          */ 
         public static Map obtieneMsgImpFactura(String pTipoComprobante, int pCantDoc, String pNumDocImpreso,String pNumPedVta, boolean isReimpresion) throws SQLException {
             parametros = new ArrayList();
             parametros.add(FarmaVariables.vCodGrupoCia);
             parametros.add(FarmaVariables.vCodLocal);
             ...
             if(isReimpresion)
                parametros.add("S");
                 ...
                 parametros.add("N");
             log.debug("PTOVENTA_CONV_BTLMF.MIFARMA_IMPR_MSG_GRAL(?,?,?,?,?,?,?) :" + 
                       parametros);
    ...
    public static String obtenerInfoRecetaProdFinal(String codProd) throws SQLException {
      ...
      return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVTA_RESPALDO_STK.GET_INFO_RECETA_PFINAL(?,?)",parametros);
    }
     ...
     * @throws SQLException
     */
    public static String obtenerIndValidaStkComp(String codProd,
                                                    int cantPedido) throws SQLException {
        parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(codProd);
      ...
      return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVTA_RESPALDO_STK.GET_VALIDA_STOCK_COMP(?,?,?,?)",parametros);
    }
    ...
    public static String obtenerIndProdInPack(String codProd) throws SQLException {
      ...
      return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_PROMOCIONES.GET_IND_PROD_IN_PACK(?,?,?)",parametros);
    }
