...
import mifarma.ptoventa.inventariociclico.reference.*;
...
public class DlgListaTomasInventarioCiclico extends JDialog {
  ...
  private JLabelFunction lblF5 = new JLabelFunction();
    ...
    System.out.println(VariablesInvCiclico.vSecToma);
	}
  ...
  private void imprimirProductosPorLaboratorio()
  {
    ...
    System.out.println("VariablesInvCiclico.vListaCodLab.size() "+ VariablesInvCiclico.vListaCodLab.size());
  ...
  public void envioTomaLocal()
  {
    try
    {
      if(FarmaUtility.rptaConfirmDialog(this,"Esta seguro de enviar la toma de inventario al local?"))
      {
