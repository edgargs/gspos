...
public class DlgResumenPedidoGratuito extends JDialog {
    ...
    private void grabarDetallePedido(String pTiComprobante, int pFila) throws Exception {
        ...
        VariablesVentas.vCod_Prod =
                ((String)((ArrayList)VariablesVentas.vArrayList_ResumenPedido.get(pFila)).get(0)).trim();
        VariablesVentas.vCant_Ingresada =
                String.valueOf(FarmaUtility.trunc(FarmaUtility.getDecimalNumber(((String)((ArrayList)VariablesVentas.vArrayList_ResumenPedido.get(pFila)).get(4)).trim())));
        VariablesVentas.vVal_Prec_Vta =
                ((String)((ArrayList)VariablesVentas.vArrayList_ResumenPedido.get(pFila)).get(6)).trim();
        VariablesVentas.vTotalPrecVtaProd =
                FarmaUtility.getDecimalNumber(((String)((ArrayList)VariablesVentas.vArrayList_ResumenPedido.get(pFila)).get(7)).trim());
        VariablesVentas.vPorc_Dcto_1 =
                String.valueOf(FarmaUtility.getDecimalNumber(((String)((ArrayList)VariablesVentas.vArrayList_ResumenPedido.get(pFila)).get(5)).trim()));
        ...
        VariablesVentas.vVal_Total_Bono =
                String.valueOf(FarmaUtility.getDecimalNumber(((String)((ArrayList)VariablesVentas.vArrayList_ResumenPedido.get(pFila)).get(8)).trim()));
        VariablesVentas.vVal_Frac =
                ((String)((ArrayList)VariablesVentas.vArrayList_ResumenPedido.get(pFila)).get(10)).trim();
        ...
        VariablesVentas.vVal_Prec_Lista =
                String.valueOf(FarmaUtility.getDecimalNumber(((String)((ArrayList)VariablesVentas.vArrayList_ResumenPedido.get(pFila)).get(3)).trim()));
        VariablesVentas.vVal_Igv_Prod =
                ((String)((ArrayList)VariablesVentas.vArrayList_ResumenPedido.get(pFila)).get(11)).trim();
        VariablesVentas.vUnid_Vta =
                ((String)((ArrayList)VariablesVentas.vArrayList_ResumenPedido.get(pFila)).get(2)).trim();
