...
public class DlgPrincAct extends JDialog {
    ...
    {
        tableModelPrincAct=new FarmaTableModel(ConstantsVentas.columnsListPrincAct,
                                        ConstantsVentas.defaultValuesListPrincAct,
                                        0);
        FarmaUtility.initSimpleList(tblLista,
                                    tableModelPrincAct,
                                    ConstantsVentas.columnsListPrincAct);
    }
