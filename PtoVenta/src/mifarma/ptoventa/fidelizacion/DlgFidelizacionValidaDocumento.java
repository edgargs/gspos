...
public class DlgFidelizacionValidaDocumento extends JDialog {
    ...
    private void chkKeyPressed(KeyEvent e) {
        ...
        if (mifarma.ptoventa.reference.UtilityPtoVenta.verificaVK_F11(e)) {
            ...
            if (isInteger(txtDocumento.getText().trim()) &&
                ...
                FarmaUtility.showMessage(this, "El documento ingresado no tiene el formato válido.", txtDocumento);
            }
    ...
    private boolean reingresoValidacionDNI() {
        ...
        String vDocumento =
            (String)JOptionPane.showInputDialog(this, "El documento ingresado (Nº. " + VariablesFidelizacion.Num_Doc +
                                                " ) es diferente \n" +
