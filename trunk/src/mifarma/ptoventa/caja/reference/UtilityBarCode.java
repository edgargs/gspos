...
{
	private static final Log log = LogFactory.getLog(UtilityBarCode.class);
 ...
 private static String CONS_DIRECTORIO = "";
  ...
  public static String crea_ima() throws Exception {
      ...
      try
      {
        ...
        System.out.println("archivo creado: " + nombre2);
    ...
    throws InvalidAtributeException
  {
    ...
    System.out.println("CONS_DIRECTORIO " + CONS_DIRECTORIO);
...
//      saveToJPEG(enlargedImage, nombreArchivo);
  ...
  public static void MostrarDirectorio() throws Exception {
      
      try {
          
           CONS_DIRECTORIO = DBCaja.ObtieneDirectorio().trim();
          System.err.println("CONS_DIRECTORIO :" + CONS_DIRECTORIO);
      }
