...
import mifarma.ptoventa.DlgFiltroProductosNuevo;
import mifarma.ptoventa.DlgProcesar;
import mifarma.ptoventa.FrmEconoFar;
import mifarma.ptoventa.caja.DlgDatosTarjeta;
import mifarma.ptoventa.caja.DlgProcesarDatosTarjeta;
                    ...
                    if ((tiempoTeclaFinal - tiempoTeclaInicial) <= maxTiempoLectora && txtProducto.getText().length() > 0 && validaFinal) {
                        ...
                        if(UtilityPuntos.isActivoFuncionalidad()){
                            ...
                            if(VariablesPuntos.frmPuntos != null && UtilityPuntos.isTarjetaValida(txtProducto.getText().trim())){
                                ...
                                boolean isAfiliado = UtilityPuntos.consultarTarjetaOrbis(myParentFrame, this, txtProducto, isLectoraLazer, false);
