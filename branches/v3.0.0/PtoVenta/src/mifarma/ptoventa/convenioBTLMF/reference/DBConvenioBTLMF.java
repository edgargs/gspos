...
public class DBConvenioBTLMF {
    ...
    public static List listaDatosConvenio(String pCodigoConvenio) throws SQLException {
        ...
        log.debug("PTOVENTA_CONV_BTLMF.BTLMF_F_CUR_LISTA_DATOS_CONV(?,?,?,?)" + 
                  parametros);
    ...
    public static String cobraPedido() throws SQLException {
        log.debug("VariablesVentas.vTipoPedido : " + 
                           VariablesVentas.vTipoPedido);
        parametros = new ArrayList();
    ...
    public static String grabarCobrarPedidoRac(String pIndCloseConecction, String pIndicadorNC) throws SQLException {
        ...
        log.debug("BTLPROD.PKG_DOCUMENTO_MF.SP_GRABA_DOCUMENTOS(?,?,?,?,?)" + 
                  parametros);
     ...
     * @throws SQLException
     */
    public static String anularPedidoRac(String pIndNotaCred, 
        ...
        log.debug("BTLPROD.PKG_DOCUMENTO_MF.SP_ANULA_DOCUMENTO(?,?,?,?) :" + 
                  parametros);
    ...
    public static String anularPedidoRacNotaCredito(String pIndCloseConecction) throws SQLException {
        ...
        log.debug("invocando  a BTLPROD.PKG_DOCUMENTO.SP_ANULA_DOCUMENTO(?,?,?) :" + 
                  parametros);
    ...
    public static int obtieneCantListaBenefRemoto() throws SQLException {
        ...
        log.debug("PTOVENTA.PTOVENTA_MATRIZ_CONV_BTLMF.GET_CANT_LISTA_BENEFICIARIO(?,?,?,?,?)"+ 
                                                                    parametros);
    ...
    public static int obtieneCantListaBenefLocal() throws SQLException {
        ...
        log.debug("PTOVENTA.PTOVENTA_CONV_BTLMF.GET_CANT_LISTA_BENEFICIARIO(?,?,?,?,?)"+ 
                                                                    parametros);
    ...
    public static void obtieneInfoProductoSug(ArrayList pArrayList, String pCodProd,String cantVta) throws SQLException {
      ...
      FarmaDBUtility.executeSQLStoredProcedureArrayList(pArrayList,"PTOVENTA_CONV_BTLMF.VTA_OBTIENE_PROD_SUG(?,?,?,?,?)",parametros);
    }    
    ...
    public static boolean validacionPedidoRAC(String pCodLocal, String pNumPedVta, String pCodConvenio, String pCodCliente,
                                             String pTipoDoc, double pMonto, String pVtaFin) throws SQLException {
        ...
        String resultado = FarmaDBUtilityRemoto.executeSQLStoredProcedureStr("BTLPROD.PKG_DOCUMENTO_MF.VALIDAR_COBRO_PEDIDO(?,?,?,?,?,?,?)", 
                                                                 parametros, 
                                                                 FarmaConstants.CONECTION_RAC, 
                                                                 "S");
     ...
     * @throws SQLException
     */
    public static boolean isExisteComprobanteEnRAC(String pCodGrupoCia, String pCodLocal, String pTipoComprobante, String pNumComprobante, String pIndComprobanteElectronico) throws SQLException{
        ArrayList parametros = new ArrayList();
        ...
        int resultado = FarmaDBUtilityRemoto.executeSQLStoredProcedureInt("BTLPROD.PKG_DOCUMENTO_MF.FN_EXISTE_DOCUMENTO(?,?,?,?,?)", parametros, FarmaConstants.CONECTION_RAC, "S");
        if(resultado == 0)
            return false;
        else
            return true;
    ...
    public static void obtieneCompPagosImpresion(ArrayList pArrayList, 
                                        String pTipClienteConv) throws SQLException {
        parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(VariablesCaja.vNumPedVta);
        parametros.add(pTipClienteConv);
        log.debug("parametros PTOVENTA_CONV_BTLMF.BTLMF_F_CUR_LST_COMP_PAGO_IMPR(?,?,?,?): " + 
                           parametros);
        FarmaDBUtility.executeSQLStoredProcedureArrayList(pArrayList, 
    ...
    public static String getComprobanteBeneficiario(String pCodConvenio)throws Exception{
        ...
        return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_CONV_BTLMF.F_CHAR_EMITE_BENEFICIARIO(?)", parametro);
    }
}
