...
//    public static String vCodTipProcPago = "";
    public static String vNumPedVtaOrigenCOBRO = "";
    ...
    public static ArrayList<HashMap<String,Object>> vListMap_SecCompPago = new ArrayList<HashMap<String,Object>>();
    public static ArrayList<String> vArrayList_SecCompPago = new ArrayList<String>();
    ...
    public static int vTipoLineas = 66;
    ...
    public static String vTipoMotivoAnulacion = ""; //LTAVARA 10.09.2014  PROCESO COMPROBANTE ELECTRONICO
    ...
    public static boolean vIndPedidoConRecarVirtual = false; //ASOSA - 08/07/2014

    //INI ASOSA - 13/07/2014
    public static String vTipoRcd = "";
    public static String vCodTipoProducto = "";
    //FIN ASOSA - 13/07/2014


    // DUBILLUZ 13.10.2014
    public static String pManualSerieComprobante = "";
    public static String pManualNumCompPago = "";
    public static String pManualTipCompPago = "";
    // DUBILLUZ 13.10.2014

    //CHUANES 27/10/2014
    public static String INDELECTRONICO = "";

    public static String vNumPedVtaNCR = "";
    
    public static boolean isImprPA = true;  //ASOSA - 17/07/2015 - IGVAZNIA
    public static String espacioBlancoFactura = "                                ";
    public static String espacioBlancoTicket = "          ";
    public static String espacioBlancoBoleta = "          ";
    
    //ERIOS 12.02.2016 Impresora Nota Credito
    public static String vSecImprLocalNotaCredito;
}
