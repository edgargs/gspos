...
public class DlgIngresoCantidadInvDiarioConteo extends JDialog {
    ...
    public DlgIngresoCantidadInvDiarioConteo(Frame parent, String title, boolean modal) {
    ...
    private void initTable() {
        tableModelKardex =
                new FarmaTableModel(ConstantsInvDiario.columnsListaMovsKardex, ConstantsInvDiario.defaultListaMovsKardex,
                                    0);
