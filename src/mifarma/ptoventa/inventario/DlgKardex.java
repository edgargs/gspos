...
public class DlgKardex extends JDialog {
   ...
   private void this_windowClosing(WindowEvent e){
    ...
    private void cargaListaProductos() {
        ...
        tblListaProductos.getTableHeader().setResizingAllowed(false);
            ...
            System.out.println("se cargo la lista de prods");
    ...
    private void cargarRegistroSeleccionado() {
        ...
        System.out.println("VariablesInventario.vFrac : " + VariablesInventario.vFrac);
    ...
    */
    ...
    {
    if(cargaLogin()){
        System.out.println("Se mostrara el Listado de Stock en Locales");
        VariablesPtoVenta.vRevisarIndStockLocales = FarmaConstants.INDICADOR_N;
        System.out.println("Se cambia la variable VariablesPtoVenta.vRevisarIndStockLocales :" +
