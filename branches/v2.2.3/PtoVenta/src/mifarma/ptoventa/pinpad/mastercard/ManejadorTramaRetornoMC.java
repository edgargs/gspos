...
public class ManejadorTramaRetornoMC
{
     ...
     * @since 17-Julio-2013
     */
    public Integer guardarTramaAnulacionBD(Map<String,String> parametros)
    {   try
    ...
    {   String libpath = System.getProperty("java.library.path");
        ...
        //TODO leer de BBDD
        String libpathMC = "C:\\farmaventa\\pinpad\\mc";
        
        if(!libpath.contains(libpathMC))
        {   libpath = libpath+ps+libpathMC+ps;
