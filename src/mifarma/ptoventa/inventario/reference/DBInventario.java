...
public class DBInventario 
{
  ...
  public static String agregarCabeceraTransferencia(String tipDestino, String codDestino,String motivo,String destino, String rucDestino, String dirDestino, String transp, String rucTransp, String dirTransp, String placa ,String cantItems, String valTotal,String codTransInterno) throws SQLException
  {
    parametros = new ArrayList();
    parametros.add(FarmaVariables.vCodGrupoCia);
    parametros.add(FarmaVariables.vCodLocal);
  ...
  public static void obtieneDetPedido(ArrayList pArreglo,String NumPed) throws SQLException {
                            ...
                            String pCantMov,int pValFrac,String pIndCloseConecction )throws SQLException
    {
     ...
     //  FarmaDBUtilityRemoto.executeSQLStoredProcedureStrOut("PTOVENTA_TRANSF.INV_P_VERI_FRAC_ENTRE_LOC(?,?,?,?,?)", parametros, false);
       System.out.println("FarmaConstants.CONECTION_MATRIZ: "+FarmaConstants.CONECTION_MATRIZ);
        System.out.println(" pIndCloseConecction: "+ pIndCloseConecction);    
...
/**
                                                 ...
                                                 String secusu)throws SQLException
    {
        ...
        System.out.println("invocando a PTOVENTA_INV.INV_F_VALIDA_ASIST_AUDIT: "+parametros);
    ...
    public static String getIndNuevaTransf() throws SQLException{
        parametros = new ArrayList();
        System.out.println("invocando a PTOVENTA_INV.INV_GET_IND_NUEVA_TRANSF:"+parametros);
    ...
    public static String getIndIngresarLote()throws SQLException{
        parametros = new ArrayList();
        System.out.println("invocando a PTOVENTA_TRANSF.TRANS_F_GET_IND_LOTE:"+parametros);
    ...
    public static String eliminarLote(String codprod,
        ...
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(FarmaVariables.vIdUsu);
        System.out.println("PTOVENTA_TRANSF.TRANS_P_DEL_LOTE(): "+parametros);
...
/**
    ...
    public static String isProductoActivo(String codProd) throws SQLException{
            ...
            parametros.add(FarmaVariables.vCodLocal);
            parametros.add(codProd.trim());
            System.out.println("PTOVENTA_INV.INV_F_ACTIVO_PROD: "+parametros);
    ...
    /**
        ...
        public static String getIndPideLoteTransf() throws SQLException{
                parametros=new ArrayList();
                parametros.add(FarmaVariables.vCodGrupoCia);                                
                System.out.println("PTOVENTA_INV.INV_GET_PIDE_LOTE_TRANSF: "+parametros);
    ...
    /**
        ...
        public static String getIndPideFechaVencTransf() throws SQLException{
                parametros=new ArrayList();
                parametros.add(FarmaVariables.vCodGrupoCia);                                
                System.out.println("PTOVENTA_INV.INV_GET_PID_FEC_VTO_TRANSF: "+parametros);
