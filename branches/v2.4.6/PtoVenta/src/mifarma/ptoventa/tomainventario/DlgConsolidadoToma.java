...
public class DlgConsolidadoToma extends JDialog 
{
  ...
  public DlgConsolidadoToma(Frame parent, String title, boolean modal)
  {
  ...
  private void obtieneTotalesToma()
  {
    try
    {
      ...
      VariablesTomaInv.vTotalItems = ((String)((ArrayList)VariablesTomaInv.vObtieneTotales.get(0)).get(0)).trim();
      VariablesTomaInv.vTotalTomados = ((String)((ArrayList)VariablesTomaInv.vObtieneTotales.get(0)).get(1)).trim();
    ...
    try
      {
        ...
        VariablesTomaInv.vObtieneInformacionValorizada = DBTomaInv.obtieneInformacionValorizada(VariablesTomaInv.vSecToma);
        VariablesTomaInv.vFaltante = ((String)((ArrayList)VariablesTomaInv.vObtieneInformacionValorizada.get(0)).get(0)).trim();
        VariablesTomaInv.vSobrante = ((String)((ArrayList)VariablesTomaInv.vObtieneInformacionValorizada.get(0)).get(1)).trim();
