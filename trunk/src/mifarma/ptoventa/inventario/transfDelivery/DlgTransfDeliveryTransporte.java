...
public class DlgTransfDeliveryTransporte extends JDialog 
{
	...
	private void chkKeyPressed(KeyEvent e)
	{
		...
		{
			if(FarmaUtility.rptaConfirmDialog(this,"Desea generar la transferencia ?")){
				if(validarCampos())
				{
					cargarCabecera();
	...
	private void cargarCabecera()
	{
		...
		System.err.println("VariablesTranfDelivery.vTipoDestino_Transf"+VariablesTranfDelivery.vTipoDestino_Transf);
		System.err.println("VariablesTranfDelivery.vMotivo_Transf"+VariablesTranfDelivery.vMotivo_Transf);
		System.err.println("VariablesTranfDelivery.vDescMotivo_Transf"+VariablesTranfDelivery.vDescMotivo_Transf);
