...
public class DlgActaRecepcionMercaderia extends JDialog {
    ...
    private void initTable() {
        tableModel = new FarmaTableModel(ConstantsRecepCiega.columnsListaActaRecepcion, ConstantsRecepCiega.defaultListaActaRecepcion, 0);
    ...
    private void imprimir() {
                 ...
                 log.debug(FarmaVariables.vImprReporte);
                  ...
                  try {
                          ...
                          vPrint.printBold(FarmaPRNUtility.llenarBlancos(40)
                                          + " ACTA DE RECEPCION DE PRODUCTOS", true);
            ...
            vPrint.printBold("Local: " + FarmaVariables.vCodLocal, true);
                          ...
                          vPrint
                                .printBold(
                                    "CODIGO DESCRIPCION                    PRESENTACION CANT  N LOTE   FECH VCT EMBALAJE ENV MDTO  ENV INMDTO " +
                                    "ROTULO  CONTENIDO R.S. ",
                                                    true); 
                          vPrint
                                          .printLine(
                                                          "=========================================================================================================================",
          ...
          FarmaPRNUtility.alinearIzquierda((String) tblListaCajas.getValueAt(i,0), 6)+" "+
          ...
          , true);
                ...
                FarmaUtility.formatNumber(tblListaCajas
                                                          .getRowCount(), ",##0"),10)
