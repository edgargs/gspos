...
public class DlgRegistroCliente extends JDialog {
        ...
        if (mifarma.ptoventa.reference.UtilityPtoVenta.verificaVK_F11(e)) {
            ...
            if (resValidacion.length() == 0) {
                if (insertarCliente())
                    ...
                    FarmaUtility.showMessage(this, "No se pudo ingresar correctamente la información del paciente.",
                                             null);
            } else {
                FarmaUtility.showMessage(this, resValidacion, null);
            }
    ...
    private void this_windowOpened(WindowEvent e) {
        //ERIOS 03.12.2015 Se muestra la etiqueta Paciente.
        if(pIndPaciente){
            this.setTitle("Datos de Paciente");
            lblDniCliente.setText("DNI Paciente: *");
        }
    ...
    private String validarFormulario() { //validar campos obligatorios vacios
        String respVacios = "";
    ...
    private void txtApePaterno_keyTyped(KeyEvent e) { //validaciones de campo
        int limite = 50;
    ...
    private void txtApeMaterno_keyTyped(KeyEvent e) { //validaciones de campo
        int limite = 50;
    ...
    private void txtNombre_keyTyped(KeyEvent e) { //validaciones de campo
        int limite = 50;
    ...
    private void txtEmail_keyTyped(KeyEvent e) { //validaciones de campo
        int limite = 100;
    ...
    public void setIndPaciente(boolean pIndPaciente) {
        this.pIndPaciente = pIndPaciente;
    }
}
