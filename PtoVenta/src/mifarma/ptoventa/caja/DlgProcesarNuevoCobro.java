...
public class DlgProcesarNuevoCobro extends JDialogProgress {
    ...
    private boolean bCobroProforma = false;
  ...
  */
    ...
    private boolean procesar() {
        ...
        if (!UtilityCaja.existeStockPedido(this, VariablesCaja.vNumPedVta, bCobroProforma))
            return false;

        //INICIO DE VALIDACIONES
        if (!UtilityCaja.validacionesCobroPedido(false, this, tblFormasPago, bCobroProforma))
            return false;
...
/////////////////////////////////////////////////////////////****************************///
            ...
            String resultado =
                DBCaja.cobraPedido(VariablesVentas.vTip_Comp_Ped, VariablesCaja.vPermiteCampaña.trim(), dniClienteFidelizado.trim());
    ...
    private boolean finalizaCobro() {
        ...
        UtilityCaja.procesoImpresionComprobante(this, txtNroPedido, false, bCobroProforma);
    ...
    private boolean anulaPedido() {
        ...
        UtilityCaja.procesoImpresionComprobante(this, txtNroPedido, true, bCobroProforma);
        //3. Anula pedido
        try {
    ...
    public void setCobroProforma(boolean bCobroProforma) {
        this.bCobroProforma = bCobroProforma;
    }
}
