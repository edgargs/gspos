 ...
 public static void eliminaFormaPagoEntegaSL(String pSecMovCaja,
   ...
   */
   public static void getListaPedidosCompRangosCierre(ArrayList pArrayList, String vFechaHoy ) throws SQLException {
    ...
    parametros.add(vFechaHoy);
    log.debug("",parametros);
   FarmaDBUtility.executeSQLStoredProcedureArrayList(pArrayList,"PTOVENTA_CAJ.CAJ_LISTA_COMPROBANT_COMPROBAR(?,?,?,?)",parametros);
 	}
    ...
    */    
     ...
     */
     public static String getIndTico() throws SQLException {
         ...
         return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_SOBRE_TICO.GET_IND_TICO(?)",
                                 parametros);     
     }
    /**
    ...
    public static void obtieneSobrePendientes(ArrayList pListaSobre) throws SQLException {
        ...
        FarmaDBUtility.executeSQLStoredProcedureArrayList(pListaSobre,"PTOVENTA_SOBRE_TICO.F_LISTAR_SOBRES(?,?)",parametros);
    }
    /**
    ...
    public static void insertSobresTICO(String indConexion,ArrayList arrayList) throws SQLException  {
        ...
        log.info("PTOVENTA.PTOVENTA_SOBRE_TICO.P_INSERT_SOBRE_TICO(?,?,?,?,?,?,?,?" +
                                                                    ",?,?,?,?)" + 
                                                                    parametros);
        log.info("IP conexion: "+FarmaVariables.vIpServidorTico);            
        
        FarmaDBUtilityRemoto.executeSQLStoredProcedure(null, "PTOVENTA.PTOVENTA_SOBRE_TICO.P_INSERT_SOBRE_TICO(?,?,?,?,?,?,?,?" +
                                                                                                ",?,?,?,?)",
                                                           parametros,
                                                           false,
                                                           FarmaConstants.CONECTION_TICO, 
                                                           indConexion);
    ...
    /**
         ...
         * @throws SQLException
         */
    public static String eliminarSobresTICO(String indConexion,
                                         String cSobre, 
                                         String cFecVta) throws SQLException  {
        parametros = new ArrayList();
    ...
    /**
         ...
         * @throws SQLException
         */
    public static void  insertCierreDiaMarket(String indConexion,
                                                String pCierreDiaVenta,
                                                String pSecUsuLogeado
                                                ) throws SQLException{
            parametros = new ArrayList();
            parametros.add(pCierreDiaVenta);
            ...
            FarmaDBUtilityRemoto.executeSQLStoredProcedure(null, "PTOVENTA.PTOVENTA_SOBRE_TICO.P_INSERT_CIERRE_DIA_MARKET(?,?,?,?)",
                                                                   parametros,
                                                                   false,
                                                                   FarmaConstants.CONECTION_TICO, 
                                                                   indConexion);    
    ...
    public static void getLocalTicoIP(ArrayList listaTicos) throws SQLException {
        ...
        FarmaDBUtility.executeSQLStoredProcedureArrayList(listaTicos,"PTOVENTA_SOBRE_TICO.GET_IPS_TICOS(?)",parametros);
        
    }
    
    public static void obtieneSobreTicoPendiente(String indConexion,
                                                 ArrayList pListaSobre,
    ...
    public static void insertSobresTICOPendiente(ArrayList arrayList,
                                                 String cCodLocal) throws SQLException  {
        for (int i = 0; i < arrayList.size(); i++)
        {
        String FecVta       = ((String) ((ArrayList) arrayList.get(i)).get(0)).trim();
        ...
        parametros.add(cIndSol);
        parametros.add(cIndDol);
        log.info("PTOVENTA_SOBRE_TICO.P_INSERT_SOBRE_TICO(?,?,?,?,?,?,?,?" +
                                                                         ",?,?,?,?)" + 
                                                                    parametros);
        FarmaDBUtility.executeSQLStoredProcedure(null,
    ...
    public static void updateSobresTico(String indConexion, ArrayList pSobresTico,
                                        String remito,String precinto, String cCodLocal) throws SQLException {
        ...
        FarmaDBUtilityRemoto.executeSQLStoredProcedure(null, "PTOVENTA.PTOVENTA_SOBRE_TICO.P_UPDATE_REMITO(?,?,?,?,?,?)",
                                                                        parametros,
                                                                        false,
                                                                        FarmaConstants.CONECTION_TICO, 
                                                                        indConexion);    
    ...
    public static void actualizarProce(String indProceso) throws SQLException {
        ...
        FarmaDBUtility.executeSQLStoredProcedure(null,"PTOVENTA_SOBRE_TICO.P_UPDATE_IND_PROCESO(?)",parametros,false);
    ...
    public static void cargaComprobantesElectronicos(FarmaTableModel pTableModel,
        ...
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(pFechaCierreDia);
        FarmaDBUtility.executeSQLStoredProcedure(pTableModel,"PTOVENTA_CE_LMR.CE_OBTIENE_RANGO_COMP_ELECT(?,?,?)",parametros,false);
