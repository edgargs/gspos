...
//JMIRANDA  30/06/2009
    ...
    public static String getNombreImpTermica()throws SQLException {
        ...
        return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_CAJ.GET_NOMBRE_IMPRES_TERMICA(?,?,?)",parametros);
    }
    /**
     * @author:CESAR HUANES
     * @since 01/09/2014
    ...
    public static Integer getCantidadComElectornico(String pNumPedVta) throws SQLException {
        ...
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(pNumPedVta);
        return Integer.parseInt(FarmaDBUtility.executeSQLStoredProcedureStr("FARMA_EPOS.FN_CONTAR_DOCELECTRONICO(?,?,?)",parametros)); 
    }
