 ...
 /* public static final String[] vDescCampoPedRep = {"Codigo", "Descripcion","Unidad","Solicitud",
  ...
  public static final Object[] defaultValuesListaResumenPedidoEsp 
    ...
    public static final FarmaColumnData[] columnsListaItemOrden = {
        new FarmaColumnData("Sel",30,JLabel.LEFT),
        new FarmaColumnData("Cod. Prod.",65,JLabel.RIGHT),
        new FarmaColumnData("Descripción",375,JLabel.LEFT),
        new FarmaColumnData("Cant. Ped.",65,JLabel.RIGHT),
        new FarmaColumnData("Cant. Rec.",65,JLabel.RIGHT),
        new FarmaColumnData("Precio",65,JLabel.RIGHT),
        new FarmaColumnData("IGV",25,JLabel.RIGHT)
    };
