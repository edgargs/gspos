...
public class DlgIngresoCantidadToma extends JDialog {
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(417, 298));
        ...
        jPanelWhite1.setBounds(new Rectangle(20, 15, 380, 220));
        ...
        jButtonLabel1.setBounds(new Rectangle(20, 190, 55, 20));
        ...
        txtEntero.setBounds(new Rectangle(80, 190, 60, 20));
        ...
        jLabelFunction1.setBounds(new Rectangle(170, 245, 105, 20));
        jLabelFunction1.setText("[ Enter ] Aceptar");
        jLabelFunction2.setBounds(new Rectangle(285, 245, 115, 20));
        jLabelFunction2.setText("[ ESCAPE ] Cerrar");
        
        
        
        txtFraccion.setBounds(new Rectangle(275, 190, 60, 20));
        ...
        lblFraccion.setBounds(new Rectangle(205, 190, 65, 20));
