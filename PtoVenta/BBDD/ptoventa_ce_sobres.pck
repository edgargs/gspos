CREATE OR REPLACE PACKAGE PTOVENTA."PTOVENTA_CE_SOBRES" AS
  ...
  FUNCTION SEG_F_CUR_GET_SOBRES(cCodGrupoCia_in IN CHAR,
                                cCodLocal_in    IN CHAR,
                                cMovCaja_in     IN CHAR,
                                cCodSobre_in    IN CHAR) RETURN FarmaCursor;
...
FUNCTION SEG_F_VAR_IMP_HTML_SOBRES_02(cCodGrupoCia_in IN CHAR,
    ...
    --Descripcion: Solo obtiene sobre para reimprimir en control de sobres
    --Fecha       Usuario		 Comentario
    --04/08/2010  ASOSA      Creación
FUNCTION SEG_F_VAR_IMP_HTML_SOBRES_03(cCodGrupoCia_in IN CHAR,
    ...
    --Descripcion: Solo obtiene sobre para reimprimir en declaracion forma pago entrega
    --Fecha       Usuario		 Comentario
      ...
      AND    T.SEC_MOV_CAJA = cSecMovCaja_in;
              ...
              AND    T.SEC_MOV_CAJA = cSecMovCaja_in;
                ...
                (COD_SOBRE,COD_GRUPO_CIA,COD_LOCAL,FEC_DIA_VTA,SEC_MOV_CAJA,SEC,COD_FORMA_PAGO,
                 TIP_MONEDA,MON_ENTREGA,MON_ENTREGA_TOTAL,USU_CREA_SOBRE,USU_MOD_SOBRE,FEC_MOD_SOBRE,ESTADO,IND_IMP,SEC_USU_QF, ind_etv)
                VALUES
                ...
                cTipMoneda_in,cMonEntrega_in,cMonEntregaTotal_in,cIdUsu_in,NULL,NULL,'A','N',secUsuQf_in, indProsegur); --edmundo queria esto 'ASOSA, 26.07.2010'
