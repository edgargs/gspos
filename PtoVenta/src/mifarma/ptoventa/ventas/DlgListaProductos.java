...
public class DlgListaProductos extends JDialog {
        ...
        try {
            if (!vEjecutaAccionTeclaListado) {
                ...
                if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                    ...
                    vEjecutaAccionTeclaListado = false;
                    UtilityVentas.muestraDetalleProducto(myParentFrame,myJTable,COL_COD,2,4);
    ...
    private void muestraIngresoCantidad() {
        ...
        flagContinua = UtilityVentas.validaVentaConMenos(this, myParentFrame, myJTable, txtProducto);
    ...
    private void verificaCheckJTable() {
        ...
        if (valor.booleanValue()) {
            ...
            // KMONCADA 07.06.2016 [PROYECTO M] VALIDA PRODUCTO CONTROLADO POR TIPO DE CLIENTE
            if(UtilityPtoVenta.isLocalVentaMayorista()){
                if(!UtilityVentas.permiteVtaProdControlado(VariablesVentas.vCod_Prod, beanClientePedido)){
                    FarmaUtility.showMessage(this, "El producto no se puede vender por ser un producto controlado.",
                                             txtProducto);
                    return;
                }
            }
...
*/
    ...
    private void evaluaTitulo() {
        if (VariablesVentas.vEsPedidoDelivery) {
            ...
            // KMONCADA 25.01.2016 CLIENTE DE LOCAL M
            if(UtilityPtoVenta.isLocalVentaMayorista()){
                //KMONCADA 07.06.2016 [PROYECTO M] CAMBIO EN LA ELECCION DE CLIENTES
                lblCliente.setText(""); 
            ...
            this.setTitle("Lista de Productos y Precios" + " /  IP : " + FarmaVariables.vIpPc + " / " + FrmEconoFar.tituloBaseFrame);
        }
    }
     ...
     * @since 12.12.2006
     */
    private void muestraInfoProd2() throws Exception {
        ArrayList myArray = new ArrayList();
    ...
    private void muestraProductosSustitutos() {
        try {
            ...
            if (vFila >= 0) {
                ...
                DBVentas.cargaListaProductosSustitutos(tblModelListaSustitutos, codigoProducto, beanClientePedido);
                tblListaSustitutos.repaint();
            }
        } catch (SQLException sqlException) {
            log.error(null, sqlException);
   ...
   */
    ...
    private void mostrarTratamiento() {
        ...
        if(flagContinua){
            UtilityVentas.mostrarTratamiento(this,myParentFrame,myJTable,COL_COD,COL_ORIG_PROD);
...
//                    if (VariablesVentas.vEsPedidoConvenio) {
        ...
        if (VariablesFidelizacion.vDataCliente.size() > 0) {
          ...
          */
            ...
            //jcallo 02.10.2008
            String msjPto = "";
            if(VariablesPuntos.frmPuntos != null && VariablesPuntos.frmPuntos.getTarjetaBean() != null && VariablesPuntos.frmPuntos.getTarjetaBean().getPuntosTotalAcumulados()!=null){
                msjPto = FarmaUtility.formatNumber(VariablesPuntos.frmPuntos.getTarjetaBean().getPuntosTotalAcumulados())+" - ";
            }
            lblCliente.setText(msjPto + VariablesFidelizacion.vNomCliente + " " + VariablesFidelizacion.vApePatCliente + " " +
                               VariablesFidelizacion.vApeMatCliente);
...
*/
    ...
    public void funcionF12(String pCodCampanaCupon,boolean vTeclaF12, boolean isPasoTarjeta) {
        ...
        AuxiliarFidelizacion.funcionF12(pCodCampanaCupon, txtProducto, this.myParentFrame, lblMensajeCampaña,
                                        lblCliente, this, "L", lblDNI_SIN_COMISION,vTeclaF12, isPasoTarjeta, 
                                        false);
            ...
            if(zan.equals("")){
                ...
                if(bRetorno){                    
                    if(UtilityVentas.verificaCobertura(this)){
                        DlgProductosGarantizados dlgProductosGarantizados = new DlgProductosGarantizados(myParentFrame,"",true);
    ...
    public void mostrarFidelizacion(String pCodCampanaCupon, JTextField txtObj, Frame myFrame, JLabel lblObj,
        ...
        if (UtilityPtoVenta.isLocalVentaMayorista()){
            AuxiliarFidelizacion.funcionF12(pCodCampanaCupon, txtObj, myFrame, lblObj,
                                            lblCli, dlgObj, pTipo, lblDniSinComision,vTeclaF12, isPasoTarjeta, isTarjetaCampania);
        }
    }
    
    public void setClientePedido(BeanClienteJuridico beanClientePedido){
        this.beanClientePedido = beanClientePedido;
    }
}
