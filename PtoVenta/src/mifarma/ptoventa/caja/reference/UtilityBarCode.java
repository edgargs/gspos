...
public class UtilityBarCode {
    ...
    public static String generarBarcode(String codigo, int cantIntentosLectura) throws InvalidAtributeException {
        try {
            obtenerDirectorio();
        } catch (Exception e) {
            log.error("", e);
        ...
        JBarcode jbcode =
            new JBarcode(EAN13Encoder.getInstance(), WidthCodedPainter.getInstance(), EAN13TextPainter.getInstance());
   ...
   */
    ...
    public static String generarBarcodeCode39(String codigo) throws InvalidAtributeException {
        ...
        JBarcode jbcode =
            new JBarcode(Code39Encoder.getInstance(), WideRatioCodedPainter.getInstance(), BaseLineTextPainter.getInstance());
...

    {
        ...
        JBarcode jbcode =
            new JBarcode(Code128Encoder.getInstance(), WidthCodedPainter.getInstance(), BaseLineTextPainter.getInstance());
