...
public class UtilityPtoVenta {
    ...
    public ArrayList<ArrayList<String>> parsearResultadoMatriz(List<BeanResultado> listado){
    ...
    {   String codProdTemp = "";//cadena;
        ...
        {   if(cadena != null && cadena.length()>2)
            {   
                ...
                {   if(validarNumero(cadena.substring(2, 9)))
                        codProdTemp = cadena.substring(2, 9);
                    else
                        codProdTemp = cadena;
                }
