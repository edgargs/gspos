...
public class CodigoBarra {
    ...
    public String generarCodeBarra(String code, String type){
        ...
        if ( !b2d && (configuracion.get("addQuietZone")== 1 ? true : false) ) digit = digit + "0000000000";
        
        return digitosToCss(digit, hri);
    }
    
    private String eanGetDigito(String code, String type){
        String[][] encoding =    { { "0001101", "0100111", "1110010" }, 
        ...
        String[] first =        { "000000", "001011", "001101", "001110", "010011", 
    ...
    private String code39GetDigit(String code){
        String[] encoding = {   "101001101101", "110100101011", "101100101011", "110110010101",
    ...
    private String code128GetDigit(String code){
        ...
        String[] encoding = {   "11011001100", "11001101100", "11001100110", "10010011000",
        ...
        for(i=0; i<code.length(); i++){
          if (tableB.indexOf(code.charAt(i)) == -1) return null;
        }
    ...
    private String digitosToCssRender(char[] digit, String hri, int mw, int mh){
        ...
        String content = "<tr>";
        String bar0 = "<td style=\"float: left; font-size: 0px; background-color: " + configuracion.get("bgColor") + "; height: " + mh + "px; width: &Wpx\"></td>";    
        //String bar1 = "<td style=\"float: left; font-size: 0px; width: &Wpx; background: " + configuracion.get("color") + "; height: " + mh + "px;\"></td>";
        String bar1 = "<td style=\"float: left; font-size: 0px; width:0; border-left: &Wpx solid "+configuracion.get("color")+"; height: " + mh + "px;\"></td>";
