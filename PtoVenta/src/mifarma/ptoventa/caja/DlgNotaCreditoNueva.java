        ...
        * anulaOrbis
        ...
        if (validaDatos()) {
            ...
            if (estaGrabado) {
                ...
                //ERIOS 12.02.2016 Impresion de Notas de Creditos
                if(UtilityPtoVenta.isLocalVentaMayorista()){
                    for(String pNumPedVta : pListaPedidos){
                        VariablesCaja.vNumPedVta = pNumPedVta;
                        if (!UtilityCaja.validaAgrupacionComprobante(this, tblListaProductos)) {
                            return;
                        }
                        if (!UtilityCaja.existeImpresorasVenta(this, tblListaProductos))
                            return;
                        UtilityCaja.procesoImpresionComprobante(this, tblListaProductos, false, false);
                    }
                }
