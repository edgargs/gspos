...
private static final Logger log = LoggerFactory.getLogger(DlgMercaderiaDirectaProducto.class);
  ...
  private void jbInit() throws Exception {
    ...
    lblEnter.setBounds(new Rectangle(10, 370, 270, 20));
    ...
    lblEsc.setBounds(new Rectangle(605, 395, 85, 20));
    ...
    this.getContentPane().add(jContentPane, BorderLayout.CENTER);
        jPanelTitle2.add(jButtonLabel1, null);
  ...
  private void addRedondeo(){
    ...
    {
        String val1 = tableModel.getValueAt(tblListaProductos.getSelectedRow(),4).toString();
        int cantPed = Integer.parseInt(val1) + Integer.parseInt(VariablesInventario.vCantEntregada);
  ...
  private void cabeceraRecepcion(){
      ...
      arrayCab.add('0' + VariablesInventario.vIdeDocumento.trim());
