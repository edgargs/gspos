...
public class DlgMantTarjetaCliente extends JDialog {
    ...
    private void initTableListaTarjetasClientes() {
        tableModelListaTarjetasClientes =
                new FarmaTableModel(ConstantsCliente.columnsListaTarjetasClientes, ConstantsCliente.defaultValuesListaTarjetasClientes,
                                    0);
        FarmaUtility.initSimpleList(tblListadoTarjetas, tableModelListaTarjetasClientes,
                                    ConstantsCliente.columnsListaTarjetasClientes);
    }
    ...
    private void cargaTarjetasCliente() {
        try {
            ...
            FarmaUtility.ordenar(tblListadoTarjetas, tableModelListaTarjetasClientes, 0,
    ...
    private void chkKeyPressed(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_ESCAPE) {
            ...
            if (resultado.equalsIgnoreCase(ConstantsCliente.RESULTADO_GRABAR_CLIENTE_EXITO)) {
                ...
                FarmaUtility.showMessage(this, "Error al grabar la traejta del cliente", txtCodigoOperador);
            ...
            if (tblListadoTarjetas.getRowCount() > 0) {
                ...
                if (VariablesCliente.vTipo_Accion.equalsIgnoreCase(ConstantsCliente.ACCION_MODIFICAR)) {
                    ...
                    VariablesCliente.vCodigoOperA =
                            ((String)tblListadoTarjetas.getValueAt(tblListadoTarjetas.getSelectedRow(), 4)).trim();
    ...
    private String agregaTarjetaCliente() {
        ...
        try {
            resultado =
                    DBCliente.agragaTarjetaCliente(VariablesCliente.vCodigoOperN, VariablesCliente.vNumeroTarj, VariablesCliente.vFechaVencConc,
    ...
    private String actualizaTarjetaCliente() {
        ...
        try {
            resultado =
                    DBCliente.actualizaTarjetaCliente(VariablesCliente.vCodigo, VariablesCliente.vCodigoOperN, VariablesCliente.vCodigoOperA,
                                                      VariablesCliente.vFechaVencConc, VariablesCliente.vNumeroTarj,
