...
public class DlgListaProductos extends JDialog {
    ...
    private void initialize() {
        ...
        try {
            pnlPedDelivery.setVisible(DBVentas.getIndVerPedidoDelivery());
            lblPedDelivery.setVisible(DBVentas.getIndVerPedidoDelivery());
    ...
    private void initTableListaPreciosProductos() {
        tableModelListaPrecioProductos = 
                new FarmaTableModel(ConstantsVentas.columnsListaProductos, 
                                    ConstantsVentas.defaultValuesListaProductos, 
                                    0);
    ...
    public void iniciaProceso(boolean pInicializar) {
        ...
        for (int i = 0; 
             i < VariablesVentas.tableModelListaGlobalProductos.getRowCount(); 
             i++)
            VariablesVentas.tableModelListaGlobalProductos.setValueAt(new Boolean(false), 
                                                                      i, 0);
        ...
        log.debug("VariablesVentas.vArrayList_PedidoVenta : " + 
                  VariablesVentas.vArrayList_PedidoVenta.size());
    ...
    private void txtProducto_keyPressed(KeyEvent e) {
        ...
        try {
                    ...
                    try {
                        ...
                        if (!VariablesVentas.vProductoVirtual) {
                            ...
                            if (myJTable.getSelectedRow() >= 0) {
                                ...
                                char ultimokeyChar = 
                                    productoBuscar.charAt(productoBuscar.length() - 
                                                          1);
                                System.err.println("productoBuscar:" + 
                                                   productoBuscar);
                                ...
                                if ((actualCodigo.equalsIgnoreCase(productoBuscar) || 
                                    ...
                                    txtProducto.selectAll();
                                           ...
                                           DIG_PROD && 
                                           UtilityVentas.esCupon(productoBuscar, 
                                                                 this, 
                                                                 txtProducto)) {
                                    System.out.println("productoBuscar.trim().length() " + 
            ...
            System.out.println("catch" + vEjecutaAccionTeclaListado);
        } finally {
            vEjecutaAccionTeclaListado = false;
        }

        System.err.println("Fin Enter:" + pasoTarjeta);
    }
    ...
    private void chkKeyPressed(KeyEvent e) {
        ...
        try {
          ...
          {
            if(FarmaUtility.rptaConfirmDialog(this,"¿Está seguro que desea iniciar una venta institucional?"))
            {
          ...
          else
          {
            ...
            if(VariablesVentas.vEsPedidoConvenio)generarPedidoConvenio();
                    ...
                    if (VariablesPtoVenta.vIndVerStockLocales.trim().equalsIgnoreCase(FarmaConstants.INDICADOR_S)) {
                        ...
                        */
                        ...
                        FarmaUtility.showMessage(this, 
                                                 "El local no puede usar esta opción.\nGracias.", 
                                                 null);
                    }
            ...
            vEjecutaAccionTeclaListado = false;
            System.out.println(" finally: " + vEjecutaAccionTeclaListado);
    ...
    private void muestraInfoProd() {
        ...
        if (myArray.size() == 1) {
            ...
            //System.err.println("DLGLISTAPRODUCTOS : porcDscto_1 - " + porcDscto_1);
        ...
        System.err.println("DLGLISTAPRODUCTOS : VariablesVentas.vPorc_Dcto_1 - " + 
                           porcDscto_1);
        myJTable.repaint();
    }
    ...
    private void muestraIngresoCantidad() {
        ...
        try {
            ...
            System.out.println("vAceptar2 : " + FarmaVariables.vAceptar);
            System.out.println("vCod_Prod: " + VariablesVentas.vCod_Prod);
            if (DBVentas.getIndCodBarra(VariablesVentas.vCod_Prod).equalsIgnoreCase("S") && 
                FarmaVariables.vAceptar && VariablesVentas.vIndEsCodBarra) {
                ...
                System.out.println("COD_BArra, flagcontinua: " + flagContinua);
            }
            ...
            if (!vMensajeProd.equalsIgnoreCase("N") && 
                ...
                //flagContinua = FarmaUtility.rptaConfirmDialogDefaultNo(this,sMensaje);
            ...
            // Valida ID Usuario 
            String pInd = 
                DBVentas.getIndSolIdUsu(VariablesVentas.vCod_Prod).trim().toUpperCase();
            ...
            if (pInd.equalsIgnoreCase("S") && FarmaVariables.vAceptar) {
                ...
                FarmaVariables.vAceptar = flagContinua;
                System.out.println("SolId. flagContinua: " + flagContinua);
                /*if (!flagContinua){
             } */
            } else {
                if (pInd.equalsIgnoreCase("J") && FarmaVariables.vAceptar) {
                    System.out.println("*** Valida Producto Venta Cero");
                    //llamar a Usuario para visualizar 
                    flagContinua = validaLoginQF();
                    FarmaVariables.vAceptar = flagContinua;
                    System.out.println("SolId. flagContinua : " + 
                                       flagContinua);
                    /*if (!flagContinua){
                 } */
                }
    ...
    private void calculaTotalVentaPedido() {
        ...
        for (int i = 0; 
             ...
             i++) {
            aux = 
(ArrayList)VariablesVentas.vArrayList_Prod_Promociones_temporal.get(i);
            //System.out.println(FarmaUtility.getDecimalNumber(""+aux.get(6))+"");
...
(ArrayList)VariablesVentas.vArrayList_Prod_Promociones.get(i);
    ...
    private void verificaCheckJTable() {
        ...
        if (valor.booleanValue()) {
            if (!buscar(VariablesVentas.vArrayList_Prod_Promociones, codigo) && 
                !buscar(VariablesVentas.vArrayList_Prod_Promociones_temporal, 
                        codigo)) {
            ...
            log.debug("VariablesVentas.vIndPedConProdVirtual " + 
            ...
            if (VariablesVentas.vIndProdVirtual.equalsIgnoreCase(FarmaConstants.INDICADOR_S) || 
                ...
                if (VariablesVentas.vArrayList_PedidoVenta.size() > 0 || 
                    ...
                    VariablesVentas.vArrayList_Prod_Promociones_temporal.size() > 
                    0 || VariablesVentas.vArrayList_Promociones.size() > 0 || 
                    VariablesVentas.vArrayList_Promociones_temporal.size() > 
                    0) {
    ...
    private void deseleccionaProducto() {
        ...
        for (int i = 0; i < VariablesVentas.vArrayList_PedidoVenta.size(); 
             i++) {
            codigoTmp = 
                    (String)((ArrayList)VariablesVentas.vArrayList_PedidoVenta.get(i)).get(0);
    ...
    private void cancelaOperacion() {
        ...
        for (int i = 0; i < VariablesVentas.vArrayList_PedidoVenta.size(); 
            ...
            for (int j = 0; 
                ...
                codProdTmp = 
                        (String)(((ArrayList)VariablesVentas.vArrayList_ResumenPedido.get(j)).get(0));
        ...
        for (int i = 0; i < VariablesVentas.vArrayList_ResumenPedido.size(); 
             i++) {
            codProd = 
                    (String)(((ArrayList)VariablesVentas.vArrayList_ResumenPedido.get(i)).get(0));
            VariablesVentas.vVal_Frac = 
                    FarmaUtility.getValueFieldArrayList(VariablesVentas.vArrayList_ResumenPedido, 
                                                        i, 10);
            String cantidad = 
                (String)(((ArrayList)VariablesVentas.vArrayList_ResumenPedido.get(i)).get(4));
            ...
            for (int j = 0; j < VariablesVentas.vArrayList_PedidoVenta.size(); 
                 j++) {
                codProdTmp = 
                        (String)(((ArrayList)VariablesVentas.vArrayList_PedidoVenta.get(j)).get(0));

                if (codProd.equalsIgnoreCase(codProdTmp)) {
                    existe = true;
                    cantidadTmp = 
                            (String)(((ArrayList)VariablesVentas.vArrayList_PedidoVenta.get(j)).get(4));
                    break;
                }
            }
            System.out.println(existe);
    ...
    private void aceptaOperacion() {
        System.err.println("ENTRO A ACEPTAR OPERACION");
        vEjecutaAccionTeclaListado = false;
    ...
    private void cargaListaFiltro() {
        ...
        if (VariablesVentas.vCodFiltro.equalsIgnoreCase("")) {
            ...
            log.debug("VariablesPtoVenta.vTipoFiltro  : " + 
      ...
      if(!VariablesVentas.vCodFiltro_temp.equalsIgnoreCase("")){
        ...
        if (FarmaVariables.vAceptar) {
            ...
            setJTable(tblProductos);
            //iniciaProceso(false);
            FarmaUtility.ponerCheckJTable(tblProductos, COL_COD, 
    ...
    private void filtrarTablaProductos(String pTipoFiltro, String pCodFiltro) {
        try {
            ...
            DBVentas.cargaListaProductosVenta_Filtro(tableModelListaPrecioProductos, 
    ...
    private void muestraProductosAlternativos() {
        ...
        if (FarmaVariables.vAceptar) {
            VariablesVentas.vIndDireccionarResumenPed = true;
            aceptaOperacion();
            /*System.out.println("Se refresca el listado temporal");
      FarmaVariables.vAceptar = false;
    ...
    private void pintaCheckOtroJTable(JTable pActualJTable, Boolean pValor) {
        //System.out.println(pValor.booleanValue());
        if (pActualJTable.getName().equalsIgnoreCase(ConstantsVentas.NAME_TABLA_PRODUCTOS)) {
            FarmaUtility.setearCheckInRow(tblListaSustitutos, pValor, true, 
                                          true, VariablesVentas.vCod_Prod, 
                                          COL_COD);
            tblListaSustitutos.repaint();
        } else if (pActualJTable.getName().equalsIgnoreCase(ConstantsVentas.NAME_TABLA_SUSTITUTOS)) {
            FarmaUtility.setearCheckInRow(tblProductos, pValor, true, true, 
                                          VariablesVentas.vCod_Prod, COL_COD);
    ...
    private void muestraProductosComplementarios() {
        ...
        VariablesVentas.vCodProdOrigen_Comple = 
                FarmaUtility.getValueFieldJTable(myJTable, vFila, COL_COD);
        VariablesVentas.vDescProdOrigen_Comple = 
                ((String)(myJTable.getValueAt(vFila, 2))).trim();
        ...
        if (FarmaVariables.vAceptar) {
            log.debug("VariablesVentas.vCodProdComplementario : " + 
                      VariablesVentas.vCodProdComplementario);
            btnRelacionProductos.doClick();
    ...
    private void cargarReceta() {
        if (VariablesReceta.vArrayList_ResumenReceta.size() <= 0) {
            ...
            ArrayList arrayRow;
            for (int i = 0; 
                 i < VariablesReceta.vArrayList_ResumenReceta.size(); i++) {
                try {
                    arrayRow = 
                            (ArrayList)VariablesReceta.vArrayList_ResumenReceta.get(i);
    ...
    private void muestraInfoProd2() throws SQLException {
        ...
        DBVentas.obtieneInfoDetalleProducto(myArray, 
                                            VariablesVentas.vCod_Prod);
        if (myArray.size() == 1) {
    ...
    private void obtieneStockProducto2() throws SQLException {
        ...
        ArrayList myArray = new ArrayList();
        DBVentas.obtieneStockProducto_ForUpdate(myArray, 
                                                VariablesVentas.vCod_Prod, 
                                                VariablesVentas.vVal_Frac);
        FarmaUtility.liberarTransaccion();
    ...
    private void seleccionaProducto2() {
        ...
        if ( /*!UtilityVentas.actualizaStkComprometidoProd(VariablesVentas.vCod_Prod,
            ...
            !UtilityVentas.operaStkCompProdResp(VariablesVentas.vCod_Prod,
                ...
                ConstantsVentas.INDICADOR_A, 
                ConstantsPtoVenta.TIP_OPERACION_RESPALDO_SUMAR, 
                Integer.parseInt(VariablesVentas.vCant_Ingresada), true, this, 
                txtProducto, ""))
            return;
            ...
            if (cantidad_ingresada != 0) {
                ...
                String valorTarj = 
                    FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber(VariablesVentas.vVal_Prec_Vta), 
                                              2);
                FarmaUtility.showMessage(this, 
                                         "Se ha seleccionado una tarjeta virtual " + 
                                         VariablesVentas.vDesc_Prod + 
    ...
    private void muestraIngresoTelefonoMonto() {
        ...
        if (FarmaVariables.vAceptar) {
            ...
            seleccionaProducto();
            System.out.println("VariablesVentas.secRespStkAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA: " + 
        ...
        if (myJTable.getRowCount() > 0) {
            ...
            if (indProdProm.equalsIgnoreCase(FarmaConstants.INDICADOR_S)) {
                ...
                if (myJTable.getName().equalsIgnoreCase(ConstantsVentas.NAME_TABLA_PRODUCTOS)) {
                    ...
                    try {
                        descripcion = 
                                DBVentas.getDescPaquete(VariablesVentas.vCodProdFiltro);
            ...
            if (VariablesVentas.vIndAplicaRedondeo.equalsIgnoreCase("S")) {
                for (int i = 0; 
                    ...
                    try {
                        ...
                        double pAux5;
                        pAux2 = 
                                UtilityVentas.Redondear(precioVentaUnitRedondeado, 
                                                        2);
                        ...
                        ((ArrayList)VariablesVentas.vArrayList_Prod_Promociones.get(i)).set(3, 
    ...
    private void seleccionaProductoPromocion() {
        ...
        FarmaUtility.ponerCheckJTable(myJTable, 1, 
                                      VariablesVentas.vArrayList_Prod_Promociones_temporal, 
                                      0);
        String cod_prod_tem = "";
        for (int i = 0; 
    ...
    private void cancela_promociones() {
        ...
        //System.out.println("");
        log.debug("!!!!>Promociona antes de Elimin " + 
                  VariablesVentas.vArrayList_Promociones_temporal.size());
        log.debug("!!!!Promociona eli " + 
                  VariablesVentas.vArrayList_Promociones_temporal);

        for (int j = 0; 
             j < VariablesVentas.vArrayList_Promociones_temporal.size(); j++) {
            array_promocion = 
                    (ArrayList)(VariablesVentas.vArrayList_Promociones_temporal.get(j));
            ...
            log.debug(">>>>**Detalles " + 
                      VariablesVentas.vArrayList_Prod_Promociones_temporal);
            prod_Prom = 
                    detalle_Prom(VariablesVentas.vArrayList_Prod_Promociones_temporal, 
                                 codProm);
...
(ArrayList)(agrupado.get(i)); //VariablesVentas.vArrayList_Prod_Promociones.get(i));
        ...
        log.debug("Tamaño de Resumen   :" + 
                  VariablesVentas.vArrayList_ResumenPedido.size() + "");
        log.debug("Tamaño de Promocion :" + 
                  VariablesVentas.vArrayList_Promociones_temporal.size() + "");
        log.debug("Tamaño de Prod_Promocion :" + 
                  VariablesVentas.vArrayList_Prod_Promociones_temporal.size() + 
                  "");
...
(ArrayList)(VariablesVentas.vArrayList_Prod_Promociones_temporal.get(i));
    ...
    private void cargaStockLocales() {
        ...
        DlgStockLocales dlgStockLocales = 
            new DlgStockLocales(myParentFrame, "", true);
        ...
        try {
            ...
            if (vFila >= 0) {
                String codigoProducto = 
                    FarmaUtility.getValueFieldJTable(myJTable, vFila, COL_COD);
                DBVentas.cargaListaProductosSustitutos(tblModelListaSustitutos, 
                                                       codigoProducto);
                tblListaSustitutos.repaint();
            }
        } catch (SQLException sqlException) {
   ...
   */
    ...
    private void clonarListadoProductos() {
        ...
        for (int i = 0; 
             i < VariablesVentas.tableModelListaGlobalProductos.data.size(); 
             i++) {
            ArrayList aux = 
                (ArrayList)((ArrayList)VariablesVentas.tableModelListaGlobalProductos.data.get(i)).clone();
            arrayClone.add(aux);
        }
    ...
    private void validarAgregarCupon(String nroCupon) {
        ...
        System.out.println("CAMP CUPON:: codCampCupon " + codCampCupon);
        String vIndFidCupon = 
        ...
        if (vIndFidCupon.trim().equalsIgnoreCase("S")) {
            ...
            if (VariablesFidelizacion.vDniCliente.trim().length() > 0) {
                ...
                if (!UtilityVentas.validarCuponEnBD(nroCupon, this, 
            ...
            if (!UtilityVentas.validarCuponEnBD(nroCupon, this, txtProducto, 
                                                indMultiuso, 
                                                VariablesFidelizacion.vDniCliente)) {
                return;
            } else {
    ...
    private void agregarCupon(String cadena) {
        ...
        if (UtilityVentas.validaCampanaCupon(cadena, this, txtProducto, 
                                             ind_multiuso, cod_camp))
            return;

        //Valida estructura del cupon en BBDD
        if (!UtilityVentas.validaDatoCupon(cadena, this, txtProducto, 
                                           ind_multiuso))
            return;
...
*/
    ...
    private boolean isExisteProdCampana(String pCodProd) {
        ...
        try {
            lblMensajeCampaña.setText("");
            pRespta = 
                    DBVentas.existeProdEnCampañaAcumulada(pCodProd, VariablesFidelizacion.vDniCliente);
...
*/
    ...
    private boolean ValidaRolUsu(String vRol) {
        ...
        try {
            result = 
                    DBVentas.verificaRolUsuario(FarmaVariables.vNuSecUsu, vRol);
    ...
    private void lblPedDelivery_actionPerformed(ActionEvent e) {
        ...
        if (VariablesVentas.HabilitarF9.equalsIgnoreCase(ConstantsVentas.ACTIVO)) {
            if (UtilityVentas.evaluaPedidoDelivery(this, txtProducto, 
                                                   VariablesVentas.vArrayList_PedidoVenta)) {
                evaluaTitulo();
                FarmaUtility.moveFocus(txtProducto);
                // Inicio Adicion Delivery 28/04/2006 Paulo
    ...
    private boolean validaLoginVendedor() {
        ...
        String apematusu = FarmaVariables.vMatUsu;
        boolean flag = false;
        System.out.println("numsec: " + numsec);
        try {
            DlgLogin dlgLogin = 
                new DlgLogin(myParentFrame, ConstantsPtoVenta.MENSAJE_LOGIN, 
                             true);
            //dlgLogin.setRolUsuario(FarmaConstants.ROL_ADMLOCAL);  
            dlgLogin.setVisible(true);
            System.out.println("FarnaVariables.NumSec: " + 
                               FarmaVariables.vNuSecUsu);
            if (FarmaVariables.vAceptar) {
                if (numsec.equalsIgnoreCase(FarmaVariables.vNuSecUsu)) {
                    System.out.println("numsec 2: " + numsec);
                    flag = true;
                } else {
                    FarmaUtility.showMessage(this, 
