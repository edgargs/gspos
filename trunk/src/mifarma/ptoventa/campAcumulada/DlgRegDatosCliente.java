...
public class DlgRegDatosCliente extends JDialog {
    ...
    private void initialize() {
        ...
        try {
            ...
            FarmaUtility.showMessage(this,
                                     "Error al obtener Parametro de Doc validos !",
                                     tblLista);
        }
    ...
    private void initTable() {
        ...
        tableModel =
                new FarmaTableModel(ConstantsCampAcumulada.columnsListaDatosClienteCampAcumulada,
                                    ConstantsCampAcumulada.defaultValuesListaDatosClienteCampAcumulada,
                                    0,
                                    ConstantsCampAcumulada.editableListaDatosClienteCampAcumulada,
                                    null);
                ...
                public void keyPressed(KeyEvent e) {
                    if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                        ...
                        if (pCodigoCampoAux.trim().equalsIgnoreCase(ConstantsCampAcumulada.DNI_CLIENTE)) {
                            ...
                            //System.err.println("entrando a buscar datos de cliente por dni");
                            if (UtilityCampAcumulada.validarDocIndentificacion(pCadena,
                                ...
                                JOptionPane.showMessageDialog(null,
                                                              "Doc de Identificacion no valido !",
                                                              "Mensaje del Sistema",
                                                              JOptionPane.WARNING_MESSAGE);
                                return;
                            }
                            //System.err.println("moviendo el cursor al siguiente texto o comnbo"+vFila);
                            ...
                            if ((vFila + 1) == tblLista.getRowCount()) {
                                //System.err.println("move focus : 0 ");
                                moveFocusTo(0);
                            } else {
                                //System.err.println("move focus : "+(vFila+1));
                                moveFocusTo(vFila + 1);
                            }
    ...
    private void moveFocusTo(int pRow) {
        ...
        System.out.println("CAMPO " + cod_campo + " - " +
                           ConstantsCampAcumulada.DNI_CLIENTE);
    ...
    public void txtFechaNacimiento_keyTyped(KeyEvent e) {
        //System.err.println("TIPEOOOOOOOOOO EN FECHA DE NACIEMIENTO");
    ...
    private void funcionF11() {
        ...
        if (txtNumeroDocumento.isEditable()) {
            System.err.println("VALIDANDO QUE DATOS YA QUE PUDO HABER CAMBIADO EL DNI EL USUARIO");
        ...
        if (validateMandatory()) { //validando todos los datos obligatorios
            ...
            try {
                ...
                e.printStackTrace();
                FarmaUtility.showMessage(this, "ERROR:" + e,
                                         txtNumeroDocumento);
            }
        }
    ...
    private void buscaMatrizActualizaDatosLocal(String pDni) {
        ...
        try {
            ...
            DBCampAcumulada.getDatosExisteDNI_Matriz(array, pDni,
                                             FarmaConstants.INDICADOR_N);
            System.out.println("Datos Cli en Matriz " + array);
            System.out.println("Tam size:" + array.size());
        ...
        if (UtilityCampAcumulada.validarDocIndentificacion(pDNI.trim(),
            ...
            try {
                ...
                if (vListaDatosDNI.size() > 0) { //si hay datos de cliente
                    ...
                    //System.out.println("vListaCampos " + vListaCampos);
                    //System.out.println("vListaDatosDNI " + vListaDatosDNI);
                    ...
                    if (!vSexCli.equalsIgnoreCase("N")) {
                        ...
                        if (pos >= 0) {
                            FarmaLoadCVL.setSelectedValueInComboBox(cmbSexo,
                                                                    "CMB_SEXO",
                                                                    vSexCli);
                            tblLista.setValueAt(FarmaLoadCVL.getCVLDescription("CMB_SEXO",
                                                                               vSexCli),
                                                pos, 1);
    ...
    private boolean validateMandatory() {
        ...
        for (int i = 0; i < tblLista.getRowCount(); i++) {
            vIndObligatorio =
                    tableModel.getValueAt(i, COL_IND_OBLI).toString().trim();
            if (vIndObligatorio.equalsIgnoreCase("S")) {
                vCodCampo =
                        tableModel.getValueAt(i, COL_COD).toString().trim();
    ...
    private void cargaVariables() {
        ...
        //System.err.println("dni"+txtNumeroDocumento.getText().trim());
        //System.err.println("apepat"+txtApellidoPaterno.getText().trim());
    ...
    private String getSexoCliente() {
        String tipoSexo;
        try {
            //System.err.println("indice del combo : "+cmbSexo.getSelectedIndex());
            tipoSexo =
        ...
        //System.err.println("sexo del cliente : "+tipoSexo);
