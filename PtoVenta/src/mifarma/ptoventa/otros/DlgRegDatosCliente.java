...
public class DlgRegDatosCliente extends JDialog {
    ...
    private void initTable() {
        ...
        tableModel =
                new FarmaTableModel(ConstantsOtros.columnsListaDatosClienteMedPresion, ConstantsOtros.defaultValuesListaDatosClienteMedPresion,
                                    0, ConstantsOtros.editableListaDatosClienteMedPresion, null);
        ...
        for (int k = 0; k < tableModel.getColumnCount(); k++) {
            TableColumn column = new TableColumn(k, ConstantsOtros.columnsListaDatosClienteMedPresion[k].m_width);
    ...
    public boolean validaDocumento() {
        ...
        try {
            ...
            pValor = DBOtros.isValidaDocumento(VariablesOtros.vDniCliente_bk, VariablesOtros.vFecNacimiento_bk);
