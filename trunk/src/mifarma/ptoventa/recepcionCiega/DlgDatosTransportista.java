 ...
 *
 */
public class DlgDatosTransportista
  extends JDialog
{
  /* ********************************************************************** */
  ...
  private void chkKeyPressed(KeyEvent e)
  {
    if (e.getKeyCode() == KeyEvent.VK_F11)
    {
      ...
      if (datosValidados())
      {
        if (FarmaUtility.rptaConfirmDialog(this, "Está seguro que desea grabar el transportista ?"))
        {
  ...
  private void getDatosTransportista(){
    ...
    System.err.println("Fecha Hora :"+FechaInicio+" "+txtHora.getText().trim());
        try {
            VariablesRecepCiega.vHoraTrans = 
                    FarmaSearch.getFechaHoraBD(FarmaConstants.FORMATO_FECHA) + " "+
                    FarmaSearch.getFechaHoraBD(FarmaConstants.FORMATO_HORA);
    ...
    System.err.println("Fecha Hora DU:"+VariablesRecepCiega.vHoraTrans);
    ...
    System.out.println("VariablesRecepCiega.vNombreTrans "+VariablesRecepCiega.vNombreTrans);
    System.out.println("VariablesRecepCiega.vHoraTrans "+VariablesRecepCiega.vHoraTrans);
    System.out.println("VariablesRecepCiega.vPlacaUnidTrans "+VariablesRecepCiega.vPlacaUnidTrans);
    System.out.println("VariablesRecepCiega.vCantBultos "+VariablesRecepCiega.vCantBultos);
    System.out.println("VariablesRecepCiega.vCantPrecintos "+VariablesRecepCiega.vCantPrecintos);
      ...
      private void cargaLogin()
      {
        ...
        if ( FarmaVariables.vAceptar ) {
            ...
            if(!FarmaVariables.vNuSecUsu.equalsIgnoreCase(VariablesRecepCiega.vNuSecUsu)){
                FarmaUtility.showMessage(this, "El usuario no es el mismo al logueado anteriormente. Verificar!!!", txtNombre);
                cerrarVentana(false);
            }
