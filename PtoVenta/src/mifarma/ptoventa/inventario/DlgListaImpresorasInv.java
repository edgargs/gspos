...
public class DlgListaImpresorasInv extends JDialog {
    ...
    private void initTableImpresoras() {
        tableModelImpresoras =
                new FarmaTableModel(ConstantsInventario.columnsListaImpresoras, ConstantsInventario.defaultValuesListaImpresoras,
                                    0);
        FarmaUtility.initSimpleList(tblListaImpresoras, tableModelImpresoras,
                                    ConstantsInventario.columnsListaImpresoras);
