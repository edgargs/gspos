...
/*          --MODIFICADO X EMAQUERA 10/06/2014
               ...
               A.VAL_FRAC_LOCAL                                            || 'Ã' ||
               NVL(TRIM(TO_CHAR(B.MIN_EXHIB_FIJO ,'999990')),0)            || 'Ã' ||
               NVL(TRIM(TO_CHAR(B.STK_TRANSITO ,'999990')),0)              || 'Ã' ||
               NVL(TO_CHAR(PEDIDO.CANT_SUGERIDA,'999990'),0)               || 'Ã' ||
               NVL(TRIM(TO_CHAR(B.UND_VTA_MES_0, '999990.00')),0)          || 'Ã' ||
               NVL(TRIM(TO_CHAR(B.UND_VTA_MES_1, '999990.00')),0)          || 'Ã' ||
               NVL(TRIM(TO_CHAR(B.UND_VTA_MES_2, '999990.00')),0)          || 'Ã' ||
