...
public class DlgVentasResumenPorDia extends JDialog 
{
  ...
  {
    this.setSize(new Dimension(759, 448));
    ...
    pnlCriterioBusqueda.setBounds(new Rectangle(10, 15, 735, 30));
    ...
    pnlTitulo.setBounds(new Rectangle(10, 55, 735, 20));
    lbllocal.setText("xxx");
    lbllocal.setBounds(new Rectangle(525, 0, 100, 20));
    ...
    jScrollPane1.setBounds(new Rectangle(10, 75, 735, 275));
    tblVentasPorDIa.addKeyListener(new KeyAdapter()
      {
        public void keyReleased(KeyEvent e)
        {
          tblVentasPorDIa_keyReleased(e);
        }
      });
    jLabelFunction1.setBounds(new Rectangle(10, 390, 117, 19));
    jLabelFunction1.setText("[ F8 ] Ordenar");
    jLabelFunction3.setBounds(new Rectangle(625, 390, 117, 19));
    jLabelFunction3.setText("[ ESC ] Salir");
    jLabelFunction4.setBounds(new Rectangle(500, 390, 117, 19));
    jLabelFunction4.setText("[ F11 ] Imprimir");
    pnlResultados.setBounds(new Rectangle(10, 350, 735, 20));
  ...
  {
    tableModelVentasPorDia = new FarmaTableModel(ConstantsReporte.columnsListaVentasPorDia,ConstantsReporte.defaultValuesListaVentasPorDia,0);
    FarmaUtility.initSimpleList(tblVentasPorDIa,tableModelVentasPorDia,ConstantsReporte.columnsListaVentasPorDia);
  }
  ...
  private void cargaVentasporDia()
  {
    try
    {
      System.out.println(VariablesReporte.vFechaInicio);
      System.out.println(VariablesReporte.vFechaFin);
  ...
  private void imprimir() {
		...
		try {
			...
			vPrint.printBold(FarmaPRNUtility.llenarBlancos(40)
					+ " REPORTE DE VENTAS POR DIA", true);
      ...
      vPrint
			...
			vPrint
					.printBold(
							"Fecha       #Pedido  Bol.Inicial  Fac.Inicial  No.Bol   No.Fact  No.Bol.Anul  No.Fact.Anu        Total",
							true);
			vPrint
					.printLine( 
							"======================================================================================================",
			...
			for (int i = 0; i < tblVentasPorDIa.getRowCount(); i++) {
				    vPrint.printCondensed(FarmaPRNUtility.alinearIzquierda((String) tblVentasPorDIa.getValueAt(i, 0), 10)+"  "+ 
            FarmaPRNUtility.alinearDerecha((String) tblVentasPorDIa.getValueAt(i,1), 7)+"  "+
            FarmaPRNUtility.alinearIzquierda((String) tblVentasPorDIa.getValueAt(i,2), 10)+"   "+
            FarmaPRNUtility.alinearIzquierda((String) tblVentasPorDIa.getValueAt(i,3), 10)+"   "+
            FarmaPRNUtility.alinearDerecha((String) tblVentasPorDIa.getValueAt(i,4), 6)+"   "+
            FarmaPRNUtility.alinearDerecha((String) tblVentasPorDIa.getValueAt(i,5), 7)+"  "+
            FarmaPRNUtility.alinearDerecha((String) tblVentasPorDIa.getValueAt(i,6), 11)+"  "+
            FarmaPRNUtility.alinearDerecha((String) tblVentasPorDIa.getValueAt(i,7), 11)+
            FarmaPRNUtility.alinearDerecha((String) tblVentasPorDIa.getValueAt(i,8), 13),true);
			...
			vPrint.printBold("Registros Impresos: "
					+ FarmaUtility.formatNumber(tblVentasPorDIa
							.getRowCount(), ",##0"), false);
