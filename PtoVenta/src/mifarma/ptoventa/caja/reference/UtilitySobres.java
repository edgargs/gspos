...
public class UtilitySobres {
      ...
      if(pTipoAccion.toUpperCase().trim().equalsIgnoreCase(ConstantsSobres.ACC_INGRESO)){
       ...
       if (pDefinido) {
             ...
             if(pNuevo){
                 ...
                 if(com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(pDialogo,"¿Esta seguro de "+pMensaje+" sobre?")){
    ...
    public static String eliminarSobre(String codSobre){
        ...
        if (indConexionTico.equals("S"))
        {
          ...
          indelim  = 
                DBCajaElectronica.eliminarSobresTICO(FarmaConstants.INDICADOR_S,codSobre,cFecVta);
     ...
     */
    public static void insertCierreDiaMarket(String fecCierre,
                                             String usuLogin ){
        FacadeRecaudacion facadeRecaudacion = new FacadeRecaudacion();
        String indConexionTico = "N";
        try {
            ...
            if (indConexionTico.equals("S"))
             {            
                 DBCajaElectronica.insertCierreDiaMarket(FarmaConstants.INDICADOR_S,
                                                         fecCierre,usuLogin);
    ...
    public static void traerSobresTico(){
        ...
        ArrayList pListaSobres =  new ArrayList();
            ...
            try {
                    ...
                    FarmaVariables.vIpServidorTico    
                                        = ((String) ((ArrayList) localMarket.get(i)).get(1)).trim();     
                
                    indConexionTico = (facadeRecaudacion.validarConexionTICO()) ? "S" : "N";
                
                    if (indConexionTico.equals("S"))
                     {         
                    DBCajaElectronica.obtieneSobreTicoPendiente(FarmaConstants.INDICADOR_S,
                                                                pListaSobres,cCodLocal);
    ...
    public static void updateRemitoTico(ArrayList pLista,
                                        String remito,
                                        String precinto){
        FacadeRecaudacion facadeRecaudacion = new FacadeRecaudacion();
        String indConexionTico = "N";
        try {
            ...
            {            
                 ...
                 {  
                     String cCodLocal    = ((String) ((ArrayList) localMarket.get(i)).get(0)).trim();         
                 DBCajaElectronica.updateSobresTico(FarmaConstants.INDICADOR_S,pLista,
                                                    remito,precinto, cCodLocal);  
                 }
                 FarmaUtility.aceptarTransaccion();
             }
        } catch (Exception e) {
