...
public class UtilityRecargaVirtual {
    ...
    private static BeanConexion conexionGTX;
    private static String strIndGestorTx = "N";
    ...
    public void gestionaSolicitudRecargaWS(final String pTelefono, final String pProveedor, final String pMonto, final String pTerminal,
        ...
        try{
            ...
            FarmaVentaCnxUtility.enviaCorreoPorCnx(FarmaVariables.vCodGrupoCia, FarmaVariables.vCodLocal,
                                      VariablesPtoVenta.vDestEmailErrorCobro, "Error de ingresaSolicitudDeRecargaWS",
    ...
    public void gestionaSolAnulRecargaWS(final String pTelefono, final String pProveedor, final String pMonto, final String pTerminal,
        ...
        try{
            ...
            String sysdate = obtieneHora();
            FarmaVentaCnxUtility.enviaCorreoPorCnx(FarmaVariables.vCodGrupoCia, FarmaVariables.vCodLocal,
                                      VariablesPtoVenta.vDestEmailErrorCobro, "Error de gestionaSolAnulRecargaWS",
    ...
    public RespuestaTXBean respuestaSolicitudRecargaWS(String pCodGrupoCia, String pCodLocal, String pNumPedVta) {
        ...
        try {
            ...
            String sysdate = obtieneHora();
            FarmaVentaCnxUtility.enviaCorreoPorCnx(FarmaVariables.vCodGrupoCia, FarmaVariables.vCodLocal,
                                      VariablesPtoVenta.vDestEmailErrorCobro, "Error de respuestaSolicitudRecargaWS",
    ...
    public String obtieneMensajeRecargaWS(String pNumPedVta, String fechaPedido) {
        ...
        try {
            ...
            String sysdate = obtieneHora();
            FarmaVentaCnxUtility.enviaCorreoPorCnx(FarmaVariables.vCodGrupoCia, FarmaVariables.vCodLocal,
                                      VariablesPtoVenta.vDestEmailErrorCobro, "Error de obtieneMensajeRecargaWS",
    ...
    public String getMensajeRPTRecargaPedidoWS(String pNumPedVta, String fechaPedido) {
        ...
        try {
            ...
            String sysdate = obtieneHora();
            FarmaVentaCnxUtility.enviaCorreoPorCnx(FarmaVariables.vCodGrupoCia, FarmaVariables.vCodLocal,
                                      VariablesPtoVenta.vDestEmailErrorCobro, "Error de getMensajeRPTRecargaPedidoWS",
    ...
    public boolean getIsRecargaAnuladaWS(String pCodGrupoCia, String pCodLocal, String pNumPedVta, String pCodTrassc){
        ...
        try{
            ...
            String sysdate = obtieneHora();
            FarmaVentaCnxUtility.enviaCorreoPorCnx(FarmaVariables.vCodGrupoCia, FarmaVariables.vCodLocal,
                                      VariablesPtoVenta.vDestEmailErrorCobro, "Error de getIsRecargaAnuladaWS",
     ...
     * @return
     */
    public String getIndGestorTx(boolean pForzarConsulta) {
        //ERIOS 16.09.2015 Para buscar en BBDD
        if(pForzarConsulta){
            try {
                strIndGestorTx = DBPtoVenta.getIndGestorTx();
            } catch (SQLException err) {
                log.error("", err);
                strIndGestorTx = "N";
            }
        }
        return strIndGestorTx;
    }
    
    public String getIndGestorTx() {
    ...
    public void cargarUsuarioRemotoGTX() {
        ...
        try {
            ...
            conexionGTX = facade.setBeanConexion(facade.getCnxRemotoGTX());
    ...
    public void marcaRespuestaRecargaWS(String pCodGrupoCia, String pCodCia, String pCodLocal, String pNumPedVta ){
        try{
            ...
            String sysdate = obtieneHora();
            FarmaVentaCnxUtility.enviaCorreoPorCnx(FarmaVariables.vCodGrupoCia, FarmaVariables.vCodLocal,
                                      VariablesPtoVenta.vDestEmailErrorCobro, "Error de marcaRespuestaRecargaWS",
