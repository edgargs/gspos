...
public class DBInventario 
{
  ...
  public static String agregarCabeceraGuiaIngreso(String fechaGuia, String tipDoc, String numDoc, String tipOrigen, String codOrigen, String cantItems, String valTotal, String nomTienda, String ciudadTienda, String rucTienda) throws SQLException
  {
    parametros = new ArrayList();
    parametros.add(FarmaVariables.vCodGrupoCia);
    parametros.add(FarmaVariables.vCodLocal);
  ...
  String fecVcto, String numLote, String pValFrac) throws SQLException
  {
    parametros = new ArrayList();
    parametros.add(FarmaVariables.vCodGrupoCia);
    parametros.add(FarmaVariables.vCodLocal);
  ...
  public static void getDatosTransporte(ArrayList array,String codDestino) throws SQLException
  {
    ...
    public static void getDatosTransporteDelivery(ArrayList array,String codDestino) throws SQLException
    {
      ...
      FarmaDBUtility.executeSQLStoredProcedureArrayList(array,"PTOVENTA_INV.INV_GET_DATOS_TRANS_DELIVERY(?,?,?)",parametros);
    }
  ...
  public static void anularGuiaIngreso(String numNota)throws SQLException
  {
    ...
    public static void getListaProdsInsum(FarmaTableModel pTableModel) throws SQLException {
                    ...
                    FarmaDBUtility.executeSQLStoredProcedure(pTableModel,"PTOVENTA_INV.INV_LISTA_INSUMOS(?,?)", parametros, false);
            }
  ...
  //------------------------------------
  public static boolean getHistoricoLote(String codProd                                      
                                                        ) throws SQLException
  {
    boolean retorno;
    int cant;
 ...
 * Listar detalle de orden de compra de la cual se espera devolver algunos productos por haber ingresado previamente sobrantes.
     ...
     * @throws SQLException
     */
    public static void listarProdOrdenCompraSobrante(String codCompra,FarmaTableModel pTableModel) throws SQLException{
        parametros=new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodCia);
        parametros.add(FarmaVariables.vCodLocal);
        ...
        FarmaDBUtility.executeSQLStoredProcedure(pTableModel,"PTOVENTA_MDIRECTA.GET_DET_OC_SOBRANTE(?,?,?,?)",parametros,false);
    }    
   ...
   /**
    ...
    public static void listarOrdCompPendRegularizar(FarmaTableModel pTableModel) throws SQLException{
        ...
        FarmaDBUtility.executeSQLStoredProcedure(pTableModel,"PTOVENTA_MDIRECTA.GET_ORD_COMP_PEND_REG(?,?,?)",parametros,false);
    }   
   ...
   /**
    ...
    public static String getIndOcRegularizada(String codCompra) throws SQLException
    {
        ...
        return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_MDIRECTA.GET_IND_OC_REGULARIZADO(?,?,?,?)",parametros);
    }
    /**
      ...
      * @throws SQLException
      */
    public static void cargaListaProductosPedido(
                                  ArrayList cLista,String cCodProd) throws SQLException
    {
      parametros = new ArrayList();
      parametros.add(FarmaVariables.vCodGrupoCia);
      parametros.add(FarmaVariables.vCodLocal);
      ...
      FarmaDBUtility.executeSQLStoredProcedureArrayList(cLista,"PTOVENTA_PED_ADICIONAL.PED_F_PROD_PED_INS(?,?,?)",parametros);
    }
