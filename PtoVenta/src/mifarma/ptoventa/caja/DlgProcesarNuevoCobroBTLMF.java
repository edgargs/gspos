            ...
            if (VariablesConvenioBTLMF.vFlgValidaLincreBenef.equals("1") || esComprobanteCredito) {
                    ...
                    if (resultado.trim().equalsIgnoreCase("EXITO")) {
                        ...
                        for (int i = 0; i < lista.size(); i++) {
                            ...
                            //ERIOS 16.09.2016 Se agrega validaciones de Receta
                            String pNumReceta = (String)datosAdicConv.get("NUM_RECETA");
                            String pFchReceta = (String)datosAdicConv.get("FCH_RECETA");
                            String pCodLocalReceta = (String)datosAdicConv.get("COD_LOCAL_RECETA");
                            String pCodMedico = (String)datosAdicConv.get("COD_MEDICO");
                            String pCadCodDiagnostico = (String)datosAdicConv.get("CAD_COD_DIAGNOSTICO");
