        ...
        try {
            ...
            if (ex.getErrorCode() == 20009)
                ...
                mensaje =
                        "No se puede cerrar caja ya que existen pedidos pendientes o en proceso de cobro. \n" +
                        "Diríjase al Menú 'Caja' luego la opción 'Reimpresión de Pedido' y Reimprima el pedido pendiente.";
            //KMONCADA 09.06.2016 [PROYECTO M] VALIDACION DE PROFORMAS PENDIENTES DE ENTREGA.
            }else if (ex.getErrorCode() == 20030){
                mensaje =
                        "No se puede cerrar caja ya que existen PROFORMAS PENDIENTES DE ENTREGA. \n" +
                        "Diríjase al Menú 'Ventas' luego la opción 'Entrega de Productos' y valide.";
            } else {
                log.error("", ex);
