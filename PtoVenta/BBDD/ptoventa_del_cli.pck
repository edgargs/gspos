...
FUNCTION CLI_LISTA_TRANSFERENCIA(
 ...
 --@@@ se coloca el un lote , que contenga la mayot cantidad solicitada
  ...
  BEGIN
    ...
    INSERT INTO TMP_COMANDA_DELIVERY VALUES('PEDIDO DELIVERY','1','C','S','N');
    ...
    SELECT REPLACE((REPLACE((EXTRACTVALUE(xt.column_value, 'e')),'Ã','&')),'Ë','<') VAL ,'1','I','N','N'
     ...
     INSERT INTO TMP_COMANDA_DELIVERY VALUES('CLIENTE','1','I','S','N');
     ...
     SELECT REPLACE((REPLACE((EXTRACTVALUE(xt.column_value, 'e')),'Ã','&')),'Ë','<') VAL ,'1','I','N','N'
      ...
      IF vCodConvenio IS NOT NULL THEN
        INSERT INTO TMP_COMANDA_DELIVERY VALUES('TIPO DE VENTA','1','I','S','N');
        ...
        INSERT INTO TMP_COMANDA_DELIVERY VALUES('VERIFICACION DE DOCUMENTOS','1','I','S','N');
      ...
      INSERT INTO TMP_COMANDA_DELIVERY VALUES('DOCUMENTOS','1','I','S','N');
      -- LTAVARA 16.09.2014 DOCUMENTOS ELECTRONICOS
      INSERT INTO TMP_COMANDA_DELIVERY
      SELECT  RPAD(' ',vEspaciosTab)||RPAD(TCP.DESC_COMP,30) || DECODE(CP.COD_TIP_PROC_PAGO,'1',CP.NUM_COMP_PAGO_E,CP.NUM_COMP_PAGO),'1','I','N','N'
      ...
      INSERT INTO TMP_COMANDA_DELIVERY VALUES('-','1','I','N','N');
      INSERT INTO TMP_COMANDA_DELIVERY VALUES('FORMA DE PAGO','1','I','S','N');
      ...
      IF vCodConvenio IS NOT NULL THEN
        INSERT INTO TMP_COMANDA_DELIVERY
        select LPAD('TOTAL A PAGAR',25)|| TO_CHAR(sum(a.im_total_pago-a.val_vuelto), '999,999,990.00') , '1', 'I', 'S', 'N'
        from tmp_vta_forma_pago_pedido a
        WHERE A.COD_GRUPO_CIA = cCodGrupoCia_in
