...
public class DBConvenioBTLMF {
    ...
    public static void crearBenificiarioNew(String pNombre, String pApellidoPat, String pApellidoMat, String pDni,
        ...
        parametros.add(VariablesConvenioBTLMF.vCodConvenio);
        parametros.add(pCodCliente.trim());
        parametros.add(pApellidoPat + " " + pApellidoMat + ", "+pNombre);
        parametros.add("A");
        parametros.add(pDni);
        parametros.add(new Double(pLineaCredito)); //LineaCredito //A_IMP_LIN_CRED
        parametros.add(pNroTarjeta);
        log.info("invocando  a PTOVENTA_CONV_BTLMF.BTLMF_P_INSERT_BENIF_NEW(?,?,?,?,?,?,?) :" +
                  parametros);
        FarmaDBUtility.executeSQLStoredProcedure(null,
    ...
    public static String crearBenificiario(String pNombre, String pApellidoPat, String pApellidoMat, String pDni,
        ...
        parametros.add(FarmaVariables.vCodLocal);
        log.info("invocando  a BTLPROD.PKG_BENEFICIARIO.SP_GRABA(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) :" + parametros);
    ...
    public static String esActivoConvenioBTLMF() throws SQLException {
        ...
        log.debug("invocando  a PTOVENTA_CONV_BTLMF.BTLMF_F_CHAR_ES_ACTIVO_CONV(?) :" + parametros);
     ...
     * @throws SQLException
     */
    public static String obtieneNvoPrecioConvenio_btlmf(String pCodConv, String pCodProd,
        ...
        log.debug("invocando a PTOVENTA_CONV_BTLMF.BTLMF_F_OBTIENE_NVO_PRECIO(?,?,?,?,?) :" + parametros);
    ...
    public static String getIndExcluidoConv(String pCodprod) throws SQLException {
        ...
        parametros.add(VariablesConvenioBTLMF.vCodConvenio);
        parametros.add(pCodprod);
        log.debug("parametros PTOVENTA_CONV_BTLMF.F_GET_IND_EXCLUIDO_CONV(?,?,?): " + parametros);
    ...
    public static void cargarListaPrecios(ArrayList pArray) throws SQLException {
        ...
        parametros.add(VariablesConvenioBTLMF.vCodConvenio);
        parametros.add(FarmaVariables.vCodLocal);
        log.debug("parametros PTOVENTA_CONV_BTLMF.BTLMF_F_CUR_LISTA_PRECIO_CONV(?,?,?): " + parametros);
    ...
    public static String cobraPedido() throws SQLException {
        ...
        parametros.add("");
        parametros.add(UtilityEposTrx.validacionEmiteElectronico() == true ? "1" :
                       "0"); //LTAVARA 27.08.2014 AGREGAR EL FLAG DE PROCESO ELECTRONICO

        log.info(" PTOVENTA_CONV_BTLMF.BTLMF_F_CHAR_COBRA_PEDIDO " + parametros);
    ...
    public static String grabaDatosTemporales() throws SQLException {
        ...
        parametros.add(VariablesCaja.vNumPedVta);
        //parametros.add(VariablesCaja.vDescripcionDetalleFormasPago);
        log.debug(" PTOVENTA_CONV_BTLMF.BTLMF_F_GRABA_DATOS_TMP(?,?,?): " + parametros);
    ...
    public static String obtieneCodigoBarraConv() throws SQLException {
        parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodLocal);
        log.debug("parametros PTOVENTA_CONV_BTLMF.BTLMF_F_CHAR_OBT_COD_BARRA_CON(?): " + parametros);
    ...
    public static String grabarCobrarPedidoRac(String pIndCloseConecction, String pIndicadorNC) throws SQLException {
        ...
        log.debug("BTLPROD.PKG_DOCUMENTO_MF.SP_GRABA_DOCUMENTOS(?,?,?,?,?)" + parametros);
    ...
    public static String grabarCobrarPedidoRacNC(String pIndCloseConecction) throws SQLException {
        return grabarCobrarPedidoRac(pIndCloseConecction, FarmaConstants.INDICADOR_S);
    }

    /**
     * Envio de documentos de documentos al RAC.
     * @author kmoncada
     * @since 26.06.2014
     * @param numPedVtaNC numero de pedido de venta que genera la Nota de Credito
     * @param pIndCloseConecction
     * @return
     * @throws SQLException
     */
    public static String grabarCobrarPedidoRacNC2(String numPedVtaNC, String pIndCloseConecction) throws SQLException {
        //return grabarCobrarPedidoRac(pIndCloseConecction,FarmaConstants.INDICADOR_S);
        parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
    ...
    public static String anularPedidoRac(String pIndNotaCred, String pIndCloseConecction) throws SQLException {
        ...
        log.debug("BTLPROD.PKG_DOCUMENTO_MF.SP_ANULA_DOCUMENTO(?,?,?,?) :" + parametros);
    ...
    public static void aceptarTransaccionRempota(FarmaTableModel pTableModel,
        ...
        parametros = new ArrayList();
        log.debug("invocando  a BTLPROD.PKG_DOCUMENTO_MF.ACEPTAR_TRANSACCION :" + parametros);
        FarmaDBUtilityRemoto.executeSQLStoredProcedure(pTableModel, "BTLPROD.PKG_DOCUMENTO_MF.ACEPTAR_TRANSACCION",
    ...
    public static void liberarTransaccionRempota(FarmaTableModel pTableModel,
        ...
        parametros = new ArrayList();
        log.debug("invocando  a BTLPROD.PKG_DOCUMENTO_MF.LIBERAR_TRANSACCION :" + parametros);
        FarmaDBUtilityRemoto.executeSQLStoredProcedure(pTableModel, "BTLPROD.PKG_DOCUMENTO_MF.LIBERAR_TRANSACCION",
                                                       parametros, true, FarmaConstants.CONECTION_RAC,
                                                       pIndCloseConecction);
    ...
    public static String anularPedidoRacNotaCredito(String pIndCloseConecction) throws SQLException {
        ...
        log.debug("invocando  a BTLPROD.PKG_DOCUMENTO.SP_ANULA_DOCUMENTO(?,?,?) :" + parametros);
    ...
    public static String obtieneDniUsuario() throws SQLException {
        ...
        log.debug("invocando  a PTOVENTA_CONV_BTLMF.BTLMF_F_CHAR_OBT_DNI_USUARIO(?,?,?) :" + parametros);
     ...
     * @throws SQLException
     */
    public static void actualizaFechaProcesoRac2(String numPedVtaNC) throws SQLException {
        parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(numPedVtaNC);
    ...
    public static void actualizaFechaProcesoAnulaNCreditoRac() throws SQLException {
        ...
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(VariablesCaja.vNumPedVta_Anul);
        log.debug("parametros PTOVENTA_CONV_BTLMF.BTLMF_P_AC_FEC_PROC_ANU_NC_RAC(?,?,?): " + parametros);
        FarmaDBUtility.executeSQLStoredProcedure(null, "PTOVENTA_CONV_BTLMF.BTLMF_P_AC_FEC_PROC_ANU_NC_RAC(?,?,?)",
                                                 parametros, false);
    }
    ...
    public static String grabarTablasTmp() throws SQLException {
        ...
        log.debug("invocando  a PTOVTA_MATRIZ_CONV_BTLMF.CON_AGREGA_DATOS_TMP(?,?,?) :" + parametros);
    ...
    public static String grabarTablasTmpNC() throws SQLException {
        ...
        log.debug("invocando  a PTOVTA_MATRIZ_CONV_BTLMF_NC.CON_AGREGA_DATOS_TMP(?,?,?) :" + parametros);
    ...
    public static void actualizaEstadoPedidoEnCobrado() throws SQLException {
        ...
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(VariablesCaja.vNumPedVta);
        log.debug("parametros PTOVENTA_CONV_BTLMF.BTLMF_P_ACT_ESTDO_PEDIDO(?,?,?): " + parametros);
        FarmaDBUtility.executeSQLStoredProcedure(null, "PTOVENTA_CONV_BTLMF.BTLMF_P_ACT_ESTDO_PEDIDO(?,?,?)",
                                                 parametros, false);
    ...
    public static List listaDocumentosVerificaRAC() throws SQLException {
        ...
        log.info("parametros PTOVENTA_CONV_BTLMF.COMP_CREDITO_VALIDA_RAC(?,?,?): " + parametros);
        return FarmaDBUtility.executeSQLStoredProcedureListMap("PTOVENTA_CONV_BTLMF.COMP_CREDITO_VALIDA_RAC(?,?,?)",
                                                               parametros);
    }


    public static boolean validacionPedidoRAC(String pCodLocal, String pNumPedVta, String pCodConvenio,
                                              String pCodCliente, String pTipoDoc, double pMonto,
                                              String pVtaFin) throws SQLException {
        ...
        log.info("BTLPROD.PKG_DOCUMENTO_MF.VALIDAR_COBRO_PEDIDO(?,?,?,?,?,?,?)" + parametros);
        String resultado =
            FarmaDBUtilityRemoto.executeSQLStoredProcedureStr("BTLPROD.PKG_DOCUMENTO_MF.VALIDAR_COBRO_PEDIDO(?,?,?,?,?,?,?)",
     ...
     * @throws SQLException
     */
    public static boolean isExisteComprobanteEnRAC(String pCodGrupoCia, String pCodLocal, String pTipoComprobante,
        ...
        log.info("BTLPROD.PKG_DOCUMENTO_MF.FN_EXISTE_DOCUMENTO(?,?,?,?,?)" + parametros);
        int resultado =
            FarmaDBUtilityRemoto.executeSQLStoredProcedureInt("BTLPROD.PKG_DOCUMENTO_MF.FN_EXISTE_DOCUMENTO(?,?,?,?,?)",
                                                              parametros, FarmaConstants.CONECTION_RAC, "S");
        if (resultado == 0)
            return false;
        else
    ...
    public static String getComprobanteBeneficiario(String pCodConvenio) throws Exception {
        ...
        log.info("PTOVENTA_CONV_BTLMF.F_CHAR_EMITE_BENEFICIARIO(?)" + parametro);
    ...
    public static String getIndPedidoConvenioBTLMF(String pcCodGrupoCia, String pCodLocal, String pNumPedVta)throws Exception{
        ...
        log.info("PTOVENTA_CONV_BTLMF.F_C_IND_PEDIDO_CONVENIO(?,?,?): " + parametro);
