...
public class FacadeEncuesta {
    ...
    private void grabarEncuesta(List<BeanPreguntaEncuesta> lstPreguntas,
                                String pCodProd){
        ...
        try {
            ...
            secuencial = daoEncuesta.grabaCabEncuesta( FarmaVariables.vCodGrupoCia,
            ...
            for(BeanPreguntaEncuesta Enc:lstPreguntas){
                ...
                daoEncuesta.grabaDetalleEncuesta(
    ...
    private void pregunta(BeanPreguntaEncuesta rpta) {
        ...
        case "SN": muestraSN(rpta); break;
        case "DT": muestraDT(rpta); break;
        }
    }
    ...
    private void muestraDT(BeanPreguntaEncuesta rpta) {
        String s = JInputDialog.showInputDialog(
                            myParentFrame,
                            rpta.getDescPegunta(),
                            rpta.getTipoValidacion());
        rpta.setRespuesta(s);
    }
    ...
    private boolean validacion(BeanPreguntaEncuesta rpta) {
        ...
        if(!(rpta.getTipoValidacion() == null || rpta.getTipoValidacion().trim().equals(""))){
            switch(rpta.getTipoPregunta()){
            case "SN": bValida = validaSN(rpta); break;
    ...
    private boolean validaDT(BeanPreguntaEncuesta rpta) {
        ...
        try{
            ...
            case "NM": bValida = FarmaUtility.isInteger(rpta.getRespuesta().trim()); 
                /*if(bValida){
