 ...
 *
 */
public class DlgIngresoTemperatura extends JDialog {
    /* ********************************************************************** */
    ...
    private void jbInit() throws Exception {
        ...
        pnlHeader1.setBorder(BorderFactory.createLineBorder(new Color(255, 140, 14), 1));
                ...
                if (com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,
                    ...
                    try {
                        ...
                        if (ex.getErrorCode() == 20001) {
                            ...
                            FarmaUtility.showMessage(this, "Usted ya registro 2 ingresos para el dia de hoy.",
                                                     txtRefrig);
                        } else if (ex.getErrorCode() == 20003) {
                            FarmaUtility.showMessage(this, "Usted no esta dentro del rango de horas permitido.",
                                                     txtRefrig);
                        } else {
    ...
    private void insertarTemp() throws SQLException {
        DBControlIngreso.ingresaTemperatura(txtVTa.getText().trim(), txtAlmc.getText().trim(),
                                            txtRefrig.getText().trim());
    }

    private void actualizaFact() throws SQLException {
            ...
            if (Ind.equalsIgnoreCase("1")) {
                if (vEntero > 31) {
                    FarmaUtility.showMessage(this,
                                             "Area Venta: La cantidad ingresada excede el valor permitido (31°).",
                                             pObjeto);
                    FarmaUtility.moveFocus(pObjeto);
                    return false;
                } else if (vEntero > 25) {
                    FarmaUtility.showMessage(this, "Alerta Area Venta: Se esta ingresando valor mayor a 25C°.",
                                             pObjeto);
                    FarmaUtility.moveFocus(pObjeto);
                }
            } else if (Ind.equalsIgnoreCase("3")) {
                if (vEntero > 31) {
                    FarmaUtility.showMessage(this, "Almacen: La cantidad ingresada excede el valor permitido (31°).",
                                             pObjeto);
                    FarmaUtility.moveFocus(pObjeto);
                    return false;
                } else if (vEntero > 25) {
                ...
                if (vEntero > 11) {
                    FarmaUtility.showMessage(this,
                                             "Refrigerador: La cantidad ingresada excede el valor permitido (11°).",
                                             pObjeto);
                    FarmaUtility.moveFocus(pObjeto);
                    return false;
                } else if (vEntero > 8) {
                    FarmaUtility.showMessage(this, "Alerta Refrigerador: Se esta ingresando valor mayor a 8C°.",
                                             pObjeto);
                    FarmaUtility.moveFocus(pObjeto);
                }
            }
