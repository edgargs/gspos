...
--------------------------------------------------------
  ...
  --14/02/2006  ERIOS     Creacion
  --19/07/2006  ERIOS     Modificacion: Rango y Filtro
  ...
  --Fecha       Usuario		Comentario
  --14/02/2006  ERIOS     Creacion
  FUNCTION INV_GET_MOTIVO_NOTA_E(cCodMotivo_in IN CHAR,cCodGrupoCia_in IN CHAR default '001') RETURN VARCHAR2;
  ...
  --28/06/2006  ERIOS     Modificacion
  FUNCTION INV_GET_TIPO_ORIGEN_GUIA_E(cCodGrupoCia_in IN CHAR default '001') RETURN FarmaCursor;

  --Descripcion: Obtiene los tipos de Documentos.
  --Fecha       Usuario		Comentario
  --15/02/2006  ERIOS     Creacion
  FUNCTION INV_GET_TIPO_DOCUMENTO(cGrupoCia_in IN CHAR) RETURN FarmaCursor;

  --AGREGAR GUIA INGRESO

  --Descripcion: Agrega la cabecera de una guia de ingreso.
  --Fecha       Usuario	  Comentario
  --16/02/2006  ERIOS     Creacion
  ...
  --Fecha       Usuario	  Comentario
  --20/02/2006  ERIOS     Creacion
  --23/06/2006  ERIOS     Modificacion: cTipOrigen_in
  ...
  --22/02/2006  ERIOS     Creacion
  --28/06/2006  ERIOS     Modificacion
  FUNCTION INV_GET_TIPO_TRANSFERENCIA(cCodGrupoCia_in IN CHAR default '001') RETURN FarmaCursor;

  --Descripcion: Obtiene los motivos de transferencias.
  --Fecha       Usuario		Comentario
  --22/02/2006  ERIOS     Creacion
  FUNCTION INV_GET_MOTIVO_TRANSFERENCIA(cCodGrupoCia_in IN CHAR default '001') RETURN FarmaCursor;

  --Descripcion: Obtiene las guias de recepcion
  --Fecha       Usuario		Comentario
  --22/02/2006  MHUAYTA     Creacion
  ...
  FUNCTION INV_AGREGA_CAB_TRANSFERENCIA(cCodGrupoCia_in IN CHAR,cCodLocal_in IN CHAR,
                                        ...
                                        vUsu_in IN VARCHAR2,cCodMotTransInterno_in CHAR) RETURN CHAR;
  ...
  */
  ...
  --Fecha       Usuario		Comentario
  --23/02/2006  MHUAYTA     Creacion
	PROCEDURE INV_ACT_CAB_GUIA_RECEP(cGrupoCia_in IN CHAR,
			  						 cCodLocal_in IN CHAR,
									 cNumNota_in  IN CHAR,
									 cIdUsu_in    IN CHAR);

  --Descripcion: Obtiene el estado de recepcion de una guia
  --Fecha       Usuario		Comentario
  --23/02/2006  MHUAYTA     Creacion
  ...
  --Fecha       Usuario		Comentario
  --06/03/2006  ERIOS     Creacion
  --30/01/2007  LREQUE		Modificacion: se le ha colocado formato a los valores numericos.
  ...
  --Fecha       Usuario		Comentario
  --06/03/2006  ERIOS     Creacion
  --20/04/2007	 LREQUE	   Modificacion
  ...
  --Fecha       Usuario		Comentario
  --09/03/2006  LMESIA     	Creacion
  --23/06/2006  ERIOS           Modificacion: cTipDoc_in, cNumDoc_in
 ...
 FUNCTION INV_LISTA_PROD_FILTRO(cCodGrupoCia_in IN CHAR,
  ...
  --Fecha       Usuario   Comentario
  --23/03/2006  ERIOS     Creacion
  --20/06/2006  ERIOS     Modificacion: cSecImprLocal_in
  ...
  --Fecha       Usuario   Comentario
  --11/04/2006  MHUAYTA   Creacion
  --13/06/2006  ERIOS     Modificacion: nSecGuia_in
 ...
 PROCEDURE INV_SETEAR_VALORES(cCodGrupoCia_in IN CHAR ,cCodLocal_in IN CHAR,
  ...
  --Descripcion: Obtiene los datos de cabecera de una guia de transferencia.
  --Fecha       Usuario	 Comentario
  --20/06/2006  ERIOS     Creacion
  ...
  --Descripcion: Obtiene el listado de Guias Impresas.
  --Fecha       Usuario	 Comentario
  --26/06/2006  ERIOS     Creacion
  ...
  --Descripcion: Actualiza Kardex de una Guia corregida.
  --Fecha       Usuario	 Comentario
  --26/06/2006  ERIOS     Creacion
  --04/07/2006  ERIOS     Modificacion
 ...
 RETURN FarmaCursor;
  ...
  --Descripcion: Obtiene la cantidad maxima para reponer.
  --Fecha       Usuario	 Comentario
  --17/07/2006  ERIOS     Creacion
  ...
  --Descripcion: Obtiene la direccion del local.
  --Fecha       Usuario	 Comentario
  --31/08/2006  ERIOS     Creacion
  FUNCTION GET_DIREC_ORIGEN_LOCAL(cGrupoCia_in IN CHAR, cCodLocal_in IN CHAR) RETURN VARCHAR2;

  --Descripcion: Verifica el estado de proceso cierre dia.
  --Fecha       Usuario	 Comentario
  --01/09/2006  ERIOS     Creacion
  ...
  --Descripcion: Obtiene el ultimo pedido reposicion del dia.
  --Fecha       Usuario	 Comentario
  --04/09/2006  ERIOS     Creacion
  ...
  --Fecha       Usuario	     Comentario
  --20/04/2007  Luis Reque   Creacion
  ...
  --Fecha       Usuario		Comentario
  --25/04/2007  Luis Reque   Creacion
