...
public class MBCaja implements DAOCaja {
    ...
    public void setVersion() throws Exception{
        ...
        mapParametros.put("vModulo_in",VariablesPtoVenta.vNombreModulo.toUpperCase());
        mapParametros.put("vVersion_in",VariablesPtoVenta.vVersion);
        mapParametros.put("vCompilacion_in",VariablesPtoVenta.vCompilacion);
