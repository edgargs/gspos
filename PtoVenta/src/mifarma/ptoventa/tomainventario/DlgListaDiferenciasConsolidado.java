...
public class DlgListaDiferenciasConsolidado extends JDialog {
    ...
    private void chkKeyPressed(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_ESCAPE) {
            ...
            if (lblF8.isVisible()) {
                ...
                FarmaUtility.saveFile(myParentFrame, ConstantsTomaInv.columnsListaDiferenciasConsolidado,
    ...
    private void imprimir() {
        ...
        for (int i = 0; i < tblRelacionDiferenciasProductos.getRowCount(); i++) {
            ...
            vStkActual = (String)tblRelacionDiferenciasProductos.getValueAt(i, 4);//3
            vDif = (String)tblRelacionDiferenciasProductos.getValueAt(i, 5);//4
            vPrecio = (String)tblRelacionDiferenciasProductos.getValueAt(i, 6);//5
            vLab = (String)tblRelacionDiferenciasProductos.getValueAt(i, 7);//6
