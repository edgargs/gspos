...
public class ConstantsVentas {
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Código", 50, JLabel.LEFT),
      new FarmaColumnData("Descripción", 200, JLabel.LEFT), new FarmaColumnData("Unidad", 100, JLabel.LEFT),
      new FarmaColumnData("Laboratorio", 150, JLabel.LEFT), new FarmaColumnData("Stock", 45, JLabel.RIGHT),
      new FarmaColumnData("Precio", 65, JLabel.RIGHT), new FarmaColumnData("Zan", 40, JLabel.RIGHT),
      new FarmaColumnData("", 0, JLabel.LEFT), //indicador producto congelado
        ...
        new FarmaColumnData("ordLista", 0, JLabel.LEFT), new FarmaColumnData("indProdEncarte", 0, JLabel.LEFT),
        new FarmaColumnData("indOrigen", 0, JLabel.LEFT) };

    //ASOSA - 21/07/2014
    public static final FarmaColumnData columnsListaBandejas[] = { new FarmaColumnData("Bandejas", 150, JLabel.LEFT) };
  ...
  */
    ...
    public static final FarmaColumnData columnsListaPromociones[] = {
        ...
        new FarmaColumnData("Cod Prom", 60, JLabel.CENTER), new FarmaColumnData("Descripción", 271, JLabel.LEFT),
        new FarmaColumnData("Precio", 80, JLabel.RIGHT), new FarmaColumnData("Stock", 50, JLabel.RIGHT),
        new FarmaColumnData("OBS", 120, JLabel.LEFT), new FarmaColumnData("indPermitido", 0, JLabel.LEFT),
        new FarmaColumnData("Descripción Corta", 0, JLabel.LEFT), new FarmaColumnData("Paquete 1", 0, JLabel.CENTER),
        new FarmaColumnData("Paquete 2", 0, JLabel.CENTER), new FarmaColumnData("", 0, JLabel.CENTER), //Desc Promocion
        } ;
    ...
    { new FarmaColumnData("Código", 53, JLabel.CENTER), new FarmaColumnData("Descripción", 212, JLabel.LEFT),
      new FarmaColumnData("Unidad", 85, JLabel.CENTER), new FarmaColumnData("Laboratorio", 219, JLabel.LEFT),
      new FarmaColumnData("Precio", 65, JLabel.CENTER), new FarmaColumnData("Unidades", 60, JLabel.CENTER),
      new FarmaColumnData("Disponible", 0, JLabel.CENTER), new FarmaColumnData("", 0, JLabel.CENTER),
