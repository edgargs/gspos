...
public class DlgProcesarNuevoCobroBTLMF extends JDialog {
            ...
            if (VariablesConvenioBTLMF.vFlgValidaLincreBenef.equals("1") || esComprobanteCredito) {
                    ...
                    if (resultado.trim().equalsIgnoreCase("EXITO")) {
                        ...
                        for (int i = 0; i < lista.size(); i++) {
                            ...
                            validado =
                                    validado && facadeConvenioBTLMF.validacionPedidoRAC(pCodLocal, pNumPedVta, pCodConvenio,
    ...
    private boolean finalizaCobro() {
        ...
        UtilityConvenioBTLMF.procesoImpresionComprobante(this, null, false, bCobroProforma);
    ...
    private boolean anulaPedido() {
        ...
        UtilityConvenioBTLMF.procesoImpresionComprobante(this, null, true, bCobroProforma);
        //3. Anula pedido
        try {
    ...
    private boolean finalizaBD_conv() {
        ...
        //3. Imprimir Comprobante
        UtilityConvenioBTLMF.procesoImpresionComprobante(this, null, false, false);
