...
private void this_windowClosing(WindowEvent e)
  {FarmaUtility.showMessage(this, "Debe presionar la tecla ESC para cerrar la ventana.", null);
		...
		}else if(e.getKeyCode() == KeyEvent.VK_F8)
    {
      ...
      if(FarmaUtility.rptaConfirmDialogDefaultNo(this,"Esta seguro de excluir la venta para el calculo del pedido de reposicion"))
  ...
  private void obtieneDatosProducto()
  {
    ...
    System.out.println("VariablesInventario.vCantAtendida : " + VariablesInventario.vCantAtendida);
    System.out.println("VariablesInventario.vNumPedido : " + VariablesInventario.vNumPedido);
  }
