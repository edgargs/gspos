    	...
    	if(tableModelListaDatos == null)
    	{
    	   tableModelListaDatos =
                new FarmaTableModel(ConstantsConvenioBTLMF.columnsListaDiagnostico,
                                    ...
                                    0);
           FarmaUtility.initSelectList(tblDatos, tableModelListaDatos,ConstantsConvenioBTLMF.columnsListaDiagnostico);
    	}
    ...
    private void guardarRegistroSeleccionado(){
        ...
        if(vFila > -1){
            ...
            if(VariablesConvenioBTLMF.vCodTipoCampo.equals(ConstantsConvenioBTLMF.COD_DATO_CONV_DIAGNOSTICO_UIE)){
                ...
                VariablesConvenioBTLMF.vCodigo = cadenaCodigos; //FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos,0,COLUMN_CODIGO);
                VariablesConvenioBTLMF.vDescripcion = cadenaCodigos; //FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos,0,COLUMN_CODIGO);
                VariablesConvenioBTLMF.vCodigoAux = FarmaUtility.getValueFieldArrayList(VariablesConvenioBTLMF.listaDatos, 0, colSel + COLUMN_CODIGO_AUX);
		...
		for (int k = 0; k < tableModelListaconvenios.getRowCount(); k++)
		{
			ArrayList listaTemp = new ArrayList();
	 		...
	 		String  dato[] = new String[50];
		   		    ...
		   		    dato[COLUMN_LINEA_CREDITO]  = FarmaUtility.getValueFieldArrayList(listaTemp,0,colSel+COLUMN_LINEA_CREDITO);
		   		    dato[COLUMN_ESTADO]         = FarmaUtility.getValueFieldArrayList(listaTemp,0,colSel+COLUMN_ESTADO);
		   		    dato[COLUMN_NOMBRE_CLIENTE] = FarmaUtility.getValueFieldArrayList(listaTemp,0,colSel+COLUMN_NOMBRE_CLIENTE);
				    ...
				    dato[COLUMN_COD_ASEGURADO]  = FarmaUtility.getValueFieldArrayList(listaTemp,0,colSel+COLUMN_COD_ASEGURADO);
				    ...
				    dato[COLUMN_NUM_CONTRATO]   = FarmaUtility.getValueFieldArrayList(listaTemp,0,colSel+COLUMN_NUM_CONTRATO);
				    dato[COLUMN_TIPO_ASEGURADO] = FarmaUtility.getValueFieldArrayList(listaTemp,0,colSel+COLUMN_TIPO_ASEGURADO);
