...
END;
  ...
  BEGIN
    ...
    */
                                        /*      Tarjeta :	4442********2098
DNI	:	45678945
Nombre cliente:	Alfredo Sosa dordan
ptos acumulados: 10 (los que gane ahorita con la venta)
ptos redimidos : 0 (si es que hay puntos usados en la venta)
Total		: 25 (cantidad de puntos totales)
*/
        ...
        INTO vTextoInmed
        FROM PBL_TAB_GRAL T
        WHERE T.ID_TAB_GRAL = codTabTextoInmed;
        ...
        INTO vTextoInmed2
        FROM PBL_TAB_GRAL T
        WHERE T.ID_TAB_GRAL = codTabTextoInmed2;
         ...
         --FIN TODOS LOS TEXTOS
               ...
               select (select substr(b.num_tarj_puntos,1,4) || 
                             ...
                             from dual),
                                  b.dni_cli,
                                  b.nom_cli_ped_vta,
                                  nvl(b.pt_acumulado,0),
                                  (NVL(B.PT_REDIMIDO,0) + ptosInmed),
                                  case when nvl(b.pt_total,0) < 0 then 0
                                    else nvl(b.pt_total,0) end
        into tarjeta,
                     docIdentidad,
                     nombreCliente,
                     ptosAcumulados,
         ...
         and b.num_ped_vta = vNumPedVta_in;
                           ...
                           INSERT INTO TMP_DOCUMENTO_ELECTRONICOS VALUES (' ', '0','I','N','N');
                            ...
                            INSERT INTO TMP_DOCUMENTO_ELECTRONICOS        
                            SELECT tarjeta ,'1','C','S','N' FROM DUAL;
                            
                            INSERT INTO TMP_DOCUMENTO_ELECTRONICOS        
                            SELECT 'DNI : ' || docIdentidad ,'0','I','N','N' FROM DUAL;
                            
                            IF ptosInmed > 0 THEN
                              INSERT INTO TMP_DOCUMENTO_ELECTRONICOS        
                              SELECT V_BOLD_I || vTextoInmed || V_BOLD_F || V_SEPARADOR || FID_F_GET_NUM_FORMATED_02(ptosInmed) || ' ' || vTextoInmed2,'0','I','N','N' FROM DUAL;
                            END IF;
                            
                            IF ptosAcumulados > 0 THEN
                              INSERT INTO TMP_DOCUMENTO_ELECTRONICOS        
                              SELECT V_BOLD_I || vTextoAcum || V_BOLD_F || V_SEPARADOR || FID_F_GET_NUM_FORMATED(ptosAcumulados) || ' ' || vTextoAcum2,'0','I','N','N' FROM DUAL;
                            END IF;
                            
                            IF ptosRedimidos > 0 THEN
                              INSERT INTO TMP_DOCUMENTO_ELECTRONICOS        
                              SELECT V_BOLD_I || vTextoRedim || V_BOLD_F || V_SEPARADOR || FID_F_GET_NUM_FORMATED(ptosRedimidos) || ' ' || vTextoRedim2,'0','I','N','N' FROM DUAL;
                            END IF;
                            /*
                            IF ptosAcumHist > 0 THEN
                              INSERT INTO TMP_DOCUMENTO_ELECTRONICOS        
                              SELECT V_BOLD_I || vTextoAcumHist || V_BOLD_F || V_SEPARADOR || FID_F_GET_NUM_FORMATED(ptosAcumHist) || ' ' || vTextoAcumHist2,'0','I','N','N' FROM DUAL;
                            END IF;
                            */
                            
                            IF ptosTotal > 0 THEN
                              INSERT INTO TMP_DOCUMENTO_ELECTRONICOS        
                              SELECT V_BOLD_I || vTextoTotal || V_BOLD_F || V_SEPARADOR || FID_F_GET_NUM_FORMATED(ptosTotal) || ' ' || vTextoTotal2,'0','I','N','N' FROM DUAL;
                            END IF;
...
IS  
   ...
   nombreCliente varchar2(100) := '';
   docIdentidad varchar2(20) := '';
   ptosAcumulados number(6,2) := 0;
   ptosRedimidos number(6,2) := 0;
   
   ptosTotal number(12,2) := 0;
           msgLegal varchar2(3000) := '';
        codTabGralGlosa number(3) := 458;
...
*/
      ...
      INSERT INTO TMP_DOCUMENTO_ELECTRONICOS VALUES ('__________________________________________', '9','I','N','N');
            INSERT INTO TMP_DOCUMENTO_ELECTRONICOS VALUES (' ', '9','I','N','N');
      
                            INSERT INTO TMP_DOCUMENTO_ELECTRONICOS        
                            SELECT 'Tarjeta : ' || tarjeta ,'0','I','S','N' FROM DUAL;
                            
                            INSERT INTO TMP_DOCUMENTO_ELECTRONICOS        
                            SELECT 'DNI : ' || docIdentidad ,'0','I','S','N' FROM DUAL;
                            
                            INSERT INTO TMP_DOCUMENTO_ELECTRONICOS        
                            SELECT 'Nombre Cliente : ' || nombreCliente ,'0','I','S','N' FROM DUAL;
                            
                            IF ptosInmed > 0 THEN
                              INSERT INTO TMP_DOCUMENTO_ELECTRONICOS        
                              SELECT V_BOLD_I || vTextoInmed || V_BOLD_F || V_SEPARADOR || V_BOLD_I_2 ||FID_F_GET_NUM_FORMATED_02(ptosInmed) || V_BOLD_F_2 || V_SEPARADOR || ' ' || vTextoInmed2,'0','I','N','N' FROM DUAL;
                            END IF;
                            
                            IF ptosAcumulados > 0 THEN
                              INSERT INTO TMP_DOCUMENTO_ELECTRONICOS        
                              SELECT V_BOLD_I || vTextoAcum || V_BOLD_F || V_SEPARADOR || V_BOLD_I_2|| FID_F_GET_NUM_FORMATED(ptosAcumulados) || V_BOLD_F_2 || V_SEPARADOR || ' ' || vTextoAcum2,'0','I','N','N' FROM DUAL;
                            END IF;
                            
                            IF ptosRedimidos > 0 THEN
                              INSERT INTO TMP_DOCUMENTO_ELECTRONICOS        
                              SELECT V_BOLD_I || vTextoRedim || V_BOLD_F || V_SEPARADOR || V_BOLD_I_2|| FID_F_GET_NUM_FORMATED(ptosRedimidos) || V_BOLD_F_2 || V_SEPARADOR || ' ' || vTextoRedim2,'0','I','N','N' FROM DUAL;
                            END IF;
                            ...
                            */
                            ...
                            IF ptosTotal > 0 THEN
                              INSERT INTO TMP_DOCUMENTO_ELECTRONICOS        
                              SELECT V_BOLD_I || vTextoTotal || V_BOLD_F || V_SEPARADOR || V_BOLD_I_2|| FID_F_GET_NUM_FORMATED(ptosTotal) || V_BOLD_F_2 || V_SEPARADOR || ' ' || vTextoTotal2,'0','I','N','N' FROM DUAL;
                            END IF;
...
END;
  ...
  BEGIN
    ...
    codOperacion :=FARMA_UTILITY.OBTENER_NUMERACION('001',cCodLocal_in,'077');
    Farma_Utility.ACTUALIZAR_NUMERA_SIN_COMMIT('001', cCodLocal_in, '077', 'ASOSA');
...
--SI EL PEDIDO SOLO EMITE GUIA ES XQ ES CONVENIO AL 100% Y X LO TANTO NO DEBE TENER PUNTOS
  ...
  END;
    ...
    expertWord varchar2(50) := 'Experta del';
