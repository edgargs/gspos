...
public class DlgListaProductos extends JDialog{
           ...
           if (tblListaProductos.getSelectedRow() >= 0)
           {
             if (!(FarmaUtility.findTextInJTable(tblListaProductos, txtProducto.getText().trim(),1, 2)) ) 
             {
               ...
               return;
                   ...
                   System.out.println("primero key press");  
               }
           }
         } 
         chkKeyPressed(e);
              ...
              System.out.println("entro al enter");
                if(this.tblListaProductos.getRowCount()>0){
                    if(this.txtProducto.getText().length()>0){
                        System.out.println("antes de SeleccionarProducto()");  
                      SeleccionarProducto();
    ...
    private void SeleccionarProducto()
    {
      ...
      System.out.println("Seleccion :"+seleccion+ "producto: " +
      ...
      {     
        FarmaUtility.setCheckValue(tblListaProductos,true);
          ...
          System.out.println("VariablesRecepCiega.vCodProd :"+VariablesRecepCiega.vCodProd );   
          ...
          System.out.println(" VariablesRecepCiega.vValPrecVta  :"+ VariablesRecepCiega.vValPrecVta  ); 
