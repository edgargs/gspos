...
/****************************************************************************************************/
  ...
  BEGIN
    ...
    FARMA_PRINTER.P_AGREGA_TEXTO(vIdDoc_in => vIdDoc , 
                                      vIpPc_in => vIpPc, 
                                      vValor_in => 'POR FAVOR, VALIDE SU DOCUMENTO DE IDENTIDAD', 
