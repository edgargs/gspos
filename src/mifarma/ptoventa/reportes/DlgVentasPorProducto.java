  ...
  try
    {
      ...
      DBReportes.cargaListaVentasporProductoFiltro(tableModelVentasProducto,VariablesReporte.vFechaInicio, VariablesReporte.vFechaFin,pTipoFiltro,pCodFiltro);
      if (tblVentasProducto.getRowCount() > 0)		
      FarmaUtility.ordenar(tblVentasProducto, tableModelVentasProducto,1, FarmaConstants.ORDEN_ASCENDENTE);
