...
public class DlgListaMedicos extends JDialog 
{
  ...
  {
    tableModelListaMedicos = new FarmaTableModel(ConstantsVentas.columnsListaMedicos,ConstantsVentas.defaultValuesListaMedicos,0);
  ...
  private void guardaRegistroMedico()
  {
    if(tblMedicos.getRowCount() > 0){
      ...
      System.out.println("VariablesVentas.vArrayList_Medicos : " + VariablesVentas.vArrayList_Medicos);      
    }
  }
  ...
  private void obtieneDatosMedico()
  {
    if(VariablesVentas.vArrayList_Medicos.size() == 1){
      VariablesVentas.vCodListaMed = ((String)((ArrayList)VariablesVentas.vArrayList_Medicos.get(0)).get(0)).trim();
      VariablesVentas.vMatriListaMed=((String)((ArrayList)VariablesVentas.vArrayList_Medicos.get(0)).get(1)).trim();
      VariablesVentas.vNombreListaMed=((String)((ArrayList)VariablesVentas.vArrayList_Medicos.get(0)).get(2)).trim();
      System.out.println("VariablesVentas.vCodListaMed : " + VariablesVentas.vCodMed);
      System.out.println("VariablesVentas.vMatriListaMed : " + VariablesVentas.vMatriculaApe);
      System.out.println("VariablesVentas.vNombreListaMed : " + VariablesVentas.vNombreListaMed);
    }
  }
