...
public class FacadeConvenioBTLMF {
    ...
    public String grabarCobroPedidoRac(String pNumPedVta, String pCodLocal, String pCodGrupoCia, String indNotaCredito){
        String resultado = "N";
        daoRACConvenioBTLMF = null;
        try{
            //Abre conexion RAC
            ...
            FarmaVentaCnxUtility.enviaCorreoPorCnx(FarmaVariables.vCodCia, 
                                                   ...
                                                   emailEnvio, 
                                                   "ERROR DE COBRO EN RAC", 
                                                   "ERORR DE COBRO CONVENIOS EN RAC", 
                                                   "Mensaje:<br>"+
                                                   "Se produjo un error al grabar un pedido en RAC :<br>"+
                                                    "IP PC: " + FarmaVariables.vIpPc + "<br>"+ 
                                                    "Correlativo : " +pNumPedVta+"<br>"+
                                                    "Error: " + ex.getMessage(),
                                                    //"daubilluz@gmail.com");
                                                    "");
        }
    ...
    public void actualizaProformaRAC(String pCodCia, String pCodLocal, String pNumProforma, String pCodLocalSap, String pNumComprobantes, String fechaEnvio){//String pNumPedVta, String pCodLocal, String pCodGrupoCia){
        DAORACConvenioBTLMF daoRACConvenioBTLMF = null;
        try{
            //Abre conexion RAC
            daoRACConvenioBTLMF = FactoryConvenioBTLMF.getDAORACConvenioBTLMF(FactoryConvenioBTLMF.Tipo.MYBATIS);
            daoRACConvenioBTLMF.openConnection();
            daoRACConvenioBTLMF.actualizaProformaRAC(pCodCia, pCodLocal, pNumProforma, pCodLocalSap, pNumComprobantes ,fechaEnvio);
