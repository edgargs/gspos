...
public class DlgListaConvenios extends JDialog {
    ...
    private void initTableListaConvenios() {
        tableModelListaconvenios =
                new FarmaTableModel(ConstantsConvenio.columnsListaConvenios, ConstantsConvenio.defaultValuesListaConvenios,
                                    0);
    ...
    private void guardaRegistroConvenio() {
        ...
        if (vFila > -1) {
            ...
            VariablesConvenio.vIndConvCliDependiente =
                    FarmaUtility.getValueFieldJTable(tblConvenios, vFila, COLUMN_IND_CONV_DEP);
    ...
    private void obtieneDatosConvenio() {
        if (VariablesConvenio.vArrayList_ListaConvenio.size() == 1) {
            VariablesConvenio.vCodConvenio =
                    FarmaUtility.getValueFieldArrayList(VariablesConvenio.vArrayList_ListaConvenio, 0,
                                                        COLUMN_COD_CONV_);
