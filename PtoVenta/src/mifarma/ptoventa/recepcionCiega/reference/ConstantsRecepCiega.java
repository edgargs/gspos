...
public class ConstantsRecepCiega {
    ...
    //JMIRANDA 17.03.2010 COLUMNAS LISTA TRANSPORTISTA
       ...
       public static boolean error_du = false;
        ...
        new FarmaColumnData("Presentación.", 100, JLabel.LEFT),
        new FarmaColumnData("Cantidad", 60, JLabel.CENTER),
        new FarmaColumnData("Nro Lote", 80, JLabel.CENTER),
        new FarmaColumnData("Fecha Vcto",80, JLabel.CENTER),
        new FarmaColumnData("Embalaje", 80, JLabel.CENTER),
        new FarmaColumnData("Envase Mediato", 80, JLabel.CENTER),
        new FarmaColumnData("Envase Inmediato", 80, JLabel.CENTER),
        new FarmaColumnData("Rótulo", 80, JLabel.CENTER),
        new FarmaColumnData("Contenido", 80, JLabel.CENTER),
        new FarmaColumnData("R.S.", 80, JLabel.CENTER)
        };
