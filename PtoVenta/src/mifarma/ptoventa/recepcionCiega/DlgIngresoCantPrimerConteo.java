        ...
        if (isInteger(txtCantidad.getText().trim())) {
            try {
                ...
                if (Integer.parseInt(txtCantidad.getText()) == 0) {
                    if (!VariablesRecepCiega.vIndModificarCant) {
                        if (JConfirmDialog.rptaConfirmDialog(this, "¿Está seguro que no desea ingresar este producto?")) {
                        ...
                        if (JConfirmDialog.rptaConfirmDialog(this, "¿Está seguro que desea eliminar este producto?")) {
                            log.debug("Eliminar");
                            //VariablesRecepCiega.vLastCodBarra = "";
