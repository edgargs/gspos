...
public class DlgListaDiferenciasToma extends JDialog {
    ...
    private void chkKeyPressed(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_ESCAPE) {
            ...
            System.out.println("TODOS 1: "+todos);
            todos=!todos;
            System.out.println("TODOS 2: "+todos);
            ...
            for (int i = 0; i < tblRelacionDiferenciasProductos.getRowCount(); i++)
            {
                ...
                */
                ...
                System.out.println("Lista Dif Seleccionada: "+ VariablesInvDiario.vListadoProductosDiferenciaSeleccionadas);
    ...
    private void filtrarTablaProductos() {
        try {
            ...
            if (tblRelacionDiferenciasProductos.getRowCount() <= 0) {
                System.out.println(VariablesPtoVenta.vCodFiltro);
        ...
        if(validacionBoleta()) {
            if(generaPedidoTemporal()) {
                ...
                if (FarmaVariables.vAceptar) {
                    ...
                    System.err.println("Pedido Generado: " + VariablesInvDiario.vSecPedidoTemporal);
                    ...
                    try{
                       ...
                       System.err.println("ERROR IMPRESION:::");
                     } 
    ...
    */
    ...
    private void ajustarProd()
    {
        if (VariablesInvDiario.vListadoProductosDiferenciaSeleccionadas.size() > 0) {
            ...
            System.out.println("VariablesInvDiario.vListadoProductosDiferenciaSeleccionadas -->"+
                    ...
                    if (FarmaVariables.vAceptar) {
                        ...
                        if(agregarAjuste()){
                          ...
                          //verificar hoja em impresora
                            ...
                            System.err.println("AJUSTE ERROR:::::");
                        }
                    }else {
    ...
    private void realizarAjuste(){
        ...
        System.err.println("AJUSTE EXITOSO");
        ...
        try
           {
            ...
            System.out.println("SE GRABO NUEVO AJUSTE : "+CodAjust);
             // FarmaSearch.updateNumera("072");
             // FarmaUtility.aceptarTransaccion();
               return true;
           }catch (SQLException sql)
    ...
    private void obetenerTotal(){
        ...
        if(VariablesInvDiario.vListadoProductosDiferenciaSeleccionadas.size()>0){
          ...
          VariablesInvDiario.dTotalProds=total;
            System.out.println("Monto total pre : "+VariablesInvDiario.dTotalProds);
          VariablesInvDiario.dTotalProds = FarmaUtility.getDecimalNumber(FarmaUtility.formatNumber(VariablesInvDiario.dTotalProds,2));
          System.out.println("Monto total de productos : "+VariablesInvDiario.dTotalProds);
            total=0.00;
        }
    ...
    private  void imprimirAjuste() throws Exception{
        System.out.println("Imprimir resultado ajuste");
        
        if (!FarmaUtility.rptaConfirmDialog(this,"¿Está seguro que desea imprimir?"))
            return;
        ...
        vPrint.printBold("Registros Impresos: " + FarmaUtility.formatNumber(tblRelacionDiferenciasProductos.getRowCount(),",##0") + 
                ...
                System.out.println(":::::::::ERROR DE IMPRESION REPORTE::::::::::::.");
            } 
    }
  }
    ...
    private  void imprimirBoleteo(String pSecPedidoTemporal) throws Exception{
        ...
        System.out.println("Imprimir pedido generado en boleteo");
        if (!FarmaUtility.rptaConfirmDialog(this, 
                                            "¿Está seguro que desea imprimir?"))
            return;
        String vImp = FarmaVariables.vImprReporte;
        ...
        if (!vPrint.startPrintService()) {
            ...
            try {
                ...
                System.out.println("Error Prueba Impresion ");
            }
        }
