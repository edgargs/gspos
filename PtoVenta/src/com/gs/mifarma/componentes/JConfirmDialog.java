...
public class JConfirmDialog extends JDialog {
    ...
    public static boolean rptaConfirmDialogDefaultNo(Object pJDialog,  String pMensaje) {
        return rptaConfirmDialog(pJDialog, pMensaje, true);
    }

    public static boolean rptaConfirmDialog(Object pJDialog, String pMensaje) {
        return rptaConfirmDialog(pJDialog, pMensaje, false);
    }
    
    private static boolean rptaConfirmDialog(Object pJDialog,  String pMensaje, boolean pValue) {
        log.warn(pMensaje);
    ...
    public static void main(String[] args) {
        JConfirmDialog.rptaConfirmDialogDefaultNo(null,"¿Cuál es la edad del paciente?");            
    }   
}
