...
public class DlgListaPromocion extends JDialog 
{
  ...
  {
    tableModelListaPromociones = new FarmaTableModel(ConstantsVentas.columnsListaPromociones,ConstantsVentas.defaultValuesListaPromociones,COL_COD);
    FarmaUtility.initSimpleList(tblPromociones,tableModelListaPromociones,ConstantsVentas.columnsListaPromociones);
  }
  ...
  */
  private void listarPromociones()
  {
    try
    {
      ...
      {
        DBVentas.listaPromocionesPorProducto(tableModelListaPromociones,VariablesVentas.vCodProdFiltro);
       lblVerTodos.setText("[F1] Ver todas");
  ...
  private void mostrarDetallePromociones()
  {
   ...
   VariablesVentas.vDesc_Prom=FarmaUtility.getValueFieldJTable(tblPromociones,row,COL_DESL);
    ...
    if (row > -1) {
     ...
     FarmaUtility.showMessage(this,"La promocion "+VariablesVentas.vDesc_Prom+
