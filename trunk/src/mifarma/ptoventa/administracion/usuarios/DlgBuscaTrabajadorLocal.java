...
public class DlgBuscaTrabajadorLocal extends JDialog {
    ...
    private void cargaListaTrabajadores() {
        try {
            ...
            //System.out.println("Lista de trabajadores cargada!");
    ...
    private void txtDniApe_keyReleased(KeyEvent e) {
        if (txtDniApe.getText().length() == 1) {
            if (e.getKeyChar() >= '0' && e.getKeyChar() <= '9') {
                //System.out.println("BUSCA DNI");
                VariablesUsuarios.vColBuscarTrab = COL_DNI;
            } else {
                //System.out.println("BUSCA APELLIDO");
        ...
        if (e.getKeyCode() == KeyEvent.VK_F11) {
            ...
            if (VariablesUsuarios.vCarne.length()==0){
                ...
                try {
                    ...
                    System.err.println("fecha_ven :" +fecha_ven );
                     if (fecha_ven.trim().equalsIgnoreCase("NV")) //El Nro Carné no está vencido.
                     
                         System.err.println("Ya se ha registrado el  Carné para este Trabajador ");
                        // FarmaUtility.showMessage(this, "Ya se ha registrado el Nro. Carné para este Trabajador", txtDniApe);
                         ...
                         if (FarmaUtility.rptaConfirmDialog(this, "El Carné de Sanidad para este Trabajador  venció el " +
                         ...
                         if (FarmaUtility.rptaConfirmDialog(this, "El Carné de Sanidad para este Trabajador está próximo a vencer el " +
                                                                   VariablesUsuarios.vFechaVencimiento +  "\n" +
                                                      "¿Desea ingresar el nuevo Número de Carné de Sanidad?")) {
    ...
    private void cargaDatosTrabajador() {
        ...
        System.err.println("VariablesUsuarios.vCodTrab :" + VariablesUsuarios.vCodTrab);
        System.err.println("VariablesUsuarios.vCodTrab_RRHH :"  + VariablesUsuarios.vCodTrab_RRHH);    
        System.err.println("VariablesUsuarios.vCarne :"  + VariablesUsuarios.vCarne); 
        System.err.println("VariablesUsuarios.vFechaVencimiento :"  + VariablesUsuarios.vFechaVencimiento); 
