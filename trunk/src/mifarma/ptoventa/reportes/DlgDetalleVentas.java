...
public class DlgDetalleVentas extends JDialog 
{
  ...
  private void jbInit() throws Exception
  {
    ...
    tblRegistroVentas.addKeyListener(new java.awt.event.KeyAdapter()
      {
        public void keyPressed(KeyEvent e)
        {
    ...
    tblDetalleVentas.addKeyListener(new java.awt.event.KeyAdapter()
      {
        public void keyPressed(KeyEvent e)
        {
    ...
    lblEsc.setBounds(new Rectangle(640, 370, 85, 20));
    lblEsc.setText("[ ESC ] Cerrar");
    lblF12.setBounds(new Rectangle(510, 370, 110, 20));
    lblF12.setText("[ F12 ] Imprimir");
    lblF9.setBounds(new Rectangle(395, 370, 85, 20));
   ...
   // jLabelFunction1.setText("[ F8 ] Guardar Archivo");
    ...
    lblF1.setBounds(new Rectangle(10, 370, 120, 20));
    lblF1.setText("[ F1 ] Ver Resumen");
    lblF3.setBounds(new Rectangle(0, 0, 80, 20));
    lblF3.setText("[ F6] Filtrar");
    lblF4.setBounds(new Rectangle(265, 370, 105, 20));
  ...
  private void cargaVentasFiltro()
  {
    try
    {
      System.out.println(VariablesReporte.vFechaInicio);
      System.out.println(VariablesReporte.vFechaFin);
      DBReportes.cargaListaFiltroDetalleVentas(tableModelDetalleVentas,VariablesReporte.vFechaInicio, VariablesReporte.vFechaFin,VariablesReporte.vCampoFiltro);
      if(tblDetalleVentas.getRowCount() <= 0){
