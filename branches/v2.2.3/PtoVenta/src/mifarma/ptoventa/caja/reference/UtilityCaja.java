...
public class UtilityCaja {
  ...
  public static void imprimeComprobantePago(JDialog pJDialog,
                                            ...
                                            boolean indAnulado) throws Exception {
  ...
  if ( pTipCompPago.equalsIgnoreCase(ConstantsVentas.TIPO_COMP_BOLETA) ){
   ...
   log.debug("*******JCORTEZ**********");
    ...
    }else if ( pTipCompPago.equalsIgnoreCase(ConstantsVentas.TIPO_COMP_FACTURA) )
    {
      ...
      {
        log.debug("*******imprimir factura para venta institucional**********");
...
*/
  ...
  private static boolean validaCodigoRespuestaTransaccion() 
  {
    ...
    log.debug("VariablesVirtual.vCodigoRespuesta 1" + VariablesVirtual.vCodigoRespuesta);
    /*  log.debug( 
    ...
    private static void imprimeBoletaTicket(JDialog   pJDialog,
        ...
        FarmaVariables.vNroPedidoNoImp = VariablesCaja.vNumPedVta;           
            ...
            try {
                ...
                ImpresoraTicket ticketera = new ImpresoraTicket();
                ticketera.generarDocumento(pJDialog,vPrint,pNomImpreso,pFechaBD,pNumComprobante,pDetalleComprobante,pValTotalNeto,pValTotalAhorro,pValRedondeo,VariablesCaja.vModeloImpresora,indAnulado);
                boolean bImprimio = ticketera.imprimir(vPrint,VariablesCaja.vModeloImpresora,VariablesCaja.vRutaImpresora,true,pNumComprobante,"C",VariablesCaja.vNumPedVta);    
           ...
           if (!htmlTicket.equals("N"))                      
           {
              ...
              st = new StringTokenizer(htmlTicket, "Ã");
               ...
               vPrint.add(FarmaPRNUtility.llenarBlancos(1)+ "----------Anulación de Pedido----------");                              
                 ...
                 vResultado = ticketera.imprimir(vPrint,VariablesCaja.vModeloImpresora,VariablesCaja.vRutaImpresora,true,pNumComprobante,"A",numpedido);    
    ...
    */     
    ...
    public static boolean impresionEnLote(JDialog pDialogo,JTable jTable){
        ...
        try{
            ...
            DBCaja.imprimirStickerPorLote(lista,vCodigos.substring(0, vCodigos.length()-1));
            String html = "";
            //Agregamos el salto de línea para separa los registros con los códigos de los tickets.
            for(int i = 0; i< lista.size();i++){
                String record = lista.get(i).toString();
                html = html + "\n" + record;
                }
            ...
            log.error("",e);
            JOptionPane.showMessageDialog(null, "Ocurrió el siguiente error al imprimir los tickets :\n"+                                            
