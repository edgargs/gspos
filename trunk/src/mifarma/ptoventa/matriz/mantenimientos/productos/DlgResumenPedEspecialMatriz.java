...
{  
  ...
  private void initialize()
  {
    ...
    System.out.println("Productos agregados "+ VariablesProducto.vArrayProductosEspeciales.size());
  ...
  private void this_windowOpened(WindowEvent e)
  {
    ...
    lblCantProductosT.setText(""+tblListaProductos.getRowCount());
      System.out.println("Open - VariablesInventario.vEsModificado "+VariablesProducto.vEsModificado);
    if(VariablesProducto.vEsModificado){
        ...
        if(FarmaVariables.vAceptar){
            ...
            System.out.println(" cargan los productos seleccionados:::::");
            cargarResumenPedidoEsp();
            }else{
                System.out.println(" CERRARRRR:::::");
                cerrarVentana(false);
            }
  ...
  private void chkKeyPressed(KeyEvent e)
  {
    	...
    	if( !VariablesProducto.flag_F3 ) {
	        ...
	        if(FarmaVariables.vAceptar){
	        	...
	        	cargarResumenPedidoEsp();
                        ...
                        System.out.println("VariablesProducto.vArrayProductosEspeciales-->"+
                                           VariablesProducto.vArrayProductosEspeciales);
                        System.out.println("VariablesProducto.vArrayListaProdsEsp-->"+
    		...
    		System.out.println("Ya se tiene abierto al ventana de listado de productos especiales !");
    	}
    }else if(e.getKeyCode() == KeyEvent.VK_F11)
    {
        if(VariablesProducto.vArrayProductosEspeciales.size()<1){
            ...
            //if(validaItemPedEspecial(ConstantsInventario.CONS_ING_PED_ESPC)){
            	...
            	if(FarmaUtility.rptaConfirmDialog(this,mensaje)){
            		generaPedido();
            	}
            //}
    ...
    }else if(e.getKeyCode() == KeyEvent.VK_ESCAPE)
    {
        ...
        System.out.println("indCierraVenta:"+indCierraVenta);
        System.out.println("VariablesProducto.vIrResumen:"+VariablesProducto.vIrResumen);
        System.out.println("VariablesProducto.vFModificar:"+VariablesProducto.vFModificar);
        System.out.println("VariablesProducto.vFNuevo:"+VariablesProducto.vFNuevo);
        //System.out.println("validaAccionModificacion:"+validaAccionModificacion);
            ...
            if (!VariablesProducto.vIrResumen) {
                ...
                if (VariablesProducto.vFModificar) {
                        try {
                            ...
                            System.out.println("Close - VariablesProducto.vEsModificado " + 
  ...
  private void generaPedido(){
    ...
    try{
      ...
      int cantItem=VariablesProducto.vArrayProductosEspeciales.size();
        ...
        System.out.println("VariablesProducto.vEsModificado (false-->nuevo; true-->modificado) :"+VariablesProducto.vEsModificado);
      if(VariablesProducto.vEsModificado){//actualmente deshabilitado
          ...
          System.out.println("Numero de pedido Matriz generado :"+VariablesProducto.vNumPedidoEspecialMatriz);
