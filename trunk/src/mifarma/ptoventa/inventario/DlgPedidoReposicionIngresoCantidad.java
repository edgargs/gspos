...
public class DlgPedidoReposicionIngresoCantidad extends JDialog
{
  ...
  private boolean validaIngresoExistsAdicional()
  {
    ...
    System.out.println("canAdicional : " + canAdicional);
    System.out.println("canPed       : " + canPed);
    if(canAdicional>0)
    {
      System.out.println("VariablesInventario.vCant_PedRep : " + FarmaUtility.getDecimalNumber(VariablesInventario.vCant_PedRep.trim()));
      System.out.println("VariablesInventario.vCantMax_PedRep : " + FarmaUtility.getDecimalNumber(VariablesInventario.vCantMax_PedRep.trim()));
