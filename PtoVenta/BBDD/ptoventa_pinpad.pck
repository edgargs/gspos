  ...
  BEGIN
      ...
      THEN
          ...
          IF (cTip_copia_in = 'C') THEN
              ...
              --se arma la cabecera del voucher para la impresión
              OBTENER_CABECERA_VOUCHERS_2(cCodGrupoCia_in,cCod_Local_in,OPERADOR_VISA);
...
--  RETURN FarmaCursor
  ...
  BEGIN
   ...
   SELECT MG.NOM_MARCA,
    ...
    -- CABECERA
    INSERT INTO TMP_VOUCHER_TARJETA
    SELECT DECODE(nTipoOperador_in,OPERADOR_VISA,'VISANET', OPERADOR_MC,'PROCESOS DE MEDIOS DE PAGO S.A.'),'0','C','N','S'
    FROM DUAL;
