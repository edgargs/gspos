    ...
    private void imprimirSticker() {
        ...
        if (selectedRow >= 0) {
            ...
            try {
                ...
                String codigoEPL = facadeProducto.obtenerCodigoEPLPorProducto(this, codigo);
                String vStock = codigoEPL.substring(codigoEPL.indexOf("Ã") + 1);
                ...
                if (flag) {
                    ...
                    if (stockProd == 0) {
                        rspta =
                                JConfirmDialog.rptaConfirmDialogDefaultNo(this, "Producto no cuenta con stock\n¿Desea continuar?");
                    }
                    if (rspta) {
                ...
                } else { // KMONCADA 18.09.2014 MSJ DE NO EXISTE IMPRESORA
                    FarmaUtility.showMessage(this, "No se encuentra configurada la impresora de Sticker, Verifique!!!",
                                             txtProducto);
                }
            } catch (Exception e) {
