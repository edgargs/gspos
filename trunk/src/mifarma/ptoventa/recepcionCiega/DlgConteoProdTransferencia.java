...
public class DlgConteoProdTransferencia extends JDialog{
   ...
   // private ArrayList myArray = new ArrayList();    
    ...
    private void tblListaProductos_keyPressed(KeyEvent e) {
        System.out.println("tblListaProductos_keyPressed");        
        chkKeyPressed(e);
    ...
    private void chkKeyPressed(KeyEvent e){        
        ...
        if (e.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            if (tblListaProductos.getRowCount() > 0) {
                if (!FarmaUtility.rptaConfirmDialog(this,"¿Está seguro de eliminar el producto de la transferencia?"))
                    return;
                eliminarProducto();
   ...
   /*
    ...
    private boolean grabar()
    {
      ...
      {  
          ...
          System.out.println("VariablesRecepCiega.vTipoDestino_Transf :"+ VariablesRecepCiega.vTipoDestino_Transf);
          System.out.println("VariablesRecepCiega.vCodDestino_Transf :"+ VariablesRecepCiega.vCodDestino_Transf);
          System.out.println("VariablesRecepCiega.vMotivo_Transf :"+ VariablesRecepCiega.vMotivo_Transf);
          System.out.println("VariablesRecepCiega.vDestino_Transf :"+ VariablesRecepCiega.vDestino_Transf);
          System.out.println("VariablesRecepCiega.vRucDestino_Transf :"+ VariablesRecepCiega.vRucDestino_Transf);
          System.out.println("VariablesRecepCiega.vDirecDestino_Transf :"+ VariablesRecepCiega.vDirecDestino_Transf);
          System.out.println("VariablesRecepCiega.vTransportista_Transf :"+ VariablesRecepCiega.vTransportista_Transf);
          System.out.println("VariablesRecepCiega.vRucTransportista_Transf :"+ VariablesRecepCiega.vRucTransportista_Transf);
          System.out.println("VariablesRecepCiega.vDirecTransportista_Transf :"+ VariablesRecepCiega.vDirecTransportista_Transf);
          System.out.println("VariablesRecepCiega.vPlacaTransportista_Transf :"+ VariablesRecepCiega.vPlacaTransportista_Transf);
          System.out.println(" tblListaProductos.getRowCount() :"+  tableModelProductos.getRowCount());
          System.out.println("VFarmaUtility.sumColumTable(tblListaProductos,7) :"+ suma);
          System.out.println("VariablesRecepCiega.vMotivo_Transf_Interno :"+ VariablesRecepCiega.vMotivo_Transf_Interno);
    ...
    private void eliminarProducto(){
        if (tableModelProductos.getRowCount() > 0) {
            ...
            if (existeProductoEnLista(codProducto)) {
                ...
                System.err.println("cantidadEnteroTotal:"+cantidadEnteroTotal);
                System.err.println("cantidad:"+cantidad);
                System.err.println("val_frac:"+val_frac);
