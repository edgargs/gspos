...
public class DlgIngresoCantVerificaConteo extends JDialog{
    ...
    private void jbInit() throws Exception {
        ...
        lblDescProducto_T.setBounds(new Rectangle(10, 20, 95, 15));
        ...
        lblDescProducto.setBounds(new Rectangle(110, 20, 150, 15));
        lblUnidad_T.setText("Unidad");
        lblUnidad_T.setBounds(new Rectangle(10, 45, 95, 15));
        lblUnidad_T.setForeground(new Color(225, 130, 14));
        lblUnidad.setText("und");
        lblUnidad.setBounds(new Rectangle(110, 45, 90, 15));
