...
public class DlgIngreseCodBarra extends JDialog {
    ...
    private void validaCodBarra(){
        System.out.println("varVentas: "+VariablesVentas.vCodigoBarra);
        ...
        try{
              ...
              System.out.println("producto: "+productoBuscar);
           }catch(Exception sql){
        ...
        {
            System.out.println("vvVCod_prod: "+VariablesVentas.vCod_Prod);
