...
public class VariablesVirtual {
    public VariablesVirtual() {
    }
    ...
    //INI ASOSA - 17/07/2014
    public static String vValorMinimo = "";
    public static String vValorMaximo = "";
    //FIN ASOSA - 17/07/2014
