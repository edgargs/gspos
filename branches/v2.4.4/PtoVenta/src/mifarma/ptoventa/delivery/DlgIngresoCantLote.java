  ...
  // **************************************************************************
	...
	private void chkKeyPressed(KeyEvent e) {
      ...
      if(tblListaIngresoLote.getRowCount() <=0 ) return;
			if( com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this, "Está seguro de eliminar el número de lote?") )
        eliminaProductoLoteCant();
		} else if (mifarma.ptoventa.reference.UtilityPtoVenta.verificaVK_F11(e)) {
      if(tblListaIngresoLote.getRowCount() <=0 ) return;
			if( com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this, "Está seguro de agregar los lotes por producto?") ){
...
// **************************************************************************
    ...
    private void cargaListaMaestros(String pTipoMaestro, JTextField pJTextField_Cod){
        ...
        if(!isControlLote){
            loteVacio = !(JConfirmDialog.rptaConfirmDialog(this, "Producto no controla lote\n¿Desea registrar lote?"));
            if(loteVacio){
