...
import mifarma.ptoventa.inventariociclico.DlgProductosInvCiclico;
...
public class DlgInicioInveDiario extends JDialog {
    ...
    private void chkKeyPressed(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_ESCAPE) {
            ...
            if (FarmaVariables.vEconoFar_Matriz)
                ...
                FarmaUtility.showMessage(this, 
                                         "El usuario no tiene el rol para iniciar una toma de inventario cíclico", 
                                         txtProductos);
            }
    ...
    private void aceptar() {
        if (FarmaUtility.rptaConfirmDialog(this, 
                                           "¿Está seguro de grabar el inventario Diario?"))
            try {
                DBInvDiario.grabarInventarioDiario();
                FarmaUtility.aceptarTransaccion();
                FarmaUtility.showMessage(this, 
                                         "El inventario se grabó correctamente.", 
                                         txtProductos);
                cerrarVentana(true);
            } catch (SQLException e) {
                FarmaUtility.liberarTransaccion();
    ...
    private void imprimir() {
        ...
        try {
            ...
            vPrint.printBold(FarmaPRNUtility.llenarBlancos(27) + 
                             " REPORTE DE PRODUCTOS PARA INVENTARIO Diario", 
                             true);
            vPrint.printBold("Nombre Compañia : " + 
                             FarmaVariables.vNomCia.trim(), true);
            vPrint.printBold("Nombre Local : " + FarmaVariables.vCodLocal + 
            ...
            for (int i = 0; i < tblRelacionProductos.getRowCount(); i++) {
                ...
                vPrint.printCondensed(FarmaPRNUtility.alinearIzquierda((String)tblRelacionProductos.getValueAt(i, 
                                                                                                               0), 
                                                                       8) + 
                                      FarmaPRNUtility.alinearIzquierda((String)tblRelacionProductos.getValueAt(i, 
                                                                                                               1), 
                                                                       42) + 
                                      FarmaPRNUtility.alinearIzquierda((String)tblRelacionProductos.getValueAt(i, 
                                                                                                               2), 
                                      ...
                                      FarmaPRNUtility.alinearIzquierda((String)tblRelacionProductos.getValueAt(i, 
                                                                                                               4), 
                                                                       15) + 
                                      FarmaPRNUtility.alinearDerecha((String)tblRelacionProductos.getValueAt(i, 
                                                                                                             5), 
                                                                     10) + 
                                      FarmaPRNUtility.alinearIzquierda(" __________", 
                                                                       11), 
                                      true);
            }
            vPrint.activateCondensed();
            ...
            vPrint.printLine(" ", true);
            vPrint.printLine(" ", true);
            vPrint.printLine(FarmaPRNUtility.llenarBlancos(33) + 
            ...
            vPrint.printLine(FarmaPRNUtility.llenarBlancos(33) + 
                             ...
                             FarmaPRNUtility.llenarBlancos(10) + 
                             "   Nombre y Firma del Auditor", true);
            vPrint.deactivateCondensed();
