...
//**************************************************************************
  ...
  lblTotal.setText(FarmaUtility.formatNumber(tot));
    ...
    private void muestraComprobantesOrd() {
        ...
        FarmaLoadCVL.loadCVLfromArrays(dlgOrdenar.getCmbOrden(), "ORDENCAMPOS", indDescOrden,
                                       indCodOrden, true);
        ...
        if (FarmaVariables.vAceptar) {
            ...
            FarmaUtility.ordenar(tblListaComprobantes, tableModelListaComprobantes, 
                                 ...
                                 Integer.parseInt(FarmaLoadCVL.getCVLCode("CAMPOSREPORTEPEDIDOSCOMPROBANTES",dlgOrdenar.getCmbCampo().getSelectedIndex())),
