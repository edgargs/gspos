...
public class DlgControlSobres extends JDialog 
{
  ...
  private void chkKeyPressed(KeyEvent e)
  {
    ...
    */
    ...
    {
      /*if(FarmaUtility.rptaConfirmDialog(this, "Esta seguro de eliminar el sobre creado?")){
        borrarSobre();    
      ...
      /*  int cant=0;
       if(tblSobres.getRowCount()>0){
            ...
            if(cant>0){
                if(FarmaUtility.rptaConfirmDialog(this, "Esta seguro de registrar los sobres ingresados?")){
                    guardarCreados();
                }
            }else
    ...
    } else if(e.getKeyCode() == KeyEvent.VK_ESCAPE)
    {
      ...
      else if(e.getKeyCode() == KeyEvent.VK_F2)
      {
           if(lblAgregar.isVisible())
            ...
            if(btnReimp.isVisible()) reimprimir();
        }
  }
  ...
  private void aprobarSobre(){
        ...
        System.out.println("ESTADO :"+estado);
         ...
         if(estado.equalsIgnoreCase("A")){
          ...
          FarmaUtility.showMessage(this,"Este sobre ya ha sido rechazado.",tblSobres);
                ...
                if(FarmaUtility.rptaConfirmDialog(this,"¿Esta seguro de aprobar el sobre?")){
   ...
   /**
    ...
    {  
        ...
        if(tblSobres.getRowCount()>0){
            for(int i = 0; i < tableModelLista.data.size(); i++){
                //valida sobre
                //System.out.println("obtiene estado->"+FarmaUtility.getValueFieldArrayList(tableModelLista.data,tblSobres.getSelectedRow(),8).trim());
                ...
                { 
                    ...
                    //System.out.println("obtiene estado-> "+isAprobado+" - "+codSobre);
    ...
    private void accionFunciones(String pTipoAccion){
        ...
        if(pPos>=0||pTipoAccion.toUpperCase().trim().equalsIgnoreCase(ConstantsSobres.ACC_INGRESO)) { // , 10.06.2010
            if (pTipoAccion.toUpperCase().trim().equalsIgnoreCase(ConstantsSobres.ACC_MODIFICA) || 
                ...
                System.err.println("pSec:"+pSec);
                System.err.println("pCodigoSobre:"+pCodigoSobre);
                System.err.println("pSecMovCaja:"+pSecMovCaja);
            }
    ...
    private void reimprimir(){
        ...
        System.out.println("SecSobre: "+secSobre);
