...
public class DlgFidelizacionValidaDocumento extends JDialog {
   ...
   private void obtenerDatos(){
      ...
      System.err.println("VariablesOtros.Tip_doc-->"+VariablesOtros.Tip_doc);
      ...
      System.err.println("VariablesOtros.vDniCliente-->"+VariablesOtros.vDniCliente);
       System.err.println("VariablesOtros.Num_Doc-->"+VariablesOtros.Num_Doc);
       System.err.println("VariablesOtros.Tip_doc-->"+VariablesOtros.Tip_doc);
         if(VariablesOtros.Num_Doc.equalsIgnoreCase(VariablesOtros.vDniCliente_bk.trim())){
              ...
              if(pIndValidaClaveConfirmacion.trim().equalsIgnoreCase("S")){
                  if ( FarmaVariables.vAceptar ) {
                      System.err.println("VariablesOtros.Desc_Tip_doc-->"+VariablesOtros.Desc_Tip_doc);
                      System.err.println("VariablesOtros.vNomCliente-->"+VariablesOtros.vNomCliente);
    ...
    private void enviarCorreo(){
        try{
            ...
            // System.out.println("Ocurrio un error al enviar correo de confirmacion");
          }
    }
    ...
    private void calculoTamanoLogin(String vMensaje){
        ...
        System.out.println("jp1: "+ jPanelTitle1.getSize().getHeight());
       // System.out.println("lblMensaje: "+ lblMensaje.getSize().getHeight());
