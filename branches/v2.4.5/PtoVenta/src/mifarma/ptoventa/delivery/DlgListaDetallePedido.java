  ...
  private void btnDetallePedido_actionPerformed(ActionEvent e)
  {
	...
	private void chkKeyPressed(KeyEvent e) {
			...
			if(tblListaDetallePedido.getRowCount() > 0)
      {
          ...
          if(com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,"Está seguro de generar el pedido institucional?"))
            cerrarVentana(true);
      }
...
// **************************************************************************
  ...
  private void obtieneValores()
  {
    ...
    VariablesDelivery.vUnidVta  =   FarmaUtility.getValueFieldJTable(tblListaDetallePedido,tblListaDetallePedido.getSelectedRow(),3);//04.08.2014
  }
  ...
  private void verificaCheckJTable()
  {
    ...
    {
      if(com.gs.mifarma.componentes.JConfirmDialog.rptaConfirmDialog(this,"Esta acción eliminará todas las cantidades seleccionadas.\nEstá seguro de eliminar?"))
