...
// **************************************************************************
  ...
  {
    if(tblListaUltimos.getRowCount() > 0){
      numPedVta = (FarmaUtility.getValueFieldArrayList(tableModelCabeceraUltimosPedidos.data, tblListaUltimos.getSelectedRow(),1)).trim();
    ...
    private void cargaDatosCabecera() {
        if (tblListaUltimos.getRowCount() > 0) {
            ...
            nomCli = FarmaUtility.getValueFieldArrayList(tableModelCabeceraUltimosPedidos.data, tblListaUltimos.getSelectedRow(), 6).trim();
            dirCli = (FarmaUtility.getValueFieldArrayList(tableModelCabeceraUltimosPedidos.data, tblListaUltimos.getSelectedRow(), 7)).trim();
            telefono = (FarmaUtility.getValueFieldArrayList(tableModelCabeceraUltimosPedidos.data, tblListaUltimos.getSelectedRow(), 8)).trim();
            indConv = (FarmaUtility.getValueFieldArrayList(tableModelCabeceraUltimosPedidos.data, tblListaUltimos.getSelectedRow(), 11)).trim();
            CodConvPedVta = (FarmaUtility.getValueFieldArrayList(tableModelCabeceraUltimosPedidos.data, tblListaUltimos.getSelectedRow(), 12)).trim();
  ...
  private boolean validaStockLocal()
  {
    ...
    for(int i=0; i<tblDetalle.getRowCount(); i++)
    {
      ...
      try {
          String numPedVta = (FarmaUtility.getValueFieldArrayList(tableModelCabeceraUltimosPedidos.data, tblListaUltimos.getSelectedRow(),1)).trim();
