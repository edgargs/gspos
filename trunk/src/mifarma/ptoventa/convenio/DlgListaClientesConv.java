  ...
  extends JDialog
{
  ...
  private void txtDescripcion_keyPressed(KeyEvent e)
  {
    ...
    if (e.getKeyCode() == KeyEvent.VK_ENTER)
    {
      ...
      * @since  : 18.08.2008
      */
       System.out.println("TIPO FILTRO CONSULTA :"+VariablesConvenio.vTipoFiltro);
  ...
  private void chkKeyPressed(KeyEvent e)
  {
    ...
    else if (e.getKeyCode() == KeyEvent.VK_ENTER)
    {
      ...
      if (e.getKeyCode() == KeyEvent.VK_F1)
      {
        if(lblF1.isVisible())
        { 
          System.out.println("Se listan los dependientes del cliente");
  ...
  private void guardaValoresMaestro()
  {
    ...
    System.out.println("VariablesConvenio.vCodTrab : "+VariablesConvenio.vCodTrab);
    System.out.println("VariablesConvenio.vNomCliente : "+VariablesConvenio.vNomCliente);
    System.out.println("VariablesConvenio.vCodClienteDependiente : "+VariablesConvenio.vCodClienteDependiente);                
    System.out.println("VariablesConvenio.vCodClienteDependiente : "+VariablesConvenio.vNumDocIdent);                
