...
public class DBDelivery
{
  ...
  public static void obtieneNombreDniCliente(FarmaTableModel pTableModel,
     ...
     * @throws SQLException
     */
    public static void obtieneTelefonoDireccion(FarmaTableModel pTableModel, String pTelefono,
                                                String pTipoTelefono,String pCodCli) throws SQLException {
        parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(pTelefono);
    ...
    public static String agregaCliente(String pNomCli,String pApePatCli,String pApeMatCli,
                                       String pTipDoc,String pNumDoc,String pIndCli,
                                       String pTelefono,String pObs)throws SQLException
    {
      parametros = new ArrayList();
      parametros.add(FarmaVariables.vCodGrupoCia);
      parametros.add(FarmaVariables.vCodLocal);
    ...
    public static String agregaDireccion(String pTipCalle,String pNomCalle,String pNumCalle,
                                         ...
                                         String pCodCli,String pCodCliNuevo,
                                         String pCodDep,
                                         String pCodProv,
                                         String pCodDistr,
                                         String pUrban
    ...
    public static String actualizaCliente(String pCodCliente,
                                          ...
                                          String pApellidoPat,
                                          String pApellidoMat,
                                          String pDni,String pObs) throws SQLException {
      parametros = new ArrayList();
      parametros.add(FarmaVariables.vCodGrupoCia);
      parametros.add(FarmaVariables.vCodLocal);
  ...
  public static String obtieneLocalOrigen(String pNumPed)throws SQLException
  {
    ...
    public static void cargaListaDetPedidos(FarmaTableModel pTableModel, String pNumPedVta, String pCodLocal, boolean filtrar) 
    throws SQLException {
  ...
  public static String isContienLotesProductos(String pLocalDelivery,String pNumPedidoDelivery)throws SQLException
  {
    ...
    public static void cambiaDirPrincipalCli(String pCodDir, String  pCodCli)throws SQLException
    {
      ...
      FarmaDBUtility.executeSQLStoredProcedure(null,"PTOVENTA_DEL_CLI.CLI_CAMBIA_DIR_PRINCIPAL(?,?,?,?)",parametros,false);
    }
    ...
    public static void cargarListaDetTransferenciaPedido(FarmaTableModel pTableModel,
                                                         String pCodLocal,
        ...
        parametros.add(pCodLocal);
        parametros.add(pNumPedVta);
        FarmaDBUtility.executeSQLStoredProcedure(pTableModel, "PTOVENTA_DEL_CLI.CLI_LISTA_TRANSFERENCIA(?,?,?)", parametros, false);
    }    
    ...
    public static void cargaLotesNumeroEntrega() throws SQLException {
      ...
      FarmaDBUtility.executeSQLStoredProcedure(null,"PTOVENTA_DEL_CLI.CARGA_LOTES_ENTREGA(?,?,?,?)",parametros,false);
    }    
    ...
    public static List getComprobanteProforma(String pCodGrupoCia, String pCodLocal, String pNumPedVta) throws Exception {
    ...
    public static void getFaltanteStkDLV(ArrayList pTableModel,
                                         String pNumPedVta,
                                         String pCodLocal) throws SQLException {
      ...
      FarmaDBUtility.executeSQLStoredProcedureArrayList(pTableModel,"PTOVENTA_DEL_CLI.VALIDA_STK_PEDIDO(?,?,?,?)",parametros);
    } 
