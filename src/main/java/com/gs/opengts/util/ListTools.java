...
public class ListTools {
        ...
        if (list == null) {
            ...
            for (Iterator<T> i = list.iterator(); i.hasNext(); index++) {
                ...
                if (listItem == item) {    // also takes care of 'null == null'
                    return index;
                } else if ((listItem != null) && listItem.equals(item)) {
                    return index;
                }
            }
    ...
    public static java.util.List<String> toList(StringTokenizer st, java.util.List<String> list) {
        java.util.List<String> v = (list != null)
                                   ? list
                                   : new Vector<String>();
    ...
    public static Map<Object, Object> toMap(Object arry[][], Map<Object, Object> map) {
        Map<Object, Object> m = (map != null)
                                ? map
                                : new HashMap<Object, Object>(); //OrderedMap<Object, Object>();
    ...
    {
        if (list != null) {
            int   ndx     = ((index > list.length) || (index < 0))
                            ? list.length
                            : index;
            Class type    = list.getClass().getComponentType();
            int   size    = (list.length > ndx)
                            ? (list.length + 1)
                            : (ndx + 1);
