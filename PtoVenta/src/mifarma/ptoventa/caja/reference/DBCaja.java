 ...
 */
    ...
    public static String verificaComprobantePago(String secImpresora, int cantCantComprobantes) throws SQLException {
...
FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_DEL_CLI.CLI_F_VAR_PARTIDA_LLEGADA(?,?,?)", parametros);
    ...
    public static void grabaFormaPagoPedido(String pCodFormaPago, String pImPago, String pTipMoneda,
                                            ...
                                            String pDNITarj, String pCodAutori, String pCodLote) throws SQLException {
    ...
    public static String getInd_prod_rimac_activado(String pNumPedVta,
        ...
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(pNumPedVta);
        log.debug("PTOVENTA_RIMAC_MATRIZ.GET_IND_EXISTE_PEDIDO_ACT(?,?,?,?):" + parametros);
        return FarmaDBUtilityRemoto.executeSQLStoredProcedureStr("PTOVENTA_RIMAC_MATRIZ.GET_IND_EXISTE_PEDIDO_ACT(?,?,?,?)",    
                                                                parametros, 
                                                                FarmaConstants.CONECTION_MATRIZ,
                                                                pIndCloseConecction);
    }
    ...
    */
    ...
    public static String getNumeroComprobante(String pCodGrupoCia, String pCodLocal, String pNumPedVta, String pSecCompPago) throws Exception{
        ArrayList parametros = new ArrayList();
        parametros.add(pCodGrupoCia);
        parametros.add(pCodLocal);
        parametros.add(pNumPedVta);
