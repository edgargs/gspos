...
public class DlgBuscaTelefono extends JDialog
{
  ...
  {
    System.out.println("Numero Telefonico  : " + VariablesDelivery.vNumeroTelefono);
  ...
  private void chkKeyPressed(KeyEvent e)
  {
    if(e.getKeyCode() == KeyEvent.VK_F11 || e.getKeyCode() == KeyEvent.VK_ENTER)
    {
      ...
      System.out.println("VariablesDelivery.vNombreInHashtable : " + VariablesDelivery.vNombreInHashtable);
      VariablesDelivery.vCampo = FarmaLoadCVL.getCVLCode(VariablesDelivery.vNombreInHashtable,cmbTipotelefono.getSelectedIndex());
      System.out.println("Tipo telefono *********************: " + VariablesDelivery.vCampo);
  ...
  private void cerrarVentana(boolean pAceptar)
    ...
    System.out.println("FarmaVariables.vImprTestigo : " + FarmaVariables.vImprTestigo);
		FarmaVariables.vAceptar = pAceptar;
    VariablesVentas.vEsPedidoDelivery = false ;
    System.out.println("VariablesVentas.vEsPedidoDelivery : " + VariablesVentas.vEsPedidoDelivery);
  ...
  private void obtieneNumeroTelefono()
  {
    ...
    {
      System.out.println("Telefono"+VariablesDelivery.vNumeroTelefono);
      cerrarVentana(true);
    }
