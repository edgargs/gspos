...
public class DBReportes 
{
  ...
  public static void obtieneComprobantes_Venta_Detalle(FarmaTableModel pTableModel,
                                               String pCodigo,
                                               String pNumPedVtaRep,
                                               String tipcCompr) throws SQLException {
 ...
 public static void cargaListaVentasDiaMes(FarmaTableModel pTableModel) throws SQLException {
  ...
  public static void cargaListaFormasPago(FarmaTableModel pTableModel, String nroPedido) throws SQLException
  {
    ...
    public static void cargaListaFormasPagoDel(ArrayList pArray, String nroPedido) throws SQLException
    {
      ...
      parametros.add(nroPedido);
      log.debug("carga lista de fornmas de pago "+parametros);
      FarmaDBUtility.executeSQLStoredProcedureArrayList(pArray,"PTOVENTA_REPORTE.REPORTE_FORMAS_PAGO_RESUMEN(?,?,?)",parametros);
 ...
 * */
   ...
   FarmaDBUtility.executeSQLStoredProcedure(pTableModel,"PTOVENTA_REPORTE.REPORTE_DET_VENTAS_VEND_TIPO(?,?,?,?,?,?)",parametros,false);
    ...
    public static void listaCamposFiltroReporteVtaDelivery(ArrayList pArray, 
                                                           String pTabla) throws SQLException {
    ...
    public static String obtenerTipoDatoColumn(String pTabla, String pColumna) throws SQLException{
        ...
        return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_REPORTE.GET_TIPO_DATO_COLUMN(?,?)",
                                                          parametros);
    }
}