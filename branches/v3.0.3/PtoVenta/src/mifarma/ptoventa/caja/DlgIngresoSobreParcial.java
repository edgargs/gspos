...
public class DlgIngresoSobreParcial extends JDialog {
    ...
    private void cargaCombo() {
        FarmaLoadCVL.loadCVLfromArrays(cmbMoneda, ConstantsSobres.HASHTABLE_MONEDASOBRES, ConstantsSobres.MONEDAS_COD,
    ...
    private void this_windowOpened(WindowEvent e) {
        ...
        //ERIOS 2.4.4 Valida caja aperturada
    ...
    private void cmbMoneda_keyPressed(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            VariablesSobre.vDescTipoMon =
                    FarmaLoadCVL.getCVLDescription(ConstantsSobres.HASHTABLE_MONEDASOBRES, VariablesSobre.vCodTipoMon);
            FarmaUtility.moveFocus(txtMonto);
    ...
    private boolean obtieneDatosFormaPago() {
        ...
        if (VariablesSobre.vCodTipoMon.equalsIgnoreCase(ConstantsCaja.EFECTIVO_SOLES)) {
            VariablesSobre.vCodFormaPagoTmp = ConstantsCaja.FORMA_PAGO_EFECTIVO_SOLES;
            ...
            VariablesSobre.vCodFormaPagoTmp = ConstantsCaja.FORMA_PAGO_EFECTIVO_DOLARES;
            VariablesSobre.vDescFormaPagoTmp = "EFECTIVO DOLARES";
        }


        log.debug(" DUBILLUZ ::::txtMonto.getText()" + FarmaUtility.getDecimalNumber(txtMonto.getText().trim()));
        //VariablesCaja.vValMontoPagadoTmp = FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber(txtMonto.getText().trim()));
        VariablesSobre.vValMontoPagadoTmp = FarmaUtility.getDecimalNumber(txtMonto.getText().trim()) + "";
        log.debug("JCORTEZ :::: VariablesSobre.vValMontoPagadoTmp" + VariablesSobre.vValMontoPagadoTmp);

        if (VariablesSobre.vCodTipoMon.equalsIgnoreCase(FarmaConstants.CODIGO_MONEDA_SOLES)) {
            VariablesSobre.vValTotalPagadoTmp = VariablesSobre.vValMontoPagadoTmp;
            ...
            log.debug("dolares");
            log.debug("FarmaUtility.getDecimalNumber(VariablesSobre.vValMontoPagadoTmp):" +
                      FarmaUtility.getDecimalNumber(VariablesSobre.vValMontoPagadoTmp));
            log.debug("FarmaUtility.getDecimalNumber(VariablesSobre.vValTipoCambioPedido):" +
                      FarmaUtility.getDecimalNumber(VariablesSobre.vValTipoCambioPedido));
        }


        log.debug(" 1.VariablesSobre.vCodFormaPagoTmp" + VariablesSobre.vCodFormaPagoTmp);
        log.debug("2.VariablesSobre.vIndTarjetaSeleccionada" + VariablesSobre.vDescFormaPagoTmp);

        log.debug("5.VariablesSobre.vValMontoPagadoTmp" + VariablesSobre.vValMontoPagadoTmp);
        log.debug("6.VariablesSobre.vValTotalPagadoTmp" + VariablesSobre.vValTotalPagadoTmp);

        //validar monto ingresado no mayor al existente en ventas
        try {
            String sTotal = lblTotal.getText().trim();
            String TotalVentas = DBCaja.getMontoVentas(VariablesSobre.vSecMovCaja);
