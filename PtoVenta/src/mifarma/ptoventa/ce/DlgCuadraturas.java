...
public class DlgCuadraturas extends JDialog {
    ...
    private void jbInit() throws Exception {
        ...
        this.setSize(new Dimension(455, 298));
        ...
        scrLista.setBounds(new Rectangle(10, 30, 430, 205));
        tblLista.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent e) {
                tblLista_keyPressed(e);
            }
        });
        pnlTitle1.setBounds(new Rectangle(10, 10, 430, 20));
    ...
    private void initTable() {
        tableModel =
                new FarmaTableModel(ConstantsCajaElectronica.columnsListaCuadraturas, ConstantsCajaElectronica.defaultValuesListaCuadraturas,
                                    0);
