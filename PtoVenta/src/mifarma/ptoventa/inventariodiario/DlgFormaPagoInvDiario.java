...
public class DlgFormaPagoInvDiario extends JDialog {
    ...
    private static final Logger log = LoggerFactory.getLogger(DlgFormaPagoInvDiario.class);
    ...
    private void initTableDetallePago() {
        tableModelDetallePago =
                new FarmaTableModel(ConstantsInvDiario.columsListaDetallePago, ConstantsInvDiario.defaultListaDetallePago,
                                    0);
        FarmaUtility.initSimpleList(tblDetallePago, tableModelDetallePago, ConstantsInvDiario.columsListaDetallePago);
    }
    ...
    private void cobrarPedido() {
        ...
        DlgProcesaCobroInvDiario dlgProcesarCobro =
            new DlgProcesaCobroInvDiario(myParentFrame, "", true, tblDetallePago, lblVuelto, tblDetallePago,
                                         txtNroPedido);
    ...
    private boolean obtieneIndCajaAbierta_ForUpdate(String pSecMovCaja) {
        ...
        try {
            ...
            FarmaUtility.showMessage(this, "Error al obtener la fecha de movimiento de caja.", tblDetallePago);
            return false;
        }
    }
    ...
    private void colocaFormaPagoPedido(String pNumPedido) {
        try {
            DBInvDiario.cargaFormaPagoPedidoInvDiario(tableModelDetallePago.data, pNumPedido);
            tableModelDetallePago.fireTableDataChanged();
        } catch (SQLException ex) {
            log.error(null, ex);
            FarmaUtility.showMessage(this, "Error al obtener forma del Pedido.\n" +
    ...
    private void validaInfoPedido(ArrayList pArrayList) {
        if (pArrayList.size() < 1) {
            ...
            FarmaUtility.showMessage(this, "Se encontró más de un pedido.\n" +
                    "Pónganse en contacto con el área de Sistemas.", txtNroPedido);
