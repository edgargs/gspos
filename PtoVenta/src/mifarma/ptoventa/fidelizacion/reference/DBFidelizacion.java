...
public class DBFidelizacion {
    ...
    * */
    ...
    public static double getDctoPersonalizadoCampanaProd(String pCodCampana, String pCodProd) throws SQLException {
        ...
        parametros.add(pCodCampana.trim());
        parametros.add(pCodProd.trim());
        log.debug("Obtiene el descuento personalizado por producto en campana PTOVENTA_CAMPANA.GET_NUM_DSCTO_PROD_USO_CAMP:" +
                  parametros);
    ...
    public static String obtieneImprVoucherFid(String pDniCliente) throws SQLException {
        ...
        return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_IMP_CUPON.F_IMPR_VOU_FID_TARJ_NEW(?,?,?,?,?)",
                                                           parametros);
    }
