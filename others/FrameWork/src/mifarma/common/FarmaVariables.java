...
public class FarmaVariables {
    ...
    public static String vIdUsuDBMatriz = "";
    public static String vClaveBDMatriz = "";
    public static String vIpServidorDBMatriz = "";
    public static String vSidDBMatriz = "";

    /** Variables de carga para el properties de la base de datos de DELIVERY*/
    public static String vIdUsuDBDelivery = "";
    public static String vClaveBDDelivery = "";
    public static String vIpServidorDBDelivery = "";
    public static String vSidDBDelivery = "";

    //Agregado por DVELIZ 15.12.2008
    /** Variables de carga para el properties de la base de datos de ADM Central*/
    public static String vIdUsuDBADMCentral = "";
    public static String vClaveBDADMCentral = "";
    public static String vIpServidorDBADMCentral = "";
    public static String vSidDBADMCentral = "";


    //Agregado por FRAMIREZ 16.12.2012
    /** Variables de carga para el properties de la base de datos de Rac*/
    public static String vIdUsuDBRac      = "";
    public static String vClaveBDRac      = "";
    public static String vIpServidorDBRac = "";
    public static String vSidDBRac        = "";
