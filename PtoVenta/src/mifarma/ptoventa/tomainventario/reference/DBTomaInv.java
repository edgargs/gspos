...
public class DBTomaInv {
     ...
     */
        parametros.add(pIdUsu.trim());
        parametros.add((UtilityPtoVenta.isLocalVentaMayorista())?"S":"N"); //LTAVARA 10.02.16
        log.debug("valor " + parametros);
        //parametros.add(FarmaVariables.vIdUsu.trim());
    ...
    public static void getListaProductoTomaLote(FarmaTableModel pTableModel) throws SQLException {
        parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(VariablesTomaInv.vSecToma.trim());
        ...
        FarmaDBUtility.executeSQLStoredProcedure(pTableModel, "PTOVENTA_TOMA_INV.TI_LISTA_PROD_LAB_LOT_TOMA_INV(?,?,?,?,?)",
                                                 parametros, false);
    }
    ...
    public static void ingresaCantidadProdInv(String pCantToma) throws SQLException {
        ...
        parametros.add((UtilityPtoVenta.isLocalVentaMayorista())?"S":"N");
        parametros.add( VariablesTomaInv.vIndActualizaProd);
        parametros.add(VariablesTomaInv.vLoteIngresado);
    ...
    /**
     * retorna los datos del producto por lote.
     * @author LTAVARA
     * @since  08.02.16
     * @param pArrayList
     * @param pCodProducto
     * @throws SQLException
     */
    public static void getInfoProdLote(ArrayList pArrayList, String pCodProducto,String pLote) throws SQLException {
        parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(pCodProducto.trim());
        parametros.add(pLote.trim());
        log.debug("load PTOVENTA_TOMA_INV.TI_LISTA_PROD_LAB_LOT_TOMA_INV(?,?,?,?) :" + parametros);
        FarmaDBUtility.executeSQLStoredProcedureArrayList(pArrayList, "PTOVENTA_TOMA_INV.TI_LISTA_PROD_LAB_LOT_TOMA_INV(?,?,?,?)",
                                                          parametros);
    }
    ...
    public static void insertAuxConteo(String pSecTomaInv, int pSecAuxConteo, String pCodProd, String pCodBarra,
                                       String pCant, String pValFracConteo, String pIndNoFound, String pLote) throws SQLException {
        ...
        //LTAVARA 29/01/2016 LOCAL MAYORISTA
        parametros.add((UtilityPtoVenta.isLocalVentaMayorista())?"S":"N");
    ...
    public static void updateProdConteo(String pSecTomaInv, String pAuxSecConteo, String pCantEnt,
                                        String pCantFraccion, String lote) throws SQLException {
        parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(pSecTomaInv);
        ...
        parametros.add(FarmaVariables.vIpPc);
        parametros.add("N");
        //LTAVARA 29.01.16 - Local Mayorista
        parametros.add((UtilityPtoVenta.isLocalVentaMayorista())?"S":"N");
        parametros.add(lote);
    ...
    public static void delProdConteo(String pSecTomaInv, String pAuxSecConteo) throws SQLException {
        ...
        parametros.add(FarmaVariables.vIdUsu);
        parametros.add(FarmaVariables.vIpPc);
        parametros.add("S");// indicador elimina
        parametros.add((UtilityPtoVenta.isLocalVentaMayorista())?"S":"N");//LTAVARA 29.01.16 INDICAR LOCAL MAYORISTA
    ...
    public static void getListaProdsDiferenciasTotales(FarmaTableModel pTableModel) throws SQLException {
        ...
        FarmaDBUtility.executeSQLStoredProcedure(pTableModel, "PTOVENTA_TOMA_INV.TI_LISTA_DIF_TOMA_INV(?,?,?)",
                                                 parametros, false);
    }
     ...
     * @throws SQLException
     */
    public static String getExisteLotePorProducto(String pCodProducto,String pLote)throws SQLException{
        ...
        parametros.add(pCodProducto.trim());
        parametros.add(pLote.trim());
        log.debug("load PTOVENTA_TOMA_INV.TI_F_GET_EXISTE_LOTE_PROD(?,?,?,?) :" + parametros);
        return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_TOMA_INV.TI_F_GET_EXISTE_LOTE_PROD(?,?,?,?)",
                                                          parametros);
    }

    /**
     * Obtener el valfrac del producto master pack
     * retorna indicador
     * @author ltavara
     * @since  01.02.2016
     * @param cCodBarra_in 
     ...
     * @throws SQLException
     */
    public static Integer getValFracMasterPackProducto(String cCodBarra_in,String cCodProd_in)throws SQLException{
       String valor="0";
        parametros = new ArrayList();
        parametros.add(cCodBarra_in);
        parametros.add(cCodProd_in);
        log.debug("load PTOVENTA_TOMA_INV.TI_F_GET_VAL_FRAC_MASTER_PACK(?,?) :" + parametros);
       
        valor =FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_TOMA_INV.TI_F_GET_VAL_FRAC_MASTER_PACK(?,?)",
                                                          parametros);
     ...
     * @throws SQLException
     */
    public static String getSinLote()throws SQLException{
