...
public class DlgProductosPorTomaCiclico extends JDialog {
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(643, 416));
        ...
        jPanelHeader1.setBounds(new Rectangle(15, 10, 610, 50));
        jPanelHeader1.setLayout(null);
        jPanelTitle1.setBounds(new Rectangle(15, 65, 610, 25));
        jPanelTitle1.setLayout(null);
        jScrollPane1.setBounds(new Rectangle(15, 90, 610, 260));
        ...
        lblF1.setBounds(new Rectangle(180, 355, 135, 20));
        lblF1.setText("[ F1 ] Ver Diferencias");
        lblEscape.setBounds(new Rectangle(515, 355, 110, 20));
        ...
        lblRellenar.setBounds(new Rectangle(340, 355, 155, 20));
        ...
        tblRelacionProductos.getTableHeader().setReorderingAllowed(false);
        tblRelacionProductos.getTableHeader().setResizingAllowed(false);        
    ...
    private void cargaListaProductosXLaboratorio() {
        try {
            ...
            //VariablesInvCiclico. =tblRelacionProductos.getRowCount(). 
