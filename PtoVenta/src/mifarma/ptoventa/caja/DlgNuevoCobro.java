...
import mifarma.ptoventa.puntos.DlgConsultaSaldoPuntos;
...
public class DlgNuevoCobro extends JDialog {
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(447, 452));
        this.getContentPane().setLayout(borderLayout1);
        this.setFont(new Font("SansSerif", 0, 11));
        this.setTitle("Cobrar Pedido");
        this.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
        this.setBounds(new Rectangle(10, 10, 447, 510));
        ...
        jPanel3.setBounds(new Rectangle(10, 175, 420, 35));
        ...
        jPanel1.setBounds(new Rectangle(10, 240, 420, 125));
        ...
        lblEsc.setBounds(new Rectangle(340, 425, 90, 35));
        lblF11.setText("<HTML><CENTER>[F11]<BR>Aceptar</HTML></CENTER>");
        lblF11.setBounds(new Rectangle(230, 425, 90, 35));
        pnlTotales.setBounds(new Rectangle(10, 375, 420, 40));
        ...
        pnlTotal.setBounds(new Rectangle(10, 5, 420, 170));
        ...
        lblF9.setBounds(new Rectangle(10, 425, 90, 35));
        lblF9.setText("<HTML><CENTER>[ F9 ] Canje<BR>de Puntos</HTML></CENTER>");
        lblF9_BLOQUEO.setBounds(new Rectangle(10, 425, 90, 35));
        ...
        lblF10.setBounds(new Rectangle(120, 425, 90, 35));
        ...
        pnlPuntos2.setBounds(new Rectangle(10, 215, 420, 20));
        ...
        lblPuntosRedimir_T.setBounds(new Rectangle(0, 0, 160, 20));
        lblPuntosRedimir_T.setForeground(SystemColor.window);
        lblPuntosRedimir.setText("0,000.00");
        lblPuntosRedimir.setBounds(new Rectangle(160, 0, 50, 20));
        ...
        pnlTotal.add(lblAhorro, new XYConstraints(334, 39, 70, 20));
        pnlTotal.add(lblAhorro_T, new XYConstraints(189, 39, 145, 20));
        pnlTotal.add(lblSolesTotalVenta, new XYConstraints(334, 19, 70, 20));
        pnlTotal.add(lblTotalVenta, new XYConstraints(224, 19, 110, 20));
        pnlTotal.add(lblTipoComprobante, new XYConstraints(4, 4, 400, 20));
        pnlTotal.add(lblRazSoc, new XYConstraints(94, 64, 315, 15));
        pnlTotal.add(lblRazSoc_T, new XYConstraints(4, 64, 85, 15));
        pnlTotal.add(lblMensaje, new XYConstraints(4, 84, 410, 40));
        pnlTotal.add(lblMsjNumRecarga, new XYConstraints(9, 134, 125, 20));
        pnlTotal.add(pnlCopago, new XYConstraints(149, 134, 245, 25));
    ...
    private String calcularRestoParaTarjeta() {
        ...
        dblSaldo = tmpDblMonto1 - tmpDblMonto2 - (tmpDblMonto3 * tmpDblMonto4) - tmpDblMonto5;
        if (dblSaldo <= 0) {
            dblSaldo = 0.0;
        }
    ...
    private void cargarFormaPago() {
        ...
        if (VariablesCaja.vIndPedidoConvenio.equalsIgnoreCase(FarmaConstants.INDICADOR_S) &&
            ...
            if (esCredito.equalsIgnoreCase("S")) {
                try {
                    creditoSaldo =
                            DBConvenio.obtieneConvenioCredito(codConvenio, codCliente, FarmaConstants.INDICADOR_S);
                } catch (SQLException e) {
                    log.error("", e);
    ...
    private void funcionF9() {
        limpiarPagos();
        facadeLealtad.ingresarPuntosRedencion(myParentFrame,this,VariablesCaja.vNumPedVta,lblPuntosRedimidos, lblMontoRedencion);
        if (FarmaVariables.vAceptar) {
            FarmaVariables.vAceptar = false;                   
    ...
    /**
     * limpia variables de los datos del cliente al cerrar la venta
     * @author desarrollo3
     * @since 2015.02.25
     */
    private void limpiaVariableDatosCliente() {
        VariablesVentas.vRuc_Cli_Ped = "";
        VariablesVentas.vNom_Cli_Ped = "";
        VariablesVentas.vDir_Cli_Ped = "";
    }
