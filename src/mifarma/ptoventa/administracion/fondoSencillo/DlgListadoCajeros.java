...
public class DlgListadoCajeros extends JDialog {
    ...
    private void asignarFondo(){
        ...
        if (vFila != -1){  
            ...
            System.out.println("estado:"+estado+"-"+estado.trim().length());
            if (estado.trim().length()==0) {
                ...
                System.out.println("Var.vSecUsuCajero:"+VariablesFondoSencillo.vSecUsuCajero);
                System.out.println("Var.vNombresCajero:"+VariablesFondoSencillo.vNombresCajero);
                System.out.println("Var.vApePaterno:"+VariablesFondoSencillo.vApePaterno);
