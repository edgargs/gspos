 ...
 */
    ...
    public static void actualizaComprobanteImpreso(String pSecCompPago, String pTipCompPago,
        ...
        parametros.add(FarmaVariables.vIdUsu);
        log.info("PTOVENTA_CAJ_ANUL.CAJ_ACTUALIZA_COMPROBANTE_IMPR(?,?,?,?,?,?,?) parametros : " + parametros);
    ...
    public static String agregarDetalleNotaCredito(String numPedVta, String numera, String codProd, String cant,
        ...
        parametros.add(UtilityEposTrx.validacionEmiteElectronico() == true ? "1" :
                       "0"); //LTAVARA 04.09.2014 FLAG PROCESO ELECTRONICO
    ...
    public static String obtieneSecNumeraTrace(int pLength) throws SQLException {
        ...
        String nuSecMovimiento =
            String.valueOf(FarmaDBUtility.executeSQLStoredProcedureInt("PTOVENTA_CAJ.OBTENER_NUMERACION_TRACE(?,?)",
                                                                       parametros));
...
FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_DEL_CLI.CLI_F_VAR_PARTIDA_LLEGADA(?,?,?)", parametros);
    ...
    */
    ...
    public static String getNumeroComprobante(String pCodGrupoCia, String pCodLocal, String pNumPedVta,
        ...
        parametros.add(pNumPedVta);
        parametros.add(pSecCompPago);
        log.info("PTOVENTA_CAJ.GET_NRO_COMPROBANTE_PAGO(?,?,?,?) " + parametros);
    ...
    public static String getIndVariosCompPedido(String pNumPedVta) throws SQLException {
        ...
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(pNumPedVta);
        log.info("PTOVENTA_FIDELIZACION.FID_F_GET_IND_VARIOS_COMP(?,?,?): " + parametros);
    ...
    public static List imprVouPtosCliente(String pNumPedVta) throws SQLException {
        ...
        //parametros.add((VariablesPuntos.frmPuntos.getTarjetaBean() == null) ? 0 : VariablesPuntos.frmPuntos.getTarjetaBean().getAhorroTotal());
        log.info("PTOVENTA_FIDELIZACION.F_IMPR_VOU_INFO_PTOS(?,?,?,?,?,?): " + parametros);
    ...
    public static boolean getIndAnularConCuponUsado() throws SQLException {
        ArrayList parametros = new ArrayList();
        log.info("invocando a PTOVENTA_CAJ_ANUL.F_IND_ANULA_CON_CUPONES_USADOS :" + parametros);
