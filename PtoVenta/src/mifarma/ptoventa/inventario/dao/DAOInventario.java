...
public interface DAOInventario extends DAOTransaccion {
     ...
     * @throws SQLException
     */
    public ArrayList listarProdOrdenCompraSobrante(String pCodOrdCompra) throws SQLException;

    public ArrayList<ArrayList<String>> listarProductosPorOrdenCompra(String pNumeroOC,
                                                                      NotaEsCabDetDTO ordenCompraCabDTO) throws SQLException;
    ...
    public ArrayList<ArrayList<String>> getCabOrdenCompraRecep(String pCodOrComp,
    ...
    public String anularRecepGuiaIngreso(String vCodGrupoCia, String vCodLocal, String vNumerGuia,
                                         String vIdeDocumento, String vNumeroDocument) throws SQLException;

    public void anulaDocumentoRecep(String vCodGrupoCia, String vCodLocal, String vNumerGuia, String cCodMotKardex_in,
                                    String cTipDocKardex_in, String vUser) throws SQLException;
     ...
     * @throws SQLException
     */
    public ArrayList<ArrayList<String>> listaOrdenDeCompraByFecha(String pFinFecha,
                                                                  String pIniFecha) throws SQLException;
    ...
    public String graba_Nota_Es_Cab(String CodGrupoCia_in, String CodLocal_in, String TipDestino_in,
                                    ...
                                    String CodMotTransInterno_in) throws SQLException;
     ...
     * @throws SQLException
     */
    public void grabarGuiaRemision(String vCodGrupoCia, String vCodLocal, String vIdUsu,
     ...
     * @throws SQLException
     */
    public void actualizaTextoImpresion(String vCodGrupoCia, String CodLocal, String NumNota,
                                        String textoImpr) throws SQLException;
     ...
     * @throws SQLException
     */
    public ArrayList<ArrayList<String>> getListaGuiasNoMuevenstock(String cCodGrupoCia,
     ...
     * @throws SQLException
     */
    public ArrayList<ArrayList<String>> getListaMaestroProductos(String cCodGrupoCia,
                                                                 String cCodLocal) throws SQLException;
    ...
    public void grabaCabRecep(String cCodGrupoCia, String cCodCia, String cCodLocal, String cCodOC, String cCodProv,
                              String cCantItem, String cIdUsu, String cNumNota) throws SQLException;
     ...
     * @throws SQLException
     */
    public String getNumAjuste(String pCodProd, String pNumComPago, String pCodMotKardex,
                               String pTipDocKardex) throws SQLException;
