 ...
 public class DlgListaCampAcumulada extends JDialog 
 {
       ...
       try{
          ...
          /* if(VariablesCampAcumulada.vListaCampanias.size()>0){
               ...
               for(int i=0 ; i < VariablesCampAcumulada.vListaCampanias.size() ; i++){
                   ...
                   System.err.println("codCamp:"+codCamp+"***");
                   for(int j=0; j < tableModelDisp.getRowCount() ; j++){
                       System.err.println("validando con :"+tableModelDisp.getValueAt(j,COL_COD_CAMP).toString().trim()+"***");
   ...
   private void  txtCampania_keyPressed(KeyEvent e){
          ...
          || e.getKeyCode() == KeyEvent.VK_ENTER){
           ...
           if(e.getKeyCode() == KeyEvent.VK_ENTER && 
                        ...
                        if( row >= 0 ){
                            ...
                            System.err.println("cod_campnias : "+VariablesCampAcumulada.vListaCampanias);
           ...
           if(rowSel >= 0){
               System.out.println("tableModelDisp.getValueAt(rowSel,5).toString().trim():"+tableModelDisp.getValueAt(rowSel,5).toString().trim());
               //System.out.println("\nlerolero\nlero lero\n****");
     ...
     private void txtCampania_keyReleased(KeyEvent e) {
         ...
         int rowSel = tblCampAcumuDisponibles.getSelectedRow();
         if(rowSel >= 0){
             System.out.println("tableModelDisp.getValueAt(rowSel,5).toString().trim():"+tableModelDisp.getValueAt(rowSel,COL_MSG_CAMP).toString().trim());
             //System.out.println("\nlerolero\nlero lero\n****");
             txtAreaMensaje.setText(tableModelDisp.getValueAt(rowSel,5).toString().trim());
         }
     }
     ...
     private void btnListaCampAcumuCliente_keyPressed(KeyEvent e){
         ...
         if(e.getKeyCode() == KeyEvent.VK_UP || e.getKeyCode() == KeyEvent.VK_DOWN || 
            e.getKeyCode() == KeyEvent.VK_PAGE_UP || e.getKeyCode() == KeyEvent.VK_PAGE_DOWN){
             ...
             if(rowSel >= 0){
                 System.out.println("tableModelDisp.getValueAt(rowSel,5).toString().trim():"+tableModelInsc.getValueAt(rowSel,COL_MSG_CAMP-1).toString().trim());
                 //System.out.println("\nlerolero\nlero lero\n****");
     ...
     {
         //System.out.println("move focus txtCampania... del Acceso");
   ...
   private void chkKeyPressed(KeyEvent e)
   {
     ...
     System.err.println("VariablesOtros.vFlagDialogAbierto:"+VariablesCampAcumulada.vFlagDialogAbierto);
        ...
        if(VariablesCampAcumulada.vListaCampanias.size()>0){//lista de campañas asociadas
            ...
            if(FarmaVariables.vAceptar){
                ...
                if(VariablesFidelizacion.vNumTarjeta.trim().length()>0){//quiere decir que ya tiene e ingreso el numero de tarjeta al sistema
                    ...
                    System.err.println("asociando clientes con las campanias");
                    ...
                    */
                    ...
                    System.err.println("OBTENIENDO NUMERO DE TARJETA DE CLIENTE SI ES QUE TIENE");
                    ...
                    if (VariablesCampAcumulada.vNroTarjeta.trim().length()>0) {
                        System.err.println("VariablesCampAcumulada.vNroTarjeta:"+VariablesCampAcumulada.vNroTarjeta);
...
/*                 DlgCantItemsImprimir dlgCantItemsImprimir = new DlgCantItemsImprimir(myParentFrame,"",true);
        ...
        // }
         ...
         if(VariablesCampAcumulada.vFlagFiltro){
             ...
             if( VariablesCampAcumulada.vListaCampanias.size() < 1 ||
                 FarmaUtility.rptaConfirmDialog(this,"Se van perder las campañas seleccionadas\nDesea continuar ?")){
         ...
         for(int i=0; i < tableModelInsc.getRowCount() ; i++){//campañas del cliente
             ...
             System.err.println("cod_camp = "+cod_camp);
             for(int k=0; k < tableModelDisp.getRowCount() ; k++){//
                 if(tableModelDisp.getValueAt(k,COL_COD_CAMP).toString().trim().equals(cod_camp)){//quiere decir que encontro el inscrito en los disponibles
                     System.err.println("encontro en disponibles = "+tableModelDisp.getValueAt(k,COL_COD_CAMP).toString().trim());
   ...
   private void buscaMatrizActualizaDatosLocal(String pDni){
    ...
    private String getTarjetasCliente(String pDni){
        ...
        try {
            ...
            if(array.size()>0){//encontro tarjetas para el cliente
                System.err.println("encontro tarjetas del cliente en local : "+array);
                ...
                System.err.println("verificar si hay conexion en matriz");
                VariablesCampAcumulada.vIndConexion = FarmaUtility.getIndLineaOnLine(FarmaConstants.CONECTION_MATRIZ,
                                                                                     FarmaConstants.INDICADOR_N);
                
                System.err.println("VariablesCampAcumulada.vIndConexion:" +VariablesCampAcumulada.vIndConexion);
                ...
                if(array.size()>0){
                    System.err.println("encontro tarjetas del cliente en matriz : "+array);
                    numeroTarjeta = ((ArrayList)array.get(0)).get(0).toString();
                }
            }
                                ...
                                */
                                ...
                                if(FarmaVariables.vAceptar){//se ingreso numero de tarjeta valido para poder usar
                                   ...
                                   //no cerrara la ventana...
                                    ...
                                    //cerrarVentana(false);
                                    System.out.println("no ingreso tarjeta...");
                                }
                            }
    ...
    private void setDatosCliente(){
        ...
        System.out.println("set de variables de campaña");
