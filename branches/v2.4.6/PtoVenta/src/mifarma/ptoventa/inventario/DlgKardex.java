   ...
   private void this_windowClosing(WindowEvent e){
        ...
        if (mifarma.ptoventa.reference.UtilityPtoVenta.verificaVK_F2(e)) {
            ...
            if(!FarmaVariables.dlgLogin.verificaRol(FarmaConstants.ROL_SUPERVISOR_VENTAS) ) {
                if(FarmaVariables.vEconoFar_Matriz)
                    ...
                    (FarmaVariables.dlgLogin.verificaRol(FarmaConstants.ROL_ADMLOCAL)&& //06.08.2014 rol administrador  
                        (tipo_reposicion.equals(ConstantsCaja.TIPO_REPOSICION_INSUMOS))) //06.08.2014 rol administrador  
                    ){
                    if (tieneRegistroSeleccionado(tblListaProductos)) {
                        cargarRegistroSeleccionado();
    ...
    public void cargaListaProductos() {
        try {
            ...
            DBInventario.getListaProdsAK(tableModel,tipo_reposicion);
