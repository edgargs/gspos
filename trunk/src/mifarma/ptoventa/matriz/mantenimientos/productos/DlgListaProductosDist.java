...
import mifarma.ptoventa.matriz.mantenimientos.*;
import mifarma.ptoventa.matriz.mantenimientos.productos.*;
import mifarma.ptoventa.matriz.mantenimientos.productos.references.*;
  ...
  extends JDialog
{
  ...
  private void txtProducto_keyPressed(KeyEvent e)
  {
    ...
    if (e.getKeyCode() == KeyEvent.VK_ENTER)
    {
     System.out.println("ANTES DE LEVANTAR FILTRO :"+VariablesProducto.vIndNuevo);
       ...
       e.consume();
        ...
        {
        System.out.println("QUE EXISTA FILAS");
  ...
  private void chkKeyPressed(KeyEvent e)
  {
    ...
    {
    if(FarmaUtility.rptaConfirmDialog(this,"¿Desea salir del modulo?")){
     cerrarVentana(true);
    }
  ...
  * */
     ...
     if(txtCodLab.getText().trim().length()>0){
      ...
      cCodBusq=ConstantsProducto.LABORATORIO;
       ...
       txtCodLab.setText(FarmaUtility.completeWithSymbol(txtCodLab.getText(), 3, "0", "I"));
        ...
        System.out.println("BUSCAR LAB");
        obtieneDescripcion(txtCodLab.getText().trim()); 
        System.out.println("OBTENIDO");
         if(arrayDescripcion.size()>0){
              System.out.println("DESCRIPCION DEL LABORATORIO :"+arrayDescripcion);
              ...
              System.out.println("ENVIANDO FILTRO LAB :"+VariablesProducto.cCodLab);
              /**
              * 
              **/
              ...
              System.out.println("COD LABORATORIO FILTRO:"+txtCodLab.getText().trim());
  ...
  int row=tblListaProductos.getSelectedRow();
    ...
    if(ExistTemporalPendiente()){
      System.out.println("NO EXISTE PEDIDO TEMPORAL");
      generarNumTemporal();
    }
    ...
    System.out.println("VariablesProducto.cCodLab "+VariablesProducto.cCodLab);
      ...
      if(!VariablesProducto.cCodLab.equalsIgnoreCase("")){
       ...
       /* listarProductos(ConstantsProducto.vFiltroListaProducto);
        ...
        System.out.println("Columna Orden -->"+VariablesProducto.vOrden);
        System.out.println("Columna columna -->"+VariablesProducto.vColumna);
        System.out.println("Producto -->"+VariablesProducto.cCodProd);
  ...
  * */
  private void generarNumTemporal(){
    ...
    System.out.println("Numero de pedido Temporal Generado :"+VariablesProducto.vNumPedidoDistGenerado_aux);
  ...
  private void generarPedidoTemporal(){
   ...
   try{
        ...
        System.out.println("Numero de pedido Temporal :"+VariablesProducto.vNumPedidoDistGenerado_aux);
  ...
  private void generarPedidoDistribucion(){
    ...
    try{
      ...
      //se genera el pedido temporal guardar
      System.out.println("Numero de pedido generado :"+VariablesProducto.vNumPedidoDistGenerado);
  ...
  private void agregarProductosTemporal(){
    ...
    try{
      ...
      System.out.println("RETORNO :"+revisado);
  ...
  private void filtrar(){
   ...
   dlgfiltro.setVisible(true);
      ...
      if(!VariablesProducto.cCodLab.equalsIgnoreCase("")){
          ...
          System.out.println("tipo de filtro :"+VariablesProducto.vIndNuevo);
          //listarProductos(VariablesProducto.cCodLab);
