...
public class DlgDetalleRegistroVentas extends JDialog 
{
  ...
  /* ************************************************************************ */
    ...
    private void jbInit() throws Exception
    {
        ...
        jPanelHeader1.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(255, 130, 14)),
                                                                 "DATOS DEL PEDIDO",
                                                                 TitledBorder.CENTER,
        ...
        jPanelTitle2.setBounds(new Rectangle(10, 375, 725, 25));
        ...
        pnlDatosDelivery.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(43, 141, 39)),
                                                                 "DATOS DE REPARTO",
                                                                 TitledBorder.CENTER,
                                                                    TitledBorder.DEFAULT_POSITION,
                                                                 new Font("SansSerif", 1, 11),
        ...
        jLabelOrange1.setText("Vuelto:   S/.");
    ...
    {
        tableModelFormasPago = new FarmaTableModel(ConstantsReporte.columnsListaFormasdePago,ConstantsReporte.defaultValuesListaListaFormasdePago,0);
        FarmaUtility.initSimpleList(tblListaFormasPago,tableModelFormasPago,ConstantsReporte.columnsListaFormasdePago);
    }
    ...
    private void cargaVariables()
    {
        ...
        if(indResumenDelivery){
            ...
            if(indVerDelivery){
                ...
                FarmaUtility.moveFocusJTable(tblDetallePedidos);
                VariablesCaja.vVuelto = FarmaUtility.formatNumber(FarmaUtility.sumColumTableModel(tableModelFormasPago,3));
                lblVuelto.setText(VariablesCaja.vVuelto);
            }else{
