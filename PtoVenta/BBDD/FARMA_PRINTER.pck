...
/* *************************************************************** */
  ...
  begin
    ...
    IF vCodMarca = '001' THEN
      vNombreImagen:= 'C:\\farmaventa\\imagenes\\LogoEMifarma.jpg';
    ELSIF vCodMarca = '002' THEN
      vNombreImagen:= 'C:\\farmaventa\\imagenes\\LogoEFasa.jpg';
    ELSIF vCodMarca = '003' THEN
      vNombreImagen:= 'C:\\farmaventa\\imagenes\\LogoEBTL.jpg';
    ELSIF vCodMarca = '004' THEN
      vNombreImagen:= 'C:\\farmaventa\\imagenes\\LogoEMimarket.jpg';
    END IF;
    
    P_AGREGA_IMAGEN(vIdDoc_in => vIdDoc_in,vIpPc_in => vIpPc_in,vRutaImagen_in => vNombreImagen);
/*    P_GRABA_LINEA_DOC( vIdDoc_in => vIdDoc_in,
                       vIpPc_in => vIpPc_in,
                       vValor_in => vNombreImagen,
...
/* *************************************************************** */  
  ...
  FUNCTION APLICA_JUSTIFICA(vLinea_in              IN VARCHAR2,
    ...
    CURSOR curLineas is
    SELECT X.CADENA
    FROM (SELECT EXTRACTVALUE(xt.column_value, 'e') cadena
