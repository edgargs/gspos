...
// **************************************************************************
  ...
  private void cargaListado()
  {
        ...
        if(VariablesInvDiario.vListaTrabSeleccionados.size()>0){
            for(int i=0;i<listaTrab.size();i++){
                for(int j=0;j<VariablesInvDiario.vListaTrabSeleccionados.size();j++){
                    //System.out.println(FarmaUtility.getValueFieldArrayList(listaTrab,i,0));
                    //System.out.println(FarmaUtility.getValueFieldArrayList(VariablesInvDiario.vListaTrabSeleccionados,j,0));
    ...
    {
      System.out.println("error al cargar lista de maestros Trabajadores: " + e);
    }
  }
