 ...
 *
 */
public class DlgDatosConvenio extends JDialog {
  ...
  JTextField vNomTrabDependiente = new JTextField();*/
    ...
    private void initTable() {
        ...
        tableModel =
                new FarmaTableModel(ConstantsConvenio.columnsListaDatosConvenio, ConstantsConvenio.defaultValuesListaDatosConvenio,
                                    0, ConstantsConvenio.editableListaDatosConvenio, null);
    ...
    private void getTxtCodigoTrabajador(int pRow, String pTipoCampo, String pInSoloLectura) {
        ...
        addKeyListenerToTextField2(txtNomCliente, pTipoCampo, pInSoloLectura,
    ...
    private void getTxtCodigoTrabajadorEmpresa(int pRow, String pTipoCampo, String pInSoloLectura) {
        ...
        addKeyListenerToTextField3(txtCodTrabajadorEmpresa, txtNomCliente, txtNumeroDocumento, pTipoCampo,
                                   pInSoloLectura, ConstantsPtoVenta.LISTA_CLIENTES_CONVENIO, vCodTrabajador);
    ...
    private void getTxtNumeroDocumento(int pRow, String pTipoCampo, String pInSoloLectura) {
        ...
        addKeyListenerToTextField4(txtNumeroDocumento, txtNomCliente, txtCodTrabajadorEmpresa, pTipoCampo,
                                   pInSoloLectura, ConstantsPtoVenta.LISTA_CLIENTES_CONVENIO, vCodTrabajador);
    ...
    private void getTxtCodigoTrabajadorDependiente(int pRow, String pTipoCampo, String pInSoloLectura) {
        ...
        addKeyListenerToTextField5(txtCodTrabDependiente, txtNomTrabDependiente, txtNumeroDocumento, pTipoCampo,
                                   pInSoloLectura, ConstantsPtoVenta.LISTA_CLIENTES_CONVENIO,
                                   vCodTrabajadorDependiente);
    ...
    private void addKeyListenerToTextField3(final JTextField pJTextField,
        //Añadido UBILLUZ
        final JTextField pJTextField2, final JTextField pJTextField3, final String pTipoCampo,
        final String pInSoloLectura, final String pTipoMaestro, final JTextField pCodMaestro) {
     ...
     * @since  26.02.2008
     */
    private void addKeyListenerToTextField4(final JTextField pJTextField, final JTextField pJTextField2,
                                            final JTextField pJTextField3, final String pTipoCampo,
                                            final String pInSoloLectura, final String pTipoMaestro,
                                            final JTextField pCodMaestro) {
                ...
                if (mifarma.ptoventa.reference.UtilityPtoVenta.verificaVK_F1(e) && pJTextField.isDisplayable() &&
                    ...
                    if (FarmaVariables.vAceptar) {
                        ...
                        tblLista.repaint();
                           ...
                           pJTextField.isDisplayable() && vIndBusqueda.equalsIgnoreCase("T")) {
                    /*
          Si el campo de documento de identidad permite la busqueda por texto,
     ...
     * @since  13.03.2008
     */
    private void addKeyListenerToTextField5(final JTextField pJTextField, final JTextField pJTextField2,
                                            final JTextField pJTextField3, final String pTipoCampo,
                                            final String pInSoloLectura, final String pTipoMaestro,
                                            final JTextField pCodMaestro) {
    ...
    private void funcionF11() {
        if (validateMandatory() && validaIngresoNumDoc()) {
            ...
            VariablesConvenio.vTextoCliente =
                    txtTrabajador.getText() + txtNomCliente.getText() + " " + txtApellidoPaterno.getText() + " " +
                    txtApellidoMaterno.getText() + " (" + VariablesConvenio.vCodTrab + ")";
    ...
    private boolean validateMandatory() {
        ...
        for (int i = 0; i < tblLista.getRowCount(); i++) {
            ...
            if (vIndObligatorio.equalsIgnoreCase("S")) {
                ...
                if ((vCodCampo.equalsIgnoreCase(ConstantsConvenio.CAMPO_CODIGO_TRABAJADOR) &&
                     getCodTrabajador().equals("")) || vDato.length() == 0) {
                    dataExists = false;
                    moveFocusTo(i);
