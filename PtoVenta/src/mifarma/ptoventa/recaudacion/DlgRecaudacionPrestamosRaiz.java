 ...
 * Nombre de la Aplicación : DlgRecaudacionPrestamosraiz.java<br>
 * <br>
 * Histórico de Creación/Modificación<br>
 * ASOSA      05.08.2015   Creación     RAIZ<br>
 * <br>
 * @author Alfredo Sosa Dordán<br>
 * @version 1.0<br>
 *
 */
public class DlgRecaudacionPrestamosRaiz extends JDialog {

    /* ********************************************************************** */
    /*                        DECLARACION PROPIEDADES                         */
    /* ********************************************************************** */

    private static final Logger log = LoggerFactory.getLogger(DlgRecaudacionPrestamosRaiz.class);
    ...
    public DlgRecaudacionPrestamosRaiz() {
        this(null, "", false);
    }

    public DlgRecaudacionPrestamosRaiz(Frame parent, String title, boolean modal) {
        ...
        try {
            ...
            utilityRecaudacion.initMensajesVentana(this, txtFecha, txtUsuario,
                                                   ConstantsRecaudacion.TIPO_REC_PRES_CITI);
        } catch (Exception e) {
            log.error("", e);
        }
    }
    ...
    private void jbInit() throws Exception {
        ...
        this.setTitle("Recaudaci\u00f3n Prestamos Raiz");
        ...
        lblPago.setBounds(new Rectangle(10, 165, 145, 15));
    ...
    private void setVisibleDni() {
        String ind = UtilityInventario.obtenerParametroString(ConstantsRecaudacion.ID_IND_DNI_VISIBLE_RAIZ);
        if (ind.equals("N")) {
    ...
    private void funcF11() {
        ...
        if (isMontoValido()) {
            ...
            /*4*/arrayCabecera.add(ConstantsRecaudacion.TIPO_REC_RAIZ); //tipo recaudacion
            ...
            if (!tmpCodigo.equals("")) {
                if (facadeRecaudacion.cobrarRecaudacion(myParentFrame, tmpCodigo, arrayCabecera,
                                                        ConstantsRecaudacion.TIPO_REC_RAIZ)) {
                    cerrarVentana(true);
                }
            } else {
    ...
    private boolean isMontoValido() {
        ...
        if (montoMax < Double.parseDouble(strTotalVenta)) {
            flag = false;
            FarmaUtility.showMessage(this, "El monto máximo a pagar es: " + montoMax, txtRecibo);
        }
        return flag;
    }
    ...
    private boolean buscarDeuda() {
        ...
        String tramaConsulta =
            facadeRecaudacion.getTramaPresCiti(tipoCod.trim(), codBus.trim(), tipoMoneda, ConstantsRecaudacion.TIPO_TRANSACCION_PAGO,
                                               facadeRecaudacion.getCodLocalMigra(), ConstantsRecaudacion.TIPO_REC_RAIZ); //FarmaVariables.vCodLocal);
